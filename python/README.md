...
**NOTE:** Starting 3.1.0 release, the default `spark-nlp` and `spark-nlp-gpu` pacakges are based on Scala 2.12 and Apache Spark 3.x by default.

**NOTE:** Starting the 3.1.0 release, we support all major releases of Apache Spark 2.3.x, Apache Spark 2.4.x, Apache Spark 3.0.x, and Apache Spark 3.1.x
...
NOTE: The Databricks 8.1 Beta ML with GPU is not supported in Spark NLP 3.1.0 due to its default CUDA 11.x incompatibility
...
!bash colab_setup.sh -p 3.1.1 -s 3.1.0
```
