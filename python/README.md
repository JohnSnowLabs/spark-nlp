...
Spark NLP *4.0.1* has been built on top of Apache Spark 3.2 while fully supports Apache Spark 3.0.x, 3.1.x, 3.2.x, and 3.3.x:
...
- Starting 4.0.1 release, the default `spark-nlp` and `spark-nlp-gpu` packages are based on Scala 2.12.15 and Apache Spark 3.2 by default.
...
```bash
com.johnsnowlabs.nlp:spark-nlp_2.12:4.0.1
```
