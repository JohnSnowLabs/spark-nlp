...
class RegexRule(ExtendedJavaWrapper):
    def __init__(self, rule, identifier):
        super(RegexRule, self).__init__("com.jsl.nlp.util.regex.RegexRule")
...
class TaggedWord(ExtendedJavaWrapper):
    def __init__(self, word, tag):
        super(TaggedWord, self).__init__("com.jsl.nlp.annotators.common.TaggedWord")
...
class TaggedSentence(ExtendedJavaWrapper):
    def __init__(self, tagged_words):
        super(TaggedSentence, self).__init__("com.jsl.nlp.annotators.common.TaggedSentence")
...
class TokenizedSentence(ExtendedJavaWrapper):
    def __init__(self, tokens):
        super(TokenizedSentence, self).__init__("com.jsl.nlp.annotators.common.TokenizedSentence")
