...
class BertEmbeddingsPytorch(AnnotatorModel,
                     HasEmbeddingsProperties,
                     HasCaseSensitiveProperties,
                     HasStorageRef,
                     HasBatchedAnnotate):
    ...
    *We introduce a new language representation model called BERT, which stands
    ...
    @keyword_only
    def __init__(self, classname="com.johnsnowlabs.nlp.embeddings.BertEmbeddingsPytorch", java_model=None):
        super(BertEmbeddingsPytorch, self).__init__(
            classname=classname,
            java_model=java_model
        )
        self._setDefault(
    ...
    @staticmethod
    def loadTorchScriptModel(folder, spark_session):
        """Loads a locally saved model.
        ...
        BertEmbeddings
            The restored model
        """
        from sparknlp.internal import _BertPytorchLoader
        jModel = _BertPytorchLoader(folder, spark_session._jsparkSession)._java_obj
        return BertEmbeddingsPytorch(java_model=jModel)

    @staticmethod
    def pretrained(name="bert_base_cased_pt", lang="en", remote_loc=None):
        """Downloads and loads a pretrained model.
        ...
        """
        from sparknlp.pretrained import ResourceDownloader
        return ResourceDownloader.downloadModel(BertEmbeddingsPytorch, name, lang, remote_loc)
