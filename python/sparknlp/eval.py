...
class NorvigSpellEvaluation(ExtendedJavaWrapper):
    ...
    def __init__(self, test_file, ground_truth_file):
        super(NorvigSpellEvaluation, self).__init__("com.johnsnowlabs.nlp.eval.spell.NorvigSpellEvaluation")
    ...
    def computeAccuracyAnnotator(self, train_file, spell):
        return self._java_obj.computeAccuracyAnnotator(train_file, spell._java_obj)
