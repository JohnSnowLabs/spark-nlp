...
Spark NLP *2.0.9* has been built on top of Apache Spark 2.4.3
...
To use the most recent version just add the `--packages JohnSnowLabs:spark-nlp:2.0.9` to you spark command

```sh
spark-shell --packages JohnSnowLabs:spark-nlp:2.0.9
```

```sh
pyspark --packages JohnSnowLabs:spark-nlp:2.0.9
```

```sh
spark-submit --packages JohnSnowLabs:spark-nlp:2.0.9
```
...
```sbtshell
// https://mvnrepository.com/artifact/com.johnsnowlabs.nlp/spark-nlp
libraryDependencies += "com.johnsnowlabs.nlp" %% "spark-nlp" % "2.0.9"
```
...
```sbtshell
// https://mvnrepository.com/artifact/com.johnsnowlabs.nlp/spark-nlp-ocr
libraryDependencies += "com.johnsnowlabs.nlp" %% "spark-nlp-ocr" % "2.0.9"
```
...
```bash
com.johnsnowlabs.nlp:spark-nlp_2.11:2.0.9
```
