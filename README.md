...
$ pip install spark-nlp==2.5.1 pyspark==2.4.4
```
...
Spark NLP *2.5.1* has been built on top of Apache Spark 2.4.x
...
Spark NLP 2.5.1 has been tested and is compatible with the following runtimes:
...
Spark NLP 2.5.1 has been tsted and is compatible with the following EMR releases:
...
**NOTE**: To use SPark NLP with GPU you can use the dedicated GPU package `com.johnsnowlabs.nlp:spark-nlp-gpu_2.11:2.5.1`
...
```sbtshell
// https://mvnrepository.com/artifact/com.johnsnowlabs.nlp/spark-nlp
libraryDependencies += "com.johnsnowlabs.nlp" %% "spark-nlp" % "2.5.1"
```
...
```sbtshell
// https://mvnrepository.com/artifact/com.johnsnowlabs.nlp/spark-nlp-gpu
libraryDependencies += "com.johnsnowlabs.nlp" %% "spark-nlp-gpu" % "2.5.1"
```
...
3. In `Libraries` tab inside your cluster you need to follow these steps:
    ...
    3.2. Install New -> Maven -> Coordinates -> `com.johnsnowlabs.nlp:spark-nlp_2.11:2.5.1` -> Install
