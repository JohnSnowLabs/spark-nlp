...
Spark NLP *3.0.1* has been built on top of Apache Spark 3.x while fully supports Apache Spark 2.3.x and Apache Spark 2.4.x:
...
**NOTE:** Starting 3.0.1 release, the default `spark-nlp` and `spark-nlp-gpu` pacakges are based on Scala 2.12 and Apache Spark 3.x by default.

**NOTE:** Starting the 3.0.1 release, we support all major releases of Apache Spark 2.3.x, Apache Spark 2.4.x, Apache Spark 3.0.x, and Apache Spark 3.1.x
...
spark-submit --packages com.johnsnowlabs.nlp:spark-nlp-gpu_2.12:3.0.1
...
spark-submit --packages com.johnsnowlabs.nlp:spark-nlp-spark24_2.11:3.0.1
```
...
spark-submit --packages com.johnsnowlabs.nlp:spark-nlp-gpu-spark24_2.11:3.0.1
...
spark-submit --packages com.johnsnowlabs.nlp:spark-nlp-spark23_2.11:3.0.1
```
...
spark-shell --packages com.johnsnowlabs.nlp:spark-nlp-gpu-spark23_2.11:3.0.1

pyspark --packages com.johnsnowlabs.nlp:spark-nlp-gpu-spark23_2.11:3.0.1

spark-submit --packages com.johnsnowlabs.nlp:spark-nlp-gpu-spark23_2.11:3.0.1
...
spark-shell \
  ...
  --packages com.johnsnowlabs.nlp:spark-nlp_2.12:3.0.1
```
