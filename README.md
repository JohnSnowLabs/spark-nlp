...
Spark NLP *4.3.0* has been built on top of Apache Spark 3.2 while fully supports Apache Spark 3.0.x, 3.1.x, 3.2.x, and
3.3.x:
...
spark-submit --packages com.johnsnowlabs.nlp:spark-nlp-silicon_2.12:4.3.0
...
```sbtshell
// https://mvnrepository.com/artifact/com.johnsnowlabs.nlp/spark-nlp-silicon
libraryDependencies += "com.johnsnowlabs.nlp" %% "spark-nlp-silicon" % "4.3.0"
```
...
- If you are local, you can load the Fat JAR from your local FileSystem, however, if you are in a cluster setup you need
  ...
  i.e., `hdfs:///tmp/spark-nlp-assembly-4.3.0.jar`)
