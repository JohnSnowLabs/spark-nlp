...
$ pip install spark-nlp==6.2.3 pyspark==3.3.1
```
...
Spark NLP *6.2.3* has been built on top of Apache Spark 3.4 while fully supports Apache Spark 3.0.x, 3.1.x, 3.2.x, 3.3.x, 3.4.x, and 3.5.x
