...
Spark NLP *2.2.0-rc1* has been built on top of Apache Spark 2.4.3
...
To use the most recent version just add the `--packages JohnSnowLabs:spark-nlp:2.2.0-rc1` to you spark command

```sh
spark-shell --packages JohnSnowLabs:spark-nlp:2.2.0-rc1
```

```sh
pyspark --packages JohnSnowLabs:spark-nlp:2.2.0-rc1
```

```sh
spark-submit --packages JohnSnowLabs:spark-nlp:2.2.0-rc1
```
...
```sbtshell
// https://mvnrepository.com/artifact/com.johnsnowlabs.nlp/spark-nlp
libraryDependencies += "com.johnsnowlabs.nlp" %% "spark-nlp" % "2.2.0-rc1"
```
...
```sbtshell
// https://mvnrepository.com/artifact/com.johnsnowlabs.nlp/spark-nlp-ocr
libraryDependencies += "com.johnsnowlabs.nlp" %% "spark-nlp-ocr" % "2.2.0-rc1"
```
...
```bash
com.johnsnowlabs.nlp:spark-nlp_2.11:2.2.0-rc1
```
...
--packages JohnSnowLabs:spark-nlp:2.2.0-rc1,com.johnsnowlabs.nlp:spark-nlp-ocr_2.11:2.2.0-rc1,javax.media.jai:com.springsource.javax.media.jai.core:1.1.3
```
