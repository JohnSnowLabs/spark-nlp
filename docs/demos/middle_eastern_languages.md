    ...
    - title: Spark NLP - World Languages 
      ...
      source: 
        ...
        - title: Recognize entities in Arabic text 
          ...
          - text: Colab Netbook
            type: blue_btn
            url: https://github.com/JohnSnowLabs/spark-nlp-workshop/blob/master/tutorials/streamlit_notebooks/public/NER_AR.ipynb
        - title: Recognize entities in Urdu text
          ...
          - text: Colab Netbook
            type: blue_btn
            url: https://github.com/JohnSnowLabs/spark-nlp-workshop/blob/master/tutorials/streamlit_notebooks/public/NER_UR.ipynb      
        ...
        - title: Recognize entities in Hebrew text 
          ...
          - text: Colab Netbook
            type: blue_btn
            url: https://colab.research.google.com/drive/1khpfmUtWqBmVR_y4obDMOYZo8KDQbRak#scrollTo=iu-P9dPHJ6iX
