---
layout: model
title: DistilBert Base Uncased Multiple Choice Fine-Tuned (ONNX)
author: John Snow Labs
name: distilbert_base_uncased_multiple_choice
date: 2025-12-05
...
supported: true
engine: onnx
annotator: DistilBertForMultipleChoice
article_header:
  type: cover
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/distilbert_base_uncased_multiple_choice_en_6.1.0_3.0_1764977843048.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/distilbert_base_uncased_multiple_choice_en_6.1.0_3.0_1764977843048.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pipeline = Pipeline(stages=[
    document_assembler,
    distilbert_for_multiple_choice
])
...
val distilbertForMC = DistilBertForMultipleChoice.pretrained("roberta_base_uncased_multiple_choice", "en")
...
|Which animal is known as the king of the jungle?                                          |[ Leopard]                           |
...
|The Great Wall of China was built to protect against invasions from which group?          |[ The Persians]                      |
|Which chemical element has the symbol 'O'?                                                |[ Osmium]                            |
...
{:.table-model}
|---|---|
|Model Name:|distilbert_base_uncased_multiple_choice|
