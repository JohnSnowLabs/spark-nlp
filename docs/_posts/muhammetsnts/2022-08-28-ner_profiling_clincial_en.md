...
name: ner_profiling_clincial
date: 2022-08-28
tags: [en, clincial, ner_profiling, ner, licensed]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/ner_profiling_clincial_en_4.0.2_3.0_1661696000819.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
{:.table-model}
|---|---|
|Model Name:|ner_profiling_clincial|
|Type:|pipeline|
