...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("mytextcheck","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("mytextcheck", "en")
