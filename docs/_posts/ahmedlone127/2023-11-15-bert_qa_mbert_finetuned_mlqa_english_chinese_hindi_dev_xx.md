...
spanClassifier = BertForQuestionAnswering.pretrained("bert_qa_mbert_finetuned_mlqa_english_chinese_hindi_dev","xx") \
...
val spanClassifier = BertForQuestionAnswering  
    .pretrained("bert_qa_mbert_finetuned_mlqa_english_chinese_hindi_dev", "xx")
...
{:.table-model}
|---|---|
|Model Name:|bert_qa_mbert_finetuned_mlqa_english_chinese_hindi_dev|
