...
zeroShotClassifier  = BertForZeroShotClassification.pretrained("gbert_large_zeroshot_nli","de") \
...
val zeroShotClassifier  = BertForZeroShotClassification.pretrained("gbert_large_zeroshot_nli", "de")
