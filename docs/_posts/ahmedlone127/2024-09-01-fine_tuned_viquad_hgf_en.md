...
spanClassifier = XlmRoBertaForQuestionAnswering.pretrained("fine_tuned_viquad_hgf","en") \
...
val spanClassifier = XlmRoBertaForQuestionAnswering.pretrained("fine_tuned_viquad_hgf", "en")
