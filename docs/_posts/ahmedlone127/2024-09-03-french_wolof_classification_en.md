...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("french_wolof_classification","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("french_wolof_classification", "en")
...
{:.table-model}
|---|---|
|Model Name:|french_wolof_classification|
