...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("n_roberta_imdb_padding0model","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("n_roberta_imdb_padding0model", "en")
