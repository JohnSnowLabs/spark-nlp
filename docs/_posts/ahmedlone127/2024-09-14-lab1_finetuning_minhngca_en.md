...
marian = MarianTransformer.pretrained("lab1_finetuning_minhngca","en") \
...
val embeddings = MarianTransformer.pretrained("lab1_finetuning_minhngca","en") 
...
{:.table-model}
|---|---|
|Model Name:|lab1_finetuning_minhngca|
