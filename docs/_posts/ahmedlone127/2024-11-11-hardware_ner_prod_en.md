...
tokenClassifier  = BertForTokenClassification.pretrained("hardware_ner_prod","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("hardware_ner_prod", "en")
