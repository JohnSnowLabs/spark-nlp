...
sequenceClassifier  = BertForSequenceClassification.pretrained("tweet_style_classifier","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("tweet_style_classifier", "en")
