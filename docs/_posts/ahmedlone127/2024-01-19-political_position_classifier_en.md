...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("political_position_classifier","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("political_position_classifier","en")
...
{:.table-model}
|---|---|
|Model Name:|political_position_classifier|
...
https://huggingface.co/SouhailO/political-position-classifier