...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("ndd_claroline_test_tags","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("ndd_claroline_test_tags", "en")
