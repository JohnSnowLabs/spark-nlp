...
sequenceClassifier  = BertForSequenceClassification.pretrained("response_quality_classifier_tiny","ru") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("response_quality_classifier_tiny", "ru")
