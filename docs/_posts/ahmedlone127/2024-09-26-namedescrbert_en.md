...
sequenceClassifier  = BertForSequenceClassification.pretrained("namedescrbert","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("namedescrbert", "en")
