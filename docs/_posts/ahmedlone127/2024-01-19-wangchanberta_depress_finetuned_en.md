...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("wangchanberta_depress_finetuned","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("wangchanberta_depress_finetuned","en")
