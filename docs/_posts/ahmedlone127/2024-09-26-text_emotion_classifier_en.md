...
sequenceClassifier  = BertForSequenceClassification.pretrained("text_emotion_classifier","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("text_emotion_classifier", "en")
