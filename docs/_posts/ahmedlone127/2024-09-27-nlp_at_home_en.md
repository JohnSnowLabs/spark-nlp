...
sequenceClassifier  = BertForSequenceClassification.pretrained("nlp_at_home","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("nlp_at_home", "en")
