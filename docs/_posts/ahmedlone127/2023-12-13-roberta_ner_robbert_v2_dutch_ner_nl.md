...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_ner_robbert_v2_dutch_ner_nl_5.2.1_3.0_1702500902650.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_ner_robbert_v2_dutch_ner_nl_5.2.1_3.0_1702500902650.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("nl.ner.roberta.conll.v2").predict("""Ik hou van Spark NLP""")
```
</div>
