...
embeddings = BGEEmbeddings.pretrained("bge_base_financial_nvidia_matryoshka","en") \
...
val embeddings = BGEEmbeddings.pretrained("bge_base_financial_nvidia_matryoshka","en") 
