...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_esg","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_esg", "en")
