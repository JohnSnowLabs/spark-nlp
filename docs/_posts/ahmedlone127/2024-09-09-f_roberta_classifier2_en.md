...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("f_roberta_classifier2","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("f_roberta_classifier2", "en")
...
{:.table-model}
|---|---|
|Model Name:|f_roberta_classifier2|
