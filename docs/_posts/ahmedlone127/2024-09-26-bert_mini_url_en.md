...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_mini_url","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_mini_url", "en")
