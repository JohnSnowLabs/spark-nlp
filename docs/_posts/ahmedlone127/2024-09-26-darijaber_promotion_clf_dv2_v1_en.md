...
sequenceClassifier  = BertForSequenceClassification.pretrained("darijaber_promotion_clf_dv2_v1","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("darijaber_promotion_clf_dv2_v1", "en")
