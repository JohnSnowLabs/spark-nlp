...
sequenceClassifier  = AlbertForSequenceClassification.pretrained("classify_clickbait_titles","en") \
...
val sequenceClassifier = AlbertForSequenceClassification.pretrained("classify_clickbait_titles", "en")
