...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/hel_english_french_4_layers_en_5.2.4_3.0_1716719879576.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/hel_english_french_4_layers_en_5.2.4_3.0_1716719879576.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
marian = MarianTransformer.pretrained("hel_english_french_4_layers","en") \
...
val embeddings = MarianTransformer.pretrained("hel_english_french_4_layers","en") 
