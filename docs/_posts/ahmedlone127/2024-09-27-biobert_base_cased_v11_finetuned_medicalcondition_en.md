...
sequenceClassifier  = BertForSequenceClassification.pretrained("biobert_base_cased_v11_finetuned_medicalcondition","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("biobert_base_cased_v11_finetuned_medicalcondition", "en")
...
{:.table-model}
|---|---|
|Model Name:|biobert_base_cased_v11_finetuned_medicalcondition|
...
https://huggingface.co/sid321axn/biobert-base-cased-v11-finetuned-medicalcondition