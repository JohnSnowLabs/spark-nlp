...
sequenceClassifier  = BertForSequenceClassification.pretrained("mitre_bert_base_cased","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("mitre_bert_base_cased", "en")
