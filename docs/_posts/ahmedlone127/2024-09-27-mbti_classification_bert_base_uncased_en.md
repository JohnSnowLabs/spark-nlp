...
sequenceClassifier  = BertForSequenceClassification.pretrained("mbti_classification_bert_base_uncased","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("mbti_classification_bert_base_uncased", "en")
