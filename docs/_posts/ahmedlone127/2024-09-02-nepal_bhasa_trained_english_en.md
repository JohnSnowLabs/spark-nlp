...
tokenClassifier  = DistilBertForTokenClassification.pretrained("nepal_bhasa_trained_english","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("nepal_bhasa_trained_english", "en")
