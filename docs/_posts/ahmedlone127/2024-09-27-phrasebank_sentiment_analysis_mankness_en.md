...
sequenceClassifier  = BertForSequenceClassification.pretrained("phrasebank_sentiment_analysis_mankness","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("phrasebank_sentiment_analysis_mankness", "en")
