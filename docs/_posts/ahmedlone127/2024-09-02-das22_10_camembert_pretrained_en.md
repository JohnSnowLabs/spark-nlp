...
embeddings = CamemBertEmbeddings.pretrained("das22_10_camembert_pretrained","en") \
...
val embeddings = CamemBertEmbeddings.pretrained("das22_10_camembert_pretrained","en") 
...
{:.table-model}
|---|---|
|Model Name:|das22_10_camembert_pretrained|
