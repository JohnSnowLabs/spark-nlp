...
tokenClassifier  = DistilBertForTokenClassification.pretrained("jnlpba_clinicalbert_ner","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("jnlpba_clinicalbert_ner", "en")
