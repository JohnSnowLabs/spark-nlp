...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("burmese_great_model_haltincay","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("burmese_great_model_haltincay", "en")
