...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("burmese_idea_classification_model_trial_1","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("burmese_idea_classification_model_trial_1", "en")
...
{:.table-model}
|---|---|
|Model Name:|burmese_idea_classification_model_trial_1|
