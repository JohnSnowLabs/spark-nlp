...
sequenceClassifier  = CamemBertForSequenceClassification.pretrained("feel_italian_finetuned_pro_emit_big6","en") \
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("feel_italian_finetuned_pro_emit_big6", "en")
