...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distil_task_b_2","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distil_task_b_2", "en")
