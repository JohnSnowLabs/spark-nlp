...
tokenClassifier  = RoBertaForTokenClassification.pretrained("biomedroberta_full_finetuned_ner_pablo","en") \
...
val tokenClassifier = RoBertaForTokenClassification.pretrained("biomedroberta_full_finetuned_ner_pablo", "en")
