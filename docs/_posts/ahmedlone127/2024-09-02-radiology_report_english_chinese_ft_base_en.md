...
marian = MarianTransformer.pretrained("radiology_report_english_chinese_ft_base","en") \
...
val embeddings = MarianTransformer.pretrained("radiology_report_english_chinese_ft_base","en") 
