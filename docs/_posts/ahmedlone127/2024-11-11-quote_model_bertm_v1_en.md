...
tokenClassifier  = BertForTokenClassification.pretrained("quote_model_bertm_v1","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("quote_model_bertm_v1", "en")
