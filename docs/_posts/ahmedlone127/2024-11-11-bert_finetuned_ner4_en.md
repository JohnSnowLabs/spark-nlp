...
tokenClassifier  = BertForTokenClassification.pretrained("bert_finetuned_ner4","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("bert_finetuned_ner4", "en")
