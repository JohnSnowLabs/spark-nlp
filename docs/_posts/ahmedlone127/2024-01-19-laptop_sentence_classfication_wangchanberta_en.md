...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("laptop_sentence_classfication_wangchanberta","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("laptop_sentence_classfication_wangchanberta","en")
