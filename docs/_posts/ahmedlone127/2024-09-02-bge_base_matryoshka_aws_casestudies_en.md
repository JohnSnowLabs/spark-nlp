...
embeddings = BGEEmbeddings.pretrained("bge_base_matryoshka_aws_casestudies","en") \
...
val embeddings = BGEEmbeddings.pretrained("bge_base_matryoshka_aws_casestudies","en") 
