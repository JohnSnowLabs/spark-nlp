...
sequenceClassifier  = BertForSequenceClassification.pretrained("autotrain_osb1a_e71jf","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("autotrain_osb1a_e71jf", "en")
