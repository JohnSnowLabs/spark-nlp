...
sequenceClassifier  = BertForSequenceClassification.pretrained("burmese_doccls_korean_model_chunwoolee0","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("burmese_doccls_korean_model_chunwoolee0", "en")
