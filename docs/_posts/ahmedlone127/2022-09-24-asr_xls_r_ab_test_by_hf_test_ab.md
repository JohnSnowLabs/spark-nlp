...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/asr_xls_r_ab_test_by_hf_test_ab_4.2.0_3.0_1664021515457.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
nlu.load("ab.speech2text.wav2vec_xlsr.by_hf_test").predict("ngm_12484_01067234848.wav")
```
