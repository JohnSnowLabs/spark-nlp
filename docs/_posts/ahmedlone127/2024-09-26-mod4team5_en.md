...
sequenceClassifier  = BertForSequenceClassification.pretrained("mod4team5","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("mod4team5", "en")
