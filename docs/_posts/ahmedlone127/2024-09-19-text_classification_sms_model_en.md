...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("text_classification_sms_model","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("text_classification_sms_model", "en")
