...
tokenClassifier  = DistilBertForTokenClassification.pretrained("distilbert_finetuned_ner_for_articles","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("distilbert_finetuned_ner_for_articles", "en")
