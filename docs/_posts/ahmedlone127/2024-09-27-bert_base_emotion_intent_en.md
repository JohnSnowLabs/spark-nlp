...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_emotion_intent","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_emotion_intent", "en")
