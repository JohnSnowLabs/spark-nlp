...
sequenceClassifier  = CamemBertForSequenceClassification.pretrained("crossencoder_camembert_l6_mmarcofr","fr") \
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("crossencoder_camembert_l6_mmarcofr", "fr")
...
{:.table-model}
|---|---|
|Model Name:|crossencoder_camembert_l6_mmarcofr|
