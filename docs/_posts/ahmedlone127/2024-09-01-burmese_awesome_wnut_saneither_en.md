...
tokenClassifier  = DistilBertForTokenClassification.pretrained("burmese_awesome_wnut_saneither","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("burmese_awesome_wnut_saneither", "en")
