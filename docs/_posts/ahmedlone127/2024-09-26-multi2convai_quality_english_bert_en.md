...
sequenceClassifier  = BertForSequenceClassification.pretrained("multi2convai_quality_english_bert","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("multi2convai_quality_english_bert", "en")
