...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert4","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert4", "en")
