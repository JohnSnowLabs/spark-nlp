...
tokenClassifier  = AlbertForTokenClassification.pretrained("ner_indic_bert","en") \
...
val tokenClassifier = AlbertForTokenClassification.pretrained("ner_indic_bert", "en")
