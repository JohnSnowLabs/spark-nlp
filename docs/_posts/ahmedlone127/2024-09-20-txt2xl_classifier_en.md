...
sequenceClassifier  = BertForSequenceClassification.pretrained("txt2xl_classifier","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("txt2xl_classifier", "en")
