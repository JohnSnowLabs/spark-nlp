...
sequenceClassifier  = BertForSequenceClassification.pretrained("baseline_bert_10k_steps","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("baseline_bert_10k_steps", "en")
