...
spanClassifier = BertForQuestionAnswering.pretrained("fine_tuned_bert_base","en") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("fine_tuned_bert_base", "en")
