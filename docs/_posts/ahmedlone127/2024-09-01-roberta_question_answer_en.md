...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("roberta_question_answer","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("roberta_question_answer", "en")
