...
sequenceClassifier  = CamemBertForSequenceClassification.pretrained("phayathaibert_sentiment_analysis","en") \
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("phayathaibert_sentiment_analysis", "en")
