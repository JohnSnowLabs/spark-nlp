...
sequenceClassifier  = BertForSequenceClassification.pretrained("imdb_bert_5e","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("imdb_bert_5e", "en")
