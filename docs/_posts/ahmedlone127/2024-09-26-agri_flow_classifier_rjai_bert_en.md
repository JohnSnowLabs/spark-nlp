...
sequenceClassifier  = BertForSequenceClassification.pretrained("agri_flow_classifier_rjai_bert","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("agri_flow_classifier_rjai_bert", "en")
