...
tokenClassifier  = RoBertaForTokenClassification.pretrained("bert_finetuned_semantic_augmentation_ner","en") \
...
val tokenClassifier = RoBertaForTokenClassification.pretrained("bert_finetuned_semantic_augmentation_ner", "en")
...
{:.table-model}
|---|---|
|Model Name:|bert_finetuned_semantic_augmentation_ner|
