...
spanClassifier = BertForQuestionAnswering.pretrained("bert_base_uncased_figurative_language","en") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("bert_base_uncased_figurative_language", "en")
