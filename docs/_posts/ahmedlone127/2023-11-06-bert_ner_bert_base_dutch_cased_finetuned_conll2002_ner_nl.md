...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_ner_bert_base_dutch_cased_finetuned_conll2002_ner_nl_5.2.0_3.0_1699286868952.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_ner_bert_base_dutch_cased_finetuned_conll2002_ner_nl_5.2.0_3.0_1699286868952.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("nl.ner.bert.conll.cased_base_finetuned").predict("""Ik hou van Spark NLP""")
```
</div>
