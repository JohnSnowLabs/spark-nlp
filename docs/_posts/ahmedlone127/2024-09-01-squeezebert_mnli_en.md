...
zeroShotClassifier  = BertForZeroShotClassification.pretrained("squeezebert_mnli","en") \
...
val zeroShotClassifier  = BertForZeroShotClassification.pretrained("squeezebert_mnli", "en")
