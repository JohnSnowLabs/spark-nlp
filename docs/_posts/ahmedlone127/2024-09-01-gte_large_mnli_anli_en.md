...
zeroShotClassifier  = BertForZeroShotClassification.pretrained("gte_large_mnli_anli","en") \
...
val zeroShotClassifier  = BertForZeroShotClassification.pretrained("gte_large_mnli_anli", "en")
