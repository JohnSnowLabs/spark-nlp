...
sequenceClassifier  = BertForSequenceClassification.pretrained("somali_what","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("somali_what", "en")
