...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("sentiment_neutral_from_other_v2","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("sentiment_neutral_from_other_v2","en")
