...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_daichi_support","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_daichi_support", "en")
