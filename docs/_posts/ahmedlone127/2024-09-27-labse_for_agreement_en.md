...
sequenceClassifier  = BertForSequenceClassification.pretrained("labse_for_agreement","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("labse_for_agreement", "en")
