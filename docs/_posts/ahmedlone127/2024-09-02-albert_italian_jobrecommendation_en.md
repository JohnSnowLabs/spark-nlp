...
sequenceClassifier  = AlbertForSequenceClassification.pretrained("albert_italian_jobrecommendation","en") \
...
val sequenceClassifier = AlbertForSequenceClassification.pretrained("albert_italian_jobrecommendation", "en")
