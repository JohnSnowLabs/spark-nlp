...
sequenceClassifier  = BertForSequenceClassification.pretrained("latdistilledmodel","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("latdistilledmodel", "en")
