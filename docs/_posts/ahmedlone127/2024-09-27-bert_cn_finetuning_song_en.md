...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_cn_finetuning_song","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_cn_finetuning_song", "en")
