...
sequenceClassifier  = BertForSequenceClassification.pretrained("agriculture_classification","zh") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("agriculture_classification", "zh")
