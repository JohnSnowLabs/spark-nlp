...
sequenceClassifier  = BertForSequenceClassification.pretrained("roberta_finetuned_domains","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("roberta_finetuned_domains", "en")
