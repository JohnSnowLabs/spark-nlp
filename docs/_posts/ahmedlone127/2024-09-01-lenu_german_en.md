...
sequenceClassifier  = BertForSequenceClassification.pretrained("lenu_german","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("lenu_german", "en")
