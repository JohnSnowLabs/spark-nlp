...
marian = MarianTransformer.pretrained("darija_tonga_tonga_islands_english","en") \
...
val embeddings = MarianTransformer.pretrained("darija_tonga_tonga_islands_english","en") 
