...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("wangchan_course","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("wangchan_course","en")
