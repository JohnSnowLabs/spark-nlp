...
sequenceClassifier  = BertForSequenceClassification.pretrained("finetuned_bert_base_on_iemocap_5","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("finetuned_bert_base_on_iemocap_5", "en")
