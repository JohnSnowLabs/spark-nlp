...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("dopamin_java_ownership","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("dopamin_java_ownership", "en")
...
{:.table-model}
|---|---|
|Model Name:|dopamin_java_ownership|
