...
pipeline = PretrainedPipeline("one_cdk10_m0_5_e5_b16_base_pipeline", lang = "en")
annotations =  pipeline.transform(df)   

```
```scala

val pipeline = new PretrainedPipeline("one_cdk10_m0_5_e5_b16_base_pipeline", lang = "en")
...
{:.table-model}
|---|---|
|Model Name:|one_cdk10_m0_5_e5_b16_base_pipeline|
|Type:|pipeline|
...
https://huggingface.co/swardiantara/one-cdk10-m0.5-e5-b16-base
