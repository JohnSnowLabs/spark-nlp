...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_reviews_iiro","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_reviews_iiro", "en")
