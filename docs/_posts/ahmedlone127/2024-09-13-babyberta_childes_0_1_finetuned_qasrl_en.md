...
spanClassifier = RoBertaForQuestionAnswering.pretrained("babyberta_childes_0_1_finetuned_qasrl","en") \
...
val spanClassifier = RoBertaForQuestionAnswering.pretrained("babyberta_childes_0_1_finetuned_qasrl", "en")
...
{:.table-model}
|---|---|
|Model Name:|babyberta_childes_0_1_finetuned_qasrl|
