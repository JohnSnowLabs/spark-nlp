...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("reranker","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("reranker", "en")
