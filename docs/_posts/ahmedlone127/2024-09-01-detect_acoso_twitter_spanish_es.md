...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("detect_acoso_twitter_spanish","es") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("detect_acoso_twitter_spanish", "es")
