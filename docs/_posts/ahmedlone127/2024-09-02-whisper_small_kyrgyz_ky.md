...
speechToText  = WhisperForCTC.pretrained("whisper_small_kyrgyz","ky") \
...
val speechToText = WhisperForCTC.pretrained("whisper_small_kyrgyz", "ky")
...
{:.table-model}
|---|---|
|Model Name:|whisper_small_kyrgyz|
