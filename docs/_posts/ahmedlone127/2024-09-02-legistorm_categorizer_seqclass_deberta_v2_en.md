...
sequenceClassifier  = DeBertaForSequenceClassification.pretrained("legistorm_categorizer_seqclass_deberta_v2","en") \
...
val sequenceClassifier = DeBertaForSequenceClassification.pretrained("legistorm_categorizer_seqclass_deberta_v2", "en")
