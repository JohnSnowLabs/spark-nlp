...
sequenceClassifier  = BertForSequenceClassification.pretrained("tiny_bert_base_bert_score","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("tiny_bert_base_bert_score", "en")
