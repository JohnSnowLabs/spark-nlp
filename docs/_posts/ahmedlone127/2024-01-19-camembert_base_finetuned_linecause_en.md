...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("camembert_base_finetuned_linecause","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("camembert_base_finetuned_linecause","en")
...
{:.table-model}
|---|---|
|Model Name:|camembert_base_finetuned_linecause|
...
https://huggingface.co/louisdeco/camembert-base-finetuned-LineCause