...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_chinese_covid19","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_chinese_covid19", "en")
