...
tokenClassifier  = BertForTokenClassification.pretrained("chinese_roberta_wwm_ext_large","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("chinese_roberta_wwm_ext_large", "en")
