...
embeddings = MPNetEmbeddings.pretrained("setfit_product_review_regression","en") \
...
val embeddings = MPNetEmbeddings.pretrained("setfit_product_review_regression","en") 
...
{:.table-model}
|---|---|
|Model Name:|setfit_product_review_regression|
