...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("discriminator_paraphrase","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("discriminator_paraphrase", "en")
...
{:.table-model}
|---|---|
|Model Name:|discriminator_paraphrase|
