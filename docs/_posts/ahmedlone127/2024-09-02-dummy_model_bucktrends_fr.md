...
embeddings = CamemBertEmbeddings.pretrained("dummy_model_bucktrends","fr") \
...
val embeddings = CamemBertEmbeddings.pretrained("dummy_model_bucktrends","fr") 
...
{:.table-model}
|---|---|
|Model Name:|dummy_model_bucktrends|
