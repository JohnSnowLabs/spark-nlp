...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("roberta_base_semantic_plausibility","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("roberta_base_semantic_plausibility", "en")
...
{:.table-model}
|---|---|
|Model Name:|roberta_base_semantic_plausibility|
