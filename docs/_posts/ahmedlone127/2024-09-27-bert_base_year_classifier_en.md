...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_year_classifier","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_year_classifier", "en")
