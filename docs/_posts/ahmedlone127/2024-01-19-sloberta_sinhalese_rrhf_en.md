...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("sloberta_sinhalese_rrhf","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("sloberta_sinhalese_rrhf","en")
...
{:.table-model}
|---|---|
|Model Name:|sloberta_sinhalese_rrhf|
