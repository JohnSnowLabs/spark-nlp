...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("extension_model","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("extension_model", "en")
