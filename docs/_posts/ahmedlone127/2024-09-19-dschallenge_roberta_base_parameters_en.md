...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("dschallenge_roberta_base_parameters","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("dschallenge_roberta_base_parameters", "en")
