...
embeddings = RoBertaEmbeddings.pretrained("takalane_sot_roberta","en") \
...
val embeddings = RoBertaEmbeddings.pretrained("takalane_sot_roberta","en") 
...
{:.table-model}
|---|---|
|Model Name:|takalane_sot_roberta|
