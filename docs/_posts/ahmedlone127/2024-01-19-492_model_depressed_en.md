...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("492_model_depressed","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("492_model_depressed","en")
...
{:.table-model}
|---|---|
|Model Name:|492_model_depressed|
...
https://huggingface.co/tinsira/492-Model-Depressed