...
sequenceClassifier  = AlbertForSequenceClassification.pretrained("best_model_yelp_polarity_32_42","en") \
...
val sequenceClassifier = AlbertForSequenceClassification.pretrained("best_model_yelp_polarity_32_42", "en")
...
{:.table-model}
|---|---|
|Model Name:|best_model_yelp_polarity_32_42|
