...
speechToText  = WhisperForCTC.pretrained("whisper_tiny_serbian_combined","en") \
...
val speechToText = WhisperForCTC.pretrained("whisper_tiny_serbian_combined", "en")
...
{:.table-model}
|---|---|
|Model Name:|whisper_tiny_serbian_combined|
