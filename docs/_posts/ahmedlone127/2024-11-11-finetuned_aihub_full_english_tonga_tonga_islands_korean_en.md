...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/finetuned_aihub_full_english_tonga_tonga_islands_korean_en_5.5.1_3.0_1731321755043.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/finetuned_aihub_full_english_tonga_tonga_islands_korean_en_5.5.1_3.0_1731321755043.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
marian = MarianTransformer.pretrained("finetuned_aihub_full_english_tonga_tonga_islands_korean","en") \
...
val embeddings = MarianTransformer.pretrained("finetuned_aihub_full_english_tonga_tonga_islands_korean","en") 
