...
tokenClassifier  = DistilBertForTokenClassification.pretrained("latest_model","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("latest_model", "en")
