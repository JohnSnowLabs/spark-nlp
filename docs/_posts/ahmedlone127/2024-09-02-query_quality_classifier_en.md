...
sequenceClassifier  = AlbertForSequenceClassification.pretrained("query_quality_classifier","en") \
...
val sequenceClassifier = AlbertForSequenceClassification.pretrained("query_quality_classifier", "en")
