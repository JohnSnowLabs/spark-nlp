...
tokenClassifier = CamemBertForTokenClassification.pretrained("camembert_ner_scd28","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("camembert_ner_scd28", "en")
...
{:.table-model}
|---|---|
|Model Name:|camembert_ner_scd28|
...
https://huggingface.co/SCD28/camembert-ner