...
sequenceClassifier  = BertForSequenceClassification.pretrained("schwartz_values_classifier","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("schwartz_values_classifier", "en")
