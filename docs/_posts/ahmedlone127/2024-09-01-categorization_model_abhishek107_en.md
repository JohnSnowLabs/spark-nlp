...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("categorization_model_abhishek107","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("categorization_model_abhishek107", "en")
