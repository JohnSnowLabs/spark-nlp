...
sequenceClassifier  = BertForSequenceClassification.pretrained("harssment_classifier","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("harssment_classifier", "en")
