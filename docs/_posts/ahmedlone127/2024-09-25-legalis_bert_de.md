...
sequenceClassifier  = BertForSequenceClassification.pretrained("legalis_bert","de") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("legalis_bert", "de")
