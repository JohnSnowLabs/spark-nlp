...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("odsc_sawyer_reward","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("odsc_sawyer_reward", "en")
