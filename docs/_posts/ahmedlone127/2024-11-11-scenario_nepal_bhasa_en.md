...
sequenceClassifier  = BertForSequenceClassification.pretrained("scenario_nepal_bhasa","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("scenario_nepal_bhasa", "en")
