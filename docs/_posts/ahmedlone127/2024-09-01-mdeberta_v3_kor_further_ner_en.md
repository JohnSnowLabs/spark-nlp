...
tokenClassifier  = DeBertaForTokenClassification.pretrained("mdeberta_v3_kor_further_ner","en") \
...
val tokenClassifier = DeBertaForTokenClassification.pretrained("mdeberta_v3_kor_further_ner", "en")
