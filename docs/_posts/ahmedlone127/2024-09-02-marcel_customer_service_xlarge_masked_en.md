...
embeddings = CamemBertEmbeddings.pretrained("marcel_customer_service_xlarge_masked","en") \
...
val embeddings = CamemBertEmbeddings.pretrained("marcel_customer_service_xlarge_masked","en") 
