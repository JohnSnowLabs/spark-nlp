...
tokenClassifier  = BertForTokenClassification.pretrained("product_recognize","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("product_recognize", "en")
