...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("somd_xlm_3stage_stage0_pre_v1","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("somd_xlm_3stage_stage0_pre_v1", "en")
...
{:.table-model}
|---|---|
|Model Name:|somd_xlm_3stage_stage0_pre_v1|
