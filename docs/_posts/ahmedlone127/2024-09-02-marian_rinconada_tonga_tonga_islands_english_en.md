...
marian = MarianTransformer.pretrained("marian_rinconada_tonga_tonga_islands_english","en") \
...
val embeddings = MarianTransformer.pretrained("marian_rinconada_tonga_tonga_islands_english","en") 
