...
tokenClassifier  = DistilBertForTokenClassification.pretrained("distilbert_finetuned_ner_tushifire","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("distilbert_finetuned_ner_tushifire", "en")
