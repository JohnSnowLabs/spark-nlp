...
tokenClassifier = CamemBertForTokenClassification.pretrained("lst20_sent_segment","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("lst20_sent_segment", "en")
...
https://huggingface.co/bnunticha/lst20-sent-segment