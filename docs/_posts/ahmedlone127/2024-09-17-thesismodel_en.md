...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("thesismodel","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("thesismodel", "en")
