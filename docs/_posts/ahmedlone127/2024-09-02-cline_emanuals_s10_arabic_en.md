...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("cline_emanuals_s10_arabic","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("cline_emanuals_s10_arabic", "en")
