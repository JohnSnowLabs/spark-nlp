...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("deadloack_model","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("deadloack_model", "en")
