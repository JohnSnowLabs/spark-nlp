...
embeddings = RoBertaEmbeddings.pretrained("codebert_javascript","en") \
...
val embeddings = RoBertaEmbeddings.pretrained("codebert_javascript","en") 
...
{:.table-model}
|---|---|
|Model Name:|codebert_javascript|
