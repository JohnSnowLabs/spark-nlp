...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("final_nlp_question1","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("final_nlp_question1", "en")
