...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_mdgender_wizard","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_mdgender_wizard", "en")
