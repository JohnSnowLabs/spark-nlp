...
sequenceClassifier  = BertForSequenceClassification.pretrained("romanian_sentiment_01","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("romanian_sentiment_01", "en")
