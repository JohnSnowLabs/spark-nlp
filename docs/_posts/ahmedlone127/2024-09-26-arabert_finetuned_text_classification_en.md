...
sequenceClassifier  = BertForSequenceClassification.pretrained("arabert_finetuned_text_classification","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("arabert_finetuned_text_classification", "en")
