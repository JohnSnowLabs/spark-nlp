...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/t5_indot5_small_id_5.4.1_3.0_1720888035663.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/t5_indot5_small_id_5.4.1_3.0_1720888035663.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
t5 = T5Transformer.pretrained("t5_indot5_small","id") \
...
val t5 = T5Transformer.pretrained("t5_indot5_small","id") 
    .setInputCols("document")
    .setOutputCol("answers")
