...
sequenceClassifier  = CamemBertForSequenceClassification.pretrained("crossencoder_camembert_l2_mmarcofr","fr") \
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("crossencoder_camembert_l2_mmarcofr", "fr")
