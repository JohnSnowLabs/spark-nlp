...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("roberta_base_bne_finetuned_amazon_reviews_spanish_02","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("roberta_base_bne_finetuned_amazon_reviews_spanish_02", "en")
