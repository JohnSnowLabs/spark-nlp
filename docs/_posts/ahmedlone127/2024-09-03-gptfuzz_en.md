...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("gptfuzz","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("gptfuzz", "en")
