...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_fine","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_fine", "en")
