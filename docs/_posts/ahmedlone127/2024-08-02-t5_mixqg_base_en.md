...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/t5_mixqg_base_en_5.4.2_3.0_1722631371095.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/t5_mixqg_base_en_5.4.2_3.0_1722631371095.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
t5 = T5Transformer.pretrained("t5_mixqg_base","en") \
...
val t5 = T5Transformer.pretrained("t5_mixqg_base","en") 
    .setInputCols("document")
    .setOutputCol("answers")
