...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("hw001_lostck","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("hw001_lostck", "en")
