...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("predict_perception_xlmr_blame_object","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("predict_perception_xlmr_blame_object", "en")
