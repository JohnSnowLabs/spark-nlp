...
tokenClassifier = CamemBertForTokenClassification.pretrained("sentence_tokenizer_thai","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("sentence_tokenizer_thai", "en")
...
{:.table-model}
|---|---|
|Model Name:|sentence_tokenizer_thai|
...
https://huggingface.co/bnunticha/sentence-tokenizer-th