...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("roberta_base_isarcasm","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("roberta_base_isarcasm", "en")
