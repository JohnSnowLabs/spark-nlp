...
embeddings = CamemBertEmbeddings.pretrained("marcel_customer_service_medium_masked","en") \
...
val embeddings = CamemBertEmbeddings.pretrained("marcel_customer_service_medium_masked","en") 
