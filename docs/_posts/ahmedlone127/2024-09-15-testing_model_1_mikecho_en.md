...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("testing_model_1_mikecho","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("testing_model_1_mikecho", "en")
