...
embeddings = MPNetEmbeddings.pretrained("lithuanian_un_data_fine_industry_english","en") \
...
val embeddings = MPNetEmbeddings.pretrained("lithuanian_un_data_fine_industry_english","en") 
