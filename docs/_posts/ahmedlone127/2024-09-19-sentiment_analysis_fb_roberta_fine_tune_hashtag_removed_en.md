...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("sentiment_analysis_fb_roberta_fine_tune_hashtag_removed","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("sentiment_analysis_fb_roberta_fine_tune_hashtag_removed", "en")
...
{:.table-model}
|---|---|
|Model Name:|sentiment_analysis_fb_roberta_fine_tune_hashtag_removed|
