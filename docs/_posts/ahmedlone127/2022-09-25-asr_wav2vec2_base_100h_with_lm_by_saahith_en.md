...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/asr_wav2vec2_base_100h_with_lm_by_saahith_en_4.2.0_3.0_1664117796201.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
nlu.load("en.speech2text.wav2vec2.v2_base_100h.by_saahith").predict("ngm_12484_01067234848.wav")
```
