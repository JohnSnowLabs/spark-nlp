...
spanClassifier = BertForQuestionAnswering.pretrained("modelo_qa_beto_squad_spanish_pdqa","en") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("modelo_qa_beto_squad_spanish_pdqa", "en")
