...
tokenClassifier  = BertForTokenClassification.pretrained("bert_finetuned_ner_tornqvistmax","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("bert_finetuned_ner_tornqvistmax", "en")
