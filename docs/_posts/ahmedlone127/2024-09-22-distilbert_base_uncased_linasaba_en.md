...
sequenceClassifier  = BertForSequenceClassification.pretrained("distilbert_base_uncased_linasaba","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("distilbert_base_uncased_linasaba", "en")
...
{:.table-model}
|---|---|
|Model Name:|distilbert_base_uncased_linasaba|
