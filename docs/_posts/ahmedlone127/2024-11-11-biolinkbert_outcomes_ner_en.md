...
tokenClassifier  = BertForTokenClassification.pretrained("biolinkbert_outcomes_ner","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("biolinkbert_outcomes_ner", "en")
