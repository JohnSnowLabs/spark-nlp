...
sequenceClassifier  = BertForSequenceClassification.pretrained("hyp_only_hum_filtered","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("hyp_only_hum_filtered", "en")
