...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("anus_wanus_panus_ranus","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("anus_wanus_panus_ranus", "en")
