...
sequenceClassifier  = BertForSequenceClassification.pretrained("passage_ranker_chocolate","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("passage_ranker_chocolate", "en")
...
{:.table-model}
|---|---|
|Model Name:|passage_ranker_chocolate|
