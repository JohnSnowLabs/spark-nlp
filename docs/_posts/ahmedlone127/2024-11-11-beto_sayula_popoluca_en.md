...
tokenClassifier  = BertForTokenClassification.pretrained("beto_sayula_popoluca","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("beto_sayula_popoluca", "en")
