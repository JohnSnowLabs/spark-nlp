...
embeddings = BertSentenceEmbeddings.pretrained("sent_cl_arabertv0_1_base","en") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_cl_arabertv0_1_base","en") 
...
{:.table-model}
|---|---|
|Model Name:|sent_cl_arabertv0_1_base|
