...
spanClassifier = DeBertaForQuestionAnswering.pretrained("ct_cos_mdeberta_idkmrc","en") \
...
val spanClassifier = DeBertaForQuestionAnswering.pretrained("ct_cos_mdeberta_idkmrc", "en")
