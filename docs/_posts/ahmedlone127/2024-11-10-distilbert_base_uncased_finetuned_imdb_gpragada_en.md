...
embeddings = DistilBertEmbeddings.pretrained("distilbert_base_uncased_finetuned_imdb_gpragada","en") \
...
val embeddings = DistilBertEmbeddings.pretrained("distilbert_base_uncased_finetuned_imdb_gpragada","en") 
