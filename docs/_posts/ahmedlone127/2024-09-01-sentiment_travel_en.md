...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("sentiment_travel","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("sentiment_travel", "en")
