...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("finetuning_sentiment_analysis_siebert","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("finetuning_sentiment_analysis_siebert", "en")
