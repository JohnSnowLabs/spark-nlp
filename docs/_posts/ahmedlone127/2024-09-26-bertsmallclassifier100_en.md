...
sequenceClassifier  = BertForSequenceClassification.pretrained("bertsmallclassifier100","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bertsmallclassifier100", "en")
