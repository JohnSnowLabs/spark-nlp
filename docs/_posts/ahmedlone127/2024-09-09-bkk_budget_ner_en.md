...
tokenClassifier  = XlmRoBertaForTokenClassification.pretrained("bkk_budget_ner","en") \
...
val tokenClassifier = XlmRoBertaForTokenClassification.pretrained("bkk_budget_ner", "en")
