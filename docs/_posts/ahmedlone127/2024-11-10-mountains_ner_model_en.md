...
tokenClassifier  = BertForTokenClassification.pretrained("mountains_ner_model","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("mountains_ner_model", "en")
