...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("twitter_roberta_base_hate_latest_southern_sotho","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("twitter_roberta_base_hate_latest_southern_sotho", "en")
...
{:.table-model}
|---|---|
|Model Name:|twitter_roberta_base_hate_latest_southern_sotho|
