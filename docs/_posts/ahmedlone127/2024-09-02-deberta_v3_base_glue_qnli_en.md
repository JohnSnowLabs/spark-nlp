...
sequenceClassifier  = DeBertaForSequenceClassification.pretrained("deberta_v3_base_glue_qnli","en") \
...
val sequenceClassifier = DeBertaForSequenceClassification.pretrained("deberta_v3_base_glue_qnli", "en")
