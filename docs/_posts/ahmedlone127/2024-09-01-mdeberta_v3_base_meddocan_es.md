...
tokenClassifier  = DeBertaForTokenClassification.pretrained("mdeberta_v3_base_meddocan","es") \
...
val tokenClassifier = DeBertaForTokenClassification.pretrained("mdeberta_v3_base_meddocan", "es")
