...
embeddings = MPNetEmbeddings.pretrained("all_mpnet_base_v2_sts_romaniox","en") \
...
val embeddings = MPNetEmbeddings.pretrained("all_mpnet_base_v2_sts_romaniox","en") 
...
{:.table-model}
|---|---|
|Model Name:|all_mpnet_base_v2_sts_romaniox|
