...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_sst5_padding40model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_sst5_padding40model", "en")
