...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("homework_1","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("homework_1", "en")
