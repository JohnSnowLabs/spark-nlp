...
sequenceClassifier  = BertForSequenceClassification.pretrained("minilm_emotions_finetuned","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("minilm_emotions_finetuned", "en")
