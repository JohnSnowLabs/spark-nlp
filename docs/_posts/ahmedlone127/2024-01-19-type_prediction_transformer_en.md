...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("type_prediction_transformer","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("type_prediction_transformer","en")
