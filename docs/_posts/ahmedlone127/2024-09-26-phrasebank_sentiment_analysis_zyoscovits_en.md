...
sequenceClassifier  = BertForSequenceClassification.pretrained("phrasebank_sentiment_analysis_zyoscovits","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("phrasebank_sentiment_analysis_zyoscovits", "en")
