...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_sst5_padding10model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_sst5_padding10model", "en")
