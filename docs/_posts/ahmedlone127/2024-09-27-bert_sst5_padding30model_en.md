...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_sst5_padding30model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_sst5_padding30model", "en")
