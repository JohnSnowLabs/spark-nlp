...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("covid_tweet_sentiment_analysis_roberta_model","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("covid_tweet_sentiment_analysis_roberta_model", "en")
