...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("amazon_spanish_reviews","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("amazon_spanish_reviews", "en")
