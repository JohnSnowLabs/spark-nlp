...
embeddings = RoBertaEmbeddings.pretrained("twitter_roberta_base_mar2021","en") \
...
val embeddings = RoBertaEmbeddings.pretrained("twitter_roberta_base_mar2021","en") 
...
{:.table-model}
|---|---|
|Model Name:|twitter_roberta_base_mar2021|
