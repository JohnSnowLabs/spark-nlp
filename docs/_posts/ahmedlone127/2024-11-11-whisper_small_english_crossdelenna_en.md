...
speechToText  = WhisperForCTC.pretrained("whisper_small_english_crossdelenna","en") \
...
val speechToText = WhisperForCTC.pretrained("whisper_small_english_crossdelenna", "en")
