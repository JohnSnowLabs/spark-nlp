...
spanClassifier = DeBertaForQuestionAnswering.pretrained("deberta_v3_large_reram_qa","en") \
...
val spanClassifier = DeBertaForQuestionAnswering.pretrained("deberta_v3_large_reram_qa", "en")
