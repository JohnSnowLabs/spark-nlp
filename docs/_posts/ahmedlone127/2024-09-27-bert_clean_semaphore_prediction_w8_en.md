...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_clean_semaphore_prediction_w8","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_clean_semaphore_prediction_w8", "en")
