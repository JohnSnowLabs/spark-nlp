...
sequenceClassifier  = BertForSequenceClassification.pretrained("roberta_base_cdconv","zh") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("roberta_base_cdconv", "zh")
...
{:.table-model}
|---|---|
|Model Name:|roberta_base_cdconv|
