...
embeddings = DistilBertEmbeddings.pretrained("custom_dataset_finetuned","en") \
...
val embeddings = DistilBertEmbeddings.pretrained("custom_dataset_finetuned","en") 
...
{:.table-model}
|---|---|
|Model Name:|custom_dataset_finetuned|
