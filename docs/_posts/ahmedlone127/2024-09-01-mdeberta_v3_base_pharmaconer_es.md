...
tokenClassifier  = DeBertaForTokenClassification.pretrained("mdeberta_v3_base_pharmaconer","es") \
...
val tokenClassifier = DeBertaForTokenClassification.pretrained("mdeberta_v3_base_pharmaconer", "es")
...
{:.table-model}
|---|---|
|Model Name:|mdeberta_v3_base_pharmaconer|
