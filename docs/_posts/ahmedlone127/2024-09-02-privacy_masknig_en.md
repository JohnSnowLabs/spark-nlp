...
tokenClassifier  = DistilBertForTokenClassification.pretrained("privacy_masknig","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("privacy_masknig", "en")
