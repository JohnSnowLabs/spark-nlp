...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_finetuned_ynat_kyeul611","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_finetuned_ynat_kyeul611", "en")
