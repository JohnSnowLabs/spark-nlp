...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("camembert_classification_tools_french","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("camembert_classification_tools_french","en")
