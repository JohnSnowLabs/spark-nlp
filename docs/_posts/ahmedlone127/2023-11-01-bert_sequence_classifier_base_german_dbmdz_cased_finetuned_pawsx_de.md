...
date: 2023-11-01
tags: [de, open_source, bert, sequence_classification, onnx]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_sequence_classifier_base_german_dbmdz_cased_finetuned_pawsx_de_5.1.4_3.4_1698807442272.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_sequence_classifier_base_german_dbmdz_cased_finetuned_pawsx_de_5.1.4_3.4_1698807442272.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("de.classify.bert.pawsx_xtreme.cased_base_finetuned").predict("""PUT YOUR STRING HERE""")
```
</div>
