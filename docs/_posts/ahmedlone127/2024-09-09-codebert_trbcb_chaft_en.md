...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("codebert_trbcb_chaft","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("codebert_trbcb_chaft", "en")
