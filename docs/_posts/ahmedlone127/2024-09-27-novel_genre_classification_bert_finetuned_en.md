...
sequenceClassifier  = BertForSequenceClassification.pretrained("novel_genre_classification_bert_finetuned","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("novel_genre_classification_bert_finetuned", "en")
...
{:.table-model}
|---|---|
|Model Name:|novel_genre_classification_bert_finetuned|
...
https://huggingface.co/Davida23/Novel_Genre_Classification_bert-finetuned