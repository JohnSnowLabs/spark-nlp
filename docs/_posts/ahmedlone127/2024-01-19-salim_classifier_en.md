...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("salim_classifier","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("salim_classifier","en")
