...
sequenceClassifier  = BertForSequenceClassification.pretrained("burmese_awesome_model_jonathanparaschou","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("burmese_awesome_model_jonathanparaschou", "en")
