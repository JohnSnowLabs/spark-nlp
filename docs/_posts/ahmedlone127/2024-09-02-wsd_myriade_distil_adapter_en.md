...
tokenClassifier  = CamemBertForTokenClassification.pretrained("wsd_myriade_distil_adapter","en") \
...
val tokenClassifier = CamemBertForTokenClassification.pretrained("wsd_myriade_distil_adapter", "en")
