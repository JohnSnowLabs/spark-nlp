...
marian = MarianTransformer.pretrained("maltese_coref_english_french_gender_exp","en") \
...
val embeddings = MarianTransformer.pretrained("maltese_coref_english_french_gender_exp","en") 
