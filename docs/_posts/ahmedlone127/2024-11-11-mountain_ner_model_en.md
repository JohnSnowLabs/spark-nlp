...
tokenClassifier  = BertForTokenClassification.pretrained("mountain_ner_model","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("mountain_ner_model", "en")
