...
marian = MarianTransformer.pretrained("spark_name_korean_tonga_tonga_islands_english","en") \
...
val embeddings = MarianTransformer.pretrained("spark_name_korean_tonga_tonga_islands_english","en") 
