...
sequenceClassifier  = BertForSequenceClassification.pretrained("arabic_tweets_spam_oriya_ham","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("arabic_tweets_spam_oriya_ham", "en")
