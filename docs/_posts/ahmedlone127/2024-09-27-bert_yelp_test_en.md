...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_yelp_test","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_yelp_test", "en")
