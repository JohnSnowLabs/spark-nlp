...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_finetuned_locations","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_finetuned_locations", "en")
