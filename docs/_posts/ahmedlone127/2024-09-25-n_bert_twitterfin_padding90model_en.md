...
sequenceClassifier  = BertForSequenceClassification.pretrained("n_bert_twitterfin_padding90model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("n_bert_twitterfin_padding90model", "en")
