...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("hate_detector","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("hate_detector", "en")
