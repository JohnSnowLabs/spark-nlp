...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_restaurant_review","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_restaurant_review", "en")
