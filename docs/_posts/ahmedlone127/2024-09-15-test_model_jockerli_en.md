...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("test_model_jockerli","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("test_model_jockerli", "en")
