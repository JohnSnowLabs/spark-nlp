...
tokenClassifier  = RoBertaForTokenClassification.pretrained("roberta_spanish_clinical_trials_neg_spec_ner","en") \
...
val tokenClassifier = RoBertaForTokenClassification.pretrained("roberta_spanish_clinical_trials_neg_spec_ner", "en")
