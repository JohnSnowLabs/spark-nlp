...
tokenClassifier  = DeBertaForTokenClassification.pretrained("mdeberta_v3_base_distemist","es") \
...
val tokenClassifier = DeBertaForTokenClassification.pretrained("mdeberta_v3_base_distemist", "es")
...
{:.table-model}
|---|---|
|Model Name:|mdeberta_v3_base_distemist|
