...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_model_news_aggregator","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_model_news_aggregator", "en")
