...
tokenClassifier  = BertForTokenClassification.pretrained("kor_naver_ner_name_v2","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("kor_naver_ner_name_v2", "en")
