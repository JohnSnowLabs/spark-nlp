...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_classifier_iterater_intention_en_5.2.0_3.0_1701226695532.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_classifier_iterater_intention_en_5.2.0_3.0_1701226695532.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.classify.roberta.by_wanyu").predict("""PUT YOUR STRING HERE""")
```
</div>
