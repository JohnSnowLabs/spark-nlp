...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("protein_custom_model_veresnoemi","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("protein_custom_model_veresnoemi", "en")
...
{:.table-model}
|---|---|
|Model Name:|protein_custom_model_veresnoemi|
