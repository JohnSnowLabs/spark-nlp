...
tokenClassifier  = BertForTokenClassification.pretrained("pii_mbert_azerbaijani","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("pii_mbert_azerbaijani", "en")
