...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_classifier_rubert_base_cased_dp_paraphrase_detection_ru_5.1.4_3.4_1698379110552.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_rubert_base_cased_dp_paraphrase_detection_ru_5.1.4_3.4_1698379110552.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("ru.classify.bert.cased_base").predict("""PUT YOUR STRING HERE""")
```
</div>
