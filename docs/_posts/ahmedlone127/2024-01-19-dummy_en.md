...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("dummy","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("dummy","en")
