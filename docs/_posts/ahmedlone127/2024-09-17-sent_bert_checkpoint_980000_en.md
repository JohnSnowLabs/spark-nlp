...
embeddings = BertSentenceEmbeddings.pretrained("sent_bert_checkpoint_980000","en") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_bert_checkpoint_980000","en") 
...
{:.table-model}
|---|---|
|Model Name:|sent_bert_checkpoint_980000|
