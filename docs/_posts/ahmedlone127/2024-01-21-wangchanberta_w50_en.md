...
tokenClassifier = CamemBertForTokenClassification.pretrained("wangchanberta_w50","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("wangchanberta_w50", "en")
...
https://huggingface.co/Norrawee/wangchanberta-w50