...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("team4_adr_detector","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("team4_adr_detector", "en")
