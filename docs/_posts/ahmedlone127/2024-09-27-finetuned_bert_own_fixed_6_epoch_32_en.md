...
sequenceClassifier  = BertForSequenceClassification.pretrained("finetuned_bert_own_fixed_6_epoch_32","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("finetuned_bert_own_fixed_6_epoch_32", "en")
