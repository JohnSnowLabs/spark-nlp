...
sequenceClassifier  = BertForSequenceClassification.pretrained("results_profoz","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("results_profoz", "en")
