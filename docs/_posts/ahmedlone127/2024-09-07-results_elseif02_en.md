...
spanClassifier = DistilBertForQuestionAnswering.pretrained("results_elseif02","en") \
...
val spanClassifier = DistilBertForQuestionAnswering.pretrained("results_elseif02", "en")
