...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("ioclassifier","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("ioclassifier","en")
