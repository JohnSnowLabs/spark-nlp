...
embeddings = BGEEmbeddings.pretrained("bge_base_financial_matryoshka_liu_xiang","en") \
...
val embeddings = BGEEmbeddings.pretrained("bge_base_financial_matryoshka_liu_xiang","en") 
