...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("practica2_arturogl","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("practica2_arturogl", "en")
