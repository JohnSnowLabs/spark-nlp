...
embeddings = MPNetEmbeddings.pretrained("procedure_tool_matching_10_epochs","en") \
...
val embeddings = MPNetEmbeddings.pretrained("procedure_tool_matching_10_epochs","en") 
