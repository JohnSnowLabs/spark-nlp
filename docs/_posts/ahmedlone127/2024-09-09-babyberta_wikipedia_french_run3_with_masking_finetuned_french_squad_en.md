...
spanClassifier = RoBertaForQuestionAnswering.pretrained("babyberta_wikipedia_french_run3_with_masking_finetuned_french_squad","en") \
...
val spanClassifier = RoBertaForQuestionAnswering.pretrained("babyberta_wikipedia_french_run3_with_masking_finetuned_french_squad", "en")
...
{:.table-model}
|---|---|
|Model Name:|babyberta_wikipedia_french_run3_with_masking_finetuned_french_squad|
