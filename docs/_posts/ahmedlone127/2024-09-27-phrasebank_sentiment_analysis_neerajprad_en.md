...
sequenceClassifier  = BertForSequenceClassification.pretrained("phrasebank_sentiment_analysis_neerajprad","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("phrasebank_sentiment_analysis_neerajprad", "en")
