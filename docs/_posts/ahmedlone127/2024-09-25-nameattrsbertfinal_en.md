...
sequenceClassifier  = BertForSequenceClassification.pretrained("nameattrsbertfinal","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("nameattrsbertfinal", "en")
