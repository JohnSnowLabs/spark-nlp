...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("sql_injection_attack_detection_distilbert","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("sql_injection_attack_detection_distilbert", "en")
...
{:.table-model}
|---|---|
|Model Name:|sql_injection_attack_detection_distilbert|
