...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("nemesis_reranker","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("nemesis_reranker", "en")
