...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_cased_snli_model3","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_cased_snli_model3", "en")
