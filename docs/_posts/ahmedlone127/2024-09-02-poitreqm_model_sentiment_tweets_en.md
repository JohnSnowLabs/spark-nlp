...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("poitreqm_model_sentiment_tweets","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("poitreqm_model_sentiment_tweets", "en")
