...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("imdb_sentiment","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("imdb_sentiment", "en")
