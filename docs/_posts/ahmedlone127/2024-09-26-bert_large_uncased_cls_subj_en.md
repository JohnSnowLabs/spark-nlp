...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_large_uncased_cls_subj","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_large_uncased_cls_subj", "en")
