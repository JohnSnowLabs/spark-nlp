...
embeddings = BertEmbeddings.pretrained("bert_base_multilingual_uncased_finetuned_hp","xx") \
...
val embeddings = BertEmbeddings.pretrained("bert_base_multilingual_uncased_finetuned_hp","xx") 
