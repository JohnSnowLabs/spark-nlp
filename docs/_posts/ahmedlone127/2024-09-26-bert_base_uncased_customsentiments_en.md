...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_uncased_customsentiments","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_uncased_customsentiments", "en")
