...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("feelings_text_classifier_eng","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("feelings_text_classifier_eng", "en")
