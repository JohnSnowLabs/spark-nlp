...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("airbnb_reviews_helpfulness_classifier_roberta_base","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("airbnb_reviews_helpfulness_classifier_roberta_base", "en")
