...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_ft_sst5","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_ft_sst5", "en")
