...
sequenceClassifier  = BertForSequenceClassification.pretrained("google_query_rating","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("google_query_rating", "en")
