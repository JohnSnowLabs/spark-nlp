...
marian = MarianTransformer.pretrained("marian_finetuned_gw_chinese_tonga_tonga_islands_english_accelerate","en") \
...
val embeddings = MarianTransformer.pretrained("marian_finetuned_gw_chinese_tonga_tonga_islands_english_accelerate","en") 
