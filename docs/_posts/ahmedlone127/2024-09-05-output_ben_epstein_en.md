...
tokenClassifier  = DistilBertForTokenClassification.pretrained("output_ben_epstein","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("output_ben_epstein", "en")
