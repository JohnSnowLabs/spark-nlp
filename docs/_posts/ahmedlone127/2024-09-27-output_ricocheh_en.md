...
sequenceClassifier  = BertForSequenceClassification.pretrained("output_ricocheh","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("output_ricocheh", "en")
