...
tokenClassifier = CamemBertForTokenClassification.pretrained("wangchanberta_base_att_spm_uncased","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("wangchanberta_base_att_spm_uncased", "en")
...
{:.table-model}
|---|---|
|Model Name:|wangchanberta_base_att_spm_uncased|
...
https://huggingface.co/bnunticha/wangchanberta-base-att-spm-uncased