...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("article_recognizer","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("article_recognizer", "en")
