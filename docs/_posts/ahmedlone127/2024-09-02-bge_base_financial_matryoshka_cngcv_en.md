...
embeddings = BGEEmbeddings.pretrained("bge_base_financial_matryoshka_cngcv","en") \
...
val embeddings = BGEEmbeddings.pretrained("bge_base_financial_matryoshka_cngcv","en") 
