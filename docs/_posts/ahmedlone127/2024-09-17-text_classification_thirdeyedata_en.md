...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("text_classification_thirdeyedata","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("text_classification_thirdeyedata", "en")
