...
embeddings = MPNetEmbeddings.pretrained("burmese_awesome_setfit_model_martinv","en") \
...
val embeddings = MPNetEmbeddings.pretrained("burmese_awesome_setfit_model_martinv","en") 
