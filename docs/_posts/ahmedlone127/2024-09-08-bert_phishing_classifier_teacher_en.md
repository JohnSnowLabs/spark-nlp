...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_phishing_classifier_teacher","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_phishing_classifier_teacher", "en")
