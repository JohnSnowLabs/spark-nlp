...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("minicheck_roberta_large","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("minicheck_roberta_large", "en")
