...
date: 2024-09-07
tags: [mr, open_source, xlm_roberta, embeddings, onnx]
task: Embeddings
language: mr
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/xlmroberta_embeddings_marathi_roberta_mr_5.5.0_3.0_1725677019423.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/xlmroberta_embeddings_marathi_roberta_mr_5.5.0_3.0_1725677019423.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
