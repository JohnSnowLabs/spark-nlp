...
embeddings = BertSentenceEmbeddings.pretrained("sent_finbert_pretrain_financeinc","en") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_finbert_pretrain_financeinc","en") 
