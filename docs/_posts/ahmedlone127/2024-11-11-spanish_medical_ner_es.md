...
tokenClassifier  = BertForTokenClassification.pretrained("spanish_medical_ner","es") \
...
val tokenClassifier = BertForTokenClassification.pretrained("spanish_medical_ner", "es")
