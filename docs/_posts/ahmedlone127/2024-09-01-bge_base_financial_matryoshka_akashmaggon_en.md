...
embeddings = BGEEmbeddings.pretrained("bge_base_financial_matryoshka_akashmaggon","en") \
...
val embeddings = BGEEmbeddings.pretrained("bge_base_financial_matryoshka_akashmaggon","en") 
