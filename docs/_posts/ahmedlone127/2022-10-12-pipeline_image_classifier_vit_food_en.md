---
layout: model
title: English pipeline_image_classifier_vit_food ViTForImageClassification from nateraw
author: John Snow Labs
name: pipeline_image_classifier_vit_food
date: 2022-10-12
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/pipeline_image_classifier_vit_food_en_4.2.1_3.0_1665535895480.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pipeline_image_classifier_vit_food_en_4.2.1_3.0_1665535895480.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
    ...
    pipeline = PretrainedPipeline('pipeline_image_classifier_vit_food', lang = 'en')
    annotations =  pipeline.transform(imageDF)
    
```
```scala

    val pipeline = new PretrainedPipeline("pipeline_image_classifier_vit_food", lang = "en")
...
{:.table-model}
|---|---|
|Model Name:|pipeline_image_classifier_vit_food|
|Type:|pipeline|
