...
sequenceClassifier  = BertForSequenceClassification.pretrained("chinese_roberta_climate_related_prediction_v3","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("chinese_roberta_climate_related_prediction_v3", "en")
