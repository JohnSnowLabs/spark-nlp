...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("umberto_uncased_covid_sentiment","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("umberto_uncased_covid_sentiment","en")
