...
sequenceClassifier  = BertForSequenceClassification.pretrained("fine_tuned_cb_bert","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("fine_tuned_cb_bert", "en")
