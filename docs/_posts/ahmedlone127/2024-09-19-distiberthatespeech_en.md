...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distiberthatespeech","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distiberthatespeech", "en")
