...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_banking77_pedroplanel","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_banking77_pedroplanel", "en")
