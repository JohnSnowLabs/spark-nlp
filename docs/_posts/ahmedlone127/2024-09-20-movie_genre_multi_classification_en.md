...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("movie_genre_multi_classification","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("movie_genre_multi_classification", "en")
