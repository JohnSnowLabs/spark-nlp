...
tokenClassifier = CamemBertForTokenClassification.pretrained("distilcamembert_base_ner_address","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("distilcamembert_base_ner_address", "en")
...
{:.table-model}
|---|---|
|Model Name:|distilcamembert_base_ner_address|
...
https://huggingface.co/konverner/distilcamembert-base-ner-address