...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("xnli_xlm_r_only_english","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("xnli_xlm_r_only_english", "en")
...
{:.table-model}
|---|---|
|Model Name:|xnli_xlm_r_only_english|
