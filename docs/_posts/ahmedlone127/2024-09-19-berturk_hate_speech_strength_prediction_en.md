...
sequenceClassifier  = BertForSequenceClassification.pretrained("berturk_hate_speech_strength_prediction","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("berturk_hate_speech_strength_prediction", "en")
