...
embeddings = DistilBertEmbeddings.pretrained("distilbert_word2vec_256k_mlm_500k","en") \
...
val embeddings = DistilBertEmbeddings.pretrained("distilbert_word2vec_256k_mlm_500k","en") 
...
{:.table-model}
|---|---|
|Model Name:|distilbert_word2vec_256k_mlm_500k|
