...
sequenceClassifier  = BertForSequenceClassification.pretrained("movie_genre_prediction_bert_base_uncased","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("movie_genre_prediction_bert_base_uncased", "en")
