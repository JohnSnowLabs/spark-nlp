...
sequenceClassifier  = BertForSequenceClassification.pretrained("ptv1_bert_large_uncased_sst2","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("ptv1_bert_large_uncased_sst2", "en")
