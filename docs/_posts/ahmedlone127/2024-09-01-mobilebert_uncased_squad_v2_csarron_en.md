...
spanClassifier = BertForQuestionAnswering.pretrained("mobilebert_uncased_squad_v2_csarron","en") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("mobilebert_uncased_squad_v2_csarron", "en")
