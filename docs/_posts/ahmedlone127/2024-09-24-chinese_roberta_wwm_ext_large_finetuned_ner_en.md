...
tokenClassifier  = BertForTokenClassification.pretrained("chinese_roberta_wwm_ext_large_finetuned_ner","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("chinese_roberta_wwm_ext_large_finetuned_ner", "en")
...
{:.table-model}
|---|---|
|Model Name:|chinese_roberta_wwm_ext_large_finetuned_ner|
