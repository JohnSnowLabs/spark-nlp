...
sequenceClassifier  = BertForSequenceClassification.pretrained("google_bert_bert_base_uncased_classification_finetuned","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("google_bert_bert_base_uncased_classification_finetuned", "en")
