...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("personality_lm_kevsun","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("personality_lm_kevsun", "en")
