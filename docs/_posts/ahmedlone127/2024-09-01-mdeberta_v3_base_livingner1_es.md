...
tokenClassifier  = DeBertaForTokenClassification.pretrained("mdeberta_v3_base_livingner1","es") \
...
val tokenClassifier = DeBertaForTokenClassification.pretrained("mdeberta_v3_base_livingner1", "es")
...
{:.table-model}
|---|---|
|Model Name:|mdeberta_v3_base_livingner1|
