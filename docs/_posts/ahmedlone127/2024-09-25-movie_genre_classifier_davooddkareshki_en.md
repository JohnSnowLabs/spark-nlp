...
sequenceClassifier  = BertForSequenceClassification.pretrained("movie_genre_classifier_davooddkareshki","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("movie_genre_classifier_davooddkareshki", "en")
