...
speechToText  = WhisperForCTC.pretrained("whisper_small_sanskasr","sa") \
...
val speechToText = WhisperForCTC.pretrained("whisper_small_sanskasr", "sa")
...
{:.table-model}
|---|---|
|Model Name:|whisper_small_sanskasr|
