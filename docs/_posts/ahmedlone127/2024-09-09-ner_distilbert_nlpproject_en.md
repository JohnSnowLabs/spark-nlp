...
tokenClassifier  = DistilBertForTokenClassification.pretrained("ner_distilbert_nlpproject","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("ner_distilbert_nlpproject", "en")
