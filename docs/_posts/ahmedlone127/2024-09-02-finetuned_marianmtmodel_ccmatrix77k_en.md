...
marian = MarianTransformer.pretrained("finetuned_marianmtmodel_ccmatrix77k","en") \
...
val embeddings = MarianTransformer.pretrained("finetuned_marianmtmodel_ccmatrix77k","en") 
