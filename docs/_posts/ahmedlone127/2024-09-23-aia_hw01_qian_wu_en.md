...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("aia_hw01_qian_wu","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("aia_hw01_qian_wu", "en")
