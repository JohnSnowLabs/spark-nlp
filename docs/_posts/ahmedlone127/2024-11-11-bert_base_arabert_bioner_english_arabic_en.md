...
tokenClassifier  = BertForTokenClassification.pretrained("bert_base_arabert_bioner_english_arabic","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("bert_base_arabert_bioner_english_arabic", "en")
