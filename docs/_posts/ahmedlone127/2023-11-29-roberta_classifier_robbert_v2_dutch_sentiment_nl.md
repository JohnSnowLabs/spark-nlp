...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_classifier_robbert_v2_dutch_sentiment_nl_5.2.0_3.0_1701234251873.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_classifier_robbert_v2_dutch_sentiment_nl_5.2.0_3.0_1701234251873.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("nl.classify.roberta.sentiment.v2").predict("""PUT YOUR STRING HERE""")
```
</div>
