...
embeddings = RoBertaEmbeddings.pretrained("roberta_base_wechsel_french","fr") \
...
val embeddings = RoBertaEmbeddings.pretrained("roberta_base_wechsel_french","fr") 
...
{:.table-model}
|---|---|
|Model Name:|roberta_base_wechsel_french|
