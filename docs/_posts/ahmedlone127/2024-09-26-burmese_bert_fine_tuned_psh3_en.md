...
sequenceClassifier  = BertForSequenceClassification.pretrained("burmese_bert_fine_tuned_psh3","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("burmese_bert_fine_tuned_psh3", "en")
