...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_ndd_html_content","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_ndd_html_content", "en")
