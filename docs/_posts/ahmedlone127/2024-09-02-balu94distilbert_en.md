...
tokenClassifier  = DistilBertForTokenClassification.pretrained("balu94distilbert","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("balu94distilbert", "en")
