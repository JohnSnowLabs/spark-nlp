...
sequenceClassifier  = BertForSequenceClassification.pretrained("albert_base_chinese_finetuned_qqp","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("albert_base_chinese_finetuned_qqp", "en")
