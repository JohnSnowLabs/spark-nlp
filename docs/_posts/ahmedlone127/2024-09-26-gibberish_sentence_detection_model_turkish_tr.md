...
sequenceClassifier  = BertForSequenceClassification.pretrained("gibberish_sentence_detection_model_turkish","tr") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("gibberish_sentence_detection_model_turkish", "tr")
