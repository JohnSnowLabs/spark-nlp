...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("burmese_distillbert_model2","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("burmese_distillbert_model2", "en")
