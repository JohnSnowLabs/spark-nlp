...
sequenceClassifier  = DeBertaForSequenceClassification.pretrained("deberta_v3_base_finetuned_mcqa_michaellutz","en") \
...
val sequenceClassifier = DeBertaForSequenceClassification.pretrained("deberta_v3_base_finetuned_mcqa_michaellutz", "en")
...
{:.table-model}
|---|---|
|Model Name:|deberta_v3_base_finetuned_mcqa_michaellutz|
