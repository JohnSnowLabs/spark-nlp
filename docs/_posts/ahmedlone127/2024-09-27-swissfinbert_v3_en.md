...
sequenceClassifier  = BertForSequenceClassification.pretrained("swissfinbert_v3","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("swissfinbert_v3", "en")
