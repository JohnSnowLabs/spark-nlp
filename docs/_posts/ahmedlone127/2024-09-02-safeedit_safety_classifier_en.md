...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("safeedit_safety_classifier","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("safeedit_safety_classifier", "en")
