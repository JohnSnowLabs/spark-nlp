...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("demo_model_tanmoyeeroy","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("demo_model_tanmoyeeroy", "en")
