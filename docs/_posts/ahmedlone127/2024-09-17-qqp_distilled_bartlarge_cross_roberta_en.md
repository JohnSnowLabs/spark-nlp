...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("qqp_distilled_bartlarge_cross_roberta","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("qqp_distilled_bartlarge_cross_roberta", "en")
...
{:.table-model}
|---|---|
|Model Name:|qqp_distilled_bartlarge_cross_roberta|
