...
tokenClassifier  = BertForTokenClassification.pretrained("finetuned_bert_chinese_base","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("finetuned_bert_chinese_base", "en")
