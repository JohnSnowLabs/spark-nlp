...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("military_distilbert_prod","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("military_distilbert_prod", "en")
