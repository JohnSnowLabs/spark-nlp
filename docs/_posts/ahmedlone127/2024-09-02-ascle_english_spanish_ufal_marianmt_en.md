...
marian = MarianTransformer.pretrained("ascle_english_spanish_ufal_marianmt","en") \
...
val embeddings = MarianTransformer.pretrained("ascle_english_spanish_ufal_marianmt","en") 
