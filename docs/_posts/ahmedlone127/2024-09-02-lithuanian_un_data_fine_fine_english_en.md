...
embeddings = MPNetEmbeddings.pretrained("lithuanian_un_data_fine_fine_english","en") \
...
val embeddings = MPNetEmbeddings.pretrained("lithuanian_un_data_fine_fine_english","en") 
