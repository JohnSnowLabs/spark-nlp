...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("test_saudi82s","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("test_saudi82s", "en")
