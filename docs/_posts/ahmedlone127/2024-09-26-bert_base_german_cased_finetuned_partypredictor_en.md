...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_german_cased_finetuned_partypredictor","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_german_cased_finetuned_partypredictor", "en")
