...
sequenceClassifier  = BertForSequenceClassification.pretrained("improved_arabert_twitter_sentiment_twitter","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("improved_arabert_twitter_sentiment_twitter", "en")
