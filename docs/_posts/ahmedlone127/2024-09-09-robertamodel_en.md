...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("robertamodel","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("robertamodel", "en")
