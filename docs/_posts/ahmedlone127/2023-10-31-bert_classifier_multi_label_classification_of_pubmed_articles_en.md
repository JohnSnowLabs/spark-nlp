...
`Phenomena and Processes [G]`, `Diseases [C]`, `Health Care [N]`, `Chemicals and Drugs [D]`, `Psychiatry and Psychology [F]`, `Anatomy [A]`, `Information Science [L]`, `Geographicals [Z]`, `Organisms [B]`, `Disciplines and Occupations [H]`, `Named Groups [M]`

{:.btn-box}
<button class="button button-orange" disabled>Live Demo</button>
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_classifier_multi_label_classification_of_pubmed_articles_en_5.1.4_3.4_1698793224415.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_multi_label_classification_of_pubmed_articles_en_5.1.4_3.4_1698793224415.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
