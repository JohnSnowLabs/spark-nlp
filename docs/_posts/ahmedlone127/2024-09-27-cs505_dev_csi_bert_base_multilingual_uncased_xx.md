...
sequenceClassifier  = BertForSequenceClassification.pretrained("cs505_dev_csi_bert_base_multilingual_uncased","xx") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("cs505_dev_csi_bert_base_multilingual_uncased", "xx")
