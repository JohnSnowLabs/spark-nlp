...
spanClassifier = DeBertaForQuestionAnswering.pretrained("finetunned_legal_deberta_v3_base","en") \
...
val spanClassifier = DeBertaForQuestionAnswering.pretrained("finetunned_legal_deberta_v3_base", "en")
