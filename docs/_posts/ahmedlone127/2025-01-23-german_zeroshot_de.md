...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/german_zeroshot_de_5.5.1_3.0_1737640916576.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/german_zeroshot_de_5.5.1_3.0_1737640916576.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
zeroShotClassifier  = BertForZeroShotClassification.pretrained("german_zeroshot","de") \
...
val zeroShotClassifier  = BertForZeroShotClassification.pretrained("german_zeroshot", "de")
