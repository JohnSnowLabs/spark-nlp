...
spanClassifier = BertForQuestionAnswering.pretrained("mobilebert_uncased_squad_v2_finetuned","en") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("mobilebert_uncased_squad_v2_finetuned", "en")
