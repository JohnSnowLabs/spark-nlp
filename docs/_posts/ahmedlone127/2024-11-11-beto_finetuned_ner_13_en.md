...
tokenClassifier  = BertForTokenClassification.pretrained("beto_finetuned_ner_13","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("beto_finetuned_ner_13", "en")
