...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("distilroberta_base_rejection_v1","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("distilroberta_base_rejection_v1", "en")
