...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("xlm_roberta_base_sanskrit_saskta_spanish","es") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("xlm_roberta_base_sanskrit_saskta_spanish", "es")
...
{:.table-model}
|---|---|
|Model Name:|xlm_roberta_base_sanskrit_saskta_spanish|
