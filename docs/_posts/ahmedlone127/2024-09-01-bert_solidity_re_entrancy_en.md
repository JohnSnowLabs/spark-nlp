...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("bert_solidity_re_entrancy","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("bert_solidity_re_entrancy", "en")
