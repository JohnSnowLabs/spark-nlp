...
sequenceClassifier  = DeBertaForSequenceClassification.pretrained("sst2_microsoft_deberta_v3_base_seed_2","en") \
...
val sequenceClassifier = DeBertaForSequenceClassification.pretrained("sst2_microsoft_deberta_v3_base_seed_2", "en")
...
{:.table-model}
|---|---|
|Model Name:|sst2_microsoft_deberta_v3_base_seed_2|
