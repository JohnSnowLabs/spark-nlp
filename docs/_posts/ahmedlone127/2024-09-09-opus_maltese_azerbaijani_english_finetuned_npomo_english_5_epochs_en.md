...
marian = MarianTransformer.pretrained("opus_maltese_azerbaijani_english_finetuned_npomo_english_5_epochs","en") \
...
val embeddings = MarianTransformer.pretrained("opus_maltese_azerbaijani_english_finetuned_npomo_english_5_epochs","en") 
