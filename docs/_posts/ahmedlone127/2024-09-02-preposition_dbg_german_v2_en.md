...
tokenClassifier  = CamemBertForTokenClassification.pretrained("preposition_dbg_german_v2","en") \
...
val tokenClassifier = CamemBertForTokenClassification.pretrained("preposition_dbg_german_v2", "en")
