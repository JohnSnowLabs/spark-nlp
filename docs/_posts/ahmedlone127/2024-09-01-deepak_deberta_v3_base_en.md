...
spanClassifier = DeBertaForQuestionAnswering.pretrained("deepak_deberta_v3_base","en") \
...
val spanClassifier = DeBertaForQuestionAnswering.pretrained("deepak_deberta_v3_base", "en")
