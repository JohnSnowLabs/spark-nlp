...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_finetuned_emowoz","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_finetuned_emowoz", "en")
