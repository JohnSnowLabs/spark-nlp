...
tokenClassifier  = BertForTokenClassification.pretrained("nees_bert_base_portuguese_cased_finetuned_ner","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("nees_bert_base_portuguese_cased_finetuned_ner", "en")
