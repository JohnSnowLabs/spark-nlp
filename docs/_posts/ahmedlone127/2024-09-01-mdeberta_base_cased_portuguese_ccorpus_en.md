...
embeddings = DeBertaEmbeddings.pretrained("mdeberta_base_cased_portuguese_ccorpus","en") \
...
val embeddings = DeBertaEmbeddings.pretrained("mdeberta_base_cased_portuguese_ccorpus","en") 
