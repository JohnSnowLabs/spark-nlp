...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("empathy_model","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("empathy_model", "en")
