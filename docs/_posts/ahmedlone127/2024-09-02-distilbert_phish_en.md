...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_phish","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_phish", "en")
