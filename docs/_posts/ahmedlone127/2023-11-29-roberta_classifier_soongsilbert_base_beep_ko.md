...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_classifier_soongsilbert_base_beep_ko_5.2.0_3.0_1701235671824.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_classifier_soongsilbert_base_beep_ko_5.2.0_3.0_1701235671824.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("ko.classify.roberta.base.by_jason9693").predict("""PUT YOUR STRING HERE""")
```
</div>
