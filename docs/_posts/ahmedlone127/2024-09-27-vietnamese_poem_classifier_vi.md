...
sequenceClassifier  = BertForSequenceClassification.pretrained("vietnamese_poem_classifier","vi") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("vietnamese_poem_classifier", "vi")
