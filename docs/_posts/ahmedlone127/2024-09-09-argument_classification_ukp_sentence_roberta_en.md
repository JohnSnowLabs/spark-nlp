...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("argument_classification_ukp_sentence_roberta","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("argument_classification_ukp_sentence_roberta", "en")
