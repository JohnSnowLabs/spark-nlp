...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_rte","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_rte", "en")
