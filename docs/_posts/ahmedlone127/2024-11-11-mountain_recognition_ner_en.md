...
tokenClassifier  = BertForTokenClassification.pretrained("mountain_recognition_ner","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("mountain_recognition_ner", "en")
