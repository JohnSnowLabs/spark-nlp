...
embeddings = BertSentenceEmbeddings.pretrained("sent_alephbertgimmel_base_512","he") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_alephbertgimmel_base_512","he") 
