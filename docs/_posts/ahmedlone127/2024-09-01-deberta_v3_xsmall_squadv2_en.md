...
spanClassifier = DeBertaForQuestionAnswering.pretrained("deberta_v3_xsmall_squadv2","en") \
...
val spanClassifier = DeBertaForQuestionAnswering.pretrained("deberta_v3_xsmall_squadv2", "en")
