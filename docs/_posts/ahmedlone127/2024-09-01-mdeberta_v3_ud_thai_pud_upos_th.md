...
tokenClassifier  = DeBertaForTokenClassification.pretrained("mdeberta_v3_ud_thai_pud_upos","th") \
...
val tokenClassifier = DeBertaForTokenClassification.pretrained("mdeberta_v3_ud_thai_pud_upos", "th")
