...
sequenceClassifier  = BertForSequenceClassification.pretrained("covid_augment_tweet_bert_large_e4","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("covid_augment_tweet_bert_large_e4", "en")
