...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("synthetic_wmdp_classifier","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("synthetic_wmdp_classifier", "en")
