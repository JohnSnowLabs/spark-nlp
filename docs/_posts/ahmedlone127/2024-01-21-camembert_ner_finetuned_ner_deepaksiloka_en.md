...
tokenClassifier = CamemBertForTokenClassification.pretrained("camembert_ner_finetuned_ner_deepaksiloka","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("camembert_ner_finetuned_ner_deepaksiloka", "en")
