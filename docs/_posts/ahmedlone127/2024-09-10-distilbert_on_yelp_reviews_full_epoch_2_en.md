...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_on_yelp_reviews_full_epoch_2","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_on_yelp_reviews_full_epoch_2", "en")
