...
tokenClassifier  = BertForTokenClassification.pretrained("bert_full_finetuned_ner_pablo","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("bert_full_finetuned_ner_pablo", "en")
