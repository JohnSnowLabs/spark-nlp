...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_ner_jameswrbrookes_bert_finetuned_ner_en_5.2.4_3.0_1716434519321.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_ner_jameswrbrookes_bert_finetuned_ner_en_5.2.4_3.0_1716434519321.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.ner.bert.finetuned.by_jameswrbrookes").predict("""PUT YOUR STRING HERE""")
```
</div>
