...
tokenClassifier  = XlmRoBertaForTokenClassification.pretrained("metaphor_detection_xlmr","en") \
...
val tokenClassifier = XlmRoBertaForTokenClassification.pretrained("metaphor_detection_xlmr", "en")
