...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/distilbert_ner_keyphrase_extraction_distilbert_openkp_en_5.2.0_3.0_1700518274457.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/distilbert_ner_keyphrase_extraction_distilbert_openkp_en_5.2.0_3.0_1700518274457.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.ner.distil_bert.keyphrase.openkp.by_dedeckerthomas").predict("""I love Spark NLP""")
```
</div>
