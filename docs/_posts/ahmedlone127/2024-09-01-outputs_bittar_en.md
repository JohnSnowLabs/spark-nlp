...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("outputs_bittar","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("outputs_bittar", "en")
