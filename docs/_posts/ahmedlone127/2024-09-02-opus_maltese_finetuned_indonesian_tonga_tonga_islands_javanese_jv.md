...
marian = MarianTransformer.pretrained("opus_maltese_finetuned_indonesian_tonga_tonga_islands_javanese","jv") \
...
val embeddings = MarianTransformer.pretrained("opus_maltese_finetuned_indonesian_tonga_tonga_islands_javanese","jv") 
...
{:.table-model}
|---|---|
|Model Name:|opus_maltese_finetuned_indonesian_tonga_tonga_islands_javanese|
