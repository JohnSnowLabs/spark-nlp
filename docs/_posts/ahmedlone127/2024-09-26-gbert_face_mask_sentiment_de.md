...
sequenceClassifier  = BertForSequenceClassification.pretrained("gbert_face_mask_sentiment","de") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("gbert_face_mask_sentiment", "de")
