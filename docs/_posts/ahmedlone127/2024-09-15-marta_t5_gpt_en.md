...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("marta_t5_gpt","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("marta_t5_gpt", "en")
