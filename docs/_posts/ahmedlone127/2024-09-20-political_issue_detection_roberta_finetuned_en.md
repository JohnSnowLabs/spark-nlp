...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("political_issue_detection_roberta_finetuned","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("political_issue_detection_roberta_finetuned", "en")
