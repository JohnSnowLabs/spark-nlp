...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("sst2_padding60model","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("sst2_padding60model", "en")
