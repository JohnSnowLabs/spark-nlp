...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_culinary","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_culinary", "en")
