...
sequenceClassifier  = BertForSequenceClassification.pretrained("nadi2024_baseline","ar") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("nadi2024_baseline", "ar")
