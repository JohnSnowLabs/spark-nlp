...
embeddings = BertEmbeddings.pretrained("bert_base_bulgarian","bg") \
...
val embeddings = BertEmbeddings.pretrained("bert_base_bulgarian","bg") 
...
{:.table-model}
|---|---|
|Model Name:|bert_base_bulgarian|
