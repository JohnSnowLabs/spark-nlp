...
embeddings = BertSentenceEmbeddings.pretrained("sent_bert_base_arabic_camelbert_msa_sixteenth","ar") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_bert_base_arabic_camelbert_msa_sixteenth","ar") 
