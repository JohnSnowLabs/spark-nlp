...
speechToText  = WhisperForCTC.pretrained("whisper_small_hindi_harshitjoshi","hi") \
...
val speechToText = WhisperForCTC.pretrained("whisper_small_hindi_harshitjoshi", "hi")
