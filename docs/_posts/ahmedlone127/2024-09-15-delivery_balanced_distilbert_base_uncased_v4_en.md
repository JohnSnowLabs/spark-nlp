...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("delivery_balanced_distilbert_base_uncased_v4","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("delivery_balanced_distilbert_base_uncased_v4", "en")
...
{:.table-model}
|---|---|
|Model Name:|delivery_balanced_distilbert_base_uncased_v4|
