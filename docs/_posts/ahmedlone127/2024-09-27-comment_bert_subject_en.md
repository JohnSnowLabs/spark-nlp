...
sequenceClassifier  = BertForSequenceClassification.pretrained("comment_bert_subject","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("comment_bert_subject", "en")
