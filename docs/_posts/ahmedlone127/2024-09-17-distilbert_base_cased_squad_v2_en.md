...
spanClassifier = DistilBertForQuestionAnswering.pretrained("distilbert_base_cased_squad_v2","en") \
...
val spanClassifier = DistilBertForQuestionAnswering.pretrained("distilbert_base_cased_squad_v2", "en")
