...
sequenceClassifier  = DeBertaForSequenceClassification.pretrained("deberta_v3_small_isarcasm","en") \
...
val sequenceClassifier = DeBertaForSequenceClassification.pretrained("deberta_v3_small_isarcasm", "en")
