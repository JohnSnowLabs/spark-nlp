...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("severe_js100_sentiment","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("severe_js100_sentiment","en")
