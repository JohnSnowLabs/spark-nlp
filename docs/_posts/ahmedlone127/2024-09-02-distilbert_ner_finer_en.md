...
tokenClassifier  = DistilBertForTokenClassification.pretrained("distilbert_ner_finer","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("distilbert_ner_finer", "en")
