...
embeddings = MPNetEmbeddings.pretrained("clinical_sentence_transformers_mpnet_base_v2","en") \
...
val embeddings = MPNetEmbeddings.pretrained("clinical_sentence_transformers_mpnet_base_v2","en") 
