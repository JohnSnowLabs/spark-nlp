...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_sst5_padding0model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_sst5_padding0model", "en")
