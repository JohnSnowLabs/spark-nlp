...
sequenceClassifier  = BertForSequenceClassification.pretrained("scibert_sdg_cased_zo_up","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("scibert_sdg_cased_zo_up", "en")
