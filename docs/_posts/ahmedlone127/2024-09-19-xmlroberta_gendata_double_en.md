...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("xmlroberta_gendata_double","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("xmlroberta_gendata_double", "en")
...
{:.table-model}
|---|---|
|Model Name:|xmlroberta_gendata_double|
