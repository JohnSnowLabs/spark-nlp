...
embeddings = XlmRoBertaEmbeddings.pretrained("glot500_with_transliteration_minangkabau","en") \
...
val embeddings = XlmRoBertaEmbeddings.pretrained("glot500_with_transliteration_minangkabau","en") 
...
{:.table-model}
|---|---|
|Model Name:|glot500_with_transliteration_minangkabau|
