...
sequenceClassifier  = BertForSequenceClassification.pretrained("e2e_deployment","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("e2e_deployment", "en")
