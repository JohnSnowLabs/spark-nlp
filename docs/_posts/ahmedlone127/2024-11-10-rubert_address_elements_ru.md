...
tokenClassifier  = BertForTokenClassification.pretrained("rubert_address_elements","ru") \
...
val tokenClassifier = BertForTokenClassification.pretrained("rubert_address_elements", "ru")
...
{:.table-model}
|---|---|
|Model Name:|rubert_address_elements|
