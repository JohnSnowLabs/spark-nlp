...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("twitter_roberta_large_nerd_latest","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("twitter_roberta_large_nerd_latest", "en")
