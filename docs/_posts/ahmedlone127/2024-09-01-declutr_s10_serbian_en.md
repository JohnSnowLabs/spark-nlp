...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("declutr_s10_serbian","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("declutr_s10_serbian", "en")
