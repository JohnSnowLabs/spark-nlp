...
sequenceClassifier  = BertForSequenceClassification.pretrained("tweetbasedsa","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("tweetbasedsa", "en")
