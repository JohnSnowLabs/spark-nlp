...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("acarisbert_distilbert","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("acarisbert_distilbert", "en")
...
{:.table-model}
|---|---|
|Model Name:|acarisbert_distilbert|
