...
embeddings = BertSentenceEmbeddings.pretrained("sent_mbert_resp_english_chinese","en") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_mbert_resp_english_chinese","en") 
