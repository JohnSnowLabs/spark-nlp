...
embeddings = DistilBertEmbeddings.pretrained("msmarco_distilbert_word2vec256k_mlm_230k","en") \
...
val embeddings = DistilBertEmbeddings.pretrained("msmarco_distilbert_word2vec256k_mlm_230k","en") 
