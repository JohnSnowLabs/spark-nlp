...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("twitter_roberta_large_similarity_latest","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("twitter_roberta_large_similarity_latest", "en")
