...
sequenceClassifier  = MPNetForSequenceClassification.pretrained("mpnet_base_sst2_distilled","en") \
...
val sequenceClassifier = MPNetForSequenceClassification.pretrained("mpnet_base_sst2_distilled", "en")
