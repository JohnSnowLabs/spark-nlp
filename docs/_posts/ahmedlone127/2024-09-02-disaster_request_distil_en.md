...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("disaster_request_distil","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("disaster_request_distil", "en")
