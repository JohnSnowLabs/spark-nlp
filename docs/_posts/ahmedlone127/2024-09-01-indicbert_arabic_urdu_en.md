...
tokenClassifier  = AlbertForTokenClassification.pretrained("indicbert_arabic_urdu","en") \
...
val tokenClassifier = AlbertForTokenClassification.pretrained("indicbert_arabic_urdu", "en")
