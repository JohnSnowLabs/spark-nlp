...
speechToText  = WhisperForCTC.pretrained("whisper_tiny_galician","gl") \
...
val speechToText = WhisperForCTC.pretrained("whisper_tiny_galician", "gl")
...
{:.table-model}
|---|---|
|Model Name:|whisper_tiny_galician|
