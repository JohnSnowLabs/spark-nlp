...
spanClassifier = AlbertForQuestionAnswering.pretrained("albert_base_qa_coqa_3","en") \
...
val spanClassifier = AlbertForQuestionAnswering.pretrained("albert_base_qa_coqa_3", "en")
