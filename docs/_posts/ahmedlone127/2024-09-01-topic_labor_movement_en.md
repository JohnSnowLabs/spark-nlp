...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("topic_labor_movement","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("topic_labor_movement", "en")
...
{:.table-model}
|---|---|
|Model Name:|topic_labor_movement|
