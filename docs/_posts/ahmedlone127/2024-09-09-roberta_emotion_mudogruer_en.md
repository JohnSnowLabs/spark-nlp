...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("roberta_emotion_mudogruer","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("roberta_emotion_mudogruer", "en")
