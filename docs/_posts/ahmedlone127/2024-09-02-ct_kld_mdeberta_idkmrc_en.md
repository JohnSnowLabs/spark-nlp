...
spanClassifier = DeBertaForQuestionAnswering.pretrained("ct_kld_mdeberta_idkmrc","en") \
...
val spanClassifier = DeBertaForQuestionAnswering.pretrained("ct_kld_mdeberta_idkmrc", "en")
