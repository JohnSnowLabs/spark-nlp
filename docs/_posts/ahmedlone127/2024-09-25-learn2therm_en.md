...
sequenceClassifier  = BertForSequenceClassification.pretrained("learn2therm","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("learn2therm", "en")
