...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("topic_govt_regulation","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("topic_govt_regulation", "en")
