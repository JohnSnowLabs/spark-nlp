...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/image_classifier_vit_base_patch16_224_finetuned_kvasirv2_colonoscopy_en_4.1.0_3.0_1660167194867.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
nlu.load("en.classify_image.base_patch16_224_finetuned_kvasirv2_colonoscopy").predict("hen.JPEG")
```
