...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("xlm_roberta_base_finetuned_marc_agudden","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("xlm_roberta_base_finetuned_marc_agudden", "en")
