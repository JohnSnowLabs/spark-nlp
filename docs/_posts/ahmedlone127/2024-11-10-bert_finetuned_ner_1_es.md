...
tokenClassifier  = BertForTokenClassification.pretrained("bert_finetuned_ner_1","es") \
...
val tokenClassifier = BertForTokenClassification.pretrained("bert_finetuned_ner_1", "es")
...
{:.table-model}
|---|---|
|Model Name:|bert_finetuned_ner_1|
