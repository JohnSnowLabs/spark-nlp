...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("finetuned_distilbertmy_model","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("finetuned_distilbertmy_model", "en")
