...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("roberta_base_legal_nli_finetuned","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("roberta_base_legal_nli_finetuned", "en")
