...
spanClassifier = BertForQuestionAnswering.pretrained("bert_qa_news_pretrain_bert_ft_nepal_bhasa_newsqa","en") \
...
val spanClassifier = BertForQuestionAnswering  
    .pretrained("bert_qa_news_pretrain_bert_ft_nepal_bhasa_newsqa", "en")
...
{:.table-model}
|---|---|
|Model Name:|bert_qa_news_pretrain_bert_ft_nepal_bhasa_newsqa|
