...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/asr_exp_w2v2r_xls_r_accent_germany_8_austria_2_s42_de_4.2.0_3.0_1664118903970.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
nlu.load("de.speech2text.wav2vec_xlsr.v2_s42_exp").predict("ngm_12484_01067234848.wav")
```
