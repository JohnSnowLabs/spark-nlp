...
marian = MarianTransformer.pretrained("sunbird_english_multiple_languages","en") \
...
val embeddings = MarianTransformer.pretrained("sunbird_english_multiple_languages","en") 
