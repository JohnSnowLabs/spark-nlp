...
sequenceClassifier  = DeBertaForSequenceClassification.pretrained("mdebertav3_subjectivity_arabic","ar") \
...
val sequenceClassifier = DeBertaForSequenceClassification.pretrained("mdebertav3_subjectivity_arabic", "ar")
...
{:.table-model}
|---|---|
|Model Name:|mdebertav3_subjectivity_arabic|
