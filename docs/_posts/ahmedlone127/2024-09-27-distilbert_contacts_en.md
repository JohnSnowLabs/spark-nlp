...
sequenceClassifier  = BertForSequenceClassification.pretrained("distilbert_contacts","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("distilbert_contacts", "en")
