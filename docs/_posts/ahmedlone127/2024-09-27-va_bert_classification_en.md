...
sequenceClassifier  = BertForSequenceClassification.pretrained("va_bert_classification","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("va_bert_classification", "en")
