...
date: 2023-07-30
tags: [mt, open_source, camembert, embeddings, onnx]
task: Embeddings
language: mt
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/camembert_embeddings_camembert_aux_amandes_mt_5.0.0_3.0_1690755523370.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/camembert_embeddings_camembert_aux_amandes_mt_5.0.0_3.0_1690755523370.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("mt.embed.camembert").predict("""I Love Spark NLP""")
```
</div>
