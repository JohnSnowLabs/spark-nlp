...
sequenceClassifier  = BertForSequenceClassification.pretrained("zipbasemodel","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("zipbasemodel", "en")
