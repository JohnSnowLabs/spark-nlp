...
zeroShotClassifier  = BertForZeroShotClassification.pretrained("contriever_mnli","en") \
...
val zeroShotClassifier  = BertForZeroShotClassification.pretrained("contriever_mnli", "en")
