...
embeddings = MPNetEmbeddings.pretrained("setfit_model_misinformation_on_media_traditional_social","en") \
...
val embeddings = MPNetEmbeddings.pretrained("setfit_model_misinformation_on_media_traditional_social","en") 
