...
embeddings = BertSentenceEmbeddings.pretrained("sent_legal_bert_base_uncased_finetuned_rramicus","en") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_legal_bert_base_uncased_finetuned_rramicus","en") 
