...
spanClassifier = BertForQuestionAnswering.pretrained("indobert_for_eqa_finetuned","ms") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("indobert_for_eqa_finetuned", "ms")
...
{:.table-model}
|---|---|
|Model Name:|indobert_for_eqa_finetuned|
