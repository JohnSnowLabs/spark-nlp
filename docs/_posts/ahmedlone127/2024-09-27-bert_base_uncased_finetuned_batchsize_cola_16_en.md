...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_uncased_finetuned_batchsize_cola_16","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_uncased_finetuned_batchsize_cola_16", "en")
