...
embeddings = RoBertaEmbeddings.pretrained("dragon_roberta_large_domain_specific","en") \
...
val embeddings = RoBertaEmbeddings.pretrained("dragon_roberta_large_domain_specific","en") 
