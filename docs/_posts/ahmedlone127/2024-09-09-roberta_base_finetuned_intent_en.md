...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("roberta_base_finetuned_intent","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("roberta_base_finetuned_intent", "en")
