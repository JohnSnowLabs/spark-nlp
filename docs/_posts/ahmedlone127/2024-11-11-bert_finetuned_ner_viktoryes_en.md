...
tokenClassifier  = BertForTokenClassification.pretrained("bert_finetuned_ner_viktoryes","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("bert_finetuned_ner_viktoryes", "en")
