...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_finetuned_customer_queries_sebak13","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_finetuned_customer_queries_sebak13", "en")
