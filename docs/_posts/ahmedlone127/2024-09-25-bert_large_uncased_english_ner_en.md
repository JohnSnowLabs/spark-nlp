...
tokenClassifier  = BertForTokenClassification.pretrained("bert_large_uncased_english_ner","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("bert_large_uncased_english_ner", "en")
