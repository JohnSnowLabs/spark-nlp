...
zeroShotClassifier  = BertForZeroShotClassification.pretrained("mcontriever_msmarco_xnli","xx") \
...
val zeroShotClassifier  = BertForZeroShotClassification.pretrained("mcontriever_msmarco_xnli", "xx")
...
{:.table-model}
|---|---|
|Model Name:|mcontriever_msmarco_xnli|
