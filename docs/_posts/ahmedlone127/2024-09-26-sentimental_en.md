...
sequenceClassifier  = BertForSequenceClassification.pretrained("sentimental","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("sentimental", "en")
