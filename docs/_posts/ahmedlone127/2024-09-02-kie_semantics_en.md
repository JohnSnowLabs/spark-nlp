...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("kie_semantics","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("kie_semantics", "en")
