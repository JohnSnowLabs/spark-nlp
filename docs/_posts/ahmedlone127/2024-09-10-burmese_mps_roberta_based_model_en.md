...
embeddings = RoBertaEmbeddings.pretrained("burmese_mps_roberta_based_model","en") \
...
val embeddings = RoBertaEmbeddings.pretrained("burmese_mps_roberta_based_model","en") 
...
{:.table-model}
|---|---|
|Model Name:|burmese_mps_roberta_based_model|
