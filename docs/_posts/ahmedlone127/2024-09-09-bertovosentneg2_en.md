...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("bertovosentneg2","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("bertovosentneg2", "en")
