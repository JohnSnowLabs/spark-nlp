...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("reviews_roberta_base_sentiment_analysis","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("reviews_roberta_base_sentiment_analysis", "en")
