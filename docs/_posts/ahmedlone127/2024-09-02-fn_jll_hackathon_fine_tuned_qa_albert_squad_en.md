...
spanClassifier = AlbertForQuestionAnswering.pretrained("fn_jll_hackathon_fine_tuned_qa_albert_squad","en") \
...
val spanClassifier = AlbertForQuestionAnswering.pretrained("fn_jll_hackathon_fine_tuned_qa_albert_squad", "en")
