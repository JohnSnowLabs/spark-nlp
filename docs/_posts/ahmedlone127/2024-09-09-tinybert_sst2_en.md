...
sequenceClassifier  = BertForSequenceClassification.pretrained("tinybert_sst2","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("tinybert_sst2", "en")
