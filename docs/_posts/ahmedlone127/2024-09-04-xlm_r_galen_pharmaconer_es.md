...
tokenClassifier  = XlmRoBertaForTokenClassification.pretrained("xlm_r_galen_pharmaconer","es") \
...
val tokenClassifier = XlmRoBertaForTokenClassification.pretrained("xlm_r_galen_pharmaconer", "es")
