...
tokenClassifier  = BertForTokenClassification.pretrained("software_ner_prod","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("software_ner_prod", "en")
