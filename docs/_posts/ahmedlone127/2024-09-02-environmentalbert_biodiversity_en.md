...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("environmentalbert_biodiversity","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("environmentalbert_biodiversity", "en")
