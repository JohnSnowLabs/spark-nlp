...
tokenClassifier  = BertForTokenClassification.pretrained("bert_ner_fahmiaziz","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("bert_ner_fahmiaziz", "en")
