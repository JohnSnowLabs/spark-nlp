...
sequenceClassifier  = BertForSequenceClassification.pretrained("icd_10_code_prediction","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("icd_10_code_prediction", "en")
...
{:.table-model}
|---|---|
|Model Name:|icd_10_code_prediction|
