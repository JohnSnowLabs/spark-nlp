...
tokenClassifier  = DistilBertForTokenClassification.pretrained("distilbert_ner_wnut_model","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("distilbert_ner_wnut_model", "en")
