...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("binaryaugmentedcards","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("binaryaugmentedcards", "en")
