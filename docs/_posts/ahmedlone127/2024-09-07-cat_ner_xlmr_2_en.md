...
tokenClassifier  = XlmRoBertaForTokenClassification.pretrained("cat_ner_xlmr_2","en") \
...
val tokenClassifier = XlmRoBertaForTokenClassification.pretrained("cat_ner_xlmr_2", "en")
