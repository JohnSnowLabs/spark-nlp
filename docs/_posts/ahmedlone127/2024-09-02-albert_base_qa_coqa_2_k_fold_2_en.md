...
spanClassifier = AlbertForQuestionAnswering.pretrained("albert_base_qa_coqa_2_k_fold_2","en") \
...
val spanClassifier = AlbertForQuestionAnswering.pretrained("albert_base_qa_coqa_2_k_fold_2", "en")
...
{:.table-model}
|---|---|
|Model Name:|albert_base_qa_coqa_2_k_fold_2|
