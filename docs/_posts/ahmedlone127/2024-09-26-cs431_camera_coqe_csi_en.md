...
sequenceClassifier  = BertForSequenceClassification.pretrained("cs431_camera_coqe_csi","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("cs431_camera_coqe_csi", "en")
