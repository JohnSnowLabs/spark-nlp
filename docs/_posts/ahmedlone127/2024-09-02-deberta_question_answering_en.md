...
spanClassifier = DeBertaForQuestionAnswering.pretrained("deberta_question_answering","en") \
...
val spanClassifier = DeBertaForQuestionAnswering.pretrained("deberta_question_answering", "en")
