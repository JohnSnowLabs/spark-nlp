...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("results_nelsonauner","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("results_nelsonauner", "en")
...
{:.table-model}
|---|---|
|Model Name:|results_nelsonauner|
