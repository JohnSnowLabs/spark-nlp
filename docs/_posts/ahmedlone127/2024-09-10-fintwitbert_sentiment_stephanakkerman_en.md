...
sequenceClassifier  = BertForSequenceClassification.pretrained("fintwitbert_sentiment_stephanakkerman","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("fintwitbert_sentiment_stephanakkerman", "en")
