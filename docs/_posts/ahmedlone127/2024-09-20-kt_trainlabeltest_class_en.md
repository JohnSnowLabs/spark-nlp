...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("kt_trainlabeltest_class","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("kt_trainlabeltest_class", "en")
