...
sequenceClassifier  = BertForSequenceClassification.pretrained("readabert_english","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("readabert_english", "en")
