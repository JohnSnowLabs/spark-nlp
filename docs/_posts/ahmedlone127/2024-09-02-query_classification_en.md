...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("query_classification","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("query_classification", "en")
