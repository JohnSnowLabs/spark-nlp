...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("roberta22_model","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("roberta22_model", "en")
