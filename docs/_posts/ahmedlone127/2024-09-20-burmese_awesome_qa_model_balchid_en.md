...
spanClassifier = BertForQuestionAnswering.pretrained("burmese_awesome_qa_model_balchid","en") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("burmese_awesome_qa_model_balchid", "en")
