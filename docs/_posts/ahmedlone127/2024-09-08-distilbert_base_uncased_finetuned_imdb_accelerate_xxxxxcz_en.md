...
embeddings = DistilBertEmbeddings.pretrained("distilbert_base_uncased_finetuned_imdb_accelerate_xxxxxcz","en") \
...
val embeddings = DistilBertEmbeddings.pretrained("distilbert_base_uncased_finetuned_imdb_accelerate_xxxxxcz","en") 
...
{:.table-model}
|---|---|
|Model Name:|distilbert_base_uncased_finetuned_imdb_accelerate_xxxxxcz|
