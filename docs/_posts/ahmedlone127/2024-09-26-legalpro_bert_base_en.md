...
sequenceClassifier  = BertForSequenceClassification.pretrained("legalpro_bert_base","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("legalpro_bert_base", "en")
