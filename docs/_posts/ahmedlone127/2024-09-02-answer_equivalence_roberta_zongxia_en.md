...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("answer_equivalence_roberta_zongxia","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("answer_equivalence_roberta_zongxia", "en")
