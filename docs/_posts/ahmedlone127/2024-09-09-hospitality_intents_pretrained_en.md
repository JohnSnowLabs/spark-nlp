...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("hospitality_intents_pretrained","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("hospitality_intents_pretrained", "en")
