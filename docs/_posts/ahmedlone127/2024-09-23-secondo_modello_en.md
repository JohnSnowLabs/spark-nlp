...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("secondo_modello","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("secondo_modello", "en")
