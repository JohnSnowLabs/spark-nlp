...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("seq_classification_demo","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("seq_classification_demo","en")
