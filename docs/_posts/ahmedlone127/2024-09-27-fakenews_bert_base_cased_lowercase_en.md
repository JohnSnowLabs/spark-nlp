...
sequenceClassifier  = BertForSequenceClassification.pretrained("fakenews_bert_base_cased_lowercase","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("fakenews_bert_base_cased_lowercase", "en")
