...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("burmese_awesome_model_tsibbett","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("burmese_awesome_model_tsibbett", "en")
