...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("burmese_awesome_model_panzy0524","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("burmese_awesome_model_panzy0524", "en")
...
{:.table-model}
|---|---|
|Model Name:|burmese_awesome_model_panzy0524|
