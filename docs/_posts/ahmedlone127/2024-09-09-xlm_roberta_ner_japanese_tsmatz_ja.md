...
tokenClassifier  = XlmRoBertaForTokenClassification.pretrained("xlm_roberta_ner_japanese_tsmatz","ja") \
...
val tokenClassifier = XlmRoBertaForTokenClassification.pretrained("xlm_roberta_ner_japanese_tsmatz", "ja")
