...
tokenClassifier = CamemBertForTokenClassification.pretrained("icdar23_entrydetector_plaintext_breaks","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("icdar23_entrydetector_plaintext_breaks", "en")
