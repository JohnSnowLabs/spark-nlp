...
sequenceClassifier  = BertForSequenceClassification.pretrained("case_analysis_inlegalbert","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("case_analysis_inlegalbert", "en")
...
{:.table-model}
|---|---|
|Model Name:|case_analysis_inlegalbert|
