...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("schemeclassifier_esp","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("schemeclassifier_esp", "en")
