...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("finbert_netcashprovidedbyusedininvestingactivities","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("finbert_netcashprovidedbyusedininvestingactivities", "en")
...
{:.table-model}
|---|---|
|Model Name:|finbert_netcashprovidedbyusedininvestingactivities|
