...
speechToText  = WhisperForCTC.pretrained("whisper_base_hungarian_v1","hu") \
...
val speechToText = WhisperForCTC.pretrained("whisper_base_hungarian_v1", "hu")
...
{:.table-model}
|---|---|
|Model Name:|whisper_base_hungarian_v1|
