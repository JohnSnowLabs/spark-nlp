...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("textfooler_roberta_base_rte_5","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("textfooler_roberta_base_rte_5", "en")
