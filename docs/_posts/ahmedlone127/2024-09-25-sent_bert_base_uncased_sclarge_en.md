...
embeddings = BertSentenceEmbeddings.pretrained("sent_bert_base_uncased_sclarge","en") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_bert_base_uncased_sclarge","en") 
...
{:.table-model}
|---|---|
|Model Name:|sent_bert_base_uncased_sclarge|
