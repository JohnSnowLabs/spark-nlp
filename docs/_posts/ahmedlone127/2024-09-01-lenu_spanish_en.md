...
sequenceClassifier  = BertForSequenceClassification.pretrained("lenu_spanish","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("lenu_spanish", "en")
