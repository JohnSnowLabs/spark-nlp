...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("test_forwarder1121","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("test_forwarder1121", "en")
