...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("camembert_classification_tools_qlora","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("camembert_classification_tools_qlora","en")
