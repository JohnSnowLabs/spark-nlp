...
embeddings = XlmRoBertaSentenceEmbeddings.pretrained("sent_entitycs_39_pep_malay_xlmr_base","xx") \
...
val embeddings = XlmRoBertaSentenceEmbeddings.pretrained("sent_entitycs_39_pep_malay_xlmr_base","xx") 
