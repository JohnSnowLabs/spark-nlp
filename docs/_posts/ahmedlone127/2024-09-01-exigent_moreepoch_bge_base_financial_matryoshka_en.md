...
embeddings = BGEEmbeddings.pretrained("exigent_moreepoch_bge_base_financial_matryoshka","en") \
...
val embeddings = BGEEmbeddings.pretrained("exigent_moreepoch_bge_base_financial_matryoshka","en") 
