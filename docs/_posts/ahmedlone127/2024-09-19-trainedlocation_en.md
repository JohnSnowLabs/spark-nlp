...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("trainedlocation","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("trainedlocation", "en")
