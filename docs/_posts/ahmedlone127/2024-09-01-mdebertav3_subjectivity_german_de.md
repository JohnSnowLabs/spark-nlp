...
sequenceClassifier  = DeBertaForSequenceClassification.pretrained("mdebertav3_subjectivity_german","de") \
...
val sequenceClassifier = DeBertaForSequenceClassification.pretrained("mdebertav3_subjectivity_german", "de")
