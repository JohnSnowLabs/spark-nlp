...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("danish_roberta_babe_ft","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("danish_roberta_babe_ft", "en")
