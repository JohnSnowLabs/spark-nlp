...
sequenceClassifier  = BertForSequenceClassification.pretrained("tupi_bert_base_portuguese_cased","pt") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("tupi_bert_base_portuguese_cased", "pt")
...
{:.table-model}
|---|---|
|Model Name:|tupi_bert_base_portuguese_cased|
