...
sequenceClassifier  = BertForSequenceClassification.pretrained("chinese_roberta_climate_related_prediction_v1","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("chinese_roberta_climate_related_prediction_v1", "en")
...
{:.table-model}
|---|---|
|Model Name:|chinese_roberta_climate_related_prediction_v1|
...
https://huggingface.co/hw2942/chinese-roberta-climate-related-prediction-V1