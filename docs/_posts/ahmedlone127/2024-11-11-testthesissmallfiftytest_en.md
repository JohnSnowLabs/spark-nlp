...
tokenClassifier  = BertForTokenClassification.pretrained("testthesissmallfiftytest","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("testthesissmallfiftytest", "en")
