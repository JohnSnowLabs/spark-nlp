...
tokenClassifier  = BertForTokenClassification.pretrained("ner_rubert_finetuned","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("ner_rubert_finetuned", "en")
