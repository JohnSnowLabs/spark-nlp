...
sequenceClassifier  = BertForSequenceClassification.pretrained("russian_sentiment_classification_model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("russian_sentiment_classification_model", "en")
