...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("aigc_detector_env2","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("aigc_detector_env2", "en")
