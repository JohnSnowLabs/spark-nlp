...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/image_classifier_vit_rare_bottle_en_4.1.0_3.0_1660172098511.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
nlu.load("en.classify_image.rare_bottle").predict("hen.JPEG")
```
