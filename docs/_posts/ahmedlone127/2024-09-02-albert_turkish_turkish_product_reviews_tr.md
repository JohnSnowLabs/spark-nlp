...
sequenceClassifier  = AlbertForSequenceClassification.pretrained("albert_turkish_turkish_product_reviews","tr") \
...
val sequenceClassifier = AlbertForSequenceClassification.pretrained("albert_turkish_turkish_product_reviews", "tr")
...
{:.table-model}
|---|---|
|Model Name:|albert_turkish_turkish_product_reviews|
