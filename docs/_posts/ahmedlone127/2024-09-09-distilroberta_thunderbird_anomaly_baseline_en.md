...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("distilroberta_thunderbird_anomaly_baseline","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("distilroberta_thunderbird_anomaly_baseline", "en")
