...
sequenceClassifier  = CamemBertForSequenceClassification.pretrained("esg_prediction_icelandic","en") \
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("esg_prediction_icelandic", "en")
