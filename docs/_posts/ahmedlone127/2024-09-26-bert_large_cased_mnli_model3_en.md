...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_large_cased_mnli_model3","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_large_cased_mnli_model3", "en")
