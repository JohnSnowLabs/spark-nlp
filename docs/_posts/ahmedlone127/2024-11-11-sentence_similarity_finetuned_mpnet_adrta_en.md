...
sequenceClassifier  = MPNetForSequenceClassification.pretrained("sentence_similarity_finetuned_mpnet_adrta","en") \
...
val sequenceClassifier = MPNetForSequenceClassification.pretrained("sentence_similarity_finetuned_mpnet_adrta", "en")
