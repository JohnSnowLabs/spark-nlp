...
tokenClassifier  = BertForTokenClassification.pretrained("bert_base_spanish_wwm_cased_ehealth_kd","es") \
...
val tokenClassifier = BertForTokenClassification.pretrained("bert_base_spanish_wwm_cased_ehealth_kd", "es")
...
{:.table-model}
|---|---|
|Model Name:|bert_base_spanish_wwm_cased_ehealth_kd|
