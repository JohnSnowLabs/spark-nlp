...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_finetuned_vashesh","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_finetuned_vashesh", "en")
