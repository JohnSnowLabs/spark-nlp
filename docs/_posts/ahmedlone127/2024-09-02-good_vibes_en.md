...
sequenceClassifier  = AlbertForSequenceClassification.pretrained("good_vibes","en") \
...
val sequenceClassifier = AlbertForSequenceClassification.pretrained("good_vibes", "en")
