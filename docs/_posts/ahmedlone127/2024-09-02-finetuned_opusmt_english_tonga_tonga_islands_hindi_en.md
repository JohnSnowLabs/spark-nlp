...
marian = MarianTransformer.pretrained("finetuned_opusmt_english_tonga_tonga_islands_hindi","en") \
...
val embeddings = MarianTransformer.pretrained("finetuned_opusmt_english_tonga_tonga_islands_hindi","en") 
