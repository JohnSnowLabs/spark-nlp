...
sequenceClassifier  = BertForSequenceClassification.pretrained("test_trainer_imbalanced1_0","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("test_trainer_imbalanced1_0", "en")
