...
tokenClassifier  = CamemBertForTokenClassification.pretrained("optimizer_ner_finetune_lst2021","en") \
...
val tokenClassifier = CamemBertForTokenClassification.pretrained("optimizer_ner_finetune_lst2021", "en")
...
{:.table-model}
|---|---|
|Model Name:|optimizer_ner_finetune_lst2021|
