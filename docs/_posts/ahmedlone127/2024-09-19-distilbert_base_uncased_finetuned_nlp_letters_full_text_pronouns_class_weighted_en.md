...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_base_uncased_finetuned_nlp_letters_full_text_pronouns_class_weighted","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_base_uncased_finetuned_nlp_letters_full_text_pronouns_class_weighted", "en")
