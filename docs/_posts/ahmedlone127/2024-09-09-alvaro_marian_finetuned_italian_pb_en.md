...
marian = MarianTransformer.pretrained("alvaro_marian_finetuned_italian_pb","en") \
...
val embeddings = MarianTransformer.pretrained("alvaro_marian_finetuned_italian_pb","en") 
