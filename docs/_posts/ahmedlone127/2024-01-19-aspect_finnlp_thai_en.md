...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("aspect_finnlp_thai","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("aspect_finnlp_thai","en")
