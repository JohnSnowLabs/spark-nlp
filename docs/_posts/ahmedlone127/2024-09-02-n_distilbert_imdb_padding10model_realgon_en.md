...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("n_distilbert_imdb_padding10model_realgon","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("n_distilbert_imdb_padding10model_realgon", "en")
