...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("sentiment_others_v1","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("sentiment_others_v1","en")
