...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_sst2_padding10model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_sst2_padding10model", "en")
