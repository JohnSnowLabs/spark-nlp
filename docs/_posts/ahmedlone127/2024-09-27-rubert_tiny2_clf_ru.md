...
sequenceClassifier  = BertForSequenceClassification.pretrained("rubert_tiny2_clf","ru") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("rubert_tiny2_clf", "ru")
