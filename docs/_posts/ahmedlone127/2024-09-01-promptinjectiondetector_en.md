...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("promptinjectiondetector","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("promptinjectiondetector", "en")
