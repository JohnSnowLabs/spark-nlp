...
sequenceClassifier  = BertForSequenceClassification.pretrained("curated_gender_equality_weighted","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("curated_gender_equality_weighted", "en")
