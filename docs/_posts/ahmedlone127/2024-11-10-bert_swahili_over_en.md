...
spanClassifier = DistilBertForQuestionAnswering.pretrained("bert_swahili_over","en") \
...
val spanClassifier = DistilBertForQuestionAnswering.pretrained("bert_swahili_over", "en")
