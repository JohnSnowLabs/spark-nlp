...
embeddings = BertEmbeddings.pretrained("bert_base_cased_swe_historical","sv") \
...
val embeddings = BertEmbeddings.pretrained("bert_base_cased_swe_historical","sv") 
...
{:.table-model}
|---|---|
|Model Name:|bert_base_cased_swe_historical|
