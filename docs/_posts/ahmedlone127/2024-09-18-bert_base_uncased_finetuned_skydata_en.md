...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_uncased_finetuned_skydata","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_uncased_finetuned_skydata", "en")
...
{:.table-model}
|---|---|
|Model Name:|bert_base_uncased_finetuned_skydata|
