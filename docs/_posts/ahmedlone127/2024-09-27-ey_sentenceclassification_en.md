...
sequenceClassifier  = BertForSequenceClassification.pretrained("ey_sentenceclassification","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("ey_sentenceclassification", "en")
