...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("db_fe_1_1","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("db_fe_1_1", "en")
