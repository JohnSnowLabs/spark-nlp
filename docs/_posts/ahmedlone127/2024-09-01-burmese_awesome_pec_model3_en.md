...
tokenClassifier  = DistilBertForTokenClassification.pretrained("burmese_awesome_pec_model3","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("burmese_awesome_pec_model3", "en")
...
{:.table-model}
|---|---|
|Model Name:|burmese_awesome_pec_model3|
