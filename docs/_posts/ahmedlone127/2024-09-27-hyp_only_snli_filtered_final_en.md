...
sequenceClassifier  = BertForSequenceClassification.pretrained("hyp_only_snli_filtered_final","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("hyp_only_snli_filtered_final", "en")
