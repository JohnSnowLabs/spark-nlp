...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("tester2","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("tester2", "en")
