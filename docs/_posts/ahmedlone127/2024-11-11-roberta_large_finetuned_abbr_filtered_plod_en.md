...
tokenClassifier  = RoBertaForTokenClassification.pretrained("roberta_large_finetuned_abbr_filtered_plod","en") \
...
val tokenClassifier = RoBertaForTokenClassification.pretrained("roberta_large_finetuned_abbr_filtered_plod", "en")
