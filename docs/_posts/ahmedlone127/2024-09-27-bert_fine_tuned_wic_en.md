...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_fine_tuned_wic","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_fine_tuned_wic", "en")
