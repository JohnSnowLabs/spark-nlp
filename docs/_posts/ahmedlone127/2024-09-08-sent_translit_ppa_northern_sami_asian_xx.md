...
embeddings = XlmRoBertaSentenceEmbeddings.pretrained("sent_translit_ppa_northern_sami_asian","xx") \
...
val embeddings = XlmRoBertaSentenceEmbeddings.pretrained("sent_translit_ppa_northern_sami_asian","xx") 
