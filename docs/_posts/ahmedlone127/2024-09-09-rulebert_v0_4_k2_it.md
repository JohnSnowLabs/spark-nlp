...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("rulebert_v0_4_k2","it") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("rulebert_v0_4_k2", "it")
