...
sequenceClassifier  = BertForSequenceClassification.pretrained("halacha_siman_seif_classifier_nepal_bhasa","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("halacha_siman_seif_classifier_nepal_bhasa", "en")
