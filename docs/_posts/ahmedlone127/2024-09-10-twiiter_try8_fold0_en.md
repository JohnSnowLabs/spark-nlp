...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("twiiter_try8_fold0","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("twiiter_try8_fold0", "en")
