...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_reviews_chadia","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_reviews_chadia", "en")
