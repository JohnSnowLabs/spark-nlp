...
spanClassifier = RoBertaForQuestionAnswering.pretrained("robertita_cased_finetuned_squad","en") \
...
val spanClassifier = RoBertaForQuestionAnswering.pretrained("robertita_cased_finetuned_squad", "en")
...
{:.table-model}
|---|---|
|Model Name:|robertita_cased_finetuned_squad|
