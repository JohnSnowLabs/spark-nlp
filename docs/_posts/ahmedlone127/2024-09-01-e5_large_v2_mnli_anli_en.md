...
zeroShotClassifier  = BertForZeroShotClassification.pretrained("e5_large_v2_mnli_anli","en") \
...
val zeroShotClassifier  = BertForZeroShotClassification.pretrained("e5_large_v2_mnli_anli", "en")
