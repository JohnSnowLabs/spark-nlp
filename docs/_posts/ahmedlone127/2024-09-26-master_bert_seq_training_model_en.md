...
sequenceClassifier  = BertForSequenceClassification.pretrained("master_bert_seq_training_model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("master_bert_seq_training_model", "en")
