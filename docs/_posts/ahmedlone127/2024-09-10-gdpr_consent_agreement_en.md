...
sequenceClassifier  = BertForSequenceClassification.pretrained("gdpr_consent_agreement","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("gdpr_consent_agreement", "en")
