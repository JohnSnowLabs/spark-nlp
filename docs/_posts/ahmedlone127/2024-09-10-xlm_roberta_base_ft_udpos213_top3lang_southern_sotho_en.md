...
tokenClassifier  = XlmRoBertaForTokenClassification.pretrained("xlm_roberta_base_ft_udpos213_top3lang_southern_sotho","en") \
...
val tokenClassifier = XlmRoBertaForTokenClassification.pretrained("xlm_roberta_base_ft_udpos213_top3lang_southern_sotho", "en")
...
{:.table-model}
|---|---|
|Model Name:|xlm_roberta_base_ft_udpos213_top3lang_southern_sotho|
