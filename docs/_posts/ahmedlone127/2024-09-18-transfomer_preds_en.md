...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("transfomer_preds","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("transfomer_preds", "en")
