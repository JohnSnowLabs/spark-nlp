...
tokenClassifier  = DistilBertForTokenClassification.pretrained("nepal_bhasa_trained_croatian","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("nepal_bhasa_trained_croatian", "en")
