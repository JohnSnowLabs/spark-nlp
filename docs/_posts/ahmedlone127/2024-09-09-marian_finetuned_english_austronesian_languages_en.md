...
marian = MarianTransformer.pretrained("marian_finetuned_english_austronesian_languages","en") \
...
val embeddings = MarianTransformer.pretrained("marian_finetuned_english_austronesian_languages","en") 
