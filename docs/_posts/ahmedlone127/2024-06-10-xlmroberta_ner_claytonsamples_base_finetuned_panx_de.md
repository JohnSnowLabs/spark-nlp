...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_claytonsamples_base_finetuned_panx_de_5.4.0_3.0_1718024553774.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_claytonsamples_base_finetuned_panx_de_5.4.0_3.0_1718024553774.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("de.ner.xlmr_roberta.xtreme.base_finetuned.by_claytonsamples").predict("""PUT YOUR STRING HERE""")
```
</div>
