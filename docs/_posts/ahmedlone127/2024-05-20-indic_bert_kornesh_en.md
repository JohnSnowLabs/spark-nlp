...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/indic_bert_kornesh_en_5.2.4_3.0_1716205607704.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/indic_bert_kornesh_en_5.2.4_3.0_1716205607704.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
embeddings =BertEmbeddings.pretrained("indic_bert_kornesh","en")             .setInputCols(["documents","token"])             .setOutputCol("embeddings")
