...
tokenClassifier  = BertForTokenClassification.pretrained("bert_finetuned_arc_ner","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("bert_finetuned_arc_ner", "en")
