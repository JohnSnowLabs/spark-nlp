...
embeddings = BertSentenceEmbeddings.pretrained("sent_bert_base_uncased_google_bert","en") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_bert_base_uncased_google_bert","en") 
