...
sequenceClassifier  = CamemBertForSequenceClassification.pretrained("sentiment_finnlp_thai_nlp_chula","en") \
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("sentiment_finnlp_thai_nlp_chula", "en")
