...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("test1_yuenorawang","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("test1_yuenorawang", "en")
