...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("inflabert","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("inflabert", "en")
