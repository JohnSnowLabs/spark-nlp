...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("flattery_prediction_text","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("flattery_prediction_text", "en")
