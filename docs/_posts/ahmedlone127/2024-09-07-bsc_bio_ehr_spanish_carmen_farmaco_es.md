...
tokenClassifier  = RoBertaForTokenClassification.pretrained("bsc_bio_ehr_spanish_carmen_farmaco","es") \
...
val tokenClassifier = RoBertaForTokenClassification.pretrained("bsc_bio_ehr_spanish_carmen_farmaco", "es")
