...
sequenceClassifier  = BertForSequenceClassification.pretrained("factuality_model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("factuality_model", "en")
