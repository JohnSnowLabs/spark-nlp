...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_based_uncased_sst2_e3","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_based_uncased_sst2_e3", "en")
