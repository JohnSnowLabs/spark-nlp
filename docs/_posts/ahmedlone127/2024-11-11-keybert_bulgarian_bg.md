...
tokenClassifier  = BertForTokenClassification.pretrained("keybert_bulgarian","bg") \
...
val tokenClassifier = BertForTokenClassification.pretrained("keybert_bulgarian", "bg")
