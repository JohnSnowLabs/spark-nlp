...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("twitter_roberta_large_topic_sentiment_latest","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("twitter_roberta_large_topic_sentiment_latest", "en")
