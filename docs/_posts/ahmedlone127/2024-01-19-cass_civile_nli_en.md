...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("cass_civile_nli","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("cass_civile_nli","en")
