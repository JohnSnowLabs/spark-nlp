...
sequenceClassifier  = DeBertaForSequenceClassification.pretrained("deberta_v3_base_cotat","en") \
...
val sequenceClassifier = DeBertaForSequenceClassification.pretrained("deberta_v3_base_cotat", "en")
