...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("fake_news_classifier_draip","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("fake_news_classifier_draip", "en")
