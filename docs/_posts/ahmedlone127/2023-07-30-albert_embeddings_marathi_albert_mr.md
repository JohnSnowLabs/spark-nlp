---
layout: model
title: Marathi ALBERT Embeddings (v1)
author: John Snow Labs
name: albert_embeddings_marathi_albert
date: 2023-07-30
tags: [albert, embeddings, mr, open_source, onnx]
task: Embeddings
language: mr
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/albert_embeddings_marathi_albert_mr_5.0.0_3.0_1690752853424.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/albert_embeddings_marathi_albert_mr_5.0.0_3.0_1690752853424.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
