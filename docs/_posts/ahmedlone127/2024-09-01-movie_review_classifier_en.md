...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("movie_review_classifier","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("movie_review_classifier", "en")
