...
embeddings = CamemBertEmbeddings.pretrained("dummy_model_dylwil3","en") \
...
val embeddings = CamemBertEmbeddings.pretrained("dummy_model_dylwil3","en") 
...
{:.table-model}
|---|---|
|Model Name:|dummy_model_dylwil3|
