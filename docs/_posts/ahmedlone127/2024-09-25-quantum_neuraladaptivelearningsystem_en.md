...
sequenceClassifier  = BertForSequenceClassification.pretrained("quantum_neuraladaptivelearningsystem","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("quantum_neuraladaptivelearningsystem", "en")
