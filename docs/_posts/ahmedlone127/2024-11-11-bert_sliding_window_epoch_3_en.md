...
spanClassifier = BertForQuestionAnswering.pretrained("bert_sliding_window_epoch_3","en") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("bert_sliding_window_epoch_3", "en")
