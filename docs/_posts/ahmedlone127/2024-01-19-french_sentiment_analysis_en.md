...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("french_sentiment_analysis","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("french_sentiment_analysis","en")
...
{:.table-model}
|---|---|
|Model Name:|french_sentiment_analysis|
...
https://huggingface.co/Peed911/french_sentiment_analysis