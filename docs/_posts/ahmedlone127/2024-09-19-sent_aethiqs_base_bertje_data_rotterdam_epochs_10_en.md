...
embeddings = BertSentenceEmbeddings.pretrained("sent_aethiqs_base_bertje_data_rotterdam_epochs_10","en") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_aethiqs_base_bertje_data_rotterdam_epochs_10","en") 
