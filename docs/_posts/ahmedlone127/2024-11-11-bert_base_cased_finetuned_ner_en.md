...
tokenClassifier  = BertForTokenClassification.pretrained("bert_base_cased_finetuned_ner","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("bert_base_cased_finetuned_ner", "en")
