...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_temp_classifier","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_temp_classifier", "en")
