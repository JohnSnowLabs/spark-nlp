...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("adaptationbert","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("adaptationbert", "en")
