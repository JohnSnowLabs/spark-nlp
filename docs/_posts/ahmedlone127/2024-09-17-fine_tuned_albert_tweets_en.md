...
sequenceClassifier  = AlbertForSequenceClassification.pretrained("fine_tuned_albert_tweets","en") \
...
val sequenceClassifier = AlbertForSequenceClassification.pretrained("fine_tuned_albert_tweets", "en")
...
{:.table-model}
|---|---|
|Model Name:|fine_tuned_albert_tweets|
