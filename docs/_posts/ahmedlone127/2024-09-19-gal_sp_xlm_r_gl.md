...
tokenClassifier  = XlmRoBertaForTokenClassification.pretrained("gal_sp_xlm_r","gl") \
...
val tokenClassifier = XlmRoBertaForTokenClassification.pretrained("gal_sp_xlm_r", "gl")
