...
tokenClassifier  = XlmRoBertaForTokenClassification.pretrained("xlm_roberta_base_finetuned_panx_italian_u00890358","en") \
...
val tokenClassifier = XlmRoBertaForTokenClassification.pretrained("xlm_roberta_base_finetuned_panx_italian_u00890358", "en")
...
{:.table-model}
|---|---|
|Model Name:|xlm_roberta_base_finetuned_panx_italian_u00890358|
