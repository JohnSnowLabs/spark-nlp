...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_chinese_climate_related_prediction_v3","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_chinese_climate_related_prediction_v3", "en")
