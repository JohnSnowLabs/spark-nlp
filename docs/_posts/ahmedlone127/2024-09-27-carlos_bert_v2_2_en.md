...
sequenceClassifier  = BertForSequenceClassification.pretrained("carlos_bert_v2_2","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("carlos_bert_v2_2", "en")
