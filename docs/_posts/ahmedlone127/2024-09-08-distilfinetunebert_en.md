...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilfinetunebert","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilfinetunebert", "en")
