...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("prova_text_classification","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("prova_text_classification", "en")
