...
sequenceClassifier  = BertForSequenceClassification.pretrained("phishing_email_detection1","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("phishing_email_detection1", "en")
