...
zeroShotClassifier  = BertForZeroShotClassification.pretrained("bert_base_multilingual_cased_allnli_turkish","xx") \
...
val zeroShotClassifier  = BertForZeroShotClassification.pretrained("bert_base_multilingual_cased_allnli_turkish", "xx")
...
{:.table-model}
|---|---|
|Model Name:|bert_base_multilingual_cased_allnli_turkish|
