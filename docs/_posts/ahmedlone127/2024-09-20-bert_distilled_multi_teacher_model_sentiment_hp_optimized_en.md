...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("bert_distilled_multi_teacher_model_sentiment_hp_optimized","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("bert_distilled_multi_teacher_model_sentiment_hp_optimized", "en")
...
{:.table-model}
|---|---|
|Model Name:|bert_distilled_multi_teacher_model_sentiment_hp_optimized|
