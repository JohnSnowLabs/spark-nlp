...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("burmese_model1","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("burmese_model1", "en")
