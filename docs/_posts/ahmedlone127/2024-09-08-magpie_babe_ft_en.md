...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("magpie_babe_ft","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("magpie_babe_ft", "en")
