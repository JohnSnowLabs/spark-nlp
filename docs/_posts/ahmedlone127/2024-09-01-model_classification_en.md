...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("model_classification","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("model_classification", "en")
