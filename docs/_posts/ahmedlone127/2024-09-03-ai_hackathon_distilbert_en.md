...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("ai_hackathon_distilbert","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("ai_hackathon_distilbert", "en")
...
{:.table-model}
|---|---|
|Model Name:|ai_hackathon_distilbert|
