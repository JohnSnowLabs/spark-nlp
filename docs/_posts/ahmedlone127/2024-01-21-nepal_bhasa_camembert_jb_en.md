...
tokenClassifier = CamemBertForTokenClassification.pretrained("nepal_bhasa_camembert_jb","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("nepal_bhasa_camembert_jb", "en")
...
{:.table-model}
|---|---|
|Model Name:|nepal_bhasa_camembert_jb|
...
https://huggingface.co/bjubert/new_camembert_jb