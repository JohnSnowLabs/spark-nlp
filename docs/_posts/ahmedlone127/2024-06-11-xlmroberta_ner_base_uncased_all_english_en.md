...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_base_uncased_all_english_en_5.4.0_3.0_1718093500047.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_base_uncased_all_english_en_5.4.0_3.0_1718093500047.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.ner.xlmr_roberta.all_english.uncased_base.by_tner").predict("""PUT YOUR STRING HERE""")
```
</div>
