...
sequenceClassifier  = BertForSequenceClassification.pretrained("sentiment_analysis_task_1","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("sentiment_analysis_task_1", "en")
