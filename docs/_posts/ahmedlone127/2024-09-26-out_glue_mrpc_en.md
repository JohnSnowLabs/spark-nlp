...
sequenceClassifier  = BertForSequenceClassification.pretrained("out_glue_mrpc","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("out_glue_mrpc", "en")
