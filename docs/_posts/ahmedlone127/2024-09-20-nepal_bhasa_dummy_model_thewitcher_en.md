...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("nepal_bhasa_dummy_model_thewitcher","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("nepal_bhasa_dummy_model_thewitcher", "en")
...
{:.table-model}
|---|---|
|Model Name:|nepal_bhasa_dummy_model_thewitcher|
