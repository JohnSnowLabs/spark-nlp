...
embeddings = RoBertaEmbeddings.pretrained("roberta_small_greek","el") \
...
val embeddings = RoBertaEmbeddings.pretrained("roberta_small_greek","el") 
...
{:.table-model}
|---|---|
|Model Name:|roberta_small_greek|
