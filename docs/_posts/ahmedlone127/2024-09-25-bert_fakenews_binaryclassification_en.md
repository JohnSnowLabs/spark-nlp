...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_fakenews_binaryclassification","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_fakenews_binaryclassification", "en")
