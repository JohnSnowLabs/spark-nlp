...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("deepchemoberta_reg","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("deepchemoberta_reg", "en")
