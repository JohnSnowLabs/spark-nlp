...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("twitterfin_padding80model","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("twitterfin_padding80model", "en")
