...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("french_verb_disambiguation_lvf","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("french_verb_disambiguation_lvf","en")
