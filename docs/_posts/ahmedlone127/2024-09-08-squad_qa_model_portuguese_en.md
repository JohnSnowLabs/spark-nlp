...
spanClassifier = DistilBertForQuestionAnswering.pretrained("squad_qa_model_portuguese","en") \
...
val spanClassifier = DistilBertForQuestionAnswering.pretrained("squad_qa_model_portuguese", "en")
