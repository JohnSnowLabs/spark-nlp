...
embeddings = BertSentenceEmbeddings.pretrained("sent_conflibert_scr_cased","en") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_conflibert_scr_cased","en") 
