...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("automated_labeling_distilbert","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("automated_labeling_distilbert", "en")
