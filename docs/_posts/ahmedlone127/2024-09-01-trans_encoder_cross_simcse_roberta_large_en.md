...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("trans_encoder_cross_simcse_roberta_large","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("trans_encoder_cross_simcse_roberta_large", "en")
