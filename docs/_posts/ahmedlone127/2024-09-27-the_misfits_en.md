...
sequenceClassifier  = BertForSequenceClassification.pretrained("the_misfits","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("the_misfits", "en")
