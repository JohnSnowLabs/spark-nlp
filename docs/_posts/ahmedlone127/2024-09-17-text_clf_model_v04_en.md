...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("text_clf_model_v04","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("text_clf_model_v04", "en")
