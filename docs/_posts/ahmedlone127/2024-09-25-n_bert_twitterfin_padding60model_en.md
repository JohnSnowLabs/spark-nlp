...
sequenceClassifier  = BertForSequenceClassification.pretrained("n_bert_twitterfin_padding60model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("n_bert_twitterfin_padding60model", "en")
