...
spanClassifier = AlbertForQuestionAnswering.pretrained("indic_malbert_squad_v2","en") \
...
val spanClassifier = AlbertForQuestionAnswering.pretrained("indic_malbert_squad_v2", "en")
