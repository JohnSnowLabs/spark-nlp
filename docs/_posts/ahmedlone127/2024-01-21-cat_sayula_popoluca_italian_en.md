...
tokenClassifier = CamemBertForTokenClassification.pretrained("cat_sayula_popoluca_italian","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("cat_sayula_popoluca_italian", "en")
...
{:.table-model}
|---|---|
|Model Name:|cat_sayula_popoluca_italian|
...
https://huggingface.co/homersimpson/cat-pos-it