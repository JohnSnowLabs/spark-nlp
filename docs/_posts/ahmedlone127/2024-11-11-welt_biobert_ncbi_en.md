...
tokenClassifier  = BertForTokenClassification.pretrained("welt_biobert_ncbi","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("welt_biobert_ncbi", "en")
