...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_base_uncased_finetuned_events_v6","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_base_uncased_finetuned_events_v6", "en")
...
{:.table-model}
|---|---|
|Model Name:|distilbert_base_uncased_finetuned_events_v6|
