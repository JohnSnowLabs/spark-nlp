...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("acrossapps_ndd_phoenix_test_content","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("acrossapps_ndd_phoenix_test_content", "en")
