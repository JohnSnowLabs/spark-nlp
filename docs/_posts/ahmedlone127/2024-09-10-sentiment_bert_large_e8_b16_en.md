...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("sentiment_bert_large_e8_b16","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("sentiment_bert_large_e8_b16", "en")
