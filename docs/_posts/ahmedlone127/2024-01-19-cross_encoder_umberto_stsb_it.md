...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("cross_encoder_umberto_stsb","it")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("cross_encoder_umberto_stsb","it")
...
{:.table-model}
|---|---|
|Model Name:|cross_encoder_umberto_stsb|
...
https://huggingface.co/efederici/cross-encoder-umberto-stsb