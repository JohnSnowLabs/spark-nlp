...
marian = MarianTransformer.pretrained("translation_model_english_korean","en") \
...
val embeddings = MarianTransformer.pretrained("translation_model_english_korean","en") 
