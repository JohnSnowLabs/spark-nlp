...
spanClassifier = DeBertaForQuestionAnswering.pretrained("ct_cos_mdeberta_idkmrc_1","en") \
...
val spanClassifier = DeBertaForQuestionAnswering.pretrained("ct_cos_mdeberta_idkmrc_1", "en")
