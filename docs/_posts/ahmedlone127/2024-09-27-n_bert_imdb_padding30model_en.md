...
sequenceClassifier  = BertForSequenceClassification.pretrained("n_bert_imdb_padding30model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("n_bert_imdb_padding30model", "en")
