...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_classifier_twitch_base_sentiment_latest_en_5.2.4_3.0_1716799545231.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_classifier_twitch_base_sentiment_latest_en_5.2.4_3.0_1716799545231.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.classify.roberta.sentiment.base.by_veb").predict("""PUT YOUR STRING HERE""")
```
</div>
