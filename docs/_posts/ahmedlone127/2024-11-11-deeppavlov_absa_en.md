...
tokenClassifier  = XlmRoBertaForTokenClassification.pretrained("deeppavlov_absa","en") \
...
val tokenClassifier = XlmRoBertaForTokenClassification.pretrained("deeppavlov_absa", "en")
