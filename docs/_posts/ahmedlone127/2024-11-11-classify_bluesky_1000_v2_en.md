...
sequenceClassifier  = AlbertForSequenceClassification.pretrained("classify_bluesky_1000_v2","en") \
...
val sequenceClassifier = AlbertForSequenceClassification.pretrained("classify_bluesky_1000_v2", "en")
