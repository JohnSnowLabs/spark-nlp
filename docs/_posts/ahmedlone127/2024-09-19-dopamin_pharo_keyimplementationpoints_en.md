...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("dopamin_pharo_keyimplementationpoints","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("dopamin_pharo_keyimplementationpoints", "en")
