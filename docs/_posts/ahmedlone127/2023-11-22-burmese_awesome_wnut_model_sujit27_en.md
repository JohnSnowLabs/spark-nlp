...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/burmese_awesome_wnut_model_sujit27_en_5.2.0_3.0_1700687181562.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/burmese_awesome_wnut_model_sujit27_en_5.2.0_3.0_1700687181562.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
tokenClassifier = DistilBertForTokenClassification.pretrained("burmese_awesome_wnut_model_sujit27","en") \
...
val tokenClassifier = DistilBertForTokenClassification  
    .pretrained("burmese_awesome_wnut_model_sujit27", "en")
