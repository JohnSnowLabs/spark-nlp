...
sequenceClassifier  = BertForSequenceClassification.pretrained("sentense_pairs_cls","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("sentense_pairs_cls", "en")
