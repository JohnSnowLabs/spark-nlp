...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("text_sentiment_analyse","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("text_sentiment_analyse", "en")
