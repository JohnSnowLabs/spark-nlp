...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("emoji_emoji_random3_seed2_roberta_base","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("emoji_emoji_random3_seed2_roberta_base", "en")
...
{:.table-model}
|---|---|
|Model Name:|emoji_emoji_random3_seed2_roberta_base|
