...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("burmese_awesome_model_cdong","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("burmese_awesome_model_cdong","en")
