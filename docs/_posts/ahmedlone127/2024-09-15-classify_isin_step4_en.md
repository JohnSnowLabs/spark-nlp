...
sequenceClassifier  = AlbertForSequenceClassification.pretrained("classify_isin_step4","en") \
...
val sequenceClassifier = AlbertForSequenceClassification.pretrained("classify_isin_step4", "en")
