...
sequenceClassifier  = BertForSequenceClassification.pretrained("model_nimmyhbas","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("model_nimmyhbas", "en")
