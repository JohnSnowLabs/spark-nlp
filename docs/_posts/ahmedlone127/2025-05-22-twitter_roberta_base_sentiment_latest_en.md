---
layout: model
title: English twitter_roberta_base_sentiment_latest RoBertaForSequenceClassification from cardiffnlp
...
Pretrained RoBertaForSequenceClassification model, adapted from Hugging Face and curated to provide scalability and production-readiness using Spark NLP.`twitter_roberta_base_sentiment_latest` is a English model originally trained by cardiffnlp.
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("twitter_roberta_base_sentiment_latest", "en")
...
{:.table-model}
|---|---|
|Model Name:|twitter_roberta_base_sentiment_latest|
