...
sequenceClassifier  = BertForSequenceClassification.pretrained("distillbert_distilled_ag_news_2","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("distillbert_distilled_ag_news_2", "en")
