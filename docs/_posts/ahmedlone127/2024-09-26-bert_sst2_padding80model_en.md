...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_sst2_padding80model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_sst2_padding80model", "en")
