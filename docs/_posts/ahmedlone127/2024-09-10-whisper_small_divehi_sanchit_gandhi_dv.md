...
speechToText  = WhisperForCTC.pretrained("whisper_small_divehi_sanchit_gandhi","dv") \
...
val speechToText = WhisperForCTC.pretrained("whisper_small_divehi_sanchit_gandhi", "dv")
...
{:.table-model}
|---|---|
|Model Name:|whisper_small_divehi_sanchit_gandhi|
