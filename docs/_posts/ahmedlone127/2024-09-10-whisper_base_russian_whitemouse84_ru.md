...
speechToText  = WhisperForCTC.pretrained("whisper_base_russian_whitemouse84","ru") \
...
val speechToText = WhisperForCTC.pretrained("whisper_base_russian_whitemouse84", "ru")
...
{:.table-model}
|---|---|
|Model Name:|whisper_base_russian_whitemouse84|
