...
sequenceClassifier  = DeBertaForSequenceClassification.pretrained("deberta_v3_small_fever_classification","en") \
...
val sequenceClassifier = DeBertaForSequenceClassification.pretrained("deberta_v3_small_fever_classification", "en")
