...
spanClassifier = DeBertaForQuestionAnswering.pretrained("ct_cos_mdeberta_idkmrc_1_2","en") \
...
val spanClassifier = DeBertaForQuestionAnswering.pretrained("ct_cos_mdeberta_idkmrc_1_2", "en")
