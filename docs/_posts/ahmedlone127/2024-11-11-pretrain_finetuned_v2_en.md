...
spanClassifier = BertForQuestionAnswering.pretrained("pretrain_finetuned_v2","en") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("pretrain_finetuned_v2", "en")
