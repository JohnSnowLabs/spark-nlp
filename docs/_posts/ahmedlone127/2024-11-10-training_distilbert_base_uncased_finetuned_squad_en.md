...
spanClassifier = DistilBertForQuestionAnswering.pretrained("training_distilbert_base_uncased_finetuned_squad","en") \
...
val spanClassifier = DistilBertForQuestionAnswering.pretrained("training_distilbert_base_uncased_finetuned_squad", "en")
