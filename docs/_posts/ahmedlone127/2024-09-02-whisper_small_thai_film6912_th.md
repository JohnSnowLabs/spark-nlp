...
speechToText  = WhisperForCTC.pretrained("whisper_small_thai_film6912","th") \
...
val speechToText = WhisperForCTC.pretrained("whisper_small_thai_film6912", "th")
...
{:.table-model}
|---|---|
|Model Name:|whisper_small_thai_film6912|
