...
sequenceClassifier  = BertForSequenceClassification.pretrained("biolinkbert_base_michiyasunaga","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("biolinkbert_base_michiyasunaga", "en")
