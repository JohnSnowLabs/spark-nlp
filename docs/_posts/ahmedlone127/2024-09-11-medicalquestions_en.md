...
sequenceClassifier  = BertForSequenceClassification.pretrained("medicalquestions","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("medicalquestions", "en")
