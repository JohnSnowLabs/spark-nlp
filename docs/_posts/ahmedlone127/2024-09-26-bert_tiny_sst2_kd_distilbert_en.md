...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_tiny_sst2_kd_distilbert","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_tiny_sst2_kd_distilbert", "en")
