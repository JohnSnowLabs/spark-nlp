...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("roberta_classweight_sentiment_classifier","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("roberta_classweight_sentiment_classifier", "en")
