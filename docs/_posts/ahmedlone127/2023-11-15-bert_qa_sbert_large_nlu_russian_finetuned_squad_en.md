...
spanClassifier = BertForQuestionAnswering.pretrained("bert_qa_sbert_large_nlu_russian_finetuned_squad","en") \
...
val spanClassifier = BertForQuestionAnswering  
    .pretrained("bert_qa_sbert_large_nlu_russian_finetuned_squad", "en")
