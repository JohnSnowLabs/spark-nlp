...
spanClassifier = CamemBertForQuestionAnswering.pretrained("wangchanberta_thai_qa","th") \
...
val spanClassifier = CamemBertForQuestionAnswering.pretrained("wangchanberta_thai_qa", "th")
...
{:.table-model}
|---|---|
|Model Name:|wangchanberta_thai_qa|
