...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_finetuned_resumes_sections","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_finetuned_resumes_sections", "en")
