...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("column_model","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("column_model", "en")
