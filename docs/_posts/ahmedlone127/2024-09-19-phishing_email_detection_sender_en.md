...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("phishing_email_detection_sender","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("phishing_email_detection_sender", "en")
