...
sequenceClassifier  = BertForSequenceClassification.pretrained("lm6_movie_aspect_extraction_bert","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("lm6_movie_aspect_extraction_bert", "en")
...
{:.table-model}
|---|---|
|Model Name:|lm6_movie_aspect_extraction_bert|
