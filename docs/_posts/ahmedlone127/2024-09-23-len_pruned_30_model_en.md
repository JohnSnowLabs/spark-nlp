...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("len_pruned_30_model","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("len_pruned_30_model", "en")
