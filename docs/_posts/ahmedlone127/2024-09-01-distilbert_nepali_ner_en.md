...
tokenClassifier  = DistilBertForTokenClassification.pretrained("distilbert_nepali_ner","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("distilbert_nepali_ner", "en")
