...
tokenClassifier  = BertForTokenClassification.pretrained("ijelid_indobertweet","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("ijelid_indobertweet", "en")
