...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("bert_vllm_gemma2b_stringmatcher_newdataset_3","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("bert_vllm_gemma2b_stringmatcher_newdataset_3", "en")
...
{:.table-model}
|---|---|
|Model Name:|bert_vllm_gemma2b_stringmatcher_newdataset_3|
