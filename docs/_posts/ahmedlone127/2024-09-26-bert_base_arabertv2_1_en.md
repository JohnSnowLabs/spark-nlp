...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_arabertv2_1","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_arabertv2_1", "en")
