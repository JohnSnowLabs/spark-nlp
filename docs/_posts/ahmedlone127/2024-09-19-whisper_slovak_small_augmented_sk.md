...
speechToText  = WhisperForCTC.pretrained("whisper_slovak_small_augmented","sk") \
...
val speechToText = WhisperForCTC.pretrained("whisper_slovak_small_augmented", "sk")
...
{:.table-model}
|---|---|
|Model Name:|whisper_slovak_small_augmented|
