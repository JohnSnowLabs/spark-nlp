...
tokenClassifier  = DistilBertForTokenClassification.pretrained("burmese_awesome_wnut_model_arunaramm7","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("burmese_awesome_wnut_model_arunaramm7", "en")
