...
tokenClassifier  = RoBertaForTokenClassification.pretrained("climateattention_ctw","en") \
...
val tokenClassifier = RoBertaForTokenClassification.pretrained("climateattention_ctw", "en")
