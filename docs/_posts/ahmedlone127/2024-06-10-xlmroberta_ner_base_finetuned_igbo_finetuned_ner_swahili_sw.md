...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_base_finetuned_igbo_finetuned_ner_swahili_sw_5.4.0_3.0_1718010054845.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_base_finetuned_igbo_finetuned_ner_swahili_sw_5.4.0_3.0_1718010054845.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("sw.ner.xlmr_roberta.base_finetuned_igbo.by_mbeukman").predict("""PUT YOUR STRING HERE""")
```
</div>
