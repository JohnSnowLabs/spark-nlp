...
embeddings = MPNetEmbeddings.pretrained("refpydst_1p_referredstates_split_v1","en") \
...
val embeddings = MPNetEmbeddings.pretrained("refpydst_1p_referredstates_split_v1","en") 
