...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distil_bert_fintuned_product_cfpb_complaints","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distil_bert_fintuned_product_cfpb_complaints", "en")
