...
sequenceClassifier  = BertForSequenceClassification.pretrained("detoxify_toxic_english","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("detoxify_toxic_english", "en")
