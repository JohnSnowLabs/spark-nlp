...
embeddings = BertSentenceEmbeddings.pretrained("sent_indobert_base_uncased","id") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_indobert_base_uncased","id") 
