...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("topic_othertopics_v2","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("topic_othertopics_v2","en")
