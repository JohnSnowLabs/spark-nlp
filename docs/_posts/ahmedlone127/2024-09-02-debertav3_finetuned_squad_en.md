...
spanClassifier = DeBertaForQuestionAnswering.pretrained("debertav3_finetuned_squad","en") \
...
val spanClassifier = DeBertaForQuestionAnswering.pretrained("debertav3_finetuned_squad", "en")
