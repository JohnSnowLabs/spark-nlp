...
sequenceClassifier  = BertForSequenceClassification.pretrained("toxic_hubert","hu") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("toxic_hubert", "hu")
