...
embeddings = RoBertaEmbeddings.pretrained("2020_q1_90p_filtered_random","en") \
...
val embeddings = RoBertaEmbeddings.pretrained("2020_q1_90p_filtered_random","en") 
...
{:.table-model}
|---|---|
|Model Name:|2020_q1_90p_filtered_random|
