...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_qa_large_uncased_finetuned_vietnamese_infovqa_en_5.2.0_3.0_1699676230936.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_qa_large_uncased_finetuned_vietnamese_infovqa_en_5.2.0_3.0_1699676230936.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
spanClassifier = BertForQuestionAnswering.pretrained("bert_qa_large_uncased_finetuned_vietnamese_infovqa","en") \
...
val spanClassifier = BertForQuestionAnswering  
    .pretrained("bert_qa_large_uncased_finetuned_vietnamese_infovqa", "en")
