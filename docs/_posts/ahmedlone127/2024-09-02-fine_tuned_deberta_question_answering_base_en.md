...
spanClassifier = DeBertaForQuestionAnswering.pretrained("fine_tuned_deberta_question_answering_base","en") \
...
val spanClassifier = DeBertaForQuestionAnswering.pretrained("fine_tuned_deberta_question_answering_base", "en")
