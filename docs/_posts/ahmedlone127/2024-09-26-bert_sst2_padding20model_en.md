...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_sst2_padding20model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_sst2_padding20model", "en")
