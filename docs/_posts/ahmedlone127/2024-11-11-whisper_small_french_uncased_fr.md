...
speechToText  = WhisperForCTC.pretrained("whisper_small_french_uncased","fr") \
...
val speechToText = WhisperForCTC.pretrained("whisper_small_french_uncased", "fr")
...
{:.table-model}
|---|---|
|Model Name:|whisper_small_french_uncased|
