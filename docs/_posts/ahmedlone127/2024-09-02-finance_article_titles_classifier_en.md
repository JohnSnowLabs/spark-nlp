...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("finance_article_titles_classifier","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("finance_article_titles_classifier", "en")
