...
marian = MarianTransformer.pretrained("marianmtfinetuningarabic2english","en") \
...
val embeddings = MarianTransformer.pretrained("marianmtfinetuningarabic2english","en") 
