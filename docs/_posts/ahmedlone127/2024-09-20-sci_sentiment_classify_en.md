...
sequenceClassifier  = BertForSequenceClassification.pretrained("sci_sentiment_classify","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("sci_sentiment_classify", "en")
