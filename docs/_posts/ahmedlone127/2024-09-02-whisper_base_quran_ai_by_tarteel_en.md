...
speechToText  = WhisperForCTC.pretrained("whisper_base_quran_ai_by_tarteel","en") \
...
val speechToText = WhisperForCTC.pretrained("whisper_base_quran_ai_by_tarteel", "en")
...
{:.table-model}
|---|---|
|Model Name:|whisper_base_quran_ai_by_tarteel|
