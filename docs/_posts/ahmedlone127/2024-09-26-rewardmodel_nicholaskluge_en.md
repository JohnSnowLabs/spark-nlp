...
sequenceClassifier  = BertForSequenceClassification.pretrained("rewardmodel_nicholaskluge","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("rewardmodel_nicholaskluge", "en")
