...
sequenceClassifier  = DeBertaForSequenceClassification.pretrained("deberta_v3_rel_class","en") \
...
val sequenceClassifier = DeBertaForSequenceClassification.pretrained("deberta_v3_rel_class", "en")
