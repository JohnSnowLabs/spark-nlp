...
sequenceClassifier  = BertForSequenceClassification.pretrained("finetuning_sentiment_analysis_bert","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("finetuning_sentiment_analysis_bert", "en")
