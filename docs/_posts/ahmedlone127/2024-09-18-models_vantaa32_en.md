...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("models_vantaa32","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("models_vantaa32", "en")
