...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/output_mask_two_steps_pretraining_plus_contr_roberta_model_from_pretrained_large_epochs_1_en_5.2.4_3.0_1716739751325.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/output_mask_two_steps_pretraining_plus_contr_roberta_model_from_pretrained_large_epochs_1_en_5.2.4_3.0_1716739751325.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
spanClassifier = RoBertaForQuestionAnswering.pretrained("output_mask_two_steps_pretraining_plus_contr_roberta_model_from_pretrained_large_epochs_1","en") \
...
val spanClassifier = RoBertaForQuestionAnswering.pretrained("output_mask_two_steps_pretraining_plus_contr_roberta_model_from_pretrained_large_epochs_1", "en")
