...
sequenceClassifier  = BertForSequenceClassification.pretrained("ssclass_best","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("ssclass_best", "en")
