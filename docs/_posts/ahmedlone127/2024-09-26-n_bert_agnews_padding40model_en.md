...
sequenceClassifier  = BertForSequenceClassification.pretrained("n_bert_agnews_padding40model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("n_bert_agnews_padding40model", "en")
