...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/image_classifier_vit_rare_puppers2_en_4.1.0_3.0_1660171547389.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
nlu.load("en.classify_image.rare_puppers2").predict("hen.JPEG")
```
