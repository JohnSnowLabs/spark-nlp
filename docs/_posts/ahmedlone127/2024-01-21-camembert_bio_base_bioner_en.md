...
tokenClassifier = CamemBertForTokenClassification.pretrained("camembert_bio_base_bioner","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("camembert_bio_base_bioner", "en")
...
{:.table-model}
|---|---|
|Model Name:|camembert_bio_base_bioner|
...
https://huggingface.co/rntc/camembert-bio-base-bioner