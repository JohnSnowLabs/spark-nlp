...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/relbert_albert_base_nce_semeval2012_en_5.2.4_3.0_1716205789612.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/relbert_albert_base_nce_semeval2012_en_5.2.4_3.0_1716205789612.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
embeddings =BertEmbeddings.pretrained("relbert_albert_base_nce_semeval2012","en")             .setInputCols(["documents","token"])             .setOutputCol("embeddings")
