...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("macdonaldsentiment_model","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("macdonaldsentiment_model", "en")
