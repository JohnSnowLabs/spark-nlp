...
sequenceClassifier  = CamemBertForSequenceClassification.pretrained("sitexsometre_camembert_base_ccnet_stsb100","en") \
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("sitexsometre_camembert_base_ccnet_stsb100", "en")
