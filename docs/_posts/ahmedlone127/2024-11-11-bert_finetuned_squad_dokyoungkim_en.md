...
spanClassifier = BertForQuestionAnswering.pretrained("bert_finetuned_squad_dokyoungkim","en") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("bert_finetuned_squad_dokyoungkim", "en")
