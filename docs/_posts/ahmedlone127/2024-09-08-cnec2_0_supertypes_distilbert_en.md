...
tokenClassifier  = DistilBertForTokenClassification.pretrained("cnec2_0_supertypes_distilbert","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("cnec2_0_supertypes_distilbert", "en")
...
{:.table-model}
|---|---|
|Model Name:|cnec2_0_supertypes_distilbert|
