...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_combined_large","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_combined_large", "en")
