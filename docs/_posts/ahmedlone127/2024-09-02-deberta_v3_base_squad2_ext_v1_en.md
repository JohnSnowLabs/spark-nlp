...
spanClassifier = DeBertaForQuestionAnswering.pretrained("deberta_v3_base_squad2_ext_v1","en") \
...
val spanClassifier = DeBertaForQuestionAnswering.pretrained("deberta_v3_base_squad2_ext_v1", "en")
...
{:.table-model}
|---|---|
|Model Name:|deberta_v3_base_squad2_ext_v1|
