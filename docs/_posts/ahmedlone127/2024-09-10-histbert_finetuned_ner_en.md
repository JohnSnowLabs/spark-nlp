...
tokenClassifier  = BertForTokenClassification.pretrained("histbert_finetuned_ner","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("histbert_finetuned_ner", "en")
