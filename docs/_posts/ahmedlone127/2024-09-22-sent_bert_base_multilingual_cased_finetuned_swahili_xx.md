...
embeddings = BertSentenceEmbeddings.pretrained("sent_bert_base_multilingual_cased_finetuned_swahili","xx") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_bert_base_multilingual_cased_finetuned_swahili","xx") 
