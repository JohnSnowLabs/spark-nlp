...
marian = MarianTransformer.pretrained("english_tonga_tonga_islands_dutch_marianmt","en") \
...
val embeddings = MarianTransformer.pretrained("english_tonga_tonga_islands_dutch_marianmt","en") 
