...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_financial_sentiment_analysis","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_financial_sentiment_analysis", "en")
