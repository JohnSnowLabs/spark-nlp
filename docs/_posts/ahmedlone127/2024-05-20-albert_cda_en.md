...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/albert_cda_en_5.2.4_3.0_1716202366767.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/albert_cda_en_5.2.4_3.0_1716202366767.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
embeddings = AlbertEmbeddings.pretrained("albert_cda","en")         .setInputCols(["document", "token"])         .setOutputCol("embeddings")
