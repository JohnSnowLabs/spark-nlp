...
sequenceClassifier  = BertForSequenceClassification.pretrained("tiny_bert_ranker","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("tiny_bert_ranker", "en")
