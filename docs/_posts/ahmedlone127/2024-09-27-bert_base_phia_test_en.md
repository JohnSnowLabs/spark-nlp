...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_phia_test","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_phia_test", "en")
