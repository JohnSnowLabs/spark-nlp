...
sequenceClassifier  = BertForSequenceClassification.pretrained("bioclinical_bert_finetuned_mtsamples","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bioclinical_bert_finetuned_mtsamples", "en")
