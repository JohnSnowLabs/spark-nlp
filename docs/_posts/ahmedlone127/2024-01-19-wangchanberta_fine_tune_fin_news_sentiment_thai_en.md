...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("wangchanberta_fine_tune_fin_news_sentiment_thai","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("wangchanberta_fine_tune_fin_news_sentiment_thai","en")
...
{:.table-model}
|---|---|
|Model Name:|wangchanberta_fine_tune_fin_news_sentiment_thai|
...
https://huggingface.co/Pakkapon/wangchanberta-fine-tune-fin-news-sentiment-th