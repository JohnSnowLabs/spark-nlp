...
tokenClassifier = CamemBertForTokenClassification.pretrained("tetis_textmine_2024_camembert_large_based","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("tetis_textmine_2024_camembert_large_based", "en")
...
{:.table-model}
|---|---|
|Model Name:|tetis_textmine_2024_camembert_large_based|
...
https://huggingface.co/rdecoupes/tetis-textmine-2024-camembert-large-based