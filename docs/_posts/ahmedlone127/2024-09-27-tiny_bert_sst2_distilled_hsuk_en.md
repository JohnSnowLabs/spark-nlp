...
sequenceClassifier  = BertForSequenceClassification.pretrained("tiny_bert_sst2_distilled_hsuk","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("tiny_bert_sst2_distilled_hsuk", "en")
