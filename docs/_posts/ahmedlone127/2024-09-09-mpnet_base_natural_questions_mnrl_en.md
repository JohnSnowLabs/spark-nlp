...
embeddings = MPNetEmbeddings.pretrained("mpnet_base_natural_questions_mnrl","en") \
...
val embeddings = MPNetEmbeddings.pretrained("mpnet_base_natural_questions_mnrl","en") 
