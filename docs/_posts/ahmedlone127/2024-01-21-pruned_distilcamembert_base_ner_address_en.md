...
tokenClassifier = CamemBertForTokenClassification.pretrained("pruned_distilcamembert_base_ner_address","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("pruned_distilcamembert_base_ner_address", "en")
