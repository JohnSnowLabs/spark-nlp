...
tokenClassifier  = BertForTokenClassification.pretrained("propaganda_ner_arabic","ar") \
...
val tokenClassifier = BertForTokenClassification.pretrained("propaganda_ner_arabic", "ar")
...
{:.table-model}
|---|---|
|Model Name:|propaganda_ner_arabic|
