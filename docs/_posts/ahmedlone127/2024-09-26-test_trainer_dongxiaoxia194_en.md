...
sequenceClassifier  = BertForSequenceClassification.pretrained("test_trainer_dongxiaoxia194","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("test_trainer_dongxiaoxia194", "en")
