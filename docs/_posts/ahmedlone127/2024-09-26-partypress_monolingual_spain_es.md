...
sequenceClassifier  = BertForSequenceClassification.pretrained("partypress_monolingual_spain","es") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("partypress_monolingual_spain", "es")
