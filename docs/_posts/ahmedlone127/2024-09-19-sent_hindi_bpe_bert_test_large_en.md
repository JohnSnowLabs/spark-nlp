...
embeddings = BertSentenceEmbeddings.pretrained("sent_hindi_bpe_bert_test_large","en") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_hindi_bpe_bert_test_large","en") 
