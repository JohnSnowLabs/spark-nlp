...
sequenceClassifier  = BertForSequenceClassification.pretrained("ptv2_bert_large_uncased_sst2","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("ptv2_bert_large_uncased_sst2", "en")
