...
tokenClassifier  = DistilBertForTokenClassification.pretrained("burmese_wnut_model_yehoshuadiller","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("burmese_wnut_model_yehoshuadiller", "en")
