...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_twitterfin_padding40model","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_twitterfin_padding40model", "en")
