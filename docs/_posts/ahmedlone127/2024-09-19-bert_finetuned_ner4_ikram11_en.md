...
tokenClassifier  = BertForTokenClassification.pretrained("bert_finetuned_ner4_ikram11","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("bert_finetuned_ner4_ikram11", "en")
...
{:.table-model}
|---|---|
|Model Name:|bert_finetuned_ner4_ikram11|
