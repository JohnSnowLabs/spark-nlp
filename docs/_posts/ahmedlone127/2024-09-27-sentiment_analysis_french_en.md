...
sequenceClassifier  = BertForSequenceClassification.pretrained("sentiment_analysis_french","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("sentiment_analysis_french", "en")
