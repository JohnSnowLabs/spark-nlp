...
spanClassifier = BertForQuestionAnswering.pretrained("hebert_finetuned_precedents","he") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("hebert_finetuned_precedents", "he")
