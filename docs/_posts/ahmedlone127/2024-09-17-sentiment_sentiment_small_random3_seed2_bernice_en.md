...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("sentiment_sentiment_small_random3_seed2_bernice","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("sentiment_sentiment_small_random3_seed2_bernice", "en")
...
{:.table-model}
|---|---|
|Model Name:|sentiment_sentiment_small_random3_seed2_bernice|
