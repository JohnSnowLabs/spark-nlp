...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("divya_resume_model","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("divya_resume_model", "en")
