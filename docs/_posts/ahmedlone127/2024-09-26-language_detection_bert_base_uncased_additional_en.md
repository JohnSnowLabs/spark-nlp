...
sequenceClassifier  = BertForSequenceClassification.pretrained("language_detection_bert_base_uncased_additional","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("language_detection_bert_base_uncased_additional", "en")
