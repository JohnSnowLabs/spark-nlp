...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_ner_icelandic_ner_roberta_is_5.2.1_3.0_1702498583203.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_ner_icelandic_ner_roberta_is_5.2.1_3.0_1702498583203.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("is.ner.roberta").predict("""Ég elska neista NLP""")
```
</div>
