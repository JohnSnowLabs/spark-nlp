...
sequenceClassifier  = MPNetForSequenceClassification.pretrained("autotrain_i7gko_heakm","en") \
...
val sequenceClassifier = MPNetForSequenceClassification.pretrained("autotrain_i7gko_heakm", "en")
