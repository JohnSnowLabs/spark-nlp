...
tokenClassifier  = BertForTokenClassification.pretrained("nlp_tutorial_ner","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("nlp_tutorial_ner", "en")
