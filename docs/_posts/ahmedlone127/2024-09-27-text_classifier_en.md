...
sequenceClassifier  = BertForSequenceClassification.pretrained("text_classifier","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("text_classifier", "en")
