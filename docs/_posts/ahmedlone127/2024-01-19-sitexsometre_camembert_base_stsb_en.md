...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("sitexsometre_camembert_base_stsb","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("sitexsometre_camembert_base_stsb","en")
