...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("esg_classification_distilbert_roberta_v4","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("esg_classification_distilbert_roberta_v4", "en")
