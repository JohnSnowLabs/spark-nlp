...
embeddings = BGEEmbeddings.pretrained("bge_base_horizon_europe_matryoshka","en") \
...
val embeddings = BGEEmbeddings.pretrained("bge_base_horizon_europe_matryoshka","en") 
