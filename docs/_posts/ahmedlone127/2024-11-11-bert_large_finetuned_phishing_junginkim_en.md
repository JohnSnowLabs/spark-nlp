...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_large_finetuned_phishing_junginkim","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_large_finetuned_phishing_junginkim", "en")
