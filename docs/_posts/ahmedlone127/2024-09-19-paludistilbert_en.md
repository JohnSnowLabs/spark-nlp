...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("paludistilbert","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("paludistilbert", "en")
