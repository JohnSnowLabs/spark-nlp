...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_finetuned_fake_reviews","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_finetuned_fake_reviews", "en")
