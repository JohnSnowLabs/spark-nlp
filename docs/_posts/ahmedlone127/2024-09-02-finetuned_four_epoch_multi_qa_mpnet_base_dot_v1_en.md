...
embeddings = MPNetEmbeddings.pretrained("finetuned_four_epoch_multi_qa_mpnet_base_dot_v1","en") \
...
val embeddings = MPNetEmbeddings.pretrained("finetuned_four_epoch_multi_qa_mpnet_base_dot_v1","en") 
