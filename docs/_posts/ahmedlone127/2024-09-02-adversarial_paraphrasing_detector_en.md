...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("adversarial_paraphrasing_detector","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("adversarial_paraphrasing_detector", "en")
