...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("hate_hate_random3_seed1_roberta_base","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("hate_hate_random3_seed1_roberta_base", "en")
...
{:.table-model}
|---|---|
|Model Name:|hate_hate_random3_seed1_roberta_base|
