...
speechToText  = WhisperForCTC.pretrained("malaysian_whisper_tiny","ms") \
...
val speechToText = WhisperForCTC.pretrained("malaysian_whisper_tiny", "ms")
...
{:.table-model}
|---|---|
|Model Name:|malaysian_whisper_tiny|
