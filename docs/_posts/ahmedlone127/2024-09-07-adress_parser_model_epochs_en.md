...
tokenClassifier  = DistilBertForTokenClassification.pretrained("adress_parser_model_epochs","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("adress_parser_model_epochs", "en")
