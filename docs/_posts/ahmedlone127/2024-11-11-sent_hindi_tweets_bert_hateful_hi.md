...
embeddings = BertSentenceEmbeddings.pretrained("sent_hindi_tweets_bert_hateful","hi") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_hindi_tweets_bert_hateful","hi") 
