...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("finetuned_roberta_base_sentiment_classifier","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("finetuned_roberta_base_sentiment_classifier", "en")
