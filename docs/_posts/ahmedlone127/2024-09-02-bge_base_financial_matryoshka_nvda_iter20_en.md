...
embeddings = BGEEmbeddings.pretrained("bge_base_financial_matryoshka_nvda_iter20","en") \
...
val embeddings = BGEEmbeddings.pretrained("bge_base_financial_matryoshka_nvda_iter20","en") 
