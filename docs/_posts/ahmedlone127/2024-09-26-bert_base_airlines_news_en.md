...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_airlines_news","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_airlines_news", "en")
