...
sequenceClassifier  = CamemBertForSequenceClassification.pretrained("tst_tfm_stm_pp","th") \
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("tst_tfm_stm_pp", "th")
