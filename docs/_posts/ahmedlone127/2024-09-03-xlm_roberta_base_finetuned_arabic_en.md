...
embeddings = XlmRoBertaEmbeddings.pretrained("xlm_roberta_base_finetuned_arabic","en") \
...
val embeddings = XlmRoBertaEmbeddings.pretrained("xlm_roberta_base_finetuned_arabic","en") 
