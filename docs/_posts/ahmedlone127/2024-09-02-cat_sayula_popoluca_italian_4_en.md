...
tokenClassifier  = CamemBertForTokenClassification.pretrained("cat_sayula_popoluca_italian_4","en") \
...
val tokenClassifier = CamemBertForTokenClassification.pretrained("cat_sayula_popoluca_italian_4", "en")
