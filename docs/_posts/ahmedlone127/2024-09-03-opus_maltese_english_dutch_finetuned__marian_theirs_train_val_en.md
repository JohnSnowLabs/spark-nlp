...
marian = MarianTransformer.pretrained("opus_maltese_english_dutch_finetuned__marian_theirs_train_val","en") \
...
val embeddings = MarianTransformer.pretrained("opus_maltese_english_dutch_finetuned__marian_theirs_train_val","en") 
