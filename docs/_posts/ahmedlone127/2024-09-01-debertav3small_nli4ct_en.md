...
sequenceClassifier  = DeBertaForSequenceClassification.pretrained("debertav3small_nli4ct","en") \
...
val sequenceClassifier = DeBertaForSequenceClassification.pretrained("debertav3small_nli4ct", "en")
