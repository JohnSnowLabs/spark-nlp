...
sequenceClassifier  = BertForSequenceClassification.pretrained("qp_mscoco_sbert_lr5e_5","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("qp_mscoco_sbert_lr5e_5", "en")
