...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_cased_semantics_cls","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_cased_semantics_cls", "en")
