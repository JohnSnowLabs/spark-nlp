...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_classifier_spanish_news_classification_headlines","es") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_classifier_spanish_news_classification_headlines", "es")
