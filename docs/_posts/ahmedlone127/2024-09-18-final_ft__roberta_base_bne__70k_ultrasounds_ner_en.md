...
tokenClassifier  = RoBertaForTokenClassification.pretrained("final_ft__roberta_base_bne__70k_ultrasounds_ner","en") \
...
val tokenClassifier = RoBertaForTokenClassification.pretrained("final_ft__roberta_base_bne__70k_ultrasounds_ner", "en")
...
{:.table-model}
|---|---|
|Model Name:|final_ft__roberta_base_bne__70k_ultrasounds_ner|
