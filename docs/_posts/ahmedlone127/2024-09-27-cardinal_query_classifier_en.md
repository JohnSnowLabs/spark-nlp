...
sequenceClassifier  = BertForSequenceClassification.pretrained("cardinal_query_classifier","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("cardinal_query_classifier", "en")
