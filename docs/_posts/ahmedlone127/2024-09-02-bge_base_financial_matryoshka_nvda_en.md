...
embeddings = BGEEmbeddings.pretrained("bge_base_financial_matryoshka_nvda","en") \
...
val embeddings = BGEEmbeddings.pretrained("bge_base_financial_matryoshka_nvda","en") 
