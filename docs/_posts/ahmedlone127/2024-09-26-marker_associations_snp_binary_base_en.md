...
sequenceClassifier  = BertForSequenceClassification.pretrained("marker_associations_snp_binary_base","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("marker_associations_snp_binary_base", "en")
