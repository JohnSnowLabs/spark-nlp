...
sequenceClassifier  = BertForSequenceClassification.pretrained("hw1_model_finetuned","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("hw1_model_finetuned", "en")
