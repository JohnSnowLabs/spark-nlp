...
embeddings = MPNetEmbeddings.pretrained("retrieval_mpnet_dot_finetuned_combined_synthetic_dataset","en") \
...
val embeddings = MPNetEmbeddings.pretrained("retrieval_mpnet_dot_finetuned_combined_synthetic_dataset","en") 
