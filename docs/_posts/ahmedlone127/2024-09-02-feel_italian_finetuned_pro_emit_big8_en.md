...
sequenceClassifier  = CamemBertForSequenceClassification.pretrained("feel_italian_finetuned_pro_emit_big8","en") \
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("feel_italian_finetuned_pro_emit_big8", "en")
...
{:.table-model}
|---|---|
|Model Name:|feel_italian_finetuned_pro_emit_big8|
