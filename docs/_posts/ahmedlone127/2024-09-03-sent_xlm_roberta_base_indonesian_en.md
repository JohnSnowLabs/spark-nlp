...
embeddings = XlmRoBertaSentenceEmbeddings.pretrained("sent_xlm_roberta_base_indonesian","en") \
...
val embeddings = XlmRoBertaSentenceEmbeddings.pretrained("sent_xlm_roberta_base_indonesian","en") 
