...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("trans_encoder_cross_simcse_roberta_base","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("trans_encoder_cross_simcse_roberta_base", "en")
