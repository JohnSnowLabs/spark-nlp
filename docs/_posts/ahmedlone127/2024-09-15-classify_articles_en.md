...
sequenceClassifier  = AlbertForSequenceClassification.pretrained("classify_articles","en") \
...
val sequenceClassifier = AlbertForSequenceClassification.pretrained("classify_articles", "en")
