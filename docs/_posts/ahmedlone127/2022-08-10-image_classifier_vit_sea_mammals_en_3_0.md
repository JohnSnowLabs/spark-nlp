...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/image_classifier_vit_sea_mammals_en_4.1.0_3.0_1660166060426.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
nlu.load("en.classify_image.sea_mammals").predict("hen.JPEG")
```
