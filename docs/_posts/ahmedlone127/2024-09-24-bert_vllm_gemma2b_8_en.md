...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("bert_vllm_gemma2b_8","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("bert_vllm_gemma2b_8", "en")
