...
tokenClassifier = CamemBertForTokenClassification.pretrained("argument_wangchanberta","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("argument_wangchanberta", "en")
...
{:.table-model}
|---|---|
|Model Name:|argument_wangchanberta|
...
https://huggingface.co/pitiwat/argument_wangchanberta