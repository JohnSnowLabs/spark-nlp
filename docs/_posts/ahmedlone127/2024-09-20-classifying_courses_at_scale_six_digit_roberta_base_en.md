...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("classifying_courses_at_scale_six_digit_roberta_base","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("classifying_courses_at_scale_six_digit_roberta_base", "en")
