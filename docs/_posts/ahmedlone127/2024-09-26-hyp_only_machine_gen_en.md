...
sequenceClassifier  = BertForSequenceClassification.pretrained("hyp_only_machine_gen","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("hyp_only_machine_gen", "en")
