...
spanClassifier = BertForQuestionAnswering.pretrained("roberta_finetuned_subjqa_movies_2_francisca28","en") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("roberta_finetuned_subjqa_movies_2_francisca28", "en")
