...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("clasificadorcorreosoportedistilespanol","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("clasificadorcorreosoportedistilespanol", "en")
