...
sequenceClassifier  = BertForSequenceClassification.pretrained("hamorspammodel","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("hamorspammodel", "en")
