...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_ner_bert_finetuned_protagonist_english_en_5.2.1_3.0_1702498885563.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_ner_bert_finetuned_protagonist_english_en_5.2.1_3.0_1702498885563.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.ner.roberta.finetuned_protagonist_english.by_airi").predict("""PUT YOUR STRING HERE""")
```
</div>
