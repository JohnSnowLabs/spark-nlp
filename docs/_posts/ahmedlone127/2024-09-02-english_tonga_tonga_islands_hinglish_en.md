...
marian = MarianTransformer.pretrained("english_tonga_tonga_islands_hinglish","en") \
...
val embeddings = MarianTransformer.pretrained("english_tonga_tonga_islands_hinglish","en") 
