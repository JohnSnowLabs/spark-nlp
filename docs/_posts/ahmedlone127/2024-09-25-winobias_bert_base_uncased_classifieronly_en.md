...
sequenceClassifier  = BertForSequenceClassification.pretrained("winobias_bert_base_uncased_classifieronly","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("winobias_bert_base_uncased_classifieronly", "en")
