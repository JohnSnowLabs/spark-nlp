...
embeddings = BGEEmbeddings.pretrained("bge_small_english_multiplrrankingloss_tax_dataset","en") \
...
val embeddings = BGEEmbeddings.pretrained("bge_small_english_multiplrrankingloss_tax_dataset","en") 
