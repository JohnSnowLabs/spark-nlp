...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("test_trainer_enyonam","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("test_trainer_enyonam", "en")
