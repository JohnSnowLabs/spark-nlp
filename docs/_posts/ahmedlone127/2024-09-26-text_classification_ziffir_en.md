...
sequenceClassifier  = BertForSequenceClassification.pretrained("text_classification_ziffir","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("text_classification_ziffir", "en")
