...
sequenceClassifier  = BertForSequenceClassification.pretrained("biobert_re_trained","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("biobert_re_trained", "en")
