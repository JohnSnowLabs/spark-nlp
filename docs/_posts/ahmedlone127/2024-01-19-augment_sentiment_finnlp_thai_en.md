...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("augment_sentiment_finnlp_thai","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("augment_sentiment_finnlp_thai","en")
...
{:.table-model}
|---|---|
|Model Name:|augment_sentiment_finnlp_thai|
...
https://huggingface.co/nlp-chula/augment-sentiment-finnlp-th