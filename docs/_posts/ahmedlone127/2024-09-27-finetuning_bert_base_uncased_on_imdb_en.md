...
sequenceClassifier  = BertForSequenceClassification.pretrained("finetuning_bert_base_uncased_on_imdb","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("finetuning_bert_base_uncased_on_imdb", "en")
