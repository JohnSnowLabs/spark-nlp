...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("finetuning_sentiment_model_3000_samples","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("finetuning_sentiment_model_3000_samples","en")
...
{:.table-model}
|---|---|
|Model Name:|finetuning_sentiment_model_3000_samples|
...
https://huggingface.co/Timothy1337/finetuning-sentiment-model-3000-samples