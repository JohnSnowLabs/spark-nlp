...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("sloberta_trendi_topics","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("sloberta_trendi_topics","en")
