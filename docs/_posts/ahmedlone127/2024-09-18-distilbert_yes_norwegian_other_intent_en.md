...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_yes_norwegian_other_intent","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_yes_norwegian_other_intent", "en")
