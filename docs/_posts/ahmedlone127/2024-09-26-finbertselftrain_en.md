...
sequenceClassifier  = BertForSequenceClassification.pretrained("finbertselftrain","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("finbertselftrain", "en")
