...
sequenceClassifier  = BertForSequenceClassification.pretrained("hatexplain_majority_relabeled","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("hatexplain_majority_relabeled", "en")
