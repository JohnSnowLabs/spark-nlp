...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/t5_small_bashsql_en_5.4.2_3.0_1722630852372.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/t5_small_bashsql_en_5.4.2_3.0_1722630852372.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
t5 = T5Transformer.pretrained("t5_small_bashsql","en") \
...
val t5 = T5Transformer.pretrained("t5_small_bashsql","en") 
    .setInputCols("document")
    .setOutputCol("answers")
