...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_imdb_fine_tuned","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_imdb_fine_tuned", "en")
