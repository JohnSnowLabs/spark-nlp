...
embeddings = RoBertaEmbeddings.pretrained("roberta_large_1160k","sv") \
...
val embeddings = RoBertaEmbeddings.pretrained("roberta_large_1160k","sv") 
...
{:.table-model}
|---|---|
|Model Name:|roberta_large_1160k|
