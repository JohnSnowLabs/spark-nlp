...
sequenceClassifier  = BertForSequenceClassification.pretrained("yelp_polarity_tuned_bert_base_100k","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("yelp_polarity_tuned_bert_base_100k", "en")
