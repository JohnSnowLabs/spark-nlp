...
sequenceClassifier  = BertForSequenceClassification.pretrained("indo_smsa_1_5g_sentiment_analysis","id") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("indo_smsa_1_5g_sentiment_analysis", "id")
