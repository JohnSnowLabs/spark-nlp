...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("dilemmas_roberta_text_disagreement_predictor","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("dilemmas_roberta_text_disagreement_predictor", "en")
