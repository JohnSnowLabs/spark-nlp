...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("augment_aspect_finnlp_thai","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("augment_aspect_finnlp_thai","en")
