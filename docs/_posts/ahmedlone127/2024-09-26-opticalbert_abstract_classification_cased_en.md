...
sequenceClassifier  = BertForSequenceClassification.pretrained("opticalbert_abstract_classification_cased","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("opticalbert_abstract_classification_cased", "en")
