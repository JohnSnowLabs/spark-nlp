...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("xlm_roberta_base_finetuned_marc_begar","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("xlm_roberta_base_finetuned_marc_begar", "en")
