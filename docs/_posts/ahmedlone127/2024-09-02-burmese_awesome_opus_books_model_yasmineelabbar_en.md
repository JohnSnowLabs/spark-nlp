...
marian = MarianTransformer.pretrained("burmese_awesome_opus_books_model_yasmineelabbar","en") \
...
val embeddings = MarianTransformer.pretrained("burmese_awesome_opus_books_model_yasmineelabbar","en") 
