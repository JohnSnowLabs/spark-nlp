...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("emotion_text_classification","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("emotion_text_classification", "en")
