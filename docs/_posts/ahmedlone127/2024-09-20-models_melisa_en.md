...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("models_melisa","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("models_melisa", "en")
