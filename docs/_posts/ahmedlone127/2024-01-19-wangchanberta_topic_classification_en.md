...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("wangchanberta_topic_classification","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("wangchanberta_topic_classification","en")
