...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_temp_classifier_boot","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_temp_classifier_boot", "en")
