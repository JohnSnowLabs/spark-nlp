...
marian = MarianTransformer.pretrained("marianmix_english_chinese_10_deskdown","en") \
...
val embeddings = MarianTransformer.pretrained("marianmix_english_chinese_10_deskdown","en") 
