...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_classifier_paraphrase_es_5.2.0_3.0_1701231125686.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_classifier_paraphrase_es_5.2.0_3.0_1701231125686.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("es.classify.roberta.by_prompsit").predict("""PUT YOUR STRING HERE""")
```
</div>
