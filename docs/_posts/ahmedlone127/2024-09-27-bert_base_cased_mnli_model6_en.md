...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_cased_mnli_model6","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_cased_mnli_model6", "en")
