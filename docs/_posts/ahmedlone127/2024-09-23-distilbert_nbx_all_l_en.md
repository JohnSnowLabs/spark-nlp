...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_nbx_all_l","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_nbx_all_l", "en")
