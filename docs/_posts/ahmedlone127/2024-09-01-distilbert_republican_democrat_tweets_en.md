...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_republican_democrat_tweets","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_republican_democrat_tweets", "en")
