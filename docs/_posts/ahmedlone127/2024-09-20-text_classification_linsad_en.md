...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("text_classification_linsad","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("text_classification_linsad", "en")
