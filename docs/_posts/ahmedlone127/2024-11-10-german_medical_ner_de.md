...
tokenClassifier  = BertForTokenClassification.pretrained("german_medical_ner","de") \
...
val tokenClassifier = BertForTokenClassification.pretrained("german_medical_ner", "de")
