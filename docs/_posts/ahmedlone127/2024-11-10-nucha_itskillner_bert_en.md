...
tokenClassifier  = BertForTokenClassification.pretrained("nucha_itskillner_bert","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("nucha_itskillner_bert", "en")
