...
sequenceClassifier  = BertForSequenceClassification.pretrained("bertanswerabilityevaluator","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bertanswerabilityevaluator", "en")
