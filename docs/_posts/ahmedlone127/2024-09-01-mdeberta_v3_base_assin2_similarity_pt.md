...
sequenceClassifier  = DeBertaForSequenceClassification.pretrained("mdeberta_v3_base_assin2_similarity","pt") \
...
val sequenceClassifier = DeBertaForSequenceClassification.pretrained("mdeberta_v3_base_assin2_similarity", "pt")
