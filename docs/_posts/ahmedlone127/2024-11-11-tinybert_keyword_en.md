...
tokenClassifier  = BertForTokenClassification.pretrained("tinybert_keyword","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("tinybert_keyword", "en")
