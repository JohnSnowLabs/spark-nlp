...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_chinese_climate_related_prediction_vv1","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_chinese_climate_related_prediction_vv1", "en")
