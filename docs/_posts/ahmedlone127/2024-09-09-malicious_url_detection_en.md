...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("malicious_url_detection","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("malicious_url_detection", "en")
