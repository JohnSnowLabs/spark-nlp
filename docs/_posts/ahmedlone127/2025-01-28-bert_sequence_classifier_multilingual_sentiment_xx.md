...
date: 2025-01-28
tags: [en, nl, de, fr, it, es, sequence_classification, bert, multilingual, sentiment, xx, open_source, onnx]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_sequence_classifier_multilingual_sentiment_xx_5.5.1_3.0_1738027591267.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_sequence_classifier_multilingual_sentiment_xx_5.5.1_3.0_1738027591267.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
