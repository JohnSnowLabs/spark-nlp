...
spanClassifier = BertForQuestionAnswering.pretrained("bert_qa_large_uncased_spanish_sign_language","en") \
...
val spanClassifier = BertForQuestionAnswering  
    .pretrained("bert_qa_large_uncased_spanish_sign_language", "en")
