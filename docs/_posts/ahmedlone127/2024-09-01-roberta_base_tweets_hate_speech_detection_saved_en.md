...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("roberta_base_tweets_hate_speech_detection_saved","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("roberta_base_tweets_hate_speech_detection_saved", "en")
