...
embeddings = BGEEmbeddings.pretrained("fine_tune_embedding_bge_base_hrpolicy_vfinal","en") \
...
val embeddings = BGEEmbeddings.pretrained("fine_tune_embedding_bge_base_hrpolicy_vfinal","en") 
