...
embeddings = MPNetEmbeddings.pretrained("setfit_model_misinformation_on_mandates_public_health","en") \
...
val embeddings = MPNetEmbeddings.pretrained("setfit_model_misinformation_on_mandates_public_health","en") 
