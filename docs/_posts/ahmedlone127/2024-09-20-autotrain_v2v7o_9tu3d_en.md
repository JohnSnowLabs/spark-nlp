...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("autotrain_v2v7o_9tu3d","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("autotrain_v2v7o_9tu3d", "en")
...
{:.table-model}
|---|---|
|Model Name:|autotrain_v2v7o_9tu3d|
