...
sequenceClassifier  = BertForSequenceClassification.pretrained("n_bert_agnews_padding80model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("n_bert_agnews_padding80model", "en")
