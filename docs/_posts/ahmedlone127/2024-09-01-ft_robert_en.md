...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("ft_robert","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("ft_robert", "en")
