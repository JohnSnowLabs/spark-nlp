...
date: 2024-06-10
tags: [xlm_roberta, ner, token_classification, tr, open_source, onnx]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_xlm_roberta_base_turkish_ner_tr_5.4.0_3.0_1718032227980.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_xlm_roberta_base_turkish_ner_tr_5.4.0_3.0_1718032227980.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("tr.ner.xlmr_roberta.base").predict("""Spark NLP'yi seviyorum""")
```
</div>
