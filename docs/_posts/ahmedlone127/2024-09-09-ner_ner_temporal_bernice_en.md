...
tokenClassifier  = XlmRoBertaForTokenClassification.pretrained("ner_ner_temporal_bernice","en") \
...
val tokenClassifier = XlmRoBertaForTokenClassification.pretrained("ner_ner_temporal_bernice", "en")
