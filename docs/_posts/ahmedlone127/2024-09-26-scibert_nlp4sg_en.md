...
sequenceClassifier  = BertForSequenceClassification.pretrained("scibert_nlp4sg","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("scibert_nlp4sg", "en")
