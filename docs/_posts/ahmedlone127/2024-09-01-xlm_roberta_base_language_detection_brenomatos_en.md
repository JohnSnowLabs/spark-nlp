...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("xlm_roberta_base_language_detection_brenomatos","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("xlm_roberta_base_language_detection_brenomatos", "en")
...
{:.table-model}
|---|---|
|Model Name:|xlm_roberta_base_language_detection_brenomatos|
