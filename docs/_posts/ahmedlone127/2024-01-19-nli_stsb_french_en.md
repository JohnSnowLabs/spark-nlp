...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("nli_stsb_french","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("nli_stsb_french","en")
