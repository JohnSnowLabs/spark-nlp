...
sequenceClassifier  = BertForSequenceClassification.pretrained("ag_bert_base_uncased_sentence_similarity_v1","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("ag_bert_base_uncased_sentence_similarity_v1", "en")
