...
speechToText  = WhisperForCTC.pretrained("sungbeom_whisper_small_korean_set54","ko") \
...
val speechToText = WhisperForCTC.pretrained("sungbeom_whisper_small_korean_set54", "ko")
