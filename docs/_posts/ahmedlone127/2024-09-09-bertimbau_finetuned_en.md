...
sequenceClassifier  = BertForSequenceClassification.pretrained("bertimbau_finetuned","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bertimbau_finetuned", "en")
...
{:.table-model}
|---|---|
|Model Name:|bertimbau_finetuned|
