...
tokenClassifier  = DistilBertForTokenClassification.pretrained("distilbert_ner_saugatkafley","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("distilbert_ner_saugatkafley", "en")
