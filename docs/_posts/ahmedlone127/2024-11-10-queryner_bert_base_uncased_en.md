...
tokenClassifier  = BertForTokenClassification.pretrained("queryner_bert_base_uncased","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("queryner_bert_base_uncased", "en")
