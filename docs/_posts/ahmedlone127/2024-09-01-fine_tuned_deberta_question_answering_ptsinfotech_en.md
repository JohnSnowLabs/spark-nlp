...
spanClassifier = DeBertaForQuestionAnswering.pretrained("fine_tuned_deberta_question_answering_ptsinfotech","en") \
...
val spanClassifier = DeBertaForQuestionAnswering.pretrained("fine_tuned_deberta_question_answering_ptsinfotech", "en")
