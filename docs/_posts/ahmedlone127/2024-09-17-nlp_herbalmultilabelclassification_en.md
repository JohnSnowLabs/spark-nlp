...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("nlp_herbalmultilabelclassification","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("nlp_herbalmultilabelclassification", "en")
