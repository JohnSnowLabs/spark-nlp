...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_classifier_minlm_finetuned_emotionnew1_en_5.1.4_3.4_1698792541734.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_minlm_finetuned_emotionnew1_en_5.1.4_3.4_1698792541734.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.classify.emotion.bert.minilm_v1.by_dinithi").predict("""PUT YOUR STRING HERE""")
```
</div>
