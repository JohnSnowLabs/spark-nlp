...
embeddings = RoBertaEmbeddings.pretrained("absa_restaurant_froberta_base_v0","en") \
...
val embeddings = RoBertaEmbeddings.pretrained("absa_restaurant_froberta_base_v0","en") 
