...
sequenceClassifier  = BertForSequenceClassification.pretrained("n_bert_agnews_padding50model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("n_bert_agnews_padding50model", "en")
