...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("social_media_fake_news_detection","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("social_media_fake_news_detection", "en")
