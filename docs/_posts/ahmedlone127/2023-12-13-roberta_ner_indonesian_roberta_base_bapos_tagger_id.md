...
date: 2023-12-13
tags: [bert, ner, open_source, id, onnx]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_ner_indonesian_roberta_base_bapos_tagger_id_5.2.1_3.0_1702498039915.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_ner_indonesian_roberta_base_bapos_tagger_id_5.2.1_3.0_1702498039915.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("id.ner.pos.base").predict("""Saya suka Spark NLP""")
```
</div>
