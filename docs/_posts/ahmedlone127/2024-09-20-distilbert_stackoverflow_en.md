...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_stackoverflow","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_stackoverflow", "en")
