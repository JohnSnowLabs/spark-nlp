...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("movie_sentiment_trainer","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("movie_sentiment_trainer", "en")
