...
tokenClassifier  = BertForTokenClassification.pretrained("token_classification_wnut","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("token_classification_wnut", "en")
