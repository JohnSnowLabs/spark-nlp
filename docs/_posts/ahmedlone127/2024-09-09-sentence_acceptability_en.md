...
sequenceClassifier  = BertForSequenceClassification.pretrained("sentence_acceptability","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("sentence_acceptability", "en")
