...
embeddings = BertSentenceEmbeddings.pretrained("sent_turkish_mini_bert_uncased","tr") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_turkish_mini_bert_uncased","tr") 
...
{:.table-model}
|---|---|
|Model Name:|sent_turkish_mini_bert_uncased|
