...
marian = MarianTransformer.pretrained("pokemon_english_tonga_tonga_islands_chinese","en") \
...
val embeddings = MarianTransformer.pretrained("pokemon_english_tonga_tonga_islands_chinese","en") 
