...
tokenClassifier  = BertForTokenClassification.pretrained("ner_finetuning_beto","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("ner_finetuning_beto", "en")
