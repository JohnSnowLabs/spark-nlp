...
marian = MarianTransformer.pretrained("opus_maltese_english_indonesian_ccmatrix_v2","en") \
...
val embeddings = MarianTransformer.pretrained("opus_maltese_english_indonesian_ccmatrix_v2","en") 
