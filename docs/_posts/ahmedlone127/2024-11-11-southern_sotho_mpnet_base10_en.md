...
sequenceClassifier  = MPNetForSequenceClassification.pretrained("southern_sotho_mpnet_base10","en") \
...
val sequenceClassifier = MPNetForSequenceClassification.pretrained("southern_sotho_mpnet_base10", "en")
