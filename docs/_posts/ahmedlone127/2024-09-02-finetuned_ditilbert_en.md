...
tokenClassifier  = DistilBertForTokenClassification.pretrained("finetuned_ditilbert","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("finetuned_ditilbert", "en")
