...
spanClassifier = BertForQuestionAnswering.pretrained("med_drugs_extraction_b","en") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("med_drugs_extraction_b", "en")
