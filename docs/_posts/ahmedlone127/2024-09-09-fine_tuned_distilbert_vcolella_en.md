...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("fine_tuned_distilbert_vcolella","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("fine_tuned_distilbert_vcolella", "en")
...
{:.table-model}
|---|---|
|Model Name:|fine_tuned_distilbert_vcolella|
