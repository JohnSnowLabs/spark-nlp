...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_kan_rom","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_kan_rom", "en")
