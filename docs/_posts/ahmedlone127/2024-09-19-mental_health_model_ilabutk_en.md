...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("mental_health_model_ilabutk","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("mental_health_model_ilabutk", "en")
...
{:.table-model}
|---|---|
|Model Name:|mental_health_model_ilabutk|
