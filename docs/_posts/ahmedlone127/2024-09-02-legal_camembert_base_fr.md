...
embeddings = CamemBertEmbeddings.pretrained("legal_camembert_base","fr") \
...
val embeddings = CamemBertEmbeddings.pretrained("legal_camembert_base","fr") 
...
{:.table-model}
|---|---|
|Model Name:|legal_camembert_base|
