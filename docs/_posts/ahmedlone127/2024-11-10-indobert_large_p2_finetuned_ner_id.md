...
tokenClassifier  = BertForTokenClassification.pretrained("indobert_large_p2_finetuned_ner","id") \
...
val tokenClassifier = BertForTokenClassification.pretrained("indobert_large_p2_finetuned_ner", "id")
