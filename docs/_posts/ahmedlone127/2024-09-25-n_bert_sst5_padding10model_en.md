...
sequenceClassifier  = BertForSequenceClassification.pretrained("n_bert_sst5_padding10model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("n_bert_sst5_padding10model", "en")
