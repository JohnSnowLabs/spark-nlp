...
sequenceClassifier  = BertForSequenceClassification.pretrained("marathi_topic_all_doc","mr") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("marathi_topic_all_doc", "mr")
