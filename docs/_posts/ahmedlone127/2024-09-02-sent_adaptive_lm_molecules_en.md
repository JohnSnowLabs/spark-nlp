...
embeddings = BertSentenceEmbeddings.pretrained("sent_adaptive_lm_molecules","en") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_adaptive_lm_molecules","en") 
