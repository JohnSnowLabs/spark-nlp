...
sequenceClassifier  = BertForSequenceClassification.pretrained("age_prediction","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("age_prediction", "en")
