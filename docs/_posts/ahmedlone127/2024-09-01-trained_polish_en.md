...
tokenClassifier  = DistilBertForTokenClassification.pretrained("trained_polish","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("trained_polish", "en")
