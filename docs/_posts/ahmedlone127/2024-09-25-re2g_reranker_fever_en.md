...
sequenceClassifier  = BertForSequenceClassification.pretrained("re2g_reranker_fever","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("re2g_reranker_fever", "en")
