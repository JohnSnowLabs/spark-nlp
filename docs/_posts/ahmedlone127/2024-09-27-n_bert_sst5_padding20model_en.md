...
sequenceClassifier  = BertForSequenceClassification.pretrained("n_bert_sst5_padding20model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("n_bert_sst5_padding20model", "en")
