...
embeddings = DistilBertEmbeddings.pretrained("distilbert_base_uncased_finetuned_imdb_aarnow","en") \
...
val embeddings = DistilBertEmbeddings.pretrained("distilbert_base_uncased_finetuned_imdb_aarnow","en") 
