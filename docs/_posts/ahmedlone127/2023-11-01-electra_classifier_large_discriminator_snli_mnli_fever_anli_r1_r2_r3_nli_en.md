...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/electra_classifier_large_discriminator_snli_mnli_fever_anli_r1_r2_r3_nli_en_5.1.4_3.4_1698801658839.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/electra_classifier_large_discriminator_snli_mnli_fever_anli_r1_r2_r3_nli_en_5.1.4_3.4_1698801658839.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.classify.electra.fever.large").predict("""PUT YOUR STRING HERE""")
```
</div>
