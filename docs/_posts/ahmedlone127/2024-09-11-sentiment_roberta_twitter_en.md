...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("sentiment_roberta_twitter","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("sentiment_roberta_twitter", "en")
