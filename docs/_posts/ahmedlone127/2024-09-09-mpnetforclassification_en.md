...
sequenceClassifier  = MPNetForSequenceClassification.pretrained("mpnetforclassification","en") \
...
val sequenceClassifier = MPNetForSequenceClassification.pretrained("mpnetforclassification", "en")
...
{:.table-model}
|---|---|
|Model Name:|mpnetforclassification|
