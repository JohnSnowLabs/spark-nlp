...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_on_polarity_yelp_reviews","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_on_polarity_yelp_reviews", "en")
