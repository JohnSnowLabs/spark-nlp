...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("neuronale_crew_a6","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("neuronale_crew_a6", "en")
