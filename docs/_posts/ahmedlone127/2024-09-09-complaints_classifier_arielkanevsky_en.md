...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("complaints_classifier_arielkanevsky","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("complaints_classifier_arielkanevsky", "en")
