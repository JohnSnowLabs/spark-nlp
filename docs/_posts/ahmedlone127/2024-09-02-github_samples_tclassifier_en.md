...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("github_samples_tclassifier","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("github_samples_tclassifier", "en")
