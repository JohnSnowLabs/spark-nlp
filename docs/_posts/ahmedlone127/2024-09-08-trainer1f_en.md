...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("trainer1f","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("trainer1f", "en")
