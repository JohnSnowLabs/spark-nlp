...
tokenClassifier = CamemBertForTokenClassification.pretrained("icdar23_entrydetector_texttokens_breaks_indents_left_diff_right_ref","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("icdar23_entrydetector_texttokens_breaks_indents_left_diff_right_ref", "en")
...
{:.table-model}
|---|---|
|Model Name:|icdar23_entrydetector_texttokens_breaks_indents_left_diff_right_ref|
...
https://huggingface.co/HueyNemud/icdar23-entrydetector_texttokens_breaks_indents_left_diff_right_ref