...
marian = MarianTransformer.pretrained("opus_maltese_indonesian_english_ccmatrix_norwegian_warmup_best_bleu","en") \
...
val embeddings = MarianTransformer.pretrained("opus_maltese_indonesian_english_ccmatrix_norwegian_warmup_best_bleu","en") 
