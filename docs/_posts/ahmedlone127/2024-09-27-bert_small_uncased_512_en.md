...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_small_uncased_512","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_small_uncased_512", "en")
