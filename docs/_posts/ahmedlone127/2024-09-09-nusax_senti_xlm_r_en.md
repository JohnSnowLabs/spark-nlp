...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("nusax_senti_xlm_r","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("nusax_senti_xlm_r", "en")
