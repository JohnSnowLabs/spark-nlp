...
tokenClassifier  = RoBertaForTokenClassification.pretrained("roberta_large_full_finetuned_ner_single","en") \
...
val tokenClassifier = RoBertaForTokenClassification.pretrained("roberta_large_full_finetuned_ner_single", "en")
