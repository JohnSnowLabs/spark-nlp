...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("twitter_roberta_base_tempo_wic_latest","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("twitter_roberta_base_tempo_wic_latest", "en")
...
{:.table-model}
|---|---|
|Model Name:|twitter_roberta_base_tempo_wic_latest|
