...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("finetuned_roberta_base_model","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("finetuned_roberta_base_model", "en")
