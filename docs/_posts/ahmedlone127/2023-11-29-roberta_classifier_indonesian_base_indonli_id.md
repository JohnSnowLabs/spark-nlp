...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_classifier_indonesian_base_indonli_id_5.2.0_3.0_1701228002403.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_classifier_indonesian_base_indonli_id_5.2.0_3.0_1701228002403.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("id.classify.roberta.base.by_w11wo").predict("""PUT YOUR STRING HERE""")
```
</div>
