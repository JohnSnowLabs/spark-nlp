...
spanClassifier = XlmRoBertaForQuestionAnswering.pretrained("xlm_roberta_qa_addi_finnish_xlm_r","fi") \
...
val spanClassifier = XlmRoBertaForQuestionAnswering.pretrained("xlm_roberta_qa_addi_finnish_xlm_r", "fi")
