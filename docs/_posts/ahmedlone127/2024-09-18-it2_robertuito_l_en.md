...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("it2_robertuito_l","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("it2_robertuito_l", "en")
