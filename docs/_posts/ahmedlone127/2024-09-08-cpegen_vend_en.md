...
tokenClassifier  = DistilBertForTokenClassification.pretrained("cpegen_vend","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("cpegen_vend", "en")
