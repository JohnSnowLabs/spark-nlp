...
date: 2025-05-21
tags: [xlm_roberta, embeddings, large, open_source, multilingual, xx, openvino]
task: Embeddings
language: xx
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/xlm_roberta_large_xx_5.5.1_3.0_1747825596216.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/xlm_roberta_large_xx_5.5.1_3.0_1747825596216.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
