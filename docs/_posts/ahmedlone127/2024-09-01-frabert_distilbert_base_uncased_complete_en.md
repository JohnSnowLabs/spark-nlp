...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("frabert_distilbert_base_uncased_complete","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("frabert_distilbert_base_uncased_complete", "en")
