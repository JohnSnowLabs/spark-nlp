...
spanClassifier = RoBertaForQuestionAnswering.pretrained("tinyroberta_squad2_step1","en") \
...
val spanClassifier = RoBertaForQuestionAnswering.pretrained("tinyroberta_squad2_step1", "en")
