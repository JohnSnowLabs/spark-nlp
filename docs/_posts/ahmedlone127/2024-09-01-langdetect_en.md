...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("langdetect","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("langdetect", "en")
