...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("roberta_base_fine_tuned_flipkart_reviews_amharic","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("roberta_base_fine_tuned_flipkart_reviews_amharic", "en")
