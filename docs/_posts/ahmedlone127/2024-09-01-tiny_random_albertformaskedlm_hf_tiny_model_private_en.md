...
embeddings = AlbertEmbeddings.pretrained("tiny_random_albertformaskedlm_hf_tiny_model_private","en") \
...
val embeddings = AlbertEmbeddings.pretrained("tiny_random_albertformaskedlm_hf_tiny_model_private","en") 
