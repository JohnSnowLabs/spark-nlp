...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("roberta_base_imdb_trained","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("roberta_base_imdb_trained", "en")
...
{:.table-model}
|---|---|
|Model Name:|roberta_base_imdb_trained|
