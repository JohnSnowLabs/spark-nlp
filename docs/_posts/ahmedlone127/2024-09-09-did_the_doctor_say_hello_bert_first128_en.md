...
sequenceClassifier  = BertForSequenceClassification.pretrained("did_the_doctor_say_hello_bert_first128","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("did_the_doctor_say_hello_bert_first128", "en")
