...
tokenClassifier = CamemBertForTokenClassification.pretrained("coref_classifier_ancor","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("coref_classifier_ancor", "en")
...
https://huggingface.co/gguichard/coref_classifier_ancor