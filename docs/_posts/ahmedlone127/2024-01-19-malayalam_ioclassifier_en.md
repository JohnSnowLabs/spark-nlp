...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("malayalam_ioclassifier","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("malayalam_ioclassifier","en")
