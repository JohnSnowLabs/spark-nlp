...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("distilroberta_nsfw_prompt_stable_diffusion","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("distilroberta_nsfw_prompt_stable_diffusion", "en")
