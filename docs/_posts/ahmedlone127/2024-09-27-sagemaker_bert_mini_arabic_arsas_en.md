...
sequenceClassifier  = BertForSequenceClassification.pretrained("sagemaker_bert_mini_arabic_arsas","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("sagemaker_bert_mini_arabic_arsas", "en")
