...
tokenClassifier  = DistilBertForTokenClassification.pretrained("trained_english","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("trained_english", "en")
