...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_fine_tuned_cola_khaledai","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_fine_tuned_cola_khaledai", "en")
