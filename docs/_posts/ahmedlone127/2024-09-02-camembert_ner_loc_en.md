...
tokenClassifier  = CamemBertForTokenClassification.pretrained("camembert_ner_loc","en") \
...
val tokenClassifier = CamemBertForTokenClassification.pretrained("camembert_ner_loc", "en")
