...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("burmese_text_classification_finetuned_v1","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("burmese_text_classification_finetuned_v1", "en")
