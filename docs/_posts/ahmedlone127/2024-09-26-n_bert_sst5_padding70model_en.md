...
sequenceClassifier  = BertForSequenceClassification.pretrained("n_bert_sst5_padding70model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("n_bert_sst5_padding70model", "en")
