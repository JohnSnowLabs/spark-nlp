...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_large_uncased_cls_cree","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_large_uncased_cls_cree", "en")
