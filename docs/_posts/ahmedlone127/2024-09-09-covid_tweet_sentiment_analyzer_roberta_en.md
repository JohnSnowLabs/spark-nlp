...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("covid_tweet_sentiment_analyzer_roberta","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("covid_tweet_sentiment_analyzer_roberta", "en")
