...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("senticse","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("senticse", "en")
