...
sequenceClassifier  = BertForSequenceClassification.pretrained("environmental_claims_vinoth24","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("environmental_claims_vinoth24", "en")
