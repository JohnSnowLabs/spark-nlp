...
marian = MarianTransformer.pretrained("marian_finetuned_dyu_tonga_tonga_islands_french","en") \
...
val embeddings = MarianTransformer.pretrained("marian_finetuned_dyu_tonga_tonga_islands_french","en") 
