...
sequenceClassifier  = BertForSequenceClassification.pretrained("russian_evasiveness","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("russian_evasiveness", "en")
