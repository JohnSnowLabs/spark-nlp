...
spanClassifier = DeBertaForQuestionAnswering.pretrained("deberta_v3_base_domain_adapted","en") \
...
val spanClassifier = DeBertaForQuestionAnswering.pretrained("deberta_v3_base_domain_adapted", "en")
