...
tokenClassifier  = XlmRoBertaForTokenClassification.pretrained("xlm_word_shopsign_pretrained","en") \
...
val tokenClassifier = XlmRoBertaForTokenClassification.pretrained("xlm_word_shopsign_pretrained", "en")
