...
spanClassifier = BertForQuestionAnswering.pretrained("answer_finder_v1_s_english","en") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("answer_finder_v1_s_english", "en")
