...
embeddings = BGEEmbeddings.pretrained("bge_base_financial_matryoshka_kperkins411","en") \
...
val embeddings = BGEEmbeddings.pretrained("bge_base_financial_matryoshka_kperkins411","en") 
