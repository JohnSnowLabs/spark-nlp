...
sequenceClassifier  = BertForSequenceClassification.pretrained("sst_mobilebert_uncased","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("sst_mobilebert_uncased", "en")
