...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("bert_intent_classifier","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("bert_intent_classifier", "en")
