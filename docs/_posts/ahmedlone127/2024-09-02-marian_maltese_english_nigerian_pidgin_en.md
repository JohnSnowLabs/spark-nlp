...
marian = MarianTransformer.pretrained("marian_maltese_english_nigerian_pidgin","en") \
...
val embeddings = MarianTransformer.pretrained("marian_maltese_english_nigerian_pidgin","en") 
