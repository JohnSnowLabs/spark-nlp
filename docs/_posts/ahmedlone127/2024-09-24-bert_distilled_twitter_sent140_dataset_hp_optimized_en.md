...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("bert_distilled_twitter_sent140_dataset_hp_optimized","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("bert_distilled_twitter_sent140_dataset_hp_optimized", "en")
...
{:.table-model}
|---|---|
|Model Name:|bert_distilled_twitter_sent140_dataset_hp_optimized|
...
https://huggingface.co/ArafatBHossain/bert-distilled-twitter-sent140_dataset_hp_optimized