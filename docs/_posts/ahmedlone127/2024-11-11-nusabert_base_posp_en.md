...
tokenClassifier  = BertForTokenClassification.pretrained("nusabert_base_posp","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("nusabert_base_posp", "en")
