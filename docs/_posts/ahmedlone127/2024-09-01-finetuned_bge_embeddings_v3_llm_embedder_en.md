...
embeddings = BGEEmbeddings.pretrained("finetuned_bge_embeddings_v3_llm_embedder","en") \
...
val embeddings = BGEEmbeddings.pretrained("finetuned_bge_embeddings_v3_llm_embedder","en") 
