...
sequenceClassifier  = BertForSequenceClassification.pretrained("pft_clf_finetuned","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("pft_clf_finetuned", "en")
