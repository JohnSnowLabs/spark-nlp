...
sequenceClassifier  = BertForSequenceClassification.pretrained("arabglossbert","ar") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("arabglossbert", "ar")
