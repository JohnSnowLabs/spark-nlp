...
speechToText  = WhisperForCTC.pretrained("linshoufanfork_whisper_small_nan_twi_pinyin","en") \
...
val speechToText = WhisperForCTC.pretrained("linshoufanfork_whisper_small_nan_twi_pinyin", "en")
