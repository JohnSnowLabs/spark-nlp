...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("twitter_roberta_base_sentiment_kapiche","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("twitter_roberta_base_sentiment_kapiche", "en")
