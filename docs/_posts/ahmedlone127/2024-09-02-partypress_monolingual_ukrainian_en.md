...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("partypress_monolingual_ukrainian","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("partypress_monolingual_ukrainian", "en")
