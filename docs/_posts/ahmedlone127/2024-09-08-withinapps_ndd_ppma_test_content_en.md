...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("withinapps_ndd_ppma_test_content","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("withinapps_ndd_ppma_test_content", "en")
