...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("soqbert","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("soqbert", "en")
