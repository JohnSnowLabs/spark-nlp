...
sequenceClassifier  = BertForSequenceClassification.pretrained("hiv_v3_bodysite","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("hiv_v3_bodysite", "en")
