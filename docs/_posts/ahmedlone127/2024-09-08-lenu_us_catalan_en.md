...
sequenceClassifier  = BertForSequenceClassification.pretrained("lenu_us_catalan","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("lenu_us_catalan", "en")
