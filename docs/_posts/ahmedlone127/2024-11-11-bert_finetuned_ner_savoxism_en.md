...
tokenClassifier  = BertForTokenClassification.pretrained("bert_finetuned_ner_savoxism","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("bert_finetuned_ner_savoxism", "en")
