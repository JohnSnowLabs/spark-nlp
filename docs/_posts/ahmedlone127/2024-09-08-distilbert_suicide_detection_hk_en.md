...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_suicide_detection_hk","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_suicide_detection_hk", "en")
