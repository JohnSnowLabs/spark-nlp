...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("emotions","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("emotions", "en")
