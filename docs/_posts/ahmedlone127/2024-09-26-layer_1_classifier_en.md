...
sequenceClassifier  = BertForSequenceClassification.pretrained("layer_1_classifier","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("layer_1_classifier", "en")
