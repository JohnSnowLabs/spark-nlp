...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("burmese_model_mahikajain","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("burmese_model_mahikajain", "en")
