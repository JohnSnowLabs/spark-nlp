...
sequenceClassifier  = BertForSequenceClassification.pretrained("iab_category_classification","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("iab_category_classification", "en")
