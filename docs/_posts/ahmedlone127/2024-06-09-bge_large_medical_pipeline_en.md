...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bge_large_medical_pipeline_en_5.4.0_3.0_1717956583375.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bge_large_medical_pipeline_en_5.4.0_3.0_1717956583375.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
