...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("camembert_base_finetunned_one_thema_balanced","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("camembert_base_finetunned_one_thema_balanced","en")
...
{:.table-model}
|---|---|
|Model Name:|camembert_base_finetunned_one_thema_balanced|
...
https://huggingface.co/dev-senolys/camembert_base_finetunned_one_thema_balanced