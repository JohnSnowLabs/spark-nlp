...
embeddings = RoBertaEmbeddings.pretrained("dapt_plus_tapt_helpfulness_base_pretraining_model_ltuzova","en") \
...
val embeddings = RoBertaEmbeddings.pretrained("dapt_plus_tapt_helpfulness_base_pretraining_model_ltuzova","en") 
