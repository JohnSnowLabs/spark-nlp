...
sequenceClassifier  = BertForSequenceClassification.pretrained("autotrain_event","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("autotrain_event", "en")
