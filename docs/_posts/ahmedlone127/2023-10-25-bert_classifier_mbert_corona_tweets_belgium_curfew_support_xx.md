...
date: 2023-10-25
tags: [en, fr, nl, open_source, bert, sequence_classification, classification, xx, onnx]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_classifier_mbert_corona_tweets_belgium_curfew_support_xx_5.1.4_3.4_1698192742817.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_mbert_corona_tweets_belgium_curfew_support_xx_5.1.4_3.4_1698192742817.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("xx.classify.bert.tweet.").predict("""PUT YOUR STRING HERE""")
```
</div>
