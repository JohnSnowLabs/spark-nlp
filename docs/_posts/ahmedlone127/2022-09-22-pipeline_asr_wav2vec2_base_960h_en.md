...
date: 2022-09-22
tags: [wav2vec2, en, audio, open_source, pipeline]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/pipeline_asr_wav2vec2_base_960h_en_4.2.0_3.0_1663882115319.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
```python
    ...
    annotations =  pipeline.fullAnnotate(imagedf)
    
```
```scala

    val pipeline = new PretrainedPipeline('pipeline_asr_wav2vec2_base_960h', lang = 'en')
    val annotations = pipeline.fullAnnotate(imagedf)
