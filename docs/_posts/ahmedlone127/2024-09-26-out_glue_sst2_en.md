...
sequenceClassifier  = BertForSequenceClassification.pretrained("out_glue_sst2","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("out_glue_sst2", "en")
