...
tokenClassifier  = BertForTokenClassification.pretrained("bert_base_german_cased_archaeo_ner","de") \
...
val tokenClassifier = BertForTokenClassification.pretrained("bert_base_german_cased_archaeo_ner", "de")
