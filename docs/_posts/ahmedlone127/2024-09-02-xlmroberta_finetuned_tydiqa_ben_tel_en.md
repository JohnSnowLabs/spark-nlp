...
spanClassifier = XlmRoBertaForQuestionAnswering.pretrained("xlmroberta_finetuned_tydiqa_ben_tel","en") \
...
val spanClassifier = XlmRoBertaForQuestionAnswering.pretrained("xlmroberta_finetuned_tydiqa_ben_tel", "en")
