...
sequenceClassifier  = BertForSequenceClassification.pretrained("financebert","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("financebert", "en")
