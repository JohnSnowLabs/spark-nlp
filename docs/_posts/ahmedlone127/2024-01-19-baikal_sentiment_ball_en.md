...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("baikal_sentiment_ball","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("baikal_sentiment_ball","en")
