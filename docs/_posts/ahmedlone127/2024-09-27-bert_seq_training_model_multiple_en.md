...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_seq_training_model_multiple","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_seq_training_model_multiple", "en")
