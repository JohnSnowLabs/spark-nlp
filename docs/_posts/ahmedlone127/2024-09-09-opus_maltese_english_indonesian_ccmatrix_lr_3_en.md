...
marian = MarianTransformer.pretrained("opus_maltese_english_indonesian_ccmatrix_lr_3","en") \
...
val embeddings = MarianTransformer.pretrained("opus_maltese_english_indonesian_ccmatrix_lr_3","en") 
