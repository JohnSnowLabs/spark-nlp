...
sequenceClassifier  = BertForSequenceClassification.pretrained("influence_tactic_paper","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("influence_tactic_paper", "en")
