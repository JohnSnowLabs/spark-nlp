...
sequenceClassifier  = BertForSequenceClassification.pretrained("thext_pce_czech","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("thext_pce_czech", "en")
