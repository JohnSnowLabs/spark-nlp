...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("finetuned_classification_model","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("finetuned_classification_model", "en")
