...
marian = MarianTransformer.pretrained("translation_english_vietnamese_official","en") \
...
val embeddings = MarianTransformer.pretrained("translation_english_vietnamese_official","en") 
