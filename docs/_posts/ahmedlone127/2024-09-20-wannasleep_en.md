...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("wannasleep","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("wannasleep", "en")
