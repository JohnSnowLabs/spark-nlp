...
marian = MarianTransformer.pretrained("spark_name_hindi_tonga_tonga_islands_english","en") \
...
val embeddings = MarianTransformer.pretrained("spark_name_hindi_tonga_tonga_islands_english","en") 
