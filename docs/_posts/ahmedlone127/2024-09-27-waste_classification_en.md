...
sequenceClassifier  = BertForSequenceClassification.pretrained("waste_classification","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("waste_classification", "en")
...
{:.table-model}
|---|---|
|Model Name:|waste_classification|
...
https://huggingface.co/XYZ123XYZ/waste-classification