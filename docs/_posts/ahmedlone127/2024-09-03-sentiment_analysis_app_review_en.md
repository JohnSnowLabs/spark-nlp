...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("sentiment_analysis_app_review","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("sentiment_analysis_app_review", "en")
