...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_protein_classifier","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_protein_classifier", "en")
