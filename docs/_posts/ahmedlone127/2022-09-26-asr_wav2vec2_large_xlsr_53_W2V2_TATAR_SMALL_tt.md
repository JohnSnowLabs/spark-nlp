...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/asr_wav2vec2_large_xlsr_53_W2V2_TATAR_SMALL_tt_4.2.0_3.0_1664192428030.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
nlu.load("tt.speech2text.wav2vec_xlsr.v2_large_small").predict("ngm_12484_01067234848.wav")
```
