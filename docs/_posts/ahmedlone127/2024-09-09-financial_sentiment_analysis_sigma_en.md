...
sequenceClassifier  = BertForSequenceClassification.pretrained("financial_sentiment_analysis_sigma","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("financial_sentiment_analysis_sigma", "en")
