...
sequenceClassifier  = MPNetForSequenceClassification.pretrained("candle_cvss_integrity","en") \
...
val sequenceClassifier = MPNetForSequenceClassification.pretrained("candle_cvss_integrity", "en")
...
{:.table-model}
|---|---|
|Model Name:|candle_cvss_integrity|
