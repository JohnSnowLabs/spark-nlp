...
tokenClassifier  = BertForTokenClassification.pretrained("albert_base_chinese_ws_finetuned_ner","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("albert_base_chinese_ws_finetuned_ner", "en")
