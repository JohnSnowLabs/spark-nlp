...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_large_finetuned_phishing_webpage_version","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_large_finetuned_phishing_webpage_version", "en")
