...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_cola","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_cola", "en")
