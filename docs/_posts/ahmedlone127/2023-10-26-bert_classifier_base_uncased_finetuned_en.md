...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_classifier_base_uncased_finetuned_en_5.1.4_3.4_1698363742576.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_base_uncased_finetuned_en_5.1.4_3.4_1698363742576.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.classify.bert.uncased_base_finetuned.by_hazrulakmal").predict("""PUT YOUR STRING HERE""")
```
</div>
