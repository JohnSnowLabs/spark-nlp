...
zeroShotClassifier  = BertForZeroShotClassification.pretrained("bge_large_english_mnli_anli","en") \
...
val zeroShotClassifier  = BertForZeroShotClassification.pretrained("bge_large_english_mnli_anli", "en")
