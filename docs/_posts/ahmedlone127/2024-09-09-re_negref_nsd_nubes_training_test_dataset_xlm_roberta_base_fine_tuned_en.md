...
tokenClassifier  = XlmRoBertaForTokenClassification.pretrained("re_negref_nsd_nubes_training_test_dataset_xlm_roberta_base_fine_tuned","en") \
...
val tokenClassifier = XlmRoBertaForTokenClassification.pretrained("re_negref_nsd_nubes_training_test_dataset_xlm_roberta_base_fine_tuned", "en")
