...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_classifier_german_sentiment_de_5.1.4_3.4_1698790745478.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_german_sentiment_de_5.1.4_3.4_1698790745478.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("de.classify.bert.sentiment.by_oliverguhr").predict("""PUT YOUR STRING HERE""")
```
</div>
