...
embeddings = BertSentenceEmbeddings.pretrained("sent_pak_legal_bert_small_uncased","en") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_pak_legal_bert_small_uncased","en") 
