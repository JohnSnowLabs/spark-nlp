...
tokenClassifier  = RoBertaForTokenClassification.pretrained("ruroberta_large_ner","en") \
...
val tokenClassifier = RoBertaForTokenClassification.pretrained("ruroberta_large_ner", "en")
