...
marian = MarianTransformer.pretrained("dataequity_opus_maltese_arabic_english","en") \
...
val embeddings = MarianTransformer.pretrained("dataequity_opus_maltese_arabic_english","en") 
