...
sequenceClassifier  = BertForSequenceClassification.pretrained("flame_italian","it") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("flame_italian", "it")
