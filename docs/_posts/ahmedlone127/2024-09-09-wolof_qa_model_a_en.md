...
spanClassifier = DistilBertForQuestionAnswering.pretrained("wolof_qa_model_a","en") \
...
val spanClassifier = DistilBertForQuestionAnswering.pretrained("wolof_qa_model_a", "en")
