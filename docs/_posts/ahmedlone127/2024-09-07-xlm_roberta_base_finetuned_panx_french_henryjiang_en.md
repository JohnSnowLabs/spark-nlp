...
tokenClassifier  = XlmRoBertaForTokenClassification.pretrained("xlm_roberta_base_finetuned_panx_french_henryjiang","en") \
...
val tokenClassifier = XlmRoBertaForTokenClassification.pretrained("xlm_roberta_base_finetuned_panx_french_henryjiang", "en")
