...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("chuvash_nlp","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("chuvash_nlp", "en")
