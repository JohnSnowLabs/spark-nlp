...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/camembert_finetuned_ner_en_5.5.0_3.0_1725266524584.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/camembert_finetuned_ner_en_5.5.0_3.0_1725266524584.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
tokenClassifier = CamemBertForTokenClassification.pretrained("camembert_finetuned_ner","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("camembert_finetuned_ner", "en")
