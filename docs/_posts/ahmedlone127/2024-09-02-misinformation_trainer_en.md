...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("misinformation_trainer","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("misinformation_trainer", "en")
...
{:.table-model}
|---|---|
|Model Name:|misinformation_trainer|
