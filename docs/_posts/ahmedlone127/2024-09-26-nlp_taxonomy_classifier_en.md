...
sequenceClassifier  = BertForSequenceClassification.pretrained("nlp_taxonomy_classifier","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("nlp_taxonomy_classifier", "en")
...
{:.table-model}
|---|---|
|Model Name:|nlp_taxonomy_classifier|
...
https://huggingface.co/TimSchopf/nlp_taxonomy_classifier