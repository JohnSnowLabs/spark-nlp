...
tokenClassifier  = CamemBertForTokenClassification.pretrained("lettuce_sayula_popoluca_french_mono","en") \
...
val tokenClassifier = CamemBertForTokenClassification.pretrained("lettuce_sayula_popoluca_french_mono", "en")
