...
tokenClassifier  = DeBertaForTokenClassification.pretrained("deberta_med_22feb","en") \
...
val tokenClassifier = DeBertaForTokenClassification.pretrained("deberta_med_22feb", "en")
