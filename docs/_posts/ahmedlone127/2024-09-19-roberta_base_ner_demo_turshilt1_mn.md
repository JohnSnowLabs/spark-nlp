...
tokenClassifier  = RoBertaForTokenClassification.pretrained("roberta_base_ner_demo_turshilt1","mn") \
...
val tokenClassifier = RoBertaForTokenClassification.pretrained("roberta_base_ner_demo_turshilt1", "mn")
...
{:.table-model}
|---|---|
|Model Name:|roberta_base_ner_demo_turshilt1|
