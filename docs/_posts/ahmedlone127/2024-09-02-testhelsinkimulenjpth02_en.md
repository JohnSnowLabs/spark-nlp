...
marian = MarianTransformer.pretrained("testhelsinkimulenjpth02","en") \
...
val embeddings = MarianTransformer.pretrained("testhelsinkimulenjpth02","en") 
...
{:.table-model}
|---|---|
|Model Name:|testhelsinkimulenjpth02|
