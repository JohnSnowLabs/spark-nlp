...
sequenceClassifier  = BertForSequenceClassification.pretrained("ft_bert_task3","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("ft_bert_task3", "en")
