...
spanClassifier = DistilBertForQuestionAnswering.pretrained("question_answer_thirdeyedata","en") \
...
val spanClassifier = DistilBertForQuestionAnswering.pretrained("question_answer_thirdeyedata", "en")
