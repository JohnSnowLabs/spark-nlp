...
sequenceClassifier  = BertForSequenceClassification.pretrained("flash_italian_ns_classifier_fpt","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("flash_italian_ns_classifier_fpt", "en")
