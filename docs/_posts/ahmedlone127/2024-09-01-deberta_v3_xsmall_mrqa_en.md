...
spanClassifier = DeBertaForQuestionAnswering.pretrained("deberta_v3_xsmall_mrqa","en") \
...
val spanClassifier = DeBertaForQuestionAnswering.pretrained("deberta_v3_xsmall_mrqa", "en")
