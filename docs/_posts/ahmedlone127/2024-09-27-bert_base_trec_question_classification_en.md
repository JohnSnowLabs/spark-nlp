...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_trec_question_classification","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_trec_question_classification", "en")
