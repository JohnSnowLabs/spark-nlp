...
tokenClassifier  = DistilBertForTokenClassification.pretrained("ner_on_proteindata","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("ner_on_proteindata", "en")
