...
sequenceClassifier  = BertForSequenceClassification.pretrained("medcpt_cross_encoder","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("medcpt_cross_encoder", "en")
