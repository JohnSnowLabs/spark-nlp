...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("twitter_roberta_base_efl_hateval","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("twitter_roberta_base_efl_hateval", "en")
