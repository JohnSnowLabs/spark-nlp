...
speechToText  = WhisperForCTC.pretrained("whisper_small_arabic_augmentation","en") \
...
val speechToText = WhisperForCTC.pretrained("whisper_small_arabic_augmentation", "en")
