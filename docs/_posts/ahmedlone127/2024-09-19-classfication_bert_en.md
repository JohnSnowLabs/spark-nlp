...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("classfication_bert","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("classfication_bert", "en")
