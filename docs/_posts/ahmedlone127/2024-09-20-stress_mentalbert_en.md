...
sequenceClassifier  = BertForSequenceClassification.pretrained("stress_mentalbert","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("stress_mentalbert", "en")
