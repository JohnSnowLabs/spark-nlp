...
embeddings = RoBertaEmbeddings.pretrained("pubchem10m_smiles_bpe_60k","en") \
...
val embeddings = RoBertaEmbeddings.pretrained("pubchem10m_smiles_bpe_60k","en") 
...
{:.table-model}
|---|---|
|Model Name:|pubchem10m_smiles_bpe_60k|
