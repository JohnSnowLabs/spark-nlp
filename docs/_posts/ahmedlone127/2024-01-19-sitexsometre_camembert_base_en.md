...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("sitexsometre_camembert_base","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("sitexsometre_camembert_base","en")
