...
embeddings = XlmRoBertaEmbeddings.pretrained("xlm_roberta_base_finetuned_kinyarwanda_kinre_finetuned_kinre_tweet_finetuned","en") \
...
val embeddings = XlmRoBertaEmbeddings.pretrained("xlm_roberta_base_finetuned_kinyarwanda_kinre_finetuned_kinre_tweet_finetuned","en") 
