...
sequenceClassifier  = BertForSequenceClassification.pretrained("kaggle_detect_generated_text","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("kaggle_detect_generated_text", "en")
