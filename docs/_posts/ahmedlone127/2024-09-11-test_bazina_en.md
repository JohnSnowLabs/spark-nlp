...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("test_bazina","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("test_bazina", "en")
