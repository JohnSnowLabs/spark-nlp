...
tokenClassifier  = BertForTokenClassification.pretrained("unified_skill_ner_echo","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("unified_skill_ner_echo", "en")
