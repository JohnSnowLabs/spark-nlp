...
tokenClassifier  = DistilBertForTokenClassification.pretrained("fresh_model_uncased","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("fresh_model_uncased", "en")
...
{:.table-model}
|---|---|
|Model Name:|fresh_model_uncased|
