...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("twitter_xlm_roberta_crypto_spam","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("twitter_xlm_roberta_crypto_spam", "en")
