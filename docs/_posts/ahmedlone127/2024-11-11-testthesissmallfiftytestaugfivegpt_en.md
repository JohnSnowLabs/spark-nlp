...
tokenClassifier  = BertForTokenClassification.pretrained("testthesissmallfiftytestaugfivegpt","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("testthesissmallfiftytestaugfivegpt", "en")
