...
embeddings = RoBertaEmbeddings.pretrained("pretrained_mario_bert_448_paths_ctx","en") \
...
val embeddings = RoBertaEmbeddings.pretrained("pretrained_mario_bert_448_paths_ctx","en") 
