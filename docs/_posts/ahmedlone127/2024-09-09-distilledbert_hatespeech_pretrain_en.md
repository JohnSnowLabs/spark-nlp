...
embeddings = DistilBertEmbeddings.pretrained("distilledbert_hatespeech_pretrain","en") \
...
val embeddings = DistilBertEmbeddings.pretrained("distilledbert_hatespeech_pretrain","en") 
