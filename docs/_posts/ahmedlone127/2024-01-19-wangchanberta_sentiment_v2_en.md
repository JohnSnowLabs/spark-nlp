...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("wangchanberta_sentiment_v2","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("wangchanberta_sentiment_v2","en")
