...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_classifier_xtremedistil_emotion_en_5.1.4_3.4_1698797452848.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_xtremedistil_emotion_en_5.1.4_3.4_1698797452848.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.classify.bert.emotion.xtremedistiled").predict("""PUT YOUR STRING HERE""")
```
</div>
