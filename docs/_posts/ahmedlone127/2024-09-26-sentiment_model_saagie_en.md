...
sequenceClassifier  = BertForSequenceClassification.pretrained("sentiment_model_saagie","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("sentiment_model_saagie", "en")
