...
sequenceClassifier  = BertForSequenceClassification.pretrained("unsup_simcse_minilm_l6","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("unsup_simcse_minilm_l6", "en")
