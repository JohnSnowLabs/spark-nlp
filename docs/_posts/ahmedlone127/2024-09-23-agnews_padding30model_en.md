...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("agnews_padding30model","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("agnews_padding30model", "en")
