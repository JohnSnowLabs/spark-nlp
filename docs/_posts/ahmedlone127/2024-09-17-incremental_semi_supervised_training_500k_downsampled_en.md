...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("incremental_semi_supervised_training_500k_downsampled","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("incremental_semi_supervised_training_500k_downsampled", "en")
