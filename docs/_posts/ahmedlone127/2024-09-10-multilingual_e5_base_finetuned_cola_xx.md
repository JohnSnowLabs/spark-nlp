...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("multilingual_e5_base_finetuned_cola","xx") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("multilingual_e5_base_finetuned_cola", "xx")
