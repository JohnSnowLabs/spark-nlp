...
tokenClassifier  = RoBertaForTokenClassification.pretrained("xlm_roberta_base_pharmaconer_mmenendezg","en") \
...
val tokenClassifier = RoBertaForTokenClassification.pretrained("xlm_roberta_base_pharmaconer_mmenendezg", "en")
