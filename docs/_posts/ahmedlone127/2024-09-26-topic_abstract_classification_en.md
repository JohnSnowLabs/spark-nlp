...
sequenceClassifier  = BertForSequenceClassification.pretrained("topic_abstract_classification","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("topic_abstract_classification", "en")
...
{:.table-model}
|---|---|
|Model Name:|topic_abstract_classification|
