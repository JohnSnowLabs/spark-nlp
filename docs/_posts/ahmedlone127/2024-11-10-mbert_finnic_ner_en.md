...
tokenClassifier  = BertForTokenClassification.pretrained("mbert_finnic_ner","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("mbert_finnic_ner", "en")
