...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("fine_tuning_nlp","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("fine_tuning_nlp", "en")
