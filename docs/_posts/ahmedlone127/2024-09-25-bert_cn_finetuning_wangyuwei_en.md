...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_cn_finetuning_wangyuwei","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_cn_finetuning_wangyuwei", "en")
