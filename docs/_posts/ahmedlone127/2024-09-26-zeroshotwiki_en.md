...
sequenceClassifier  = BertForSequenceClassification.pretrained("zeroshotwiki","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("zeroshotwiki", "en")
