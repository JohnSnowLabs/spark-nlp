...
sequenceClassifier  = BertForSequenceClassification.pretrained("friends_emotions_detection_distilbert","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("friends_emotions_detection_distilbert", "en")
