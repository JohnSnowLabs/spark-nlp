...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_emotion_narapuram","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_emotion_narapuram", "en")
