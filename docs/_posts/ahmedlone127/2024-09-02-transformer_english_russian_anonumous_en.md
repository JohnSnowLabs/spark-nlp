...
marian = MarianTransformer.pretrained("transformer_english_russian_anonumous","en") \
...
val embeddings = MarianTransformer.pretrained("transformer_english_russian_anonumous","en") 
