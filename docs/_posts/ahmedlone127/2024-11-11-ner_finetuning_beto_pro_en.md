...
tokenClassifier  = BertForTokenClassification.pretrained("ner_finetuning_beto_pro","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("ner_finetuning_beto_pro", "en")
