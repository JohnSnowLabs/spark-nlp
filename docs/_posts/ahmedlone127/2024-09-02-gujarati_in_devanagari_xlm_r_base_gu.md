...
embeddings = XlmRoBertaEmbeddings.pretrained("gujarati_in_devanagari_xlm_r_base","gu") \
...
val embeddings = XlmRoBertaEmbeddings.pretrained("gujarati_in_devanagari_xlm_r_base","gu") 
...
{:.table-model}
|---|---|
|Model Name:|gujarati_in_devanagari_xlm_r_base|
