...
sequenceClassifier  = BertForSequenceClassification.pretrained("n_bert_imdb_padding90model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("n_bert_imdb_padding90model", "en")
