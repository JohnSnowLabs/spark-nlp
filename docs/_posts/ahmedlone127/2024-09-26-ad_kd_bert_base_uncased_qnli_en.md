...
sequenceClassifier  = BertForSequenceClassification.pretrained("ad_kd_bert_base_uncased_qnli","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("ad_kd_bert_base_uncased_qnli", "en")
