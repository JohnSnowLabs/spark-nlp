...
speechToText  = WhisperForCTC.pretrained("whisper_small_divehi_chaouch","en") \
...
val speechToText = WhisperForCTC.pretrained("whisper_small_divehi_chaouch", "en")
...
{:.table-model}
|---|---|
|Model Name:|whisper_small_divehi_chaouch|
