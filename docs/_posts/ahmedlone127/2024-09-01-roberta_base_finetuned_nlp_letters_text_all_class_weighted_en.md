...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("roberta_base_finetuned_nlp_letters_text_all_class_weighted","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("roberta_base_finetuned_nlp_letters_text_all_class_weighted", "en")
