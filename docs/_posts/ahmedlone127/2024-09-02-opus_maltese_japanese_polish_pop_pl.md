...
marian = MarianTransformer.pretrained("opus_maltese_japanese_polish_pop","pl") \
...
val embeddings = MarianTransformer.pretrained("opus_maltese_japanese_polish_pop","pl") 
