...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("burmese_amazon_model","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("burmese_amazon_model", "en")
