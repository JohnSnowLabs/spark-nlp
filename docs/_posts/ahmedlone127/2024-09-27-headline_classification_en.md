...
sequenceClassifier  = BertForSequenceClassification.pretrained("headline_classification","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("headline_classification", "en")
