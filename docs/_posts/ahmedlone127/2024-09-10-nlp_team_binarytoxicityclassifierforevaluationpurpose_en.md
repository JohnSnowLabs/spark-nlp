...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("nlp_team_binarytoxicityclassifierforevaluationpurpose","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("nlp_team_binarytoxicityclassifierforevaluationpurpose", "en")
...
{:.table-model}
|---|---|
|Model Name:|nlp_team_binarytoxicityclassifierforevaluationpurpose|
