...
embeddings = BertEmbeddings.pretrained("norwegian_bokml_bert_ncc_male2female","en") \
...
val embeddings = BertEmbeddings.pretrained("norwegian_bokml_bert_ncc_male2female","en") 
...
{:.table-model}
|---|---|
|Model Name:|norwegian_bokml_bert_ncc_male2female|
