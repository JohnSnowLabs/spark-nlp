...
date: 2024-10-09
tags: [xx, multilingual, embeddings, bert, open_source, onnx]
task: Embeddings
language: xx
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_base_multilingual_uncased_xx_5.5.1_3.0_1728440503861.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_base_multilingual_uncased_xx_5.5.1_3.0_1728440503861.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
