...
sequenceClassifier  = BertForSequenceClassification.pretrained("bertbase_uncased_2_actual","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bertbase_uncased_2_actual", "en")
