...
embeddings = BertSentenceEmbeddings.pretrained("sent_biobert_patent_reference_extraction","en") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_biobert_patent_reference_extraction","en") 
