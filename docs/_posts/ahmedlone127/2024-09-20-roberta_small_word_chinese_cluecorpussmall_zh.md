...
embeddings = BertEmbeddings.pretrained("roberta_small_word_chinese_cluecorpussmall","zh") \
...
val embeddings = BertEmbeddings.pretrained("roberta_small_word_chinese_cluecorpussmall","zh") 
