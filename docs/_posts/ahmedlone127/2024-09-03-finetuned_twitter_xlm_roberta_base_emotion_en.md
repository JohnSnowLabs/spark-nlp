...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("finetuned_twitter_xlm_roberta_base_emotion","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("finetuned_twitter_xlm_roberta_base_emotion", "en")
