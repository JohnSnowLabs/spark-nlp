...
tokenClassifier  = DistilBertForTokenClassification.pretrained("def_and_notat_token_classification_model","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("def_and_notat_token_classification_model", "en")
