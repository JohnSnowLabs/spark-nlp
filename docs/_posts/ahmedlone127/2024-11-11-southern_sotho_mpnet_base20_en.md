...
sequenceClassifier  = MPNetForSequenceClassification.pretrained("southern_sotho_mpnet_base20","en") \
...
val sequenceClassifier = MPNetForSequenceClassification.pretrained("southern_sotho_mpnet_base20", "en")
