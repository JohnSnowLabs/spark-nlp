...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_v3rx2000_base_finetuned_panx_all_xx_5.4.0_3.0_1718031589448.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_v3rx2000_base_finetuned_panx_all_xx_5.4.0_3.0_1718031589448.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("xx.ner.xlmr_roberta.base_finetuned_panx_all.by_v3rx2000").predict("""PUT YOUR STRING HERE""")
```
</div>
