...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_classifier_based_uncased_sst2_e1_en_5.1.4_3.4_1698202548911.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_based_uncased_sst2_e1_en_5.1.4_3.4_1698202548911.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.classify.bert.uncased_base.by_ehsanaghazadeh").predict("""PUT YOUR STRING HERE""")
```
</div>
