...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/albert_for_arqmath_3_en_5.2.4_3.0_1716203444640.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/albert_for_arqmath_3_en_5.2.4_3.0_1716203444640.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
spanClassifier = CamemBertForQuestionAnswering.pretrained("albert_for_arqmath_3","en")     .setInputCols(["document_question","document_context"])     .setOutputCol("answer")
