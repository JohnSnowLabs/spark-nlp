...
sequenceClassifier  = BertForSequenceClassification.pretrained("bertfordetectingdepression_twitter2015","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bertfordetectingdepression_twitter2015", "en")
...
{:.table-model}
|---|---|
|Model Name:|bertfordetectingdepression_twitter2015|
...
https://huggingface.co/Silicon23/BERTForDetectingDepression-Twitter2015