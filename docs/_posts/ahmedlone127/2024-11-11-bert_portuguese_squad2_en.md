...
spanClassifier = BertForQuestionAnswering.pretrained("bert_portuguese_squad2","en") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("bert_portuguese_squad2", "en")
