...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_mdgender_convai_ternary","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_mdgender_convai_ternary", "en")
