...
tokenClassifier  = BertForTokenClassification.pretrained("persian_text_ner_bert_v1","fa") \
...
val tokenClassifier = BertForTokenClassification.pretrained("persian_text_ner_bert_v1", "fa")
