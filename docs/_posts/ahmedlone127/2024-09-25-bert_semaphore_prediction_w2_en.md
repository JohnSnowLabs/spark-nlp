...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_semaphore_prediction_w2","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_semaphore_prediction_w2", "en")
...
{:.table-model}
|---|---|
|Model Name:|bert_semaphore_prediction_w2|
