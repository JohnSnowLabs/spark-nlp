...
embeddings = BertEmbeddings.pretrained("roberta_base_word_chinese_cluecorpussmall","zh") \
...
val embeddings = BertEmbeddings.pretrained("roberta_base_word_chinese_cluecorpussmall","zh") 
