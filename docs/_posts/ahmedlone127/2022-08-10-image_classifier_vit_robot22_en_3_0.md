---
layout: model
title: English image_classifier_vit_robot22 ViTForImageClassification from sudo-s
author: John Snow Labs
name: image_classifier_vit_robot22
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/image_classifier_vit_robot22_en_4.1.0_3.0_1660168305706.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/image_classifier_vit_robot22_en_4.1.0_3.0_1660168305706.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
nlu.load("en.classify_image.robot22").predict("hen.JPEG")
```
