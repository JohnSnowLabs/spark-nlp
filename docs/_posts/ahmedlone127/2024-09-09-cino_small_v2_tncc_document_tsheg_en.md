...
sequenceClassifier  = XlmRoBertaForSequenceClassification.pretrained("cino_small_v2_tncc_document_tsheg","en") \
...
val sequenceClassifier = XlmRoBertaForSequenceClassification.pretrained("cino_small_v2_tncc_document_tsheg", "en")
...
{:.table-model}
|---|---|
|Model Name:|cino_small_v2_tncc_document_tsheg|
