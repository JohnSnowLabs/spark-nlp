...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_uncased_ftd_on_glue_qqp_iter_1","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_uncased_ftd_on_glue_qqp_iter_1", "en")
...
{:.table-model}
|---|---|
|Model Name:|bert_base_uncased_ftd_on_glue_qqp_iter_1|
