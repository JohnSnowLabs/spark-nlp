...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("4_datasets_fake_news_with_balanced","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("4_datasets_fake_news_with_balanced", "en")
...
{:.table-model}
|---|---|
|Model Name:|4_datasets_fake_news_with_balanced|
