...
tokenClassifier  = DistilBertForTokenClassification.pretrained("fabner_ner","en") \
...
val tokenClassifier = DistilBertForTokenClassification.pretrained("fabner_ner", "en")
