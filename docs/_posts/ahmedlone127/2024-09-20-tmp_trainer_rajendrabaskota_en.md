...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("tmp_trainer_rajendrabaskota","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("tmp_trainer_rajendrabaskota", "en")
...
{:.table-model}
|---|---|
|Model Name:|tmp_trainer_rajendrabaskota|
