...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("article_sentiment_analysis_model","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("article_sentiment_analysis_model", "en")
