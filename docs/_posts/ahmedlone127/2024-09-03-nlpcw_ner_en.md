...
tokenClassifier  = RoBertaForTokenClassification.pretrained("nlpcw_ner","en") \
...
val tokenClassifier = RoBertaForTokenClassification.pretrained("nlpcw_ner", "en")
