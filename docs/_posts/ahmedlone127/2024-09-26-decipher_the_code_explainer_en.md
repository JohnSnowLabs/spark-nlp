...
sequenceClassifier  = BertForSequenceClassification.pretrained("decipher_the_code_explainer","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("decipher_the_code_explainer", "en")
