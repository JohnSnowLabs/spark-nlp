...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_finetuned_age","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_finetuned_age", "en")
