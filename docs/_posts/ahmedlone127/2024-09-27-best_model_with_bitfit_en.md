...
sequenceClassifier  = BertForSequenceClassification.pretrained("best_model_with_bitfit","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("best_model_with_bitfit", "en")
