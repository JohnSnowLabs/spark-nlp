...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("emotions_roberta_test_6","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("emotions_roberta_test_6", "en")
