...
sequenceClassifier  = BertForSequenceClassification.pretrained("issue_classification_tweets","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("issue_classification_tweets", "en")
