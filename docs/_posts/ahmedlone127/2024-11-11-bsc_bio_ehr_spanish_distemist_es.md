...
tokenClassifier  = RoBertaForTokenClassification.pretrained("bsc_bio_ehr_spanish_distemist","es") \
...
val tokenClassifier = RoBertaForTokenClassification.pretrained("bsc_bio_ehr_spanish_distemist", "es")
...
{:.table-model}
|---|---|
|Model Name:|bsc_bio_ehr_spanish_distemist|
