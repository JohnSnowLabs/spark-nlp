...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_sequence_classifier_mini_finetuned_age_news_classification_en_5.1.4_3.4_1698810216676.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_sequence_classifier_mini_finetuned_age_news_classification_en_5.1.4_3.4_1698810216676.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.classify.bert.news.mini_finetuned").predict("""PUT YOUR STRING HERE""")
```
</div>
