...
sequenceClassifier  = BertForSequenceClassification.pretrained("kd_bertbase_berttiny","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("kd_bertbase_berttiny", "en")
