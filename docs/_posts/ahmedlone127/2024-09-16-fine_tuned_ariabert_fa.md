...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("fine_tuned_ariabert","fa") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("fine_tuned_ariabert", "fa")
...
{:.table-model}
|---|---|
|Model Name:|fine_tuned_ariabert|
