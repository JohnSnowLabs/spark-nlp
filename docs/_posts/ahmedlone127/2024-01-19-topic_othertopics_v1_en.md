...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("topic_othertopics_v1","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("topic_othertopics_v1","en")
