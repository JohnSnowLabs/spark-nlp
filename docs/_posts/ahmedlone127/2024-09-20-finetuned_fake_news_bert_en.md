...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("finetuned_fake_news_bert","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("finetuned_fake_news_bert", "en")
