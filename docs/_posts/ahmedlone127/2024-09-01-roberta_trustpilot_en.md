...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("roberta_trustpilot","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("roberta_trustpilot", "en")
