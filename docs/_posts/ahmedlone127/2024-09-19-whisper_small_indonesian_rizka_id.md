...
speechToText  = WhisperForCTC.pretrained("whisper_small_indonesian_rizka","id") \
...
val speechToText = WhisperForCTC.pretrained("whisper_small_indonesian_rizka", "id")
...
{:.table-model}
|---|---|
|Model Name:|whisper_small_indonesian_rizka|
