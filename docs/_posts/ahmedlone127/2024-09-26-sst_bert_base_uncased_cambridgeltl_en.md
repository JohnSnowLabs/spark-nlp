...
sequenceClassifier  = BertForSequenceClassification.pretrained("sst_bert_base_uncased_cambridgeltl","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("sst_bert_base_uncased_cambridgeltl", "en")
