...
sequenceClassifier  = BertForSequenceClassification.pretrained("finetuned_sentiment_bert_base_model","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("finetuned_sentiment_bert_base_model", "en")
