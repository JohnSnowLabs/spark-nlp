...
tokenClassifier  = BertForTokenClassification.pretrained("beto_finetuned_ner","en") \
...
val tokenClassifier = BertForTokenClassification.pretrained("beto_finetuned_ner", "en")
