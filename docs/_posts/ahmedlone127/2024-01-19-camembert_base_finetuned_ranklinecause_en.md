...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("camembert_base_finetuned_ranklinecause","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("camembert_base_finetuned_ranklinecause","en")
...
{:.table-model}
|---|---|
|Model Name:|camembert_base_finetuned_ranklinecause|
...
https://huggingface.co/louisdeco/camembert-base-finetuned-RankLineCause