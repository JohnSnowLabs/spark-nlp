...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("commitments_classification_model","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("commitments_classification_model", "en")
