...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_base_cased_textcls_rheology","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_base_cased_textcls_rheology", "en")
