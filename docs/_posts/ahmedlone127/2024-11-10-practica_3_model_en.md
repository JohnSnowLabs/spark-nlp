...
spanClassifier = DistilBertForQuestionAnswering.pretrained("practica_3_model","en") \
...
val spanClassifier = DistilBertForQuestionAnswering.pretrained("practica_3_model", "en")
