...
speechToText  = WhisperForCTC.pretrained("whisper_small_serbian_ri","en") \
...
val speechToText = WhisperForCTC.pretrained("whisper_small_serbian_ri", "en")
...
{:.table-model}
|---|---|
|Model Name:|whisper_small_serbian_ri|
