...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/t5_scifive_base_pubmed_en_5.4.1_3.0_1720890366651.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/t5_scifive_base_pubmed_en_5.4.1_3.0_1720890366651.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
t5 = T5Transformer.pretrained("t5_scifive_base_pubmed","en") \
...
val t5 = T5Transformer.pretrained("t5_scifive_base_pubmed","en") 
    .setInputCols("document")
    .setOutputCol("answers")
