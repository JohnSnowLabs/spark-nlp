...
sequenceClassifier  = MPNetForSequenceClassification.pretrained("southern_sotho_mpnet_base_normal","en") \
...
val sequenceClassifier = MPNetForSequenceClassification.pretrained("southern_sotho_mpnet_base_normal", "en")
