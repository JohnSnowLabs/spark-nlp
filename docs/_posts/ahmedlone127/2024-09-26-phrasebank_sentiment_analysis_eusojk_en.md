...
sequenceClassifier  = BertForSequenceClassification.pretrained("phrasebank_sentiment_analysis_eusojk","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("phrasebank_sentiment_analysis_eusojk", "en")
