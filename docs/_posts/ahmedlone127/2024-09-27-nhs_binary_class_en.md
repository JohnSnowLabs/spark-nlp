...
sequenceClassifier  = BertForSequenceClassification.pretrained("nhs_binary_class","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("nhs_binary_class", "en")
