...
embeddings = BertSentenceEmbeddings.pretrained("sent_bert_base_cased_swe_historical","sv") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_bert_base_cased_swe_historical","sv") 
