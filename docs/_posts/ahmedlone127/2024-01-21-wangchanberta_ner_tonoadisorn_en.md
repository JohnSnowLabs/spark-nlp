...
tokenClassifier = CamemBertForTokenClassification.pretrained("wangchanberta_ner_tonoadisorn","en") \
...
val tokenClassifier = CamemBertForTokenClassification  
    .pretrained("wangchanberta_ner_tonoadisorn", "en")
...
{:.table-model}
|---|---|
|Model Name:|wangchanberta_ner_tonoadisorn|
...
https://huggingface.co/tonoadisorn/wangchanberta-ner