...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/image_classifier_vit_base_beans_demo_v2_en_4.1.0_3.0_1660166573645.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
nlu.load("en.classify_image.base_beans_demo_v2").predict("hen.JPEG")
```
