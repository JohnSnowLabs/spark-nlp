...
embeddings = BGEEmbeddings.pretrained("bge_base_english_trivia_anchor_positive","en") \
...
val embeddings = BGEEmbeddings.pretrained("bge_base_english_trivia_anchor_positive","en") 
