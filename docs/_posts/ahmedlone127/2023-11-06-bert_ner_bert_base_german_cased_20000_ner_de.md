...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_ner_bert_base_german_cased_20000_ner_de_5.2.0_3.0_1699285737918.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_ner_bert_base_german_cased_20000_ner_de_5.2.0_3.0_1699285737918.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("de.ner.bert.cased_base").predict("""Ich liebe Spark NLP""")
```
</div>
