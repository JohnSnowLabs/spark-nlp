...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("chat_category_classifier","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("chat_category_classifier", "en")
