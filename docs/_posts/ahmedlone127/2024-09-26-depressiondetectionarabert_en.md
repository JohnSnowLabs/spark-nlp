...
sequenceClassifier  = BertForSequenceClassification.pretrained("depressiondetectionarabert","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("depressiondetectionarabert", "en")
