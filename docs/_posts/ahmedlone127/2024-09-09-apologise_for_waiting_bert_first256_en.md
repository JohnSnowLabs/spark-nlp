...
sequenceClassifier  = BertForSequenceClassification.pretrained("apologise_for_waiting_bert_first256","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("apologise_for_waiting_bert_first256", "en")
...
{:.table-model}
|---|---|
|Model Name:|apologise_for_waiting_bert_first256|
