...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("testing_model_katowtkkk","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("testing_model_katowtkkk", "en")
