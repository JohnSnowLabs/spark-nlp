...
sequenceClassifier  = BertForSequenceClassification.pretrained("paraphrase_detection_bert","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("paraphrase_detection_bert", "en")
