...
tokenClassifier  = XlmRoBertaForTokenClassification.pretrained("xlmr_base_trained_panx_japanese","en") \
...
val tokenClassifier = XlmRoBertaForTokenClassification.pretrained("xlmr_base_trained_panx_japanese", "en")
