...
sequenceClassifier  = BertForSequenceClassification.pretrained("sst2_benign_bert_uncased","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("sst2_benign_bert_uncased", "en")
