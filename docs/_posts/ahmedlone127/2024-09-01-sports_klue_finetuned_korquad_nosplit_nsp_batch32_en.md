...
spanClassifier = BertForQuestionAnswering.pretrained("sports_klue_finetuned_korquad_nosplit_nsp_batch32","en") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("sports_klue_finetuned_korquad_nosplit_nsp_batch32", "en")
