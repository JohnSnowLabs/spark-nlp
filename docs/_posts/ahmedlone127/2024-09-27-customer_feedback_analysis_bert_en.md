...
sequenceClassifier  = BertForSequenceClassification.pretrained("customer_feedback_analysis_bert","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("customer_feedback_analysis_bert", "en")
