...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("readability_spanish_3class_paragraphs","es") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("readability_spanish_3class_paragraphs", "es")
...
{:.table-model}
|---|---|
|Model Name:|readability_spanish_3class_paragraphs|
