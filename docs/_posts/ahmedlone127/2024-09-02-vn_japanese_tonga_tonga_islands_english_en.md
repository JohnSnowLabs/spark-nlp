...
marian = MarianTransformer.pretrained("vn_japanese_tonga_tonga_islands_english","en") \
...
val embeddings = MarianTransformer.pretrained("vn_japanese_tonga_tonga_islands_english","en") 
