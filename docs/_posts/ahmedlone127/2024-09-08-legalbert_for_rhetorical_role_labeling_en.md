...
sequenceClassifier  = BertForSequenceClassification.pretrained("legalbert_for_rhetorical_role_labeling","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("legalbert_for_rhetorical_role_labeling", "en")
