...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("hate_speech_detection_tweets_roberta_base","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("hate_speech_detection_tweets_roberta_base", "en")
...
{:.table-model}
|---|---|
|Model Name:|hate_speech_detection_tweets_roberta_base|
