...
sequenceClassifier  = BertForSequenceClassification.pretrained("dummy_model_hefeng0","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("dummy_model_hefeng0", "en")
