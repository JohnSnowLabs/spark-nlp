...
sequenceClassifier  = BertForSequenceClassification.pretrained("mbert_base_parsinlu_entailment","fa") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("mbert_base_parsinlu_entailment", "fa")
