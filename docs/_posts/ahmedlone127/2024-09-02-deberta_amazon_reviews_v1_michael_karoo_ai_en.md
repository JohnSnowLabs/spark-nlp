...
sequenceClassifier  = DeBertaForSequenceClassification.pretrained("deberta_amazon_reviews_v1_michael_karoo_ai","en") \
...
val sequenceClassifier = DeBertaForSequenceClassification.pretrained("deberta_amazon_reviews_v1_michael_karoo_ai", "en")
