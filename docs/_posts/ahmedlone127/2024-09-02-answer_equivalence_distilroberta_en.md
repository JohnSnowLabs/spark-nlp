...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("answer_equivalence_distilroberta","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("answer_equivalence_distilroberta", "en")
