...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("adept_roberta_l","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("adept_roberta_l", "en")
