...
sequenceClassifier  = BertForSequenceClassification.pretrained("q06_kaggle_bertbasecased","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("q06_kaggle_bertbasecased", "en")
