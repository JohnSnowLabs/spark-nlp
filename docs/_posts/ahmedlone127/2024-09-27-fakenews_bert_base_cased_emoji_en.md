...
sequenceClassifier  = BertForSequenceClassification.pretrained("fakenews_bert_base_cased_emoji","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("fakenews_bert_base_cased_emoji", "en")
