...
sequenceClassifier  = BertForSequenceClassification.pretrained("cosent_similarity_text2vec","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("cosent_similarity_text2vec", "en")
