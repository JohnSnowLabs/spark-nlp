...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("albert_test_model","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("albert_test_model", "en")
