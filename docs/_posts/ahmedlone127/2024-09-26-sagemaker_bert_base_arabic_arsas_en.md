...
sequenceClassifier  = BertForSequenceClassification.pretrained("sagemaker_bert_base_arabic_arsas","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("sagemaker_bert_base_arabic_arsas", "en")
