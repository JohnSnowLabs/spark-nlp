...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("sarcasm_detection_french_camembert","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("sarcasm_detection_french_camembert","en")
