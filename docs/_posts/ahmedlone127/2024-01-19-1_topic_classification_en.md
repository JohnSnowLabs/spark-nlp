...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("1_topic_classification","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("1_topic_classification","en")
