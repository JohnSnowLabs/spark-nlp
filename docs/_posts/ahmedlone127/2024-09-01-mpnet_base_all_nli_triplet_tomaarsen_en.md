...
embeddings = MPNetEmbeddings.pretrained("mpnet_base_all_nli_triplet_tomaarsen","en") \
...
val embeddings = MPNetEmbeddings.pretrained("mpnet_base_all_nli_triplet_tomaarsen","en") 
