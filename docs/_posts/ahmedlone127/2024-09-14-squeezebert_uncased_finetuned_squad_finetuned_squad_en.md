...
spanClassifier = BertForQuestionAnswering.pretrained("squeezebert_uncased_finetuned_squad_finetuned_squad","en") \
...
val spanClassifier = BertForQuestionAnswering.pretrained("squeezebert_uncased_finetuned_squad_finetuned_squad", "en")
