...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("immunization_classification_model","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("immunization_classification_model", "en")
