...
sequenceClassifier = CamemBertForSequenceClassification.pretrained("camembert_classification_tools","en")\
...
val sequenceClassifier = CamemBertForSequenceClassification.pretrained("camembert_classification_tools","en")
