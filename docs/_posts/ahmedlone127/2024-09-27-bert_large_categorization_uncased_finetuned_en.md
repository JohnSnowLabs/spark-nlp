...
sequenceClassifier  = BertForSequenceClassification.pretrained("bert_large_categorization_uncased_finetuned","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("bert_large_categorization_uncased_finetuned", "en")
