...
sequenceClassifier  = RoBertaForSequenceClassification.pretrained("mformer_fairness","en") \
...
val sequenceClassifier = RoBertaForSequenceClassification.pretrained("mformer_fairness", "en")
