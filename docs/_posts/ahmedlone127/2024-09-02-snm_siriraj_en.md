...
tokenClassifier  = CamemBertForTokenClassification.pretrained("snm_siriraj","en") \
...
val tokenClassifier = CamemBertForTokenClassification.pretrained("snm_siriraj", "en")
