...
embeddings = BertSentenceEmbeddings.pretrained("sent_conflibert_scr_uncased_snowood1","en") \
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_conflibert_scr_uncased_snowood1","en") 
