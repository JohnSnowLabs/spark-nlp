...
sequenceClassifier  = BertForSequenceClassification.pretrained("fine_tuned_metaphor_detection","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("fine_tuned_metaphor_detection", "en")
