...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("distilbert_uncased_finetuned_cyberbullying","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("distilbert_uncased_finetuned_cyberbullying", "en")
