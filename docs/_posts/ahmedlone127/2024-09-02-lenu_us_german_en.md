...
sequenceClassifier  = BertForSequenceClassification.pretrained("lenu_us_german","en") \
...
val sequenceClassifier = BertForSequenceClassification.pretrained("lenu_us_german", "en")
