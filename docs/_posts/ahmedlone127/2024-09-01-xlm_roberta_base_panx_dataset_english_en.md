...
tokenClassifier  = XlmRoBertaForTokenClassification.pretrained("xlm_roberta_base_panx_dataset_english","en") \
...
val tokenClassifier = XlmRoBertaForTokenClassification.pretrained("xlm_roberta_base_panx_dataset_english", "en")
