...
embeddings = DistilBertEmbeddings.pretrained("mlm_snodis_dis_descreption_epochs_5","en") \
...
val embeddings = DistilBertEmbeddings.pretrained("mlm_snodis_dis_descreption_epochs_5","en") 
...
{:.table-model}
|---|---|
|Model Name:|mlm_snodis_dis_descreption_epochs_5|
