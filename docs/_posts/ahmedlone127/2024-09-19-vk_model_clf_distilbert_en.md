...
sequenceClassifier  = DistilBertForSequenceClassification.pretrained("vk_model_clf_distilbert","en") \
...
val sequenceClassifier = DistilBertForSequenceClassification.pretrained("vk_model_clf_distilbert", "en")
