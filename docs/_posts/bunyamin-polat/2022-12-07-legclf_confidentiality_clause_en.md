...
name: legclf_confidentiality_clause
date: 2022-12-07
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_confidentiality_clause_en_1.0.0_3.0_1670431588795.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_confidentiality_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_confidentiality_clause|
...
confidentiality       1.00      0.96      0.98        25
