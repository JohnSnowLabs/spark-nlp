...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_letter_agreement_en_1.0.0_3.0_1668590492334.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
doc_classifier = nlp.ClassifierDLModel.pretrained("legclf_letter_agreement", "en", "legal/models")\
...
|------------------|-----------|--------|----------|---------|
| letter-agreement | 0.94      | 0.81   | 0.87     | 37      |
| other            | 0.91      | 0.97   | 0.94     | 69      |
| accuracy         | -         | -      | 0.92     | 106     |
