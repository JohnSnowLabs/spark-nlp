...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_separation_agreement_en_1.0.0_3.0_1669294576564.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_separation_agreement", "en", "legal/models")\
