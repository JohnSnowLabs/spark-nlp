---
layout: model
title: Legal Union Security Clause Binary Classifier
author: John Snow Labs
name: legclf_union_security_clause
date: 2022-12-07
tags: [en, legal, classification, clauses, union_security, licensed, tensorflow]
...
`union-security`, `other`

{:.btn-box}
<button class="button button-orange" disabled>Live Demo</button>
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_union_security_clause_en_1.0.0_3.0_1670431769653.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_union_security_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_union_security_clause|
