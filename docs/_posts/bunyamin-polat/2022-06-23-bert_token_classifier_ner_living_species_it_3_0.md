...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/bert_token_classifier_ner_living_species_it_3.5.3_3.0_1655971337011.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
ner_model = BertForTokenClassification.pretrained("bert_token_classifier_ner_living_species", "it", "clinical/models")\
...
val ner_model = BertForTokenClassification.pretrained("bert_token_classifier_ner_living_species", "it", "clinical/models")
