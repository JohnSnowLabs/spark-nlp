...
This model is a Bert-based model that can be used to classify Italian Swiss Judgement documents into the following 6 classes according to their case area. It has been trained with SOTA approach.
