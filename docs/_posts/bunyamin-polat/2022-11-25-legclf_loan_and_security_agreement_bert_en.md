...
The `legclf_loan_and_security_agreement_bert` model is a Bert Sentence Embeddings Document Classifier used to classify if the document belongs to the class `loan-and-security-agreement` or not (Binary Classification).
