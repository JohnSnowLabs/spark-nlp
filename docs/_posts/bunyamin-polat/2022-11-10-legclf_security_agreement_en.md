...
The `legclf_security_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `security-agreement` or not (Binary Classification).
