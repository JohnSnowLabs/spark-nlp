...
The `legclf_separation_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `separation-agreement` (check [Lawinsider](https://www.lawinsider.com/tags) for similar document type classification) or not (Binary Classification).
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_separation_agreement_en_1.0.0_3.0_1668593324129.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
doc_classifier = nlp.ClassifierDLModel.pretrained("legclf_separation_agreement", "en", "legal/models")\
...
|----------------------|-----------|--------|----------|---------|
| other                | 0.96      | 0.93   | 0.94     | 69      |
| separation-agreement | 0.87      | 0.92   | 0.89     | 36      |
| accuracy             | -         | -      | 0.92     | 105     |
