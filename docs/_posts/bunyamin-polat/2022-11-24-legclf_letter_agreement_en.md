...
name: legclf_letter_agreement
date: 2022-11-24
tags: [en, legal, classification, agreement, letter, licensed]
...
The `legclf_letter_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `letter-agreement` (check [Lawinsider](https://www.lawinsider.com/tags) for similar document type classification) or not (Binary Classification).
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_letter_agreement_en_1.0.0_3.0_1669292126317.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_letter_agreement_en_1.0.0_3.0_1669292126317.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
