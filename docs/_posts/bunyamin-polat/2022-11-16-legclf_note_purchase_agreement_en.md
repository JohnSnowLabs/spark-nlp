...
The `legclf_note_purchase_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `note-purchase-agreement` (check [Lawinsider](https://www.lawinsider.com/tags) for similar document type classification) or not (Binary Classification).
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_note_purchase_agreement_en_1.0.0_3.0_1668591070228.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
doc_classifier = nlp.ClassifierDLModel.pretrained("legclf_note_purchase_agreement", "en", "legal/models")\
...
|-------------------------|-----------|--------|----------|---------|
| note-purchase-agreement | 0.94      | 0.97   | 0.95     | 31      |
| other                   | 0.99      | 0.97   | 0.98     | 69      |
| accuracy                | -         | -      | 0.97     | 100     |
