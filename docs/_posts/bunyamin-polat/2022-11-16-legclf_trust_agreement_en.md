...
The `legclf_trust_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `trust-agreement` (check [Lawinsider](https://www.lawinsider.com/tags) for similar document type classification) or not (Binary Classification).
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_trust_agreement_en_1.0.0_3.0_1668594391102.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
doc_classifier = nlp.ClassifierDLModel.pretrained("legclf_trust_agreement", "en", "legal/models")\
...
|-----------------|-----------|--------|----------|---------|
| other           | 0.97      | 1.00   | 0.99     | 69      |
| trust-agreement | 1.00      | 0.95   | 0.97     | 40      |
| accuracy        | -         | -      | 0.98     | 109     |
