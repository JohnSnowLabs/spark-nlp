...
The `legclf_loan_and_security_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `loan-and-security-agreement` or not (Binary Classification).
