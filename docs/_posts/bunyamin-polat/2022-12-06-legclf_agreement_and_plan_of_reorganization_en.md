...
The `legclf_agreement_and_plan_of_reorganization` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `agreement-and-plan-of-reorganization` (check [Lawinsider](https://www.lawinsider.com/tags) for similar document type classification) or not (Binary Classification).
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_agreement_and_plan_of_reorganization_en_1.0.0_3.0_1670357495950.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_agreement_and_plan_of_reorganization", "en", "legal/models")\
