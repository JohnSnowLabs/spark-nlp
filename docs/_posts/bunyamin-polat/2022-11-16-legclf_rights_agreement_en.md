...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_rights_agreement_en_1.0.0_3.0_1668592048470.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
doc_classifier = nlp.ClassifierDLModel.pretrained("legclf_rights_agreement", "en", "legal/models")\
...
|------------------|-----------|--------|----------|---------|
| other            | 0.97      | 0.97   | 0.97     | 69      |
| rights-agreement | 0.94      | 0.94   | 0.94     | 34      |
| accuracy         | -         | -      | 0.96     | 103     |
