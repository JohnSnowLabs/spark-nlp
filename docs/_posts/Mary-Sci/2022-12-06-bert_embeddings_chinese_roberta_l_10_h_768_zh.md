...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_embeddings_chinese_roberta_l_10_h_768_zh_4.2.4_3.0_1670325770644.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_embeddings_chinese_roberta_l_10_h_768_zh_4.2.4_3.0_1670325770644.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("zh.embed.bert.10l_768d_768d").predict("""I love Spark NLP""")
```
