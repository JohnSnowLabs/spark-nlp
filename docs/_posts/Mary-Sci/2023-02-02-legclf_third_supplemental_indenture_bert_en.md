...
The `legclf_third_supplemental_indenture_bert` model is a Bert Sentence Embeddings Document Classifier used to classify if the document belongs to the class `third-supplemental-indenture` (check [Lawinsider](https://www.lawinsider.com/tags) for similar document type classification) or not (Binary Classification).
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_third_supplemental_indenture_bert_en_1.0.0_3.0_1675360680501.zip){:.button.button-orange}
