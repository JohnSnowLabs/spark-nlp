...
name: distilbert_embeddings_marathi_bert
date: 2022-12-08
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/distilbert_embeddings_marathi_bert_mr_4.2.4_3.0_1670504632287.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
bert_loaded = DistilBertEmbeddings.pretrained("distilbert_embeddings_marathi_bert","mr") \
...
val bert_loaded = DistilBertEmbeddings.pretrained("distilbert_embeddings_marathi_bert","mr") 
...
{:.table-model}
|---|---|
|Model Name:|distilbert_embeddings_marathi_bert|
