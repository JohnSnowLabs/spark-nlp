...
```python
sentence_embeddings = RoBertaEmbeddings.pretrained("roberta_base_danish_legal", "da")\
  .setInputCols(["sentence"])\
  .setOutputCol("embeddings")
```
```scala
val sentence_embeddings = RoBertaEmbeddings.pretrained("roberta_base_danish_legal", "da")
  .setInputCols("sentence")
  .setOutputCol("embeddings"))
```
</div>
