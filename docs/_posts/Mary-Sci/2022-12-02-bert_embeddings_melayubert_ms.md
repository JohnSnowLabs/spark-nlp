...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_embeddings_melayubert_ms_4.2.4_3.0_1670015457507.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("ms.embed.bert").predict("""I love Spark NLP""")
```
