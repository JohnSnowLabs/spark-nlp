...
```python
import nlu
nlu.load("ar.embed.bert.v2_large").predict("""I love Spark NLP""")
```
...
- /aubmindlab/bert-large-arabertv2/blob/main/(https://github.com/google-research/bert/blob/master/multilingual.md)
