...
name: distilbert_embeddings_javanese_bert_small
date: 2022-12-08
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/distilbert_embeddings_javanese_bert_small_jv_4.2.4_3.0_1670504556045.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
bert_loaded = DistilBertEmbeddings.pretrained("distilbert_embeddings_javanese_bert_small","jv") \
...
val bert_loaded = DistilBertEmbeddings.pretrained("distilbert_embeddings_javanese_bert_small","jv") 
...
{:.table-model}
|---|---|
|Model Name:|distilbert_embeddings_javanese_bert_small|
