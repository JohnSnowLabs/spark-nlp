...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_embeddings_minirbt_h256_zh_4.2.4_3.0_1670326879123.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("zh.embed.bert.mini").predict("""I love Spark NLP""")
```
