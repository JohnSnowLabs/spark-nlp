...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_embeddings_chinese_roberta_l_12_h_128_zh_4.2.4_3.0_1670325790515.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_embeddings_chinese_roberta_l_12_h_128_zh_4.2.4_3.0_1670325790515.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("zh.embed.bert.12l_128d_128d").predict("""I love Spark NLP""")
```
