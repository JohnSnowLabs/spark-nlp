...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_embeddings_javanese_small_imdb_jv_4.2.4_3.0_1670326764200.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_embeddings_javanese_small_imdb_jv_4.2.4_3.0_1670326764200.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("jv.embed.bert.imdb_javanese.small").predict("""I love Spark NLP""")
```
