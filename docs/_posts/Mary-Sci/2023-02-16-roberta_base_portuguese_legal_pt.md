...
```python
sentence_embeddings = RoBertaEmbeddings.pretrained("roberta_base_portuguese_legal", "pt")\
  .setInputCols(["sentence"])\
  .setOutputCol("embeddings")
```
```scala
val sentence_embeddings = RoBertaEmbeddings.pretrained("roberta_base_portuguese_legal", "pt")
  .setInputCols("sentence")
  .setOutputCol("embeddings"))
```
</div>
