...
```python
sentence_embeddings = RoBertaEmbeddings.pretrained("roberta_base_french_legal", "fr")\
  .setInputCols(["sentence"])\
  .setOutputCol("embeddings")
```
```scala
val sentence_embeddings = RoBertaEmbeddings.pretrained("roberta_base_french_legal", "fr")
  .setInputCols("sentence")
  .setOutputCol("embeddings"))
```
</div>
