...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_embeddings_kb_distilled_cased_sv_4.2.4_3.0_1670022547171.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_embeddings_kb_distilled_cased_sv_4.2.4_3.0_1670022547171.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("sv.embed.bert.distilled_cased").predict("""I love Spark NLP""")
```
