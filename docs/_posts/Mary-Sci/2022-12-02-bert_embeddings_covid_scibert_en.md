...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_embeddings_covid_scibert_en_4.2.4_3.0_1670014857338.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.embed.scibert.covid_scibert.").predict("""I love Spark NLP""")
```
