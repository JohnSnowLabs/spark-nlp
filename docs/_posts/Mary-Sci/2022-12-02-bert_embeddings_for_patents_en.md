...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_embeddings_for_patents_en_4.2.4_3.0_1670019529456.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.embed.bert.by_anferico").predict("""I love Spark NLP""")
```
