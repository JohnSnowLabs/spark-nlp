...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_embeddings_fa_base_uncased_fa_4.2.4_3.0_1670019389838.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("fa.embed.bert.uncased_base").predict("""I love Spark NLP""")
```
