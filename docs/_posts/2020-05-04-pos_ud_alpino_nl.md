...
```bash
[Row(annotatorType='pos', begin=0, end=6, result='SCONJ', metadata={'word': 'Behalve'}, embeddings=[]),
Row(annotatorType='pos', begin=8, end=10, result='SCONJ', metadata={'word': 'dat'}, embeddings=[]),
Row(annotatorType='pos', begin=12, end=14, result='PRON', metadata={'word': 'hij'}, embeddings=[]),
Row(annotatorType='pos', begin=16, end=17, result='DET', metadata={'word': 'de'}, embeddings=[]),
Row(annotatorType='pos', begin=19, end=24, result='NOUN', metadata={'word': 'koning'}, embeddings=[]),
...]
```
