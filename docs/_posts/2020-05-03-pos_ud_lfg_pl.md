...
```bash
[Row(annotatorType='pos', begin=0, end=5, result='ADP', metadata={'word': 'Oprócz'}, embeddings=[]),
Row(annotatorType='pos', begin=7, end=11, result='NOUN', metadata={'word': 'bycia'}, embeddings=[]),
Row(annotatorType='pos', begin=13, end=18, result='NOUN', metadata={'word': 'królem'}, embeddings=[]),
Row(annotatorType='pos', begin=20, end=26, result='NOUN', metadata={'word': 'północy'}, embeddings=[]),
Row(annotatorType='pos', begin=27, end=27, result='PUNCT', metadata={'word': ','}, embeddings=[]),
...]
```
