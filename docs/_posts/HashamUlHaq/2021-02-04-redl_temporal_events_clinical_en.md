...
name: redl_temporal_events_clinical
date: 2021-02-04
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/redl_temporal_events_clinical_en_2.7.3_2.4_1612437176601.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
re_model = RelationExtractionDLModel()\
    .pretrained('redl_temporal_events_clinical', 'en', "clinical/models") \
...
{:.table-model}
|---|---|
|Model Name:|redl_temporal_events_clinical|
