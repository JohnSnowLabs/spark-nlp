...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/ner_measurements_clinical_en_3.0.0_3.0_1617260795877.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
clinical_ner = MedicalNerModel.pretrained("ner_measurements_clinical", "en", "clinical/models")   .setInputCols(["sentence", "token", "embeddings"])   .setOutputCol("ner")
...
