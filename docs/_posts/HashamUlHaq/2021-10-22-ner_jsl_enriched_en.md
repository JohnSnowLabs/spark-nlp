...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/ner_jsl_enriched_en_3.3.0_3.0_1634865045033.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
```bash
Quality on validation dataset (20.0%), validation examples = 12991
time to finish evaluation: 639.42s
...
tp: 71581 fp: 9121 fn: 10180 labels: 162
Macro-average	 prec: 0.7729799, rec: 0.721845, f1: 0.7465378
Micro-average	 prec: 0.8869793, rec: 0.8754908, f1: 0.88119763
```