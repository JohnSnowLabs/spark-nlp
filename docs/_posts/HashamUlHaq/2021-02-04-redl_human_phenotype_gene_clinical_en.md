...
name: redl_human_phenotype_gene_clinical
date: 2021-02-04
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/redl_human_phenotype_gene_clinical_en_2.7.3_2.4_1612438676323.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
re_model = RelationExtractionDLModel()\
    .pretrained('redl_human_phenotype_gene_clinical', 'en', "clinical/models") \
...
{:.table-model}
|---|---|
|Model Name:|redl_human_phenotype_gene_clinical|
