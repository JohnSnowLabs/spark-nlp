...
clinical_ner = MedicalNerModel.pretrained("ner_jsl_enriched_biobert", "en", "clinical/models")   .setInputCols(["sentence", "token", "embeddings"])   .setOutputCol("ner")
...
...
val ner = MedicalNerModel.pretrained("ner_jsl_enriched_biobert", "en", "clinical/models")
