...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/sbert_jsl_tiny_umls_uncased_en_3.0.3_3.0_1621017145970.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
```bash
MedNLI Acc: 0.616, STS (cos): 0.632
```