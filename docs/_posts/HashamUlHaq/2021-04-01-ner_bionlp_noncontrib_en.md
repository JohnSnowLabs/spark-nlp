...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/ner_bionlp_noncontrib_en_3.0.0_3.0_1617260643725.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
clinical_ner = MedicalNerModel.pretrained("ner_bionlp_noncontrib", "en", "clinical/models")   .setInputCols(["sentence", "token", "embeddings"])   .setOutputCol("ner")
...
...
val ner = MedicalNerModel.pretrained("ner_bionlp_noncontrib", "en", "clinical/models")
...
{:.table-model}
|---|---|
|Model Name:|ner_bionlp_noncontrib|
