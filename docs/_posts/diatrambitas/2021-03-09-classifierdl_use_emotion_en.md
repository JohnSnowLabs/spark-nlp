...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/classifierdl_use_emotion_en_2.7.1_2.4_1615291325074.zip){:.button.button-orange.button-orange-trans.arr.button-icon}

## How to use

Use for extracting emotions form twitter data.
