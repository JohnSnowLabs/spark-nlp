...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/umls_clinical_drugs_mapping_en_4.0.0_3.0_1657281548490.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
```bash
+-----------------+----------------+-----------+-------------+--------------------+
|chunk            |umls_mapper     |chunks_fail|resolver_code|umls                |
+-----------------+----------------+-----------+-------------+--------------------+
|[Adapin, coumadn]|[C0728756, NONE]|[coumadn]  |[C0591275]   |[C0728756, C0591275]|
+-----------------+----------------+-----------+-------------+--------------------+
