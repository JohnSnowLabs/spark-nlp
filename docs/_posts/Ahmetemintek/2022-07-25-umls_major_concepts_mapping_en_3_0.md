---
layout: model
title: Clinical Major Concepts to UMLS Code Mapping
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/umls_major_concepts_mapping_en_4.0.0_3.0_1658736979238.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
|chunks                         |umls_code                     |
+-------------------------------+------------------------------+
|[pustules, stairs, Arthroscopy]|[C0241157, C4300351, C0179144]|
+-------------------------------+------------------------------+
```
