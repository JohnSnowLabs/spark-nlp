---
layout: model
title: Sentence Entity Resolver for ICD10-PCS (using sbiobert_base_cased_mli embeddings)
...
snomed_ct_resolver = SentenceEntityResolverModel.pretrained("sbiobertresolve_icd10pcs","en", "clinical/models") \
