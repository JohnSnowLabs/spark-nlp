...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legner_br_bert_large_pt_1.0.0_3.0_1664362018252.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legner_br_bert_large_pt_1.0.0_3.0_1664362018252.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
