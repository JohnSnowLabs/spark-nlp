...
name: legal_sequence_classifier_representations_clause
date: 2022-08-04
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legal_sequence_classifier_representations_clause_en_1.0.0_3.2_1659611406570.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
docClassifier = ClassifierDLModel().pretrained("legal_sequence_classifier_representations_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legal_sequence_classifier_representations_clause|
|Type:|legal|
...
```bash
          ...
          other       0.95      0.97      0.96       159
representations       0.94      0.87      0.90        69
