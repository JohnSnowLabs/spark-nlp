...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/finance/models/finclf_executives_item_en_1.0.0_3.2_1660154056048.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
docClassifier = ClassifierDLModel().pretrained("finclf_executives_item", "en", "finance/models")\
