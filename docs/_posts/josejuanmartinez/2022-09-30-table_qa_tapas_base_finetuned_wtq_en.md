---
layout: model
title: Google's Tapas Table Understanding (Base, WTQ)
author: John Snow Labs
name: table_qa_tapas_base_finetuned_wtq
date: 2022-09-30
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/table_qa_tapas_base_finetuned_wtq_en_4.2.0_3.0_1664530550311.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/table_qa_tapas_base_finetuned_wtq_en_4.2.0_3.0_1664530550311.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
{:.table-model}
|---|---|
|Model Name:|table_qa_tapas_base_finetuned_wtq|
