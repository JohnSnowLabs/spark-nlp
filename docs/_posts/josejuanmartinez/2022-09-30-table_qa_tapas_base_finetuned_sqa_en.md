---
layout: model
title: Google's Tapas Table Understanding (Base, SQA)
author: John Snow Labs
name: table_qa_tapas_base_finetuned_sqa
date: 2022-09-30
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/table_qa_tapas_base_finetuned_sqa_en_4.2.0_3.0_1664530865349.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/table_qa_tapas_base_finetuned_sqa_en_4.2.0_3.0_1664530865349.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.answer_question.tapas.sqa.base_finetuned").predict("""
{
  "header": ["name", "money", "age"],
  "rows": [
    ["Donald Trump", "$100,000,000", "75"],
