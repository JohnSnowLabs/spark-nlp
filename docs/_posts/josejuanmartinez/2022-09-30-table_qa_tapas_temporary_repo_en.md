---
layout: model
title: Lysandre's Tapas Table Understanding (Base)
author: John Snow Labs
name: table_qa_tapas_temporary_repo
date: 2022-09-30
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/table_qa_tapas_temporary_repo_en_4.2.0_3.0_1664530579779.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/table_qa_tapas_temporary_repo_en_4.2.0_3.0_1664530579779.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
tapas = TapasForQuestionAnswering\
    .pretrained("table_qa_tapas_temporary_repo","en")\
...
```python
import nlu
nlu.load("en.answer_question.tapas.by_uploaded by huggingface").predict("""
{
  "header": ["name", "money", "age"],
  "rows": [
    ["Donald Trump", "$100,000,000", "75"],
...
{:.table-model}
|---|---|
|Model Name:|table_qa_tapas_temporary_repo|
