...
name: finclf_lt_bert_sentiment_analysis
date: 2022-10-22
tags: [en, legal, classification, sentiment, analysis, licensed]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/finance/models/finclf_lt_bert_sentiment_analysis_en_1.0.0_3.0_1666475172536.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
sequenceClassifier_loaded = finance.BertForSequenceClassification.pretrained("finclf_lt_bert_sentiment_analysis", "lt", "finance/models")\
...
{:.table-model}
|---|---|
|Model Name:|finclf_lt_bert_sentiment_analysis|
