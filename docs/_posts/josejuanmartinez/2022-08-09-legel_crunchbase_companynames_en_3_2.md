...
```python
from johnsnowlabs.extensions.legal.chunk_classification.resolution import SentenceEntityResolverModel
...
resolver = SentenceEntityResolverModel.pretrained("legel_crunchbase_companynames", "en", "legal/models") \
