...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/finance/models/finance_sequence_classifier_esg_en_1.0.0_3.2_1659539747409.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
sequenceClassifier = FinancialBertForSequenceClassification.pretrained("finance_sequence_classifier_esg", "en", "finance/models"))\
