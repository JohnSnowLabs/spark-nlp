...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legner_bert_base_courts_de_1.0.0_3.2_1660046909660.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
ner_model = LegalBertForTokenClassification.pretrained("legner_bert_base_courts", "de", "legal/models")\
