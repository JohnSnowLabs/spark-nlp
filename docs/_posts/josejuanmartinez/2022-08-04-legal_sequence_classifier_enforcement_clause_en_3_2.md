...
name: legal_sequence_classifier_enforcement_clause
date: 2022-08-04
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legal_sequence_classifier_enforcement_clause_en_1.0.0_3.2_1659609300490.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
docClassifier = ClassifierDLModel().pretrained("legal_sequence_classifier_enforcement_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legal_sequence_classifier_enforcement_clause|
|Type:|legal|
