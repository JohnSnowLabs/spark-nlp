---
layout: model
title: Legal Lease agreement Document Binary Classifier
author: John Snow Labs
name: legclf_lease_agreement_document
date: 2022-10-21
...
The `legclf_lease_agreement_document` model is a Legal Longformer Document Classifier to classify if the document belongs to the class lease-agreement (check [Lawinsider](https://www.lawinsider.com/tags) for similar document type classification) or not (Binary Classification).
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_lease_agreement_document_en_1.0.0_3.0_1666368646071.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
docClassifier = ClassifierDLModel.pretrained("legclf_lease_agreement_document", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_lease_agreement_document|
...
lease-agreement       0.93      0.98      0.95        43
