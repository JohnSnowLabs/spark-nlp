...
name: finance_sequence_classifier_bank_complaints
date: 2022-08-05
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/finance/models/finance_sequence_classifier_bank_complaints_en_1.0.0_3.2_1659711386425.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
classsifier_dl = ClassifierDLModel.load("complaint_classification_use_final")\
...
{:.table-model}
|---|---|
|Model Name:|finance_sequence_classifier_bank_complaints|
|Type:|finance|
