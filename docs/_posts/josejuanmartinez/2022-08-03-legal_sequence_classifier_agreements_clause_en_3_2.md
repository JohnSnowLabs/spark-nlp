...
name: legal_sequence_classifier_agreements_clause
date: 2022-08-03
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legal_sequence_classifier_agreements_clause_en_1.0.0_3.2_1659543494075.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
docClassifier = ClassifierDLModel().pretrained("legal_sequence_classifier_agreements_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legal_sequence_classifier_agreements_clause|
|Type:|legal|
...
Propietary legal documents annotated in-house
...
```bash
  ...
  agreements       0.81      0.72      0.76       120
       other       0.88      0.92      0.90       274

    accuracy                           0.86       394
   macro avg       0.85      0.82      0.83       394
