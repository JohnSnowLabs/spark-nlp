...
date: 2022-11-23
tags: [summary, summarization, eo, licensed]
task: Summarization
language: eo
...
This model is a Financial news Summarizer, trained maximize the probability of retrieving the smallest headers / captions from Financial news.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/finance/models/finsum_news_lg_spark_nlp_eo_1.0.0_3.0_1669208192131.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
In-house financial news dataset.