...
name: finclf_classifier_augmented_esg
date: 2022-08-09
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/finance/models/finclf_classifier_augmented_esg_en_1.0.0_3.2_1660045809069.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
{:.table-model}
|---|---|
|Model Name:|finclf_classifier_augmented_esg|
