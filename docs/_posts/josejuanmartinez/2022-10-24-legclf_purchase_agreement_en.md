---
layout: model
title: Legal Purchase agreement Document Classifier (Longformer)
author: John Snow Labs
name: legclf_purchase_agreement
date: 2022-10-24
...
The `legclf_purchase_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class purchase-agreement (check [Lawinsider](https://www.lawinsider.com/tags) for similar document type classification) or not (Binary Classification).
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_purchase_agreement_en_1.0.0_3.0_1666621006686.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_purchase_agreement_en_1.0.0_3.0_1666621006686.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
