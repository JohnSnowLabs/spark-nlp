---
layout: model
title: ESG Text Classification (Augmented)
author: John Snow Labs
name: finance_sequence_classifier_augmented_esg
date: 2022-08-03
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/finance/models/finance_sequence_classifier_augmented_esg_en_1.0.0_3.2_1659539687882.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
{:.table-model}
|---|---|
|Model Name:|finance_sequence_classifier_augmented_esg|
|Type:|finance|
