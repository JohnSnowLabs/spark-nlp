---
layout: model
title: Legal Lease agreement Document Classifier (Longformer)
author: John Snow Labs
name: legclf_lease_agreement
date: 2022-10-24
...
The `legclf_lease_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class lease-agreement (check [Lawinsider](https://www.lawinsider.com/tags) for similar document type classification) or not (Binary Classification).
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_lease_agreement_en_1.0.0_3.0_1666620984031.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_lease_agreement_en_1.0.0_3.0_1666620984031.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_lease_agreement", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_lease_agreement|
