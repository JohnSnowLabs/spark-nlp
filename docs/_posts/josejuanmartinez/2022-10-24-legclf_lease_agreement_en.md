...
The `legclf_lease_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class lease-agreement or not (Binary Classification).
