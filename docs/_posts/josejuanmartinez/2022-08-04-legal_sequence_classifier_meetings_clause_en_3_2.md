...
name: legal_sequence_classifier_meetings_clause
date: 2022-08-04
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legal_sequence_classifier_meetings_clause_en_1.0.0_3.2_1659611171712.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
docClassifier = ClassifierDLModel().pretrained("legal_sequence_classifier_meetings_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legal_sequence_classifier_meetings_clause|
|Type:|legal|
