...
The `legclf_service_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class service-agreement or not (Binary Classification).
