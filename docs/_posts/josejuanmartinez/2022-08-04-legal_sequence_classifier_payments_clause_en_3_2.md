...
name: legal_sequence_classifier_payments_clause
date: 2022-08-04
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legal_sequence_classifier_payments_clause_en_1.0.0_3.2_1659611262219.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
docClassifier = ClassifierDLModel().pretrained("legal_sequence_classifier_payments_clause", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legal_sequence_classifier_payments_clause|
|Type:|legal|
...
```bash
       ...
       other       0.94      0.93      0.93       260
    payments       0.86      0.89      0.88       134

    accuracy                           0.91       394
   macro avg       0.90      0.91      0.90       394
