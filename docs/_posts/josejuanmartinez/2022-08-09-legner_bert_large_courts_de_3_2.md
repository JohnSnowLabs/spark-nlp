...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legner_bert_large_courts_de_1.0.0_3.2_1660056373355.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
ner_model = BertForTokenClassifier.pretrained("legner_bert_large_courts", "de", "legal/models")\
