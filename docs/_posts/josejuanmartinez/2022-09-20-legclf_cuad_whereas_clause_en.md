---
layout: model
title: Legal Whereas Clause Binary Classifier (CUAD dataset)
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_cuad_whereas_clause_en_1.0.0_3.2_1663693211440.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
docClassifier = legal.ClassifierDLModel.pretrained("legclf_whereas_clause", "en", "legal/models")\
