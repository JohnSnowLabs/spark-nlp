...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/finance/models/finclf_work_experience_item_en_1.0.0_3.0_1667398321847.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
```bash
          ...
          other       0.97      0.95      0.96       132
work_experience       0.82      0.89      0.85        36

       accuracy                           0.93       168
      macro avg       0.89      0.92      0.91       168
