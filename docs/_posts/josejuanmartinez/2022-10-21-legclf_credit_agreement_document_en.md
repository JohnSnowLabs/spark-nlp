---
layout: model
title: Legal Credit agreement Document Binary Classifier
author: John Snow Labs
name: legclf_credit_agreement_document
date: 2022-10-21
...
The `legclf_credit_agreement_document` model is a Legal Longformer Document Classifier to classify if the document belongs to the class credit-agreement (check [Lawinsider](https://www.lawinsider.com/tags) for similar document type classification) or not (Binary Classification).
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_credit_agreement_document_en_1.0.0_3.0_1666368631293.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
docClassifier = ClassifierDLModel.pretrained("legclf_credit_agreement_document", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_credit_agreement_document|
...
credit-agreement       0.97      1.00      0.99        33
