...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/table_qa_tapas_small_finetuned_wikisql_supervised_en_4.2.0_3.0_1664530735482.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/table_qa_tapas_small_finetuned_wikisql_supervised_en_4.2.0_3.0_1664530735482.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.answer_question.tapas.wikisql.small_finetuned").predict("""
{
  "header": ["name", "money", "age"],
  "rows": [
    ["Donald Trump", "$100,000,000", "75"],
