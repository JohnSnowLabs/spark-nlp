...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_embeddings_muril_adapted_local_pa_3.4.2_3.0_1649674956785.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("pa.embed.muril_adapted_local").predict("""ਮੈਨੂੰ ਸਪਾਰਕ ਐਨਐਲਪੀ ਪਸੰਦ ਹੈ""")
```
