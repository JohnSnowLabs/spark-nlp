---
layout: model
title: Japanese Bert Embeddings (Base, Character Tokenization, v2)
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_embeddings_bert_base_japanese_char_v2_ja_3.4.2_3.0_1649674322814.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("ja.embed.bert_base_japanese_char_v2").predict("""私はSpark NLPを愛しています""")
```
