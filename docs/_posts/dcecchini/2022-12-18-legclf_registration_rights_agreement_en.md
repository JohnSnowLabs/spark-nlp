...
The `legclf_registration_rights_agreement` model is a Longformer Document Classifier used to classify if the document belongs to the class `registration-rights-agreement` or not (Binary Classification).
