...
The `legclf_management_agreement` model is a Longformer Document Classifier used to classify if the document belongs to the class `management-agreement` or not (Binary Classification).
