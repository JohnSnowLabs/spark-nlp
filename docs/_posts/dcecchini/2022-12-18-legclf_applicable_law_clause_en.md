...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_applicable_law_clause_en_1.0.0_3.0_1671391316336.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
|---------------:|------------:|---------:|-----------:|----------:|
| applicable-law |        1.00 |     1.00 |          1 |        28 |
|          other |        1.00 |     1.00 |          1 |        39 |
|       accuracy |           - |        - |          1 |        67 |
|      macro-avg |        1.00 |     1.00 |          1 |        67 |
|   weighted-avg |        1.00 |     1.00 |          1 |        67 |
```