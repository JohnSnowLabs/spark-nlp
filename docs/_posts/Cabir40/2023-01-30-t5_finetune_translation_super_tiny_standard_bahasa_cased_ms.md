...
name: t5_finetune_translation_super_tiny_standard_bahasa_cased
date: 2023-01-30
...
t5 = T5Transformer.pretrained("t5_finetune_translation_super_tiny_standard_bahasa_cased","ms") \
...
val t5 = T5Transformer.pretrained("t5_finetune_translation_super_tiny_standard_bahasa_cased","ms") 
    .setInputCols("document")
    .setOutputCol("answers")
...
{:.table-model}
|---|---|
|Model Name:|t5_finetune_translation_super_tiny_standard_bahasa_cased|
