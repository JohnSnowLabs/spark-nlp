...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/ner_sdoh_mentions_test_en_4.2.3_3.0_1671404339484.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/clinical/models/ner_sdoh_mentions_test_en_4.2.3_3.0_1671404339484.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
ner_model = MedicalNerModel.pretrained("ner_sdoh_mentions_test", "en", "clinical/models")\
...
val embeddings = WordEmbeddingsModel.pretrained("embeddings_clinical", "en", "clinical/models")
    ...
    .setOutputCol("embeddings")
val ner_model = MedicalNerModel.pretrained("ner_sdoh_mentions_test", "en", "clinical/models")
...
{:.table-model}
|---|---|
|Model Name:|ner_sdoh_mentions_test|
