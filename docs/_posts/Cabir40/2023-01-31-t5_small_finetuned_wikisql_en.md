...
t5 = T5Transformer.pretrained("t5_small_finetuned_wikisql","en") \
...
val t5 = T5Transformer.pretrained("t5_small_finetuned_wikisql","en") 
    .setInputCols("document")
    .setOutputCol("answers")
...
{:.table-model}
|---|---|
|Model Name:|t5_small_finetuned_wikisql|
