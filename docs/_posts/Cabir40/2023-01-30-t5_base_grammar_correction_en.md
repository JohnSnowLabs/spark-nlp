...
t5 = T5Transformer.pretrained("t5_base_grammar_correction","en") \
...
val t5 = T5Transformer.pretrained("t5_base_grammar_correction","en") 
    .setInputCols("document")
    .setOutputCol("answers")
...
{:.table-model}
|---|---|
|Model Name:|t5_base_grammar_correction|
