...
```python
import nlu
nlu.load("en.answer_question.bert.squadv2.based_only_classfn_epochs_1_shard_1_squad2.by_AnonymousSub").predict("""What is my name?|||"My name is Clara and I live in Berkeley.""")
```
