---
layout: model
title: Spanish Electra Word Embeddings Base model (from mrm8488)
...
Pretrained Word Embeddings model, adapted from Hugging Face and curated to provide scalability and production-readiness using Spark NLP. `legalectra-base-spanish` is a English model originally trained by `mrm8488`.
