---
layout: model
title: English DistilBertForQuestionAnswering model (from machine2049) Squad
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/distilbert_qa_machine2049_base_uncased_finetuned_squad_en_4.0.0_3.0_1654725871586.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
spanClassifier = DistilBertForQuestionAnswering.pretrained("distilbert_qa_machine2049_base_uncased_finetuned_squad","en") \
...
val spanClassifer = DistilBertForQuestionAnswering.pretrained("distilbert_qa_machine2049_base_uncased_finetuned_squad","en") 
