...
name: bert_classifier_dehatebert_mono_italian
date: 2022-09-07
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_classifier_dehatebert_mono_italian_it_4.1.0_3.0_1662512212735.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_dehatebert_mono_italian_it_4.1.0_3.0_1662512212735.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
val seq_classifier = BertForSequenceClassification.pretrained("bert_classifier_dehatebert_mono_italian","it")
...
```python
import nlu
nlu.load("it.classify.bert.hate.").predict("""PUT YOUR STRING HERE""")
```
