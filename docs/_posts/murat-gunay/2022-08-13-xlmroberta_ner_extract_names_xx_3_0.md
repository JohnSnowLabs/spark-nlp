...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_extract_names_xx_4.1.0_3.0_1660422227464.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("xx.ner.xlmr_roberta").predict("""PUT YOUR STRING HERE""")
```
