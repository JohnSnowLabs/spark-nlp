...
name: roberta_classifier_minilm_l12_clinc_distilled
date: 2022-09-19
...
Pretrained RoBertaForSequenceClassification model, adapted from Hugging Face and curated to provide scalability and production-readiness using Spark NLP. `MiniLM-L12-clinc-distilled` is a English model originally trained by `moshew`.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_classifier_minilm_l12_clinc_distilled_en_4.1.0_3.0_1663603711905.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_classifier_minilm_l12_clinc_distilled_en_4.1.0_3.0_1663603711905.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
seq_classifier = RoBertaForSequenceClassification.pretrained("roberta_classifier_minilm_l12_clinc_distilled","en") \
...
val seq_classifier = RoBertaForSequenceClassification.pretrained("roberta_classifier_minilm_l12_clinc_distilled","en")
...
```python
import nlu
nlu.load("en.classify.roberta.distilled_mini_lm_mini").predict("""PUT YOUR STRING HERE""")
```
...
{:.table-model}
|---|---|
|Model Name:|roberta_classifier_minilm_l12_clinc_distilled|
...
- https://huggingface.co/moshew/MiniLM-L12-clinc-distilled