...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_ner_codebert_base_finetuned_stackoverflow_en_4.0.0_3.0_1658212367861.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.ner.roberta.base_finetuned").predict("""PUT YOUR STRING HERE.""")
```
