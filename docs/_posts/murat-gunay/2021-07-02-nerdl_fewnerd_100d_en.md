...
date: 2021-07-02
tags: [ner, en, fewnerd, open_source]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/nerdl_fewnerd_100d_en_3.1.1_3.0_1625219664546.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
Few-NERD (inter) data set is used for training. | https://arxiv.org/abs/2105.07464
