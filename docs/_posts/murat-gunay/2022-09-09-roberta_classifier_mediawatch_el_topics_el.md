...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_classifier_mediawatch_el_topics_el_4.1.0_3.0_1662764469221.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("el.classify.roberta").predict("""PUT YOUR STRING HERE""")
```
