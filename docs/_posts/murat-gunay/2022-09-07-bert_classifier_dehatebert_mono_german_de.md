...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_dehatebert_mono_german_de_4.1.0_3.0_1662512147961.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("de.classify.bert.hate.").predict("""PUT YOUR STRING HERE""")
```
