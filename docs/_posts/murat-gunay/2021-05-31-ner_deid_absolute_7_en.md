---
layout: model
title: Detect PHI for Deidentification (Absolute, 7 labels)
author: John Snow Labs
name: ner_deid_absolute_7
date: 2021-05-31
tags: [ner, clinical, licensed, deid, en]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/ner_deid_absolute_7_en_3.0.3_3.0_1622498191812.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
deid7_absolute_ner = MedicalNerModel.pretrained("ner_deid_absolute_7", "en", "clinical/models") \
...
nlpPipeline = Pipeline(stages=[document_assembler, sentence_detector, tokenizer, word_embeddings, deid7_absolute_ner, ner_converter])
...
val deid7_absolute_ner = MedicalNerModel.pretrained("ner_deid_absolute_7", "en", "clinical/models") \
...
val nlpPipeline = new Pipeline().setStages(Array(document_assembler, sentence_detector, tokenizer, word_embeddings, deid7_absolute_ner, ner_converter))
model = nlpPipeline.fit(spark.createDataFrame([[""]]).toDF("text"))
...
{:.table-model}
|---|---|
|Model Name:|ner_deid_absolute_7|
