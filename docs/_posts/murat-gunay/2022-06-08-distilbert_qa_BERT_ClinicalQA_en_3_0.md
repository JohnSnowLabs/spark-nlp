...
Pretrained Question Answering model, adapted from Hugging Face and curated to provide scalability and production-readiness using Spark NLP. `BERT-ClinicalQA` is a English model orginally trained by `exafluence`.

{:.btn-box}
<button class="button button-orange" disabled>Live Demo</button>
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/distilbert_qa_BERT_ClinicalQA_en_3.4.4_3.0_1654722853170.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
