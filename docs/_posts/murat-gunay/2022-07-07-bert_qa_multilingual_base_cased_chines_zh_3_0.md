...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_qa_multilingual_base_cased_chines_zh_4.0.0_3.0_1657190418828.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_qa_multilingual_base_cased_chines_zh_4.0.0_3.0_1657190418828.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
spanClassifier = BertForQuestionAnswering.pretrained("bert_qa_multilingual_base_cased_chines","zh") \
...
val spanClassifer = BertForQuestionAnswering.pretrained("bert_qa_multilingual_base_cased_chines","zh") 
...
```python
import nlu
nlu.load("zh.answer_question.bert.cased_multilingual_base").predict("""PUT YOUR QUESTION HERE|||"PUT YOUR CONTEXT HERE""")
```
