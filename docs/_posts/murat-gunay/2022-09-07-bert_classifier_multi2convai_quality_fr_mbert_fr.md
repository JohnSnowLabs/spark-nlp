...
name: bert_classifier_multi2convai_quality_fr_mbert
date: 2022-09-07
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_classifier_multi2convai_quality_fr_mbert_fr_4.1.0_3.0_1662514263434.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_multi2convai_quality_fr_mbert_fr_4.1.0_3.0_1662514263434.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
seq_classifier = BertForSequenceClassification.pretrained("bert_classifier_multi2convai_quality_fr_mbert","fr") \
...
val seq_classifier = BertForSequenceClassification.pretrained("bert_classifier_multi2convai_quality_fr_mbert","fr")
...
```python
import nlu
nlu.load("fr.classify.bert.multi2convai.v2.by_inovex").predict("""PUT YOUR STRING HERE""")
```
...
{:.table-model}
|---|---|
|Model Name:|bert_classifier_multi2convai_quality_fr_mbert|
