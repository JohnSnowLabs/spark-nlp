...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_mubikan_base_finetuned_panx_de_4.1.0_3.0_1660435528174.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_mubikan_base_finetuned_panx_de_4.1.0_3.0_1660435528174.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
token_classifier = XlmRoBertaForTokenClassification.pretrained("xlmroberta_ner_mubikan_base_finetuned_panx","de") \
...
val token_classifier = XlmRoBertaForTokenClassification.pretrained("xlmroberta_ner_mubikan_base_finetuned_panx","de")
...
```python
import nlu
nlu.load("de.ner.xlmr_roberta.xtreme.base_finetuned.by_mubikan").predict("""PUT YOUR STRING HERE""")
```
