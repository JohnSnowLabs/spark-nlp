...
Pretrained Question Answering model, adapted from Hugging Face and curated to provide scalability and production-readiness using Spark NLP. `distilbert-base-cased-distilled-squad-finetuned-squad-test` is a English model orginally trained by `ncduy`.

{:.btn-box}
<button class="button button-orange" disabled>Live Demo</button>
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/distilbert_qa_base_cased_distilled_squad_finetuned_squad_test_en_3.4.4_3.0_1654723644873.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
