...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/electra_classifier_ko_base_v3_generalized_sentiment_analysis_ko_4.1.0_3.0_1663179743566.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("ko.classify.electra.sentiment.base").predict("""PUT YOUR STRING HERE""")
```
