...
name: roberta_classifier_large_finetuned_clinc_1234
date: 2022-09-19
...
Pretrained RoBertaForSequenceClassification model, adapted from Hugging Face and curated to provide scalability and production-readiness using Spark NLP. `roberta-large-finetuned-clinc-1234` is a English model originally trained by `lewtun`.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_classifier_large_finetuned_clinc_1234_en_4.1.0_3.0_1663612732160.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_classifier_large_finetuned_clinc_1234_en_4.1.0_3.0_1663612732160.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
seq_classifier = RoBertaForSequenceClassification.pretrained("roberta_classifier_large_finetuned_clinc_1234","en") \
...
val seq_classifier = RoBertaForSequenceClassification.pretrained("roberta_classifier_large_finetuned_clinc_1234","en") 
...
```python
import nlu
nlu.load("en.classify.roberta.clinc.v5large_finetuned.by_lewtun").predict("""PUT YOUR STRING HERE""")
```
...
{:.table-model}
|---|---|
|Model Name:|roberta_classifier_large_finetuned_clinc_1234|
...
- https://huggingface.co/lewtun/roberta-large-finetuned-clinc-1234