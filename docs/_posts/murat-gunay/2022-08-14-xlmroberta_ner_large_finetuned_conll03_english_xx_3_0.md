...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_large_finetuned_conll03_english_xx_4.1.0_3.0_1660453726099.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("xx.ner.xlmr_roberta.conll.large_finetuned").predict("""PUT YOUR STRING HERE""")
```
