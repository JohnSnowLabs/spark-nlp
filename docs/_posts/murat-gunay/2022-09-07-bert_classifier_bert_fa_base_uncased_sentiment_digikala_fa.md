...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_bert_fa_base_uncased_sentiment_digikala_fa_4.1.0_3.0_1662509883523.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("fa.classify.bert.sentiment.digikala.uncased_base.by_HooshvareLab").predict("""PUT YOUR STRING HERE""")
```
