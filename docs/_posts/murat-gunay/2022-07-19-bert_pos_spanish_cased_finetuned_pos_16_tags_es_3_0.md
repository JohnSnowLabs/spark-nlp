...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_pos_spanish_cased_finetuned_pos_16_tags_es_4.0.0_3.0_1658249425886.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("es.ner.pos.cased_finetuned.by_mrm8488").predict("""PUT YOUR STRING HERE.""")
```
