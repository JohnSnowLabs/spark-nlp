...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_bert_large_cased_finetuned_wnli_en_4.1.0_3.0_1662510546301.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.classify.bert.wnli_glue.cased_large_finetuned").predict("""PUT YOUR STRING HERE""")
```
