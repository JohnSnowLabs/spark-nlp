...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_classifier_base_ca_te_cased_ca_4.1.0_3.0_1662765506070.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("ca.classify.roberta.cased_base.te.by_projecte_aina").predict("""PUT YOUR STRING HERE""")
```
