...
```python
import nlu
nlu.load("en.answer_question.bert.squadv2.based_hier_triplet_epochs_1_shard_1_kldiv_squad2.by_AnonymousSub").predict("""What is my name?|||"My name is Clara and I live in Berkeley.""")
```
