---
layout: model
title: Named Entity Recognition (NER) Model in Swedish (GloVe 6B 300)
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/swedish_ner_6B_300_sv_2.6.0_2.4_1598810268071.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/swedish_ner_6B_300_sv_2.6.0_2.4_1598810268071.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
ner_model = NerDLModel.pretrained("swedish_ner_6B_300", "sv") \
...
.setOutputCol("embeddings")
val ner_model = NerDLModel.pretrained("swedish_ner_6B_300", "sv")
...
ner_df = nlu.load('sv.ner.6B_300').predict(text, output_level = "chunk")
...
{:.h2_title}
## Data Source
Trained on a custom dataset with multi-lingual GloVe Embeddings ``glove_6B_300``.