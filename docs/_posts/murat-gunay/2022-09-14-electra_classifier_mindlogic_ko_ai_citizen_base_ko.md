...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/electra_classifier_mindlogic_ko_ai_citizen_base_ko_4.1.0_3.0_1663180096137.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("ko.classify.electra.base.by_mindlogic").predict("""PUT YOUR STRING HERE""")
```
