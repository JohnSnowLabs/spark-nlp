...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_classifier_readability_es_3class_sentences_es_4.1.0_3.0_1662764976252.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("es.classify.3class_sentences.roberta.by_hackathon_pln_es").predict("""PUT YOUR STRING HERE""")
```
