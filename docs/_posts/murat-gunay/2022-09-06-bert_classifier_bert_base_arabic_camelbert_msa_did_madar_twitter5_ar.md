...
name: bert_classifier_bert_base_arabic_camelbert_msa_did_madar_twitter5
date: 2022-09-06
...
Pretrained BertForSequenceClassification model, adapted from Hugging Face and curated to provide scalability and production-readiness using Spark NLP. `bert-base-arabic-camelbert-msa-did-madar-twitter5` is a Arabic model originally trained by `CAMeL-Lab`.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_classifier_bert_base_arabic_camelbert_msa_did_madar_twitter5_ar_4.1.0_3.0_1662507576293.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_bert_base_arabic_camelbert_msa_did_madar_twitter5_ar_4.1.0_3.0_1662507576293.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
