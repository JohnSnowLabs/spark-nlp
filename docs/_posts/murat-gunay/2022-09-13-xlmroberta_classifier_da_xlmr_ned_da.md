...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/xlmroberta_classifier_da_xlmr_ned_da_4.1.0_3.0_1663063060545.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("da.classify.xlmr_roberta").predict("""PUT YOUR STRING HERE""")
```
