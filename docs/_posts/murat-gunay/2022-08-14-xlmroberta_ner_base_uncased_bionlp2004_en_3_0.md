...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_base_uncased_bionlp2004_en_4.1.0_3.0_1660450173301.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_base_uncased_bionlp2004_en_4.1.0_3.0_1660450173301.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
token_classifier = XlmRoBertaForTokenClassification.pretrained("xlmroberta_ner_base_uncased_bionlp2004","en") \
...
val token_classifier = XlmRoBertaForTokenClassification.pretrained("xlmroberta_ner_base_uncased_bionlp2004","en") 
...
```python
import nlu
nlu.load("en.ner.xlmr_roberta.bionlp2004.uncased_base.by_tner").predict("""PUT YOUR STRING HERE""")
```
