...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_base_finetuned_luganda_finetuned_luganda_lg_4.1.0_3.0_1660426976430.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/xlmroberta_ner_base_finetuned_luganda_finetuned_luganda_lg_4.1.0_3.0_1660426976430.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
token_classifier = XlmRoBertaForTokenClassification.pretrained("xlmroberta_ner_base_finetuned_luganda_finetuned_luganda","lg") \
...
val token_classifier = XlmRoBertaForTokenClassification.pretrained("xlmroberta_ner_base_finetuned_luganda_finetuned_luganda","lg") 
...
```python
import nlu
nlu.load("lg.ner.xlmr_roberta.base_finetuned_luganda.by_mbeukman").predict("""PUT YOUR STRING HERE""")
```
...
{:.table-model}
|---|---|
|Model Name:|xlmroberta_ner_base_finetuned_luganda_finetuned_luganda|
