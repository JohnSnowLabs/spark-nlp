...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_classifier_multi2convai_quality_de_4.1.0_3.0_1662514060710.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_multi2convai_quality_de_4.1.0_3.0_1662514060710.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
seq_classifier = BertForSequenceClassification.pretrained("bert_classifier_multi2convai_quality","de") \
...
val seq_classifier = BertForSequenceClassification.pretrained("bert_classifier_multi2convai_quality","de")
...
```python
import nlu
nlu.load("de.classify.quality.bert.multi2convai.by_inovex").predict("""PUT YOUR STRING HERE""")
```
