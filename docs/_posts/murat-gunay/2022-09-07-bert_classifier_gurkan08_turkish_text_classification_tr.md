...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_gurkan08_turkish_text_classification_tr_4.1.0_3.0_1662511032569.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("tr.classify.bert.by_gurkan08").predict("""PUT YOUR STRING HERE""")
```
