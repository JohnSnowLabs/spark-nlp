...
```bash
[Row(annotatorType='pos', begin=0, end=1, result='ADP', metadata={'word': 'În'}, embeddings=[]),
Row(annotatorType='pos', begin=3, end=7, result='ADV', metadata={'word': 'afară'}, embeddings=[]),
Row(annotatorType='pos', begin=9, end=10, result='ADP', metadata={'word': 'de'}, embeddings=[]),
Row(annotatorType='pos', begin=12, end=12, result='PART', metadata={'word': 'a'}, embeddings=[]),
Row(annotatorType='pos', begin=14, end=15, result='AUX', metadata={'word': 'fi'}, embeddings=[]),
...]
```
