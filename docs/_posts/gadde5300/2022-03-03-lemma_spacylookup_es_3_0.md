...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_spacylookup_es_3.4.1_3.0_1646316590883.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("es.lemma").predict("""No eres mejor que yo""")
```
