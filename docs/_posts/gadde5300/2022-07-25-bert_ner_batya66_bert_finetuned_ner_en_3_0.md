---
layout: model
title: English BertForTokenClassification Cased model (from batya66)
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_ner_batya66_bert_finetuned_ner_en_4.1.0_3.0_1658750858074.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_ner_batya66_bert_finetuned_ner_en_4.1.0_3.0_1658750858074.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.ner.bert.conll.finetuned.by_batya66").predict("""PUT YOUR STRING HERE""")
```
