...
name: roberta_qa_deepset_roberta_base_squad2
date: 2022-06-20
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_qa_deepset_roberta_base_squad2_en_4.0.0_3.0_1655734936057.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
spanClassifier = RoBertaForQuestionAnswering.pretrained("roberta_qa_deepset_roberta_base_squad2","en") \
...
val spanClassifier = RoBertaForQuestionAnswering
  .pretrained("roberta_qa_deepset_roberta_base_squad2","en")
...
{:.table-model}
|---|---|
|Model Name:|roberta_qa_deepset_roberta_base_squad2|
