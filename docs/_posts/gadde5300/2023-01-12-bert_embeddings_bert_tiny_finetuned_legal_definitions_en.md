...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_embeddings_bert_tiny_finetuned_legal_definitions_en_4.2.7_3.0_1673544317347.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.embed.bert.tiny_finetuned_legal").predict("""I love Spark NLP""")
```
