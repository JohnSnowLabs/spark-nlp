...
name: bert_ner_bert_finetuned_ner_swedish_test
date: 2022-08-02
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_ner_bert_finetuned_ner_swedish_test_sv_4.1.0_3.0_1659423309960.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_ner_bert_finetuned_ner_swedish_test_sv_4.1.0_3.0_1659423309960.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("sv.ner.bert.finetuned").predict("""Jag �lskar Spark NLP""")
```
