...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/camembert_classifier_est_roberta_hist_ner_et_4.2.0_3.0_1664084330209.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("et.ner.camembert").predict("""Ma armastan s�det nlp""")
```
