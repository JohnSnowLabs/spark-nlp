...
date: 2022-11-24
tags: [en, legal, subcontracting, classification, clauses, licensed, open_source]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/legclf_subcontracting_clause_en_1.0.0_3.0_1669312298719.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_subcontracting_clause", "en", "legal/models")\
