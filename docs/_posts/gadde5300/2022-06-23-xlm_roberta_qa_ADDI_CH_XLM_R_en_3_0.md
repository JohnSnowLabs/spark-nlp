...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/xlm_roberta_qa_ADDI_CH_XLM_R_en_4.0.0_3.0_1655978341187.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
spanClassifier = XlmRoBertaForQuestionAnswering.pretrained("xlm_roberta_qa_ADDI_CH_XLM_R","en") \
...
val spanClassifier = XlmRoBertaForQuestionAnswering
  .pretrained("xlm_roberta_qa_ADDI_CH_XLM_R","en")
