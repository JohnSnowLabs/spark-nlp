...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_pos_veganuary_pos_ca_4.1.0_3.0_1660143116501.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("ca.ner.pos.universal_dependencies.").predict("""M'encanta la Spark NLP""")
```
