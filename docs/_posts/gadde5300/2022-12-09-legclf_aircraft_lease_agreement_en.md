...
The `legclf_aircraft_lease_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `aircraft-lease-agreement` (check [Lawinsider](https://www.lawinsider.com/tags) for similar document type classification) or not (Binary Classification).
...
`aircraft-lease-agreement`, `other`

{:.btn-box}
<button class="button button-orange" disabled>Live Demo</button>
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_aircraft_lease_agreement_en_1.0.0_3.0_1670579287218.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_aircraft_lease_agreement_en_1.0.0_3.0_1670579287218.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_aircraft_lease_agreement", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_aircraft_lease_agreement|
...
aircraft-lease-agreement       1.00      0.96      0.98        27
