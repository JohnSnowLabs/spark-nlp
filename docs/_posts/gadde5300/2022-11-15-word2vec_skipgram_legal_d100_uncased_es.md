...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/word2vec_skipgram_legal_d100_uncased_es_4.2.1_3.0_1668537410459.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("es.embed.legal.skipgram.uncased_d100").predict("""Put your text here.""")
```
