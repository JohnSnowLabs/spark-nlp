...
date: 2024-12-06
tags: [bert, embeddings, en, financial, open_source, tensorflow]
task: Embeddings
language: en
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_embeddings_sec_bert_base_en_5.5.1_3.4_1733495760969.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_embeddings_sec_bert_base_en_5.5.1_3.4_1733495760969.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
