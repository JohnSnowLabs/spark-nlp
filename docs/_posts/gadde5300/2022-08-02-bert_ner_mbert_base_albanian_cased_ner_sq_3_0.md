...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_ner_mbert_base_albanian_cased_ner_sq_4.1.0_3.0_1659459345977.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_ner_mbert_base_albanian_cased_ner_sq_4.1.0_3.0_1659459345977.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("sq.ner.bert.cased_base").predict("""E dua shk�ndij�n nlp""")
```
