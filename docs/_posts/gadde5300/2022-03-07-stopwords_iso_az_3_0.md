---
layout: model
title: Stopwords Remover for Azerbaijani language (140 entries)
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/stopwords_iso_az_3.4.1_3.0_1646672362326.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
```python
import nlu
nlu.load("az.stopwords").predict("""Sən məndən yaxşı deyilsən""")
```
