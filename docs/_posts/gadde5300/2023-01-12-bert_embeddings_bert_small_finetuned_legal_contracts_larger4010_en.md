---
layout: model
title: English Legal BERT Embedding Small Uncased model(Uncased)
...
```python
import nlu
nlu.load("en.embed.bert.contracts.large_small_finetuned_legal.by_muhtasham").predict("""I love Spark NLP""")
```
