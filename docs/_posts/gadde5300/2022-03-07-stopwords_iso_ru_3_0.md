---
layout: model
title: Stopwords Remover for Russian language (stopwords-iso)
author: John Snow Labs
name: stopwords_iso
date: 2022-03-07
tags: [stopwords, ru, open_source]
task: Lemmatization
language: ru
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/stopwords_iso_ru_3.4.1_3.0_1646665589701.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
stop_words = StopWordsCleaner.pretrained("stopwords_iso","ru") \
    .setInputCols(["token"]) \
...
val lemmatizer = StopWordsCleaner.pretrained("stopwords_iso","ru") 
