---
layout: model
title: Stopwords Remover for Thai language (1006 entries)
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/stopwords_iso_th_3.4.1_3.0_1646673180836.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("th.stopwords").predict("""Put your text here.""")
```
