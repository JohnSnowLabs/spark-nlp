...
Pretrained RobertaForTokenClassification model, adapted from Hugging Face and curated to provide scalability and production-readiness using Spark NLP. `roberta-base-bne-capitel-pos` is a Spanish model originally trained by `BSC-TeMU`.

{:.btn-box}
<button class="button button-orange" disabled>Live Demo</button>
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_pos_veganuary_pos_es_4.1.0_3.0_1660143097991.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
- https://huggingface.co/BSC-TeMU/roberta-base-bne-capitel-pos
