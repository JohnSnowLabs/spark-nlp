...
The `legclf_exchange_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class exchange-agreement or not (Binary Classification).
