...
name: jurisbert_class_tratados_internacionales_sistema_universal
date: 2022-05-20
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/jurisbert_class_tratados_internacionales_sistema_universal_es_3.4.4_3.0_1653047495920.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
tokenClassifier = RoBertaForTokenClassification.pretrained("jurisbert_class_tratados_internacionales_sistema_universal","es") \
...
val tokenClassifier = RoBertaForTokenClassification.pretrained("jurisbert_class_tratados_internacionales_sistema_universal","es") 
...
{:.table-model}
|---|---|
|Model Name:|jurisbert_class_tratados_internacionales_sistema_universal|
