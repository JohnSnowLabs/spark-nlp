...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_ner_bert_mention_fr_vera_pro_fr_4.1.0_3.0_1659426270005.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("fr.ner.bert").predict("""J'adore Spark NLP""")
```
