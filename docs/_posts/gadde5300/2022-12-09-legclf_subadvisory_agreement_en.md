...
The `legclf_subadvisory_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `subadvisory-agreement` or not (Binary Classification).
