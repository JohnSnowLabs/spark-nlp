...
The `legclf_subadvisory_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `subadvisory-agreement` (check [Lawinsider](https://www.lawinsider.com/tags) for similar document type classification) or not (Binary Classification).
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_subadvisory_agreement_en_1.0.0_3.0_1670579448932.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_subadvisory_agreement_en_1.0.0_3.0_1670579448932.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_subadvisory_agreement", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_subadvisory_agreement|
...
```bash
                ...
                other      0.94   0.96      0.95       76
subadvisory-agreement      0.87   0.80      0.83       25
             accuracy         -      -      0.92      101
