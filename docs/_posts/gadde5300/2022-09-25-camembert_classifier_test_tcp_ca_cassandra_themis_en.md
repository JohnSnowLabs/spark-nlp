---
layout: model
title: English CamembertForTokenClassification Cased model (from cassandra-themis)
author: John Snow Labs
name: camembert_classifier_test_tcp_ca_cassandra_themis
date: 2022-09-25
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/camembert_classifier_test_tcp_ca_cassandra_themis_en_4.2.0_3.0_1664084359983.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/camembert_classifier_test_tcp_ca_cassandra_themis_en_4.2.0_3.0_1664084359983.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
