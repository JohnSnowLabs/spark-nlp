...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_qa_loodos_bert_base_uncased_QA_fine_tuned_tr_4.0.0_3.0_1654188187941.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("tr.answer_question.bert.base_uncased").predict("""What's my name?|||"My name is Clara and I live in Berkeley.""")
```
