---
layout: model
title: English BertForTokenClassification Cased model (from eduardopds)
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_ner_eduardopds_bert_finetuned_ner_en_4.1.0_3.0_1658750941194.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_ner_eduardopds_bert_finetuned_ner_en_4.1.0_3.0_1658750941194.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.ner.bert.finetuned.by_eduardopds").predict("""PUT YOUR STRING HERE""")
```
