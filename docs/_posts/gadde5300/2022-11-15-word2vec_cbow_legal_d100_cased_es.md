...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/word2vec_cbow_legal_d100_cased_es_4.2.1_3.0_1668534200139.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("es.embed.legal.cbow.cased_d100").predict("""Put your text here.""")
```
