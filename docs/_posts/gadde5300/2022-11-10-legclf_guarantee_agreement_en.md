...
The `legclf_guarantee_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class guarantee-agreement or not (Binary Classification).
