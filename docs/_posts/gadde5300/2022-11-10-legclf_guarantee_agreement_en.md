---
layout: model
title: Legal Guarantee Agreement Document Classifier (Longformer)
author: John Snow Labs
name: legclf_guarantee_agreement
date: 2022-11-10
...
The `legclf_guarantee_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class guarantee-agreement (check [Lawinsider](https://www.lawinsider.com/tags) for similar document type classification) or not (Binary Classification).
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_guarantee_agreement", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_guarantee_agreement|
