...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_nb_large_user_needs_nb_4.2.0_3.0_1663668274042.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("nb.classify.bert.large").predict("""PUT YOUR STRING HERE""")
```
