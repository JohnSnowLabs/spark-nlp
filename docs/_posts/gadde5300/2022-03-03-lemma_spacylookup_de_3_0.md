...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_spacylookup_de_3.4.1_3.0_1646316522910.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("de.lemma").predict("""Du bist nicht besser als ich""")
```
