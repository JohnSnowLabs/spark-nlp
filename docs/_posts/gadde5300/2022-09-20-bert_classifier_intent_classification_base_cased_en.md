---
layout: model
title: English BertForSequenceClassification Base Cased model (from dipesh)
author: John Snow Labs
name: bert_classifier_intent_classification_base_cased
date: 2022-09-20
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_classifier_intent_classification_base_cased_en_4.2.0_3.0_1663666883820.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_intent_classification_base_cased_en_4.2.0_3.0_1663666883820.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
