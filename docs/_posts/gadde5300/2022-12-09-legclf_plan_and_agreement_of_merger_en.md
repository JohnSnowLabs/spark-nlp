...
The `legclf_plan_and_agreement_of_merger` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `plan-and-agreement-of-merger` or not (Binary Classification).
