...
The `legclf_plan_and_agreement_of_merger` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `plan-and-agreement-of-merger` (check [Lawinsider](https://www.lawinsider.com/tags) for similar document type classification) or not (Binary Classification).
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_plan_and_agreement_of_merger_en_1.0.0_3.0_1670582465777.zip){:.button.button-orange.button-orange-trans.arr.button-icon.hidden}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/legal/models/legclf_plan_and_agreement_of_merger_en_1.0.0_3.0_1670582465777.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_plan_and_agreement_of_merger", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_plan_and_agreement_of_merger|
...
plan-and-agreement-of-merger       1.00      0.93      0.96        28
                    accuracy          -         -      0.98        93
