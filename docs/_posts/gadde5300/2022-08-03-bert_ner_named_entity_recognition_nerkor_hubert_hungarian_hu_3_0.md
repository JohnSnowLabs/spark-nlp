...
name: bert_ner_named_entity_recognition_nerkor_hubert_hungarian
date: 2022-08-03
...
tokenClassifier = BertForTokenClassification.pretrained("bert_ner_named_entity_recognition_nerkor_hubert_hungarian","hu") \
...
val tokenClassifier = BertForTokenClassification.pretrained("bert_ner_named_entity_recognition_nerkor_hubert_hungarian","hu") 
...
```python
import nlu
nlu.load("hu.ner.bert").predict("""Szeretem a Spark NLP -t""")
```
...
{:.table-model}
|---|---|
|Model Name:|bert_ner_named_entity_recognition_nerkor_hubert_hungarian|
