...
The `legclf_custody_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `custody-agreement` or not (Binary Classification).
