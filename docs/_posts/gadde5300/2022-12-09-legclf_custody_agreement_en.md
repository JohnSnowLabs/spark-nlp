---
layout: model
title: Legal Custody Agreement Clause Binary Classifier (Longformer)
author: John Snow Labs
name: legclf_custody_agreement
date: 2022-12-09
...
The `legclf_custody_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `custody-agreement` (check [Lawinsider](https://www.lawinsider.com/tags) for similar document type classification) or not (Binary Classification).
...
doc_classifier = legal.ClassifierDLModel.pretrained("legclf_custody_agreement", "en", "legal/models")\
...
{:.table-model}
|---|---|
|Model Name:|legclf_custody_agreement|
