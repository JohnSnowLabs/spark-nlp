...
The `legclf_administrative_services_agreement_bert` model is a Bert Sentence Embeddings Document Classifier used to classify if the document belongs to the class `administrative-services-agreement` or not (Binary Classification).
