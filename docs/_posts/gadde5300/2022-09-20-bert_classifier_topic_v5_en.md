---
layout: model
title: English BertForSequenceClassification Cased model (from slowturtle)
author: John Snow Labs
name: bert_classifier_topic_v5
date: 2022-09-20
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_classifier_topic_v5_en_4.2.0_3.0_1663668798108.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_classifier_topic_v5_en_4.2.0_3.0_1663668798108.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
