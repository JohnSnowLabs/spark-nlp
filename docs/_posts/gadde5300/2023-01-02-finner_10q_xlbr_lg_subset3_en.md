...
name: finner_10q_xlbr_lg_subset3
date: 2023-01-02
...
`EquityMethodInvestments`, `AcquiredFiniteLivedIntangibleAssetsWeightedAverageUsefulLife`, `BusinessAcquisitionPercentageOfVotingInterestsAcquired`, `NumberOfRealEstateProperties`, `PropertyPlantAndEquipmentUsefulLife`, `DerivativeNotionalAmount`, `FiniteLivedIntangibleAssetUsefulLife`, `AreaOfRealEstateProperty`, `EquityMethodInvestmentOwnershipPercentage`, `Goodwill`, `OperatingLeaseRightOfUseAsset`, `CashAndCashEquivalentsFairValueDisclosure`, `OperatingLossCarryforwards`

{:.btn-box}
<button class="button button-orange" disabled>Live Demo</button>
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/finance/models/finner_10q_xlbr_lg_subset3_en_1.0.0_3.0_1672635873911.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
nerTagger = finance.NerModel.pretrained('finner_10q_xlbr_lg_subset3', 'en', 'finance/models')\
...
{:.table-model}
|---|---|
|Model Name:|finner_10q_xlbr_lg_subset3|
