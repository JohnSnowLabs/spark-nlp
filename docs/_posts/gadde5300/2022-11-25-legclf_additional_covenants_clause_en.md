...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_additional_covenants_clause_en_1.0.0_3.0_1669350524399.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_additional_covenants_clause", "en", "legal/models")\
...
additional-covenants       0.95      0.83      0.89        24
