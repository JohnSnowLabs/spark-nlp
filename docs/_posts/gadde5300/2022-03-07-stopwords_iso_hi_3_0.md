...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/stopwords_iso_hi_3.4.1_3.0_1646672942184.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("hi.stopwords").predict("""तुम मुझसे बेहतर नहीं हो""")
```
