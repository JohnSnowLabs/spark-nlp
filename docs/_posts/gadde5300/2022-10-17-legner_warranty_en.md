...
data = spark.createDataFrame([["The Company represents, warrants and agrees with HOC as of the date of this Agreement"]]).toDF("text")
...
|chunk                          |entity                  |
+-------------------------------+------------------------+
|The Company                    |WARRANTY_SUBJECT        |
|represents, warrants and agrees|WARRANTY_ACTION         |
|HOC                            |WARRANTY_INDIRECT_OBJECT|
+-------------------------------+------------------------+
