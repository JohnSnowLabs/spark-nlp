...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_limitation_clause_en_1.0.0_3.0_1669358384894.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_limitation_clause", "en", "legal/models")\
...
```bash
  ...
  limitation       0.79      0.92      0.85        24
       other       0.97      0.92      0.94        73

    accuracy                           0.92        97
   macro avg       0.88      0.92      0.89        97
weighted avg       0.93      0.92      0.92        97
