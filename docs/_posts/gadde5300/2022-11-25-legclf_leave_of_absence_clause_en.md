...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/legal/models/legclf_leave_of_absence_clause_en_1.0.0_3.0_1669348902613.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
docClassifier = nlp.ClassifierDLModel.pretrained("legclf_leave_of_absence_clause", "en", "legal/models")\
...
leave-of-absence       1.00      0.93      0.96        29
