---
layout: model
title: Stopwords Remover for Hebrew language (226 entries)
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/stopwords_iso_he_3.4.1_3.0_1646673023597.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("he.stopwords").predict("""אתה לא יותר טוב ממני""")
```
