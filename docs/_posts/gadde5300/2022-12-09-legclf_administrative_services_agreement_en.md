...
The `legclf_administrative_services_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `administrative-services-agreement` or not (Binary Classification).
