...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_pos_bert_base_dutch_cased_upos_alpino_frisian_xx_4.0.0_3.0_1657887714690.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("xx.ner.pos.cased_base").predict("""PUT YOUR STRING HERE""")
```
