...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_qa_Neulvo_bert_finetuned_squad_en_4.0.0_3.0_1654535543683.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_qa_Neulvo_bert_finetuned_squad_en_4.0.0_3.0_1654535543683.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.answer_question.squad.bert.by_Neulvo").predict("""What's my name?|||"My name is Clara and I live in Berkeley.""")
```
