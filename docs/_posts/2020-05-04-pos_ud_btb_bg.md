...
```bash
[Row(annotatorType='pos', begin=0, end=4, result='ADP', metadata={'word': 'Освен'}, embeddings=[]),
Row(annotatorType='pos', begin=6, end=7, result='SCONJ', metadata={'word': 'че'}, embeddings=[]),
Row(annotatorType='pos', begin=9, end=9, result='AUX', metadata={'word': 'е'}, embeddings=[]),
Row(annotatorType='pos', begin=11, end=14, result='VERB', metadata={'word': 'крал'}, embeddings=[]),
Row(annotatorType='pos', begin=16, end=17, result='ADP', metadata={'word': 'на'}, embeddings=[]),
...]
```
