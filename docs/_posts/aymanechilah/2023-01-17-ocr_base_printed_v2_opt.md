...
Ocr base printed model v2 optimized with ONNX for recognise printed text based on Tesseract architecture and printed datasets.
...
[Open in Colab](https://colab.research.google.com/github/JohnSnowLabs/spark-ocr-workshop/blob/master/tutorials/Cards/SparkOcrImageToTextPrinted_V2_opt.ipynb){:.button.button-orange.button-orange-trans.co.button-icon}
...
val ocr = ImageToTextOnnx.
  pretrained("ocr_base_printed_v2_opt")
...
val r = Benchmark.time("Using ocr_base_printed_v2_opt",true) {
