...
```bash
[Row(annotatorType='pos', begin=0, end=5, result='ADV', metadata={'word': 'Además'}, embeddings=[]),
...
Row(annotatorType='pos', begin=17, end=19, result='NOUN', metadata={'word': 'rey'}, embeddings=[]),
...]
```
