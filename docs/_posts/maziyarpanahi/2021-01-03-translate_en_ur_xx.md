...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/translate_en_ur_xx_2.7.0_2.4_1609690466742.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
translate_df = nlu.load('xx.en.translate_to.ur').predict(text, output_level='sentence')
translate_df
```
