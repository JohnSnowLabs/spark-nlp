...
Pretrained Lemmatizer model (`lemma_icepahc`) trained on Universal Dependencies 2.9 (UD_Icelandic-IcePaHC) in Icelandic language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_icepahc_is_3.4.3_3.0_1651416736423.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("is.lemma").predict("""I love Spark NLP""")
```
