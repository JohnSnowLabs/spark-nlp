...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_nynorsklia_no_3.4.3_3.0_1651419705677.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("no.pos.nynorsklia").predict("""I love Spark NLP""")
```
