...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_csui_id_3.4.3_3.0_1651419771222.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_csui", "id")\ 
...
val pos = PerceptronModel.pretrained("pos_csui", "id")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("id.pos").predict("""I love Spark NLP""")
```
