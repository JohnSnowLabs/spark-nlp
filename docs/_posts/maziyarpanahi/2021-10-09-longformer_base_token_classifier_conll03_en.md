...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/longformer_base_token_classifier_conll03_en_3.3.0_3.0_1633777793851.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.classify.token_longformer.base_token_classifier_conll03").predict("""My name is John!""")
```
