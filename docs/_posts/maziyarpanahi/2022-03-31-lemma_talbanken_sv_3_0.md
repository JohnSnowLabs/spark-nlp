---
layout: model
title: Lemma UD model for Swedish (lemma_talbanken)
author: John Snow Labs
name: lemma_talbanken
date: 2022-03-31
...
Pretrained Lemmatizer model (`lemma_talbanken`) trained on Universal Dependencies 2.9 (UD_Swedish-Talbanken) in Swedish language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_talbanken_sv_3.4.3_3.0_1648738614567.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_talbanken_sv_3.4.3_3.0_1648738614567.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("sv.lemma.talbanken").predict("""I love Spark NLP""")
```
