...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_sst_sl_3.4.3_3.0_1651419815057.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_sst", "sl")\ 
...
val pos = PerceptronModel.pretrained("pos_sst", "sl")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("sl.pos").predict("""I love Spark NLP""")
```
