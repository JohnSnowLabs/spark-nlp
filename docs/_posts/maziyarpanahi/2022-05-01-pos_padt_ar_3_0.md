...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_padt_ar_3.4.3_3.0_1651419694672.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_padt", "ar")\ 
...
val pos = PerceptronModel.pretrained("pos_padt", "ar")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("ar.pos").predict("""I love Spark NLP""")
```
