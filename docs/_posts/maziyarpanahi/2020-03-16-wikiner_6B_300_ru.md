---
layout: model
title: Detect Persons, Locations, Organizations and Misc Entities in Russian (WikiNER 6B 300)
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/wikiner_6B_300_ru_2.4.4_2.4_1584014001694.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
ner_model = NerDLModel.pretrained("wikiner_6B_300", "ru") \
...
.setOutputCol("embeddings")
val ner_model = NerDLModel.pretrained("wikiner_6B_300", "ru")
...
ner_df = nlu.load('ru.ner.wikiner.glove.6B_300').predict(text, output_level = "chunk")
