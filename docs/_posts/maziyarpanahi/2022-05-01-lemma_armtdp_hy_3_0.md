...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_armtdp_hy_3.4.3_3.0_1651416747978.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("hy.lemma").predict("""I love Spark NLP""")
```
