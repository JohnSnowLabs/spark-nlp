---
layout: model
title: Lemma UD model for Turkish (lemma_boun)
...
Pretrained Lemmatizer model (`lemma_boun`) trained on Universal Dependencies 2.9 (UD_Turkish-BOUN) in Turkish language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_boun_tr_3.4.3_3.0_1648738620401.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_boun_tr_3.4.3_3.0_1648738620401.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("tr.lemma.boun").predict("""I love Spark NLP""")
```
