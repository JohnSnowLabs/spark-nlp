...
Pretrained Lemmatizer model (`lemma_lines`) trained on Universal Dependencies 2.9 (UD_Swedish-LinES) in Swedish language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_lines_sv_3.4.3_3.0_1651416695889.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("sv.lemma").predict("""I love Spark NLP""")
```
