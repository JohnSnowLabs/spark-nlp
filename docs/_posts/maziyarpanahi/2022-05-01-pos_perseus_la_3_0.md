...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_perseus_la_3.4.3_3.0_1651419661766.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_perseus", "la")\ 
...
val pos = PerceptronModel.pretrained("pos_perseus", "la")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("la.pos").predict("""I love Spark NLP""")
```
