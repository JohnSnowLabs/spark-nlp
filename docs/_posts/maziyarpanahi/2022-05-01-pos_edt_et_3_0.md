...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_edt_et_3.4.3_3.0_1651419847997.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_edt", "et")\ 
...
val pos = PerceptronModel.pretrained("pos_edt", "et")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("et.pos").predict("""I love Spark NLP""")
```
