...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_partut_it_3.4.3_3.0_1651419596094.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_partut", "it")\ 
...
val pos = PerceptronModel.pretrained("pos_partut", "it")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("it.pos").predict("""I love Spark NLP""")
```
