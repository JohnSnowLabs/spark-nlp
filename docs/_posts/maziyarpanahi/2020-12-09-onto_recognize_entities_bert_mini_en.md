---
layout: model
title: Recognize Entities OntoNotes - BERT Mini
...
A pre-trained pipeline containing NerDl Model. The NER model trained on OntoNotes 5.0 with `small_bert_L4_256` embeddings. It can extract up to following 18 entities:
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/onto_recognize_entities_bert_mini_en_2.7.0_2.4_1607510918214.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/onto_recognize_entities_bert_mini_en_2.7.0_2.4_1607510918214.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
