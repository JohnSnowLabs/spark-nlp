...
Pretrained Lemmatizer model (`lemma_proiel`) trained on Universal Dependencies 2.9 (UD_Latin-PROIEL) in Latin language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_proiel_la_3.4.3_3.0_1651416580158.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("la.lemma").predict("""I love Spark NLP""")
```
