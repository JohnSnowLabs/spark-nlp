---
layout: model
title: Lemma UD model for Slavic (lemma_rnc)
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_rnc_orv_3.4.3_3.0_1648738437096.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_rnc_orv_3.4.3_3.0_1648738437096.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("orv.lemma.rnc").predict("""I love Spark NLP""")
```
