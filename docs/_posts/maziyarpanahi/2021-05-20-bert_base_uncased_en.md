---
layout: model
title: English BERT Embeddings (Base Uncased)
author: John Snow Labs
name: bert_base_uncased
date: 2021-05-20
tags: [en, english, bert, embeddings, open_source]
task: Embeddings
language: en
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/bert_base_uncased_en_3.1.0_3.0_1621517239949.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
text = ["I love NLP"]
embeddings_df = nlu.load('en.embed.bert.base_uncased').predict(text, output_level='token')
embeddings_df
```
</div>
