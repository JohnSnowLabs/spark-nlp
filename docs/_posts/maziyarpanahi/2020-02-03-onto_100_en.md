---
layout: model
title: Detect Entities (Onto 100)
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/onto_100_en_2.4.0_2.4_1579729071672.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
ner_df = nlu.load('en.ner.onto.glove.6B_100d').predict(text, output_level = "chunk")
