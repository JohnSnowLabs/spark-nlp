...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_twittiro_it_3.4.3_3.0_1651419672529.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_twittiro", "it")\ 
...
val pos = PerceptronModel.pretrained("pos_twittiro", "it")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("it.pos.twittiro").predict("""I love Spark NLP""")
```
