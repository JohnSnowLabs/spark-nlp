...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_imst_tr_3.4.3_3.0_1651419639715.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_imst", "tr")\ 
...
val pos = PerceptronModel.pretrained("pos_imst", "tr")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("tr.pos.imst").predict("""I love Spark NLP""")
```
