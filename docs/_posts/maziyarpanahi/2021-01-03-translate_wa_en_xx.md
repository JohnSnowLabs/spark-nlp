...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/translate_wa_en_xx_2.7.0_2.4_1609690770769.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
translate_df = nlu.load('xx.wa.translate_to.en').predict(text, output_level='sentence')
translate_df
```
