...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/asr_xls_r_test_gpu_hi_4.2.0_3.0_1664091040801.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
speech_to_text = Wav2Vec2ForCTC \
    .pretrained("asr_xls_r_test_gpu", "hi")\
...
nlu.load("hi.speech2text.wav2vec_xlsr.gpu.by_priyajay").predict("ngm_12484_01067234848.wav")
```
