...
Pretrained Lemmatizer model (`lemma_armtdp`) trained on Universal Dependencies 2.9 (UD_Armenian-ArmTDP) in Armenian language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_armtdp_hyw_3.4.3_3.0_1651416811654.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("hyw.lemma").predict("""I love Spark NLP""")
```
