...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/deberta_v3_small_sequence_classifier_imdb_en_3.4.3_3.0_1649511772003.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.classify.sentiment.imdb.deberta.small").predict("""I really liked that movie!""")
```
