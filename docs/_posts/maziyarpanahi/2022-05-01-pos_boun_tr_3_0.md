...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_boun_tr_3.4.3_3.0_1651419837079.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_boun", "tr")\ 
...
val pos = PerceptronModel.pretrained("pos_boun", "tr")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("tr.pos").predict("""I love Spark NLP""")
```
