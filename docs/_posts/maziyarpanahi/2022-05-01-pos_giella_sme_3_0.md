...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_giella_sme_3.4.3_3.0_1651419902419.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_giella", "sme")\ 
...
val pos = PerceptronModel.pretrained("pos_giella", "sme")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("sme.pos").predict("""I love Spark NLP""")
```
