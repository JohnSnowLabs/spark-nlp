---
layout: model
title: Lemma UD model for Japanese (lemma_gsd)
...
Pretrained Lemmatizer model (`lemma_gsd`) trained on Universal Dependencies 2.9 (UD_Japanese-GSD) in Japanese language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_gsd_ja_3.4.3_3.0_1648738626230.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_gsd_ja_3.4.3_3.0_1648738626230.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("ja.lemma.gsd").predict("""I love Spark NLP""")
```
