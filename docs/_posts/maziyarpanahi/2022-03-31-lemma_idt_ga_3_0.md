---
layout: model
title: Lemma UD model for Irish (lemma_idt)
author: John Snow Labs
name: lemma_idt
date: 2022-03-31
tags: [open_source, universal_dependency, lemmatizer, ga, irish]
task: Lemmatization
language: ga
...
Pretrained Lemmatizer model (`lemma_idt`) trained on Universal Dependencies 2.9 (UD_Irish-IDT) in Irish language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_idt_ga_3.4.3_3.0_1648738767302.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_idt_ga_3.4.3_3.0_1648738767302.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("ga.lemma.idt").predict("""I love Spark NLP""")
```
