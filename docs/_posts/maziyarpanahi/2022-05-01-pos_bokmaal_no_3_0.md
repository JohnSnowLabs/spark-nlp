...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_bokmaal_no_3.4.3_3.0_1651419519905.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_bokmaal", "no")\ 
...
val pos = PerceptronModel.pretrained("pos_bokmaal", "no")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("no.pos").predict("""I love Spark NLP""")
```
