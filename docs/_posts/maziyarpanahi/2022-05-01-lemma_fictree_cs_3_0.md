...
Pretrained Lemmatizer model (`lemma_fictree`) trained on Universal Dependencies 2.9 (UD_Czech-FicTree) in Czech language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_fictree_cs_3.4.3_3.0_1651429171950.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("cs.lemma.fictree").predict("""I love Spark NLP""")
```
