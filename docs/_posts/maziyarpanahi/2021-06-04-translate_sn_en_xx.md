...
date: 2021-06-04
tags: [open_source, pipeline, seq2seq, translation, sn, en, xx, multilingual]
task: Translation
language: xx
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/translate_sn_en_xx_3.1.0_2.4_1622843357285.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/translate_sn_en_xx_3.1.0_2.4_1622843357285.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
translate_df = nlu.load('xx.Shona.translate_to.English').predict(text, output_level='sentence')
translate_df
```
</div>
