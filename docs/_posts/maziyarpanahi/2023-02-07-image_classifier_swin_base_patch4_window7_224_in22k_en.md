...
imageClassifier = SwinForImageClassification.pretrained("image_classifier_swin_base_patch4_window7_224_in22k", "en")    .setInputCols("image_assembler")     .setOutputCol("class")
