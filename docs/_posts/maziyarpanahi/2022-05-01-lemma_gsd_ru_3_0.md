...
Pretrained Lemmatizer model (`lemma_gsd`) trained on Universal Dependencies 2.9 (UD_Russian-GSD) in Russian language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_gsd_ru_3.4.3_3.0_1651416771086.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("ru.lemma").predict("""I love Spark NLP""")
```
