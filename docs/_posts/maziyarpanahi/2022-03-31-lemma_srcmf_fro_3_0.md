---
layout: model
title: Lemma UD model for French (lemma_srcmf)
author: John Snow Labs
name: lemma_srcmf
date: 2022-03-31
tags: [open_source, universal_dependency, lemmatizer, fro, french]
task: Lemmatization
language: fro
...
Pretrained Lemmatizer model (`lemma_srcmf`) trained on Universal Dependencies 2.9 (UD_French-SRCMF) in French language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_srcmf_fro_3.4.3_3.0_1648738643798.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_srcmf_fro_3.4.3_3.0_1648738643798.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("fro.lemma").predict("""I love Spark NLP""")
```
