---
layout: model
title: Part of Speech UD model for Afrikaans (pos_afribooms)
author: John Snow Labs
name: pos_afribooms
date: 2022-04-01
tags: [open_source, universal_dependency, pos, part_of_speech, af, afrikaans]
...
Pretrained Part of Speech model (`pos_afribooms`) trained on Universal Dependencies 2.9 (UD_Afrikaans-AfriBooms) in Afrikaans language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/pos_afribooms_af_3.4.3_3.0_1648798118656.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_afribooms_af_3.4.3_3.0_1648798118656.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("af.pos").predict("""I love Spark NLP""")
```
