...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_gsd_zh_3.4.3_3.0_1651419793207.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_gsd", "zh")\ 
...
val pos = PerceptronModel.pretrained("pos_gsd", "zh")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("zh.pos.gsd").predict("""I love Spark NLP""")
```
