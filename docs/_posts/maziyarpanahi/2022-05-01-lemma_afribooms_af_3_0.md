...
Pretrained Lemmatizer model (`lemma_afribooms`) trained on Universal Dependencies 2.9 (UD_Afrikaans-AfriBooms) in Afrikaans language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_afribooms_af_3.4.3_3.0_1651416765342.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("af.lemma.afribooms").predict("""I love Spark NLP""")
```
