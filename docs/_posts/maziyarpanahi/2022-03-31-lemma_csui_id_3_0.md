---
layout: model
title: Lemma UD model for Indonesian (lemma_csui)
...
Pretrained Lemmatizer model (`lemma_csui`) trained on Universal Dependencies 2.9 (UD_Indonesian-CSUI) in Indonesian language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_csui_id_3.4.3_3.0_1648738448860.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_csui_id_3.4.3_3.0_1648738448860.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("id.lemma.csui").predict("""I love Spark NLP""")
```
