---
layout: model
title: Lemma UD model for Italian (lemma_partut)
...
Pretrained Lemmatizer model (`lemma_partut`) trained on Universal Dependencies 2.9 (UD_Italian-ParTUT) in Italian language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_partut_it_3.4.3_3.0_1648738472593.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_partut_it_3.4.3_3.0_1648738472593.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("it.lemma.partut").predict("""I love Spark NLP""")
```
