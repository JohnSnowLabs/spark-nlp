...
Pretrained Lemmatizer model (`lemma_kaist`) trained on Universal Dependencies 2.9 (UD_Korean-Kaist) in Korean language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_kaist_ko_3.4.3_3.0_1651416678558.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("ko.lemma.kaist").predict("""I love Spark NLP""")
```
