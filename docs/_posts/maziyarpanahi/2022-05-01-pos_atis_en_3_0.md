...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_atis_en_3.4.3_3.0_1651419509175.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_atis", "en")\ 
...
val pos = PerceptronModel.pretrained("pos_atis", "en")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("en.pos").predict("""I love Spark NLP""")
```
