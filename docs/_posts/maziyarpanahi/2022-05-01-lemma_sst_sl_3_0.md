...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_sst_sl_3.4.3_3.0_1651416574371.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("sl.lemma").predict("""I love Spark NLP""")
```
