...
Pretrained Lemmatizer model (`lemma_llct`) trained on Universal Dependencies 2.9 (UD_Latin-LLCT) in Latin language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_llct_la_3.4.3_3.0_1651416724882.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("la.lemma.llct").predict("""I love Spark NLP""")
```
