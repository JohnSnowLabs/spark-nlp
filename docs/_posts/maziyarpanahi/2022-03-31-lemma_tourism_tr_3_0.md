---
layout: model
title: Lemma UD model for Turkish (lemma_tourism)
...
Pretrained Lemmatizer model (`lemma_tourism`) trained on Universal Dependencies 2.9 (UD_Turkish-Tourism) in Turkish language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_tourism_tr_3.4.3_3.0_1648738661398.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_tourism_tr_3.4.3_3.0_1648738661398.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("tr.lemma.tourism").predict("""I love Spark NLP""")
```
