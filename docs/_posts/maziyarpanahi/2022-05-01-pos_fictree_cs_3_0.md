...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_fictree_cs_3.4.3_3.0_1651419968651.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_fictree", "cs")\ 
...
val pos = PerceptronModel.pretrained("pos_fictree", "cs")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("cs.pos").predict("""I love Spark NLP""")
```
