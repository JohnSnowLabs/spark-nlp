...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_gsd_de_3.4.3_3.0_1648797988313.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("de.pos.gsd").predict("""I love Spark NLP""")
```
