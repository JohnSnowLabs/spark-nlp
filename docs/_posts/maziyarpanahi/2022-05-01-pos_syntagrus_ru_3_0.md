...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_syntagrus_ru_3.4.3_3.0_1651419804126.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_syntagrus", "ru")\ 
...
val pos = PerceptronModel.pretrained("pos_syntagrus", "ru")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("ru.pos").predict("""I love Spark NLP""")
```
