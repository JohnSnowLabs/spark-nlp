...
Pretrained Lemmatizer model (`lemma_udtb`) trained on Universal Dependencies 2.9 (UD_Urdu-UDTB) in Urdu language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_udtb_ur_3.4.3_3.0_1651416788530.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("ur.lemma").predict("""I love Spark NLP""")
```
