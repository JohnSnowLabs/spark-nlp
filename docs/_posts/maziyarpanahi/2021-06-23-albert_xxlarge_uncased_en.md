...
date: 2021-06-23
tags: [open_source, en, english, embeddings, albert, xxlarge]
task: Embeddings
language: en
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/albert_xxlarge_uncased_en_3.1.1_2.4_1624450979499.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/albert_xxlarge_uncased_en_3.1.1_2.4_1624450979499.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
[https://huggingface.co/albert-xxlarge-v2](https://huggingface.co/albert-xxlarge-v2)