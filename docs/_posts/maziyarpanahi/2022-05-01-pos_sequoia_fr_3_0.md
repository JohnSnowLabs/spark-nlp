...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_sequoia_fr_3.4.3_3.0_1651419552605.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_sequoia", "fr")\ 
...
val pos = PerceptronModel.pretrained("pos_sequoia", "fr")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("fr.pos").predict("""I love Spark NLP""")
```
