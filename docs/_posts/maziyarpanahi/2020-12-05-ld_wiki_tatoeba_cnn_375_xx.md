---
layout: model
title: Fast and Accurate Language Identification - 375 Languages
...
language_detector = LanguageDetectorDL.pretrained("ld_wiki_tatoeba_cnn_375")\
...
val languageDetector = LanguageDetectorDL.pretrained("ld_wiki_tatoeba_cnn_375")
  .setInputCols("sentence")
  .setOutputCol("language")
