...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_set_sr_3.4.3_3.0_1651416556958.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("sr.lemma.set").predict("""I love Spark NLP""")
```
