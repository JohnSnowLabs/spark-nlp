---
layout: model
title: Lemma UD model for Lithuanian (lemma_alksnis)
author: John Snow Labs
name: lemma_alksnis
date: 2022-03-31
tags: [open_source, universal_dependency, lemmatizer, lt, lithuanian]
task: Lemmatization
language: lt
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_alksnis_lt_3.4.3_3.0_1648738478483.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_alksnis_lt_3.4.3_3.0_1648738478483.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
