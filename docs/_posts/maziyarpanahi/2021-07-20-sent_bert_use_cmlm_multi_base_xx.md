---
layout: model
title: Universal sentence encoder for 100+ languages trained with CMLM (sent_bert_use_cmlm_multi_base)
author: John Snow Labs
name: sent_bert_use_cmlm_multi_base
date: 2021-07-20
tags: [embeddings, bert, use, xx, multilingual, cmlm, open_source]
task: Embeddings
language: xx
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/sent_bert_use_cmlm_multi_base_xx_3.1.3_2.4_1626783880233.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/sent_bert_use_cmlm_multi_base_xx_3.1.3_2.4_1626783880233.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
[https://tfhub.dev/google/universal-sentence-encoder-cmlm/multilingual-base/1](https://tfhub.dev/google/universal-sentence-encoder-cmlm/multilingual-base/1)
