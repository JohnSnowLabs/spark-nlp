...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_proiel_cu_3.4.3_3.0_1651419541784.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_proiel", "cu")\ 
...
val pos = PerceptronModel.pretrained("pos_proiel", "cu")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("cu.pos").predict("""I love Spark NLP""")
```
