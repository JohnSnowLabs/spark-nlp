...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/xlm_roberta_base_finetuned_luganda_lg_3.3.1_3.0_1634303195341.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
marian = XlmRoBertaSentenceEmbeddings.pretrained("xlm_roberta_base_finetuned_luganda", "lg")\ 
...
val marian = XlmRoBertaSentenceEmbeddings.pretrained("xlm_roberta_base_finetuned_luganda", "lg")
    .setInputCols("sentence")
    .setOutputCol("sentence_embeddings")
```
</div>
