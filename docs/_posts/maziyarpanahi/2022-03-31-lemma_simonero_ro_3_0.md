...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_simonero_ro_3.4.3_3.0_1648738384254.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_simonero_ro_3.4.3_3.0_1648738384254.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("ro.lemma.simonero").predict("""I love Spark NLP""")
```
