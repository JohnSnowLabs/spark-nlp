---
layout: model
title: Fast and Accurate Language Identification - 231 Languages
...
language_detector = LanguageDetectorDL.pretrained("ld_wiki_cnn_231")\
...
val languageDetector = LanguageDetectorDL.pretrained("ld_wiki_cnn_231")
  .setInputCols("sentence")
  .setOutputCol("language")
