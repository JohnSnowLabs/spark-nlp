...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/sent_xlm_roberta_base_finetuned_naija_pcm_3.3.1_3.0_1634303778837.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
marian = XlmRoBertaSentenceEmbeddings.pretrained("sent_xlm_roberta_base_finetuned_naija", "pcm")\ 
...
val marian = XlmRoBertaSentenceEmbeddings.pretrained("sent_xlm_roberta_base_finetuned_naija", "pcm")
    .setInputCols("sentence")
    .setOutputCol("sentence_embeddings")
```
</div>
