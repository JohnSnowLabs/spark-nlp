...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_hiencs_qhe_3.4.3_3.0_1651416568620.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("qhe.lemma").predict("""I love Spark NLP""")
```
