...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/xlm_roberta_base_finetuned_amharic_am_3.3.1_3.0_1634303422352.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
marian = XlmRoBertaSentenceEmbeddings.pretrained("xlm_roberta_base_finetuned_amharic", "am")\ 
...
val marian = XlmRoBertaSentenceEmbeddings.pretrained("xlm_roberta_base_finetuned_amharic", "am")
    .setInputCols("sentence")
    .setOutputCol("sentence_embeddings")
```
</div>
