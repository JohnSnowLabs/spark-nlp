...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/sent_xlm_roberta_base_finetuned_kinyarwanda_rw_3.3.1_3.0_1634303874492.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
marian = XlmRoBertaSentenceEmbeddings.pretrained("sent_xlm_roberta_base_finetuned_kinyarwanda", "rw")\ 
...
val marian = XlmRoBertaSentenceEmbeddings.pretrained("sent_xlm_roberta_base_finetuned_kinyarwanda", "rw")
    .setInputCols("sentence")
    .setOutputCol("sentence_embeddings")
```
</div>
