...
Pretrained Lemmatizer model (`lemma_padt`) trained on Universal Dependencies 2.9 (UD_Arabic-PADT) in Arabic language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_padt_ar_3.4.3_3.0_1651416551210.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("ar.lemma").predict("""I love Spark NLP""")
```
