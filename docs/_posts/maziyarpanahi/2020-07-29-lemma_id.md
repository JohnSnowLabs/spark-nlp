...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_id_2.5.5_2.4_1596054397023.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
lemma_df = nlu.load('id.lemma').predict(text, output_level='document')
