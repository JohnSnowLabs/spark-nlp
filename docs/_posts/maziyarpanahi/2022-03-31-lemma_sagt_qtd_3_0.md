---
layout: model
title: Lemma UD model for German (lemma_sagt)
author: John Snow Labs
name: lemma_sagt
date: 2022-03-31
tags: [open_source, universal_dependency, lemmatizer, qtd, german]
task: Lemmatization
language: qtd
...
Pretrained Lemmatizer model (`lemma_sagt`) trained on Universal Dependencies 2.9 (UD_German-SAGT) in German language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_sagt_qtd_3.4.3_3.0_1648738655591.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_sagt_qtd_3.4.3_3.0_1648738655591.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("qtd.lemma").predict("""I love Spark NLP""")
```
