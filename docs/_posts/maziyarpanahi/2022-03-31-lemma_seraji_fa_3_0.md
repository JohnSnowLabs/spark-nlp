---
layout: model
title: Lemma UD model for Persian (lemma_seraji)
...
Pretrained Lemmatizer model (`lemma_seraji`) trained on Universal Dependencies 2.9 (UD_Persian-Seraji) in Persian language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_seraji_fa_3.4.3_3.0_1648738667272.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_seraji_fa_3.4.3_3.0_1648738667272.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("fa.lemma.seraji").predict("""I love Spark NLP""")
```
