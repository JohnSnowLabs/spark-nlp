---
layout: model
title: Translate Indic languages to Indic languages Pipeline
author: John Snow Labs
name: translate_inc_inc
date: 2021-06-04
tags: [open_source, pipeline, seq2seq, translation, inc, xx, multilingual]
task: Translation
language: xx
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/translate_inc_inc_xx_3.1.0_2.4_1622842169993.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/translate_inc_inc_xx_3.1.0_2.4_1622842169993.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
