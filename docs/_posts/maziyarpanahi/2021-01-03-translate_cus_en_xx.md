...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/translate_cus_en_xx_2.7.0_2.4_1609690727352.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
translate_df = nlu.load('xx.cus.translate_to.en').predict(text, output_level='sentence')
translate_df
```
