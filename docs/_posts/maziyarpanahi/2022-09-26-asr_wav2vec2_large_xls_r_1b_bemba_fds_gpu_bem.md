...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/asr_wav2vec2_large_xls_r_1b_bemba_fds_gpu_bem_4.2.0_3.0_1664193530490.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
nlu.load("bem.speech2text.wav2vec_xlsr.v2_large_gpu").predict("ngm_12484_01067234848.wav")
```
