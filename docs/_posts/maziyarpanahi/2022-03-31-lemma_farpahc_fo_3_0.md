---
layout: model
title: Lemma UD model for Faroese (lemma_farpahc)
author: John Snow Labs
name: lemma_farpahc
date: 2022-03-31
tags: [open_source, universal_dependency, lemmatizer, fo, faroese]
task: Lemmatization
language: fo
...
Pretrained Lemmatizer model (`lemma_farpahc`) trained on Universal Dependencies 2.9 (UD_Faroese-FarPaHC) in Faroese language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_farpahc_fo_3.4.3_3.0_1648738537198.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_farpahc_fo_3.4.3_3.0_1648738537198.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("fo.lemma").predict("""I love Spark NLP""")
```
