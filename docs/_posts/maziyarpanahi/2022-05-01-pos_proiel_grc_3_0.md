...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_proiel_grc_3.4.3_3.0_1651419957736.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
val pos = PerceptronModel.pretrained("pos_proiel", "grc")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("grc.pos").predict("""I love Spark NLP""")
```
