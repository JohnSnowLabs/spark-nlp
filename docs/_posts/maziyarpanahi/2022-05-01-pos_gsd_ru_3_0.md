...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_gsd_ru_3.4.3_3.0_1651419914366.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_gsd", "ru")\ 
...
val pos = PerceptronModel.pretrained("pos_gsd", "ru")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("ru.pos.gsd").predict("""I love Spark NLP""")
```
