...
Pretrained Lemmatizer model (`lemma_bosque`) trained on Universal Dependencies 2.9 (UD_Portuguese-Bosque) in Portuguese language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_bosque_pt_3.4.3_3.0_1651416690145.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("pt.lemma").predict("""I love Spark NLP""")
```
