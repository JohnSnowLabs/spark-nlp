...
This model is a distilled version of the  `BERT` base model. It was introduced in [this paper](https://arxiv.org/abs/1910.01108). This model is uncased: it does not make a difference between english and English.
