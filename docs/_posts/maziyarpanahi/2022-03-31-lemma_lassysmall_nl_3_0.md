---
layout: model
title: Lemma UD model for Dutch (lemma_lassysmall)
author: John Snow Labs
name: lemma_lassysmall
date: 2022-03-31
...
Pretrained Lemmatizer model (`lemma_lassysmall`) trained on Universal Dependencies 2.9 (UD_Dutch-LassySmall) in Dutch language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_lassysmall_nl_3.4.3_3.0_1648738525507.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_lassysmall_nl_3.4.3_3.0_1648738525507.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("nl.lemma.lassysmall").predict("""I love Spark NLP""")
```
