---
layout: model
title: Translate Marathi to English Pipeline
author: John Snow Labs
name: translate_mr_en
date: 2021-06-04
tags: [open_source, pipeline, seq2seq, translation, mr, en, xx, multilingual]
task: Translation
language: xx
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/translate_mr_en_xx_3.1.0_2.4_1622836794740.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/translate_mr_en_xx_3.1.0_2.4_1622836794740.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pipeline.annotate("मला वाचायला आवडते.")
```
```scala
