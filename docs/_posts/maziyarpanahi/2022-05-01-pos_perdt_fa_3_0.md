...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_perdt_fa_3.4.3_3.0_1651419683334.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_perdt", "fa")\ 
...
val pos = PerceptronModel.pretrained("pos_perdt", "fa")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("fa.pos").predict("""I love Spark NLP""")
```
