---
layout: model
title: Part of Speech UD model for Telugu (pos_mtg)
author: John Snow Labs
name: pos_mtg
date: 2022-04-01
tags: [open_source, universal_dependency, pos, part_of_speech, te, telugu]
...
Pretrained Part of Speech model (`pos_mtg`) trained on Universal Dependencies 2.9 (UD_Telugu-MTG) in Telugu language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/pos_mtg_te_3.4.3_3.0_1648797923517.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_mtg_te_3.4.3_3.0_1648797923517.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("te.pos").predict("""I love Spark NLP""")
```
