---
layout: model
title: Lemma UD model for Italian (lemma_vit)
...
Pretrained Lemmatizer model (`lemma_vit`) trained on Universal Dependencies 2.9 (UD_Italian-VIT) in Italian language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_vit_it_3.4.3_3.0_1648738360749.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_vit_it_3.4.3_3.0_1648738360749.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("it.lemma.vit").predict("""I love Spark NLP""")
```
