...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_mudt_mt_3.4.3_3.0_1651419738338.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_mudt", "mt")\ 
...
val pos = PerceptronModel.pretrained("pos_mudt", "mt")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("mt.pos").predict("""I love Spark NLP""")
```
