...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_cac_cs_3.4.3_3.0_1648738431086.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("cs.lemma.cac").predict("""I love Spark NLP""")
```
