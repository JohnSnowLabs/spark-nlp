...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_gsdsimp_zh_3.4.3_3.0_1651419650687.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_gsdsimp", "zh")\ 
...
val pos = PerceptronModel.pretrained("pos_gsdsimp", "zh")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("zh.pos").predict("""I love Spark NLP""")
```
