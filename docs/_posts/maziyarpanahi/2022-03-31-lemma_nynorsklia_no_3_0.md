---
layout: model
title: Lemma UD model for Norwegian (lemma_nynorsklia)
author: John Snow Labs
name: lemma_nynorsklia
date: 2022-03-31
...
Pretrained Lemmatizer model (`lemma_nynorsklia`) trained on Universal Dependencies 2.9 (UD_Norwegian-NynorskLIA) in Norwegian language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_nynorsklia_no_3.4.3_3.0_1648738578439.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_nynorsklia_no_3.4.3_3.0_1648738578439.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("no.lemma.nynorsklia").predict("""I love Spark NLP""")
```
