---
layout: model
title: Smaller BERT Sentence Embeddings (L-4_H-128_A-2)
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/sent_small_bert_L4_128_en_2.6.0_2.4_1598350314094.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/sent_small_bert_L4_128_en_2.6.0_2.4_1598350314094.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
...
embeddings = BertSentenceEmbeddings.pretrained("sent_small_bert_L4_128", "en") \
...
```scala
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_small_bert_L4_128", "en")
.setInputCols("sentence")
.setOutputCol("sentence_embeddings")
...
embeddings_df = nlu.load('en.embed_sentence.small_bert_L4_128').predict(text, output_level='sentence')
embeddings_df
```
