---
layout: model
title: Lemma UD model for Russian (lemma_syntagrus)
author: John Snow Labs
name: lemma_syntagrus
date: 2022-03-31
...
Pretrained Lemmatizer model (`lemma_syntagrus`) trained on Universal Dependencies 2.9 (UD_Russian-SynTagRus) in Russian language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_syntagrus_ru_3.4.3_3.0_1648738702459.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_syntagrus_ru_3.4.3_3.0_1648738702459.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("ru.lemma.syntagrus").predict("""I love Spark NLP""")
```
