...
Pretrained Lemmatizer model (`lemma_kenet`) trained on Universal Dependencies 2.9 (UD_Turkish-Kenet) in Turkish language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_kenet_tr_3.4.3_3.0_1651416805920.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("tr.lemma.kenet").predict("""I love Spark NLP""")
```
