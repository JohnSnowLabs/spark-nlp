...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_idt_ga_3.4.3_3.0_1651419946977.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_idt", "ga")\ 
...
val pos = PerceptronModel.pretrained("pos_idt", "ga")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("ga.pos").predict("""I love Spark NLP""")
```
