...
Pretrained Lemmatizer model (`lemma_penn`) trained on Universal Dependencies 2.9 (UD_Turkish-Penn) in Turkish language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_penn_tr_3.4.3_3.0_1651416782671.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("tr.lemma").predict("""I love Spark NLP""")
```
