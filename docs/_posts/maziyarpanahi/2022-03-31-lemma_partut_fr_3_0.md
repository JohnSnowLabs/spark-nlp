---
layout: model
title: Lemma UD model for French (lemma_partut)
...
Pretrained Lemmatizer model (`lemma_partut`) trained on Universal Dependencies 2.9 (UD_French-ParTUT) in French language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_partut_fr_3.4.3_3.0_1648738743849.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_partut_fr_3.4.3_3.0_1648738743849.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("fr.lemma.partut").predict("""I love Spark NLP""")
```
