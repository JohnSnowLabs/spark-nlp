...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_wtb_wo_3.4.3_3.0_1651419607008.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_wtb", "wo")\ 
...
val pos = PerceptronModel.pretrained("pos_wtb", "wo")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("wo.pos").predict("""I love Spark NLP""")
```
