...
Pretrained Lemmatizer model (`lemma_treegal`) trained on Universal Dependencies 2.9 (UD_Galician-TreeGal) in Galician language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_treegal_gl_3.4.3_3.0_1651416661165.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("gl.lemma").predict("""I love Spark NLP""")
```
