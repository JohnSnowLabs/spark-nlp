...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_vedic_sa_3.4.3_3.0_1651419891455.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_vedic", "sa")\ 
...
val pos = PerceptronModel.pretrained("pos_vedic", "sa")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("sa.pos").predict("""I love Spark NLP""")
```
