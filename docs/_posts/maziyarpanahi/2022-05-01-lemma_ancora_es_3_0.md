...
Pretrained Lemmatizer model (`lemma_ancora`) trained on Universal Dependencies 2.9 (UD_Spanish-AnCora) in Spanish language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_ancora_es_3.4.3_3.0_1651416800165.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("es.lemma.ancora").predict("""I love Spark NLP""")
```
