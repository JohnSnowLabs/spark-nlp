...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_ufal_mr_3.4.3_3.0_1651419880677.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_ufal", "mr")\ 
...
val pos = PerceptronModel.pretrained("pos_ufal", "mr")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("mr.pos").predict("""I love Spark NLP""")
```
