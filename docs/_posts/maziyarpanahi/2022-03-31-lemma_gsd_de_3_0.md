---
layout: model
title: Lemma UD model for German (lemma_gsd)
...
Pretrained Lemmatizer model (`lemma_gsd`) trained on Universal Dependencies 2.9 (UD_German-GSD) in German language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_gsd_de_3.4.3_3.0_1648738678934.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_gsd_de_3.4.3_3.0_1648738678934.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("de.lemma.gsd").predict("""I love Spark NLP""")
```
