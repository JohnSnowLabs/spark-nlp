...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/translate_en_fr_xx_2.7.0_2.4_1609684421875.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
from sparknlp.pretrained import PretrainedPipeline\ 
 pipeline = PretrainedPipeline("{}", lang = "xx")\ 
