...
Pretrained Lemmatizer model (`lemma_bdt`) trained on Universal Dependencies 2.9 (UD_Basque-BDT) in Basque language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_bdt_eu_3.4.3_3.0_1651416597493.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("eu.lemma").predict("""I love Spark NLP""")
```
