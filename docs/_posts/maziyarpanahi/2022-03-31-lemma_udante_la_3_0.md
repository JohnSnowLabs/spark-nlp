---
layout: model
title: Lemma UD model for Latin (lemma_udante)
...
Pretrained Lemmatizer model (`lemma_udante`) trained on Universal Dependencies 2.9 (UD_Latin-UDante) in Latin language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_udante_la_3.4.3_3.0_1648738513757.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_udante_la_3.4.3_3.0_1648738513757.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("la.lemma.udante").predict("""I love Spark NLP""")
```
