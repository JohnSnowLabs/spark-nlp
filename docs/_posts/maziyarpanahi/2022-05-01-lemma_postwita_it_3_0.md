...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_postwita_it_3.4.3_3.0_1651416545313.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("it.lemma.postwita").predict("""I love Spark NLP""")
```
