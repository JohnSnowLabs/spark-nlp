...
Pretrained Lemmatizer model (`lemma_twittiro`) trained on Universal Dependencies 2.9 (UD_Italian-TWITTIRO) in Italian language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_twittiro_it_3.4.3_3.0_1651416626485.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("it.lemma").predict("""I love Spark NLP""")
```
