...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_tourism_tr_3.4.3_3.0_1651419979517.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_tourism", "tr")\ 
...
val pos = PerceptronModel.pretrained("pos_tourism", "tr")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("tr.pos.tourism").predict("""I love Spark NLP""")
```
