...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/opus_mt_en_el_xx_2.7.0_2.4_1609163144290.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
opus_df = nlu.load('xx.en.marian.translate_to.el').predict(text, output_level='sentence')
opus_df
```
