---
layout: model
title: Smaller BERT Sentence Embeddings (L-2_H-128_A-2)
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/sent_small_bert_L2_128_en_2.6.0_2.4_1598350305687.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/sent_small_bert_L2_128_en_2.6.0_2.4_1598350305687.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```scala
...
val embeddings = BertSentenceEmbeddings.pretrained("sent_small_bert_L2_128", "en")
.setInputCols("sentence")
.setOutputCol("sentence_embeddings")
