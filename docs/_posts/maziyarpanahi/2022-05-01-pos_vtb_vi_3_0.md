...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_vtb_vi_3.4.3_3.0_1651419628936.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("vi.pos").predict("""I love Spark NLP""")
```
