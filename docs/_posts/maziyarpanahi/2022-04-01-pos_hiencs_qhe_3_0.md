...
name: pos_hiencs
date: 2022-04-01
tags: [open_source, universal_dependency, pos, part_of_speech, qhe, english]
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/pos_hiencs_qhe_3.4.3_3.0_1648797976695.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_hiencs_qhe_3.4.3_3.0_1648797976695.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_hiencs", "qhe")\ 
...
val pos = PerceptronModel.pretrained("pos_hiencs", "qhe")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("qhe.pos").predict("""I love Spark NLP""")
```
