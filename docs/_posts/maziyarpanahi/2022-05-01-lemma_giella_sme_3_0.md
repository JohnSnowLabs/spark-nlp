...
Pretrained Lemmatizer model (`lemma_giella`) trained on Universal Dependencies 2.9 (UD_Sami-Giella) in Sami language.
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_giella_sme_3.4.3_3.0_1651416632240.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("sme.lemma").predict("""I love Spark NLP""")
```
