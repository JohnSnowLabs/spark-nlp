...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_gsd_ko_3.4.3_3.0_1651419617827.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_gsd", "ko")\ 
...
val pos = PerceptronModel.pretrained("pos_gsd", "ko")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("ko.pos").predict("""I love Spark NLP""")
```
