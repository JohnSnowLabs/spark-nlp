...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_ccg_cy_3.4.3_3.0_1648738502014.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("cy.lemma.ccg").predict("""I love Spark NLP""")
```
