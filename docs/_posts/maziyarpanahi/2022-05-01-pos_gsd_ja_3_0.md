...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_gsd_ja_3.4.3_3.0_1651419782325.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pos = PerceptronModel.pretrained("pos_gsd", "ja")\ 
...
val pos = PerceptronModel.pretrained("pos_gsd", "ja")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("ja.pos").predict("""I love Spark NLP""")
```
