...
DistilbertNER model has been trained for the Named Entity Recognition (NER) task that covered ten types of entities: 
...
## Data Source
 ...
 NER dataset collected from [ARMAN](https://github.com/HaniehP/PersianNER), [PEYMA](http://nsurl.org/2019-2/tasks/task-7-named-entity-recognition-ner-for-farsi/), and [WikiANN](https://elisa-ie.github.io/wikiann/) 
