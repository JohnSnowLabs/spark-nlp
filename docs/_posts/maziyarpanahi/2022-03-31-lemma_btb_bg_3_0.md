...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_btb_bg_3.4.3_3.0_1648738602851.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("bg.lemma.btb").predict("""I love Spark NLP""")
```
