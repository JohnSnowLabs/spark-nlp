---
layout: model
title: Dutch, Flemish asr_xlsr300m_7.0_lm_gpu TFWav2Vec2ForCTC for GPU from Iskaj
author: John Snow Labs
name: asr_xlsr300m_7.0_lm_gpu
date: 2022-09-25
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/asr_xlsr300m_7.0_lm_gpu_nl_4.2.0_3.0_1664106096355.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/asr_xlsr300m_7.0_lm_gpu_nl_4.2.0_3.0_1664106096355.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
nlu.load("nl.speech2text.wav2vec_xlsr.300m_gpu").predict("ngm_12484_01067234848.wav")
```
