---
layout: model
title: English asr_wav2vec2_large_960h_gpu TFWav2Vec2ForCTC for GPU from facebook
author: John Snow Labs
name: asr_wav2vec2_large_960h_gpu
date: 2022-09-24
...
NOTE: This model only works on a GPU, if you need to use this model on a CPU device please use asr_wav2vec2_large_960h
...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/asr_wav2vec2_large_960h_gpu_en_4.2.0_3.0_1664037665082.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
speech_to_text = Wav2Vec2ForCTC \
    .pretrained("asr_wav2vec2_large_960h_gpu", "en")\
...
nlu.load("en.speech2text.wav2vec2.v2_large_960h_gpu").predict("ngm_12484_01067234848.wav")
```
...
{:.table-model}
|---|---|
|Model Name:|asr_wav2vec2_large_960h_gpu|
