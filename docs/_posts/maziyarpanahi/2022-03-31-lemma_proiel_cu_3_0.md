---
layout: model
title: Lemma UD model for Slavonic (lemma_proiel)
author: John Snow Labs
name: lemma_proiel
date: 2022-03-31
tags: [open_source, universal_dependency, lemmatizer, cu, slavonic]
task: Lemmatization
language: cu
...
Pretrained Lemmatizer model (`lemma_proiel`) trained on Universal Dependencies 2.9 (UD_Slavonic-PROIEL) in Slavonic language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_proiel_cu_3.4.3_3.0_1648738378390.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_proiel_cu_3.4.3_3.0_1648738378390.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("cu.lemma").predict("""I love Spark NLP""")
```
