...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/stopwords_af_af_2.5.4_2.4_1594742440083.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
val data = Seq("Anders as die koning van die noorde, is John Snow "n Engelse dokter en "n leier in die ontwikkeling van narkose en mediese higiëne.").toDF("text")
