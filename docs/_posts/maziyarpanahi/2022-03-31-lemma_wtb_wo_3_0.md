---
layout: model
title: Lemma UD model for Wolof (lemma_wtb)
author: John Snow Labs
name: lemma_wtb
date: 2022-03-31
tags: [open_source, universal_dependency, lemmatizer, wo, wolof]
task: Lemmatization
language: wo
...
Pretrained Lemmatizer model (`lemma_wtb`) trained on Universal Dependencies 2.9 (UD_Wolof-WTB) in Wolof language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_wtb_wo_3.4.3_3.0_1648738566666.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/lemma_wtb_wo_3.4.3_3.0_1648738566666.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("wo.lemma.wtb").predict("""I love Spark NLP""")
```
