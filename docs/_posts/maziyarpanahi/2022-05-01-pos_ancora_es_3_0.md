...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_ancora_es_3.4.3_3.0_1651419859072.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
val pos = PerceptronModel.pretrained("pos_ancora", "es")
.setInputCols("sentence", "token")
.setOutputCol("pos")
...
```python
import nlu
nlu.load("es.pos").predict("""I love Spark NLP""")
```
