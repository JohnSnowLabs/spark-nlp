...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/opus_mt_en_fiu_xx_2.7.0_2.4_1609168517010.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
opus_df = nlu.load('xx.en.marian.translate_to.fiu').predict(text, output_level='sentence')
opus_df
```
