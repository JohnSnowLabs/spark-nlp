...
date: 2021-01-20
tags: [en, clinical, deidentify, ner, licensed]
article_header:
  type: cover
...
Deidentification NER (Augmented) is a Named Entity Recognition model that annotates text to find protected health information that may need to be deidentified. The entities it annotates are 'AGE', 'CONTACT', 'DATE', 'ID', 'LOCATION', 'NAME', 'PROFESSION'.
...
[Open in Colab](https://github.com/JohnSnowLabs/spark-nlp-workshop/blob/461c5b8d51c20fbadc24348b3507d75683179fbf/tutorials/Certification_Trainings/Public/4.NERDL_Training.ipynb){:.button.button-orange.button-orange-trans.co.button-icon}
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/ner_deid_augmented_en_2.6.2_2.4_1611143257515.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
