...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_token_classifier_biobertpt_clin_tempclinbr_pt_4.2.4_3.0_1669822235861.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("pt.ner.biobert").predict("""PUT YOUR STRING HERE""")
```
