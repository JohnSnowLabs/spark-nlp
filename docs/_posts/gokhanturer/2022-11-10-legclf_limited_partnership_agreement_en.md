...
The `legclf_limited_partnership_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `limited-partnership-agreement` or not (Binary Classification).
