...
The `legclf_exclusive_license_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `exclusive-license-agreement` or not (Binary Classification).
