...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_token_classifier_berturk_cased_ner_tr_4.2.4_3.0_1669815532606.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("tr.ner.bert.cased.by_alierenak").predict("""PUT YOUR STRING HERE""")
```
