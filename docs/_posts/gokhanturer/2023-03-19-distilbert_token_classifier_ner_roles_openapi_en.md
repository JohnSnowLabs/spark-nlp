...
``, `PER`, `ENTITY`, `ACTION`, `OR`, `MISC`, `ROLE`, `ORG`, `PRG`, `LOC`

{:.btn-box}
<button class="button button-orange" disabled>Live Demo</button>
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/distilbert_token_classifier_ner_roles_openapi_en_4.3.1_3.0_1679228385980.zip){:.button.button-orange}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/distilbert_token_classifier_ner_roles_openapi_en_4.3.1_3.0_1679228385980.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
