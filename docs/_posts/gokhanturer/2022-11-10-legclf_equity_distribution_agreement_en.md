...
The `legclf_equity_distribution_agreement` model is a Legal Longformer Document Classifier to classify if the document belongs to the class `equity-distribution-agreement` or not (Binary Classification).
...
equity-distribution-agreement      1.00   1.00       1.0       41
                        other      1.00   1.00       1.0       66
                     accuracy         -      -       1.0      107
                    macro-avg      1.00   1.00       1.0      107
                 weighted-avg      1.00   1.00       1.0      107
