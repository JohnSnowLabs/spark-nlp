...
example = spark.createDataFrame(pd.DataFrame({'text': ["Pozdravljeni iz JOHN Snow Labs! "]}))
...
val result = pipeline.fit(Seq.empty["Pozdravljeni iz JOHN Snow Labs! "].toDS.toDF("text")).transform(data)
