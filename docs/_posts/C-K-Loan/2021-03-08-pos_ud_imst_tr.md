...
example = spark.createDataFrame(pd.DataFrame({'text': ["John Snow Labs'tan merhaba! "]}))
...
val result = pipeline.fit(Seq.empty["John Snow Labs'tan merhaba! "].toDS.toDF("text")).transform(data)
