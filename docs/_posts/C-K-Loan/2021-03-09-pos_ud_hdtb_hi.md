...
example = spark.createDataFrame(pd.DataFrame({'text': ["जॉन स्नो लैब्स से नमस्ते! "]}))
...
val result = pipeline.fit(Seq.empty["जॉन स्नो लैब्स से नमस्ते! "].toDS.toDF("text")).transform(data)
