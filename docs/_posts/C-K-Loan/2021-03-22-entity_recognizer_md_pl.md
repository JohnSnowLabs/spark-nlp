---
layout: model
title: Recognize Entities DL Pipeline for Polish - Medium
author: John Snow Labs
name: entity_recognizer_md
date: 2021-03-22
tags: [open_source, polish, entity_recognizer_md, pipeline, pl]
supported: true
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/entity_recognizer_md_pl_3.0.0_3.0_1616450153520.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/entity_recognizer_md_pl_3.0.0_3.0_1616450153520.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
pipeline = PretrainedPipeline('entity_recognizer_md', lang = 'pl')
...
val pipeline = new PretrainedPipeline("entity_recognizer_md", lang = "pl")
...
result_df = nlu.load('pl.ner.md').predict(text)
result_df
