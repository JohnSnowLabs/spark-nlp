...
example = spark.createDataFrame(pd.DataFrame({'text': ["Hej fra John Snow Labs! "]}))
...
val result = pipeline.fit(Seq.empty["Hej fra John Snow Labs! "].toDS.toDF("text")).transform(data)
