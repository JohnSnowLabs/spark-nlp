...
example = spark.createDataFrame(pd.DataFrame({'text': ["Ahoj z Johna Snow Labs! "]}))
...
val result = pipeline.fit(Seq.empty["Ahoj z Johna Snow Labs! "].toDS.toDF("text")).transform(data)
