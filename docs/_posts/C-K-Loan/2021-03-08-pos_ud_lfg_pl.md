...
example = spark.createDataFrame(pd.DataFrame({'text': ["Witaj z John Snow Labs! "]}))
...
val result = pipeline.fit(Seq.empty["Witaj z John Snow Labs! "].toDS.toDF("text")).transform(data)
