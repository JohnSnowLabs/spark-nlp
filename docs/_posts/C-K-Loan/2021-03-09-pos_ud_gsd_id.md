...
example = spark.createDataFrame(pd.DataFrame({'text': ["Halo dari John Salju Labs! "]}))
...
val result = pipeline.fit(Seq.empty["Halo dari John Salju Labs! "].toDS.toDF("text")).transform(data)
