...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/pos_ud_treegal_gl_3.0.0_3.0_1615292173539.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
example = spark.createDataFrame([['Ola de John Snow Labs! ']], ["text"])
...
val data = Seq("Ola de John Snow Labs! ").toDF("text")
