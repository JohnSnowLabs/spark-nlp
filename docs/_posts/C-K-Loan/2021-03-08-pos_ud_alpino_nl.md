...
example = spark.createDataFrame(pd.DataFrame({'text': ["Hallo van John Snow Labs! "]}))
...
val result = pipeline.fit(Seq.empty["Hallo van John Snow Labs! "].toDS.toDF("text")).transform(data)
