...
example = spark.createDataFrame(pd.DataFrame({'text': ["Dia duit ó John Labs Sneachta! "]}))
...
val result = pipeline.fit(Seq.empty["Dia duit ó John Labs Sneachta! "].toDS.toDF("text")).transform(data)
