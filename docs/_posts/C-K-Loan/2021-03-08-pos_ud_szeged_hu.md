...
example = spark.createDataFrame(pd.DataFrame({'text': ["Helló John Snow Labs! "]}))
...
val result = pipeline.fit(Seq.empty["Helló John Snow Labs! "].toDS.toDF("text")).transform(data)
