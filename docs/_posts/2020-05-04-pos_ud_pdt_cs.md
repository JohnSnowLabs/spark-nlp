...
```bash
[Row(annotatorType='pos', begin=0, end=4, result='ADP', metadata={'word': 'Kromě'}, embeddings=[]),
Row(annotatorType='pos', begin=6, end=9, result='DET', metadata={'word': 'toho'}, embeddings=[]),
Row(annotatorType='pos', begin=10, end=10, result='PUNCT', metadata={'word': ','}, embeddings=[]),
Row(annotatorType='pos', begin=12, end=13, result='SCONJ', metadata={'word': 'že'}, embeddings=[]),
Row(annotatorType='pos', begin=15, end=16, result='AUX', metadata={'word': 'je'}, embeddings=[]),
...]
```
