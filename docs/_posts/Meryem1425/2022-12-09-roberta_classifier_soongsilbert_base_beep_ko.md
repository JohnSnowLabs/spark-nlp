...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_classifier_soongsilbert_base_beep_ko_4.2.4_3.0_1670621936226.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
roberta_classifier = RoBertaForSequenceClassification.pretrained("roberta_classifier_soongsilbert_base_beep","ko") \
...
val roberta_classifier = RoBertaForSequenceClassification.pretrained("roberta_classifier_soongsilbert_base_beep","ko") 
