...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_classifier_autonlp_predict_roi_1_29797730_en_4.2.4_3.0_1670622865249.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.classify.roberta.by_ds198799").predict("""I feel lucky to be here.""")
```
