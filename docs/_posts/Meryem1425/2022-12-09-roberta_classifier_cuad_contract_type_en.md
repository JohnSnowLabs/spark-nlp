...
`Collaboration`, `Non_Compete_Non_Solicit`, `Service`, `Hosting`, `Sponsorship`, `Endorsement Agreement`, `Development`, `License_Agreements`, `Marketing`, `Reseller`, `Distributor`, `Transportation`, `Franchise`, `Outsourcing`, `Consulting Agreements`, `Supply`, `Manufacturing`, `Joint Venture`, `Agency Agreements`, `Promotion`, `Co_Branding`, `Affiliate Agreement`, `Strategic Alliance`, `Maintenance`, `IP`

{:.btn-box}
<button class="button button-orange" disabled>Live Demo</button>
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_classifier_cuad_contract_type_en_4.2.4_3.0_1670624892947.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
roberta_classifier = RoBertaForSequenceClassification.pretrained("roberta_classifier_cuad_contract_type","en") \
...
val roberta_classifier = RoBertaForSequenceClassification.pretrained("roberta_classifier_cuad_contract_type","en") 
