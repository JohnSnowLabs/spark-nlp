...
name: roberta_classifier_distil_finetuned_age_news_classification
date: 2022-12-09
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_classifier_distil_finetuned_age_news_classification_en_4.2.4_3.0_1670625064511.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
roberta_classifier = RoBertaForSequenceClassification.pretrained("roberta_classifier_distil_finetuned_age_news_classification","en") \
...
val roberta_classifier = RoBertaForSequenceClassification.pretrained("roberta_classifier_distil_finetuned_age_news_classification","en") 
...
{:.table-model}
|---|---|
|Model Name:|roberta_classifier_distil_finetuned_age_news_classification|
