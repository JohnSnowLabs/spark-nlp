...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_classifier_distil_base_finetuned_fake_news_english_en_4.2.4_3.0_1670625001454.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
roberta_classifier = RoBertaForSequenceClassification.pretrained("roberta_classifier_distil_base_finetuned_fake_news_english","en") \
...
val roberta_classifier = RoBertaForSequenceClassification.pretrained("roberta_classifier_distil_base_finetuned_fake_news_english","en") 
