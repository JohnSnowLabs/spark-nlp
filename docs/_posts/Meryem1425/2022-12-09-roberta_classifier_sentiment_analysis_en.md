...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_classifier_sentiment_analysis_en_4.2.4_3.0_1670621684250.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("en.classify.roberta.sentiment.by_souvikcmsa").predict("""I feel lucky to be here.""")
```
