...
```bash
[Row(annotatorType='pos', begin=0, end=4, result='NOUN', metadata={'word': 'Annet'}, embeddings=[]),
...
Row(annotatorType='pos', begin=12, end=15, result='VERB', metadata={'word': 'være'}, embeddings=[]),
