...
```python
...
embeddings = BertEmbeddings.pretrained("sent_small_bert_L4_256", "en") \
...
```scala
...
val embeddings = BertEmbeddings.pretrained("sent_small_bert_L4_256", "en")
      .setInputCols("sentence")
      .setOutputCol("sentence_embeddings")
...
```bash
	...
	I hate cancer	                [[0.04478158429265022, 0.46452823281288147, 0....
	Antibiotics aren't painkiller	    [[0.04478158429265022, 0.46452823281288147, 0...
```
