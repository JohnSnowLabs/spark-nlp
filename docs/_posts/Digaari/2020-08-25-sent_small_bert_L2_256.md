---
layout: model
title: Smaller BERT Sentence Embeddings (L-2_H-256_A-4)
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/sent_small_bert_L2_256_en_2.6.0_2.4_1598350372298.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
...
```python
...
embeddings = BertEmbeddings.pretrained("sent_small_bert_L2_256", "en") \
...
```scala
...
val embeddings = BertEmbeddings.pretrained("sent_small_bert_L2_256", "en")
      .setInputCols("sentence")
      .setOutputCol("sentence_embeddings")
...
## Results
```bash
	sentence	                        en_embed_sentence_small_bert_L2_256_embeddings
		
	I hate cancer	                  [[-1.2195377349853516, -0.7168622016906738, 1...
      Antibiotics aren't painkiller 	[[-1.2195377349853516, -0.7168622016906738, 1...
```
