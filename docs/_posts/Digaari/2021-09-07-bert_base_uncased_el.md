...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/bert_base_uncased_el_3.2.2_3.0_1630999695036.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
import nlu
nlu.load("el.embed.bert.base_uncased").predict("""Put your text here.""")
```
