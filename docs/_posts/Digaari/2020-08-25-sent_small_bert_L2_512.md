...
```python
...
embeddings = BertEmbeddings.pretrained("sent_small_bert_L2_512", "en") \
...
```scala
...
val embeddings = BertEmbeddings.pretrained("sent_small_bert_L2_512", "en")
      .setInputCols("sentence")
      .setOutputCol("sentence_embeddings")
...
```bash
	...
	I hate cancer	                  [[0.036712437868118286, 0.7282527089118958, 0....
      Antibiotics aren't painkiller 	[[0.036712437868118286, 0.7282527089118958, 0...
```
