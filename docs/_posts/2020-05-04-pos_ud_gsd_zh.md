...
```bash
[Row(annotatorType='pos', begin=0, end=20, result='NOUN', metadata={'word': '除了担任北方国王之外，约翰·斯诺（John'}, embeddings=[]),
Row(annotatorType='pos', begin=22, end=50, result='X', metadata={'word': 'Snow）是一位英国医师，也是麻醉和医疗卫生发展的领导者。'}, embeddings=[]),
...]
```
