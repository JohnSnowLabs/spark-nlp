...
- Apache Spark 3.5.x, 3.4.x, 3.3.x, 3.2.x, 3.1.x, 3.0.x (Scala 2.12), or Apache Spark 4.0.0, 4.0.1, 4.1.0, 4.1.1, 4.1.2 (Scala 2.13)
- On Apache Spark 4.0.0 use the `spark-nlp-spark400_2.13` artifact; on Apache Spark 4.0.1 and later validated Spark 4 versions use `spark-nlp_2.13`
