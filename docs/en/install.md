...
From Licensed version 2.3.4 in order to access private JohnSnowLabs
...
We will be using version 2.3.4 of Spark NLP Open Source and 2.3.4 of
...
```bash
// https://mvnrepository.com/artifact/com.johnsnowlabs.nlp/spark-nlp-ocr
libraryDependencies += "com.johnsnowlabs.nlp" %% "spark-nlp-ocr" % "2.3.4"
```
...
5- Now, all available **Spark Packages** are at your fingertips! Just search for **JohnSnowLabs:spark-nlp:version** where **version** stands for the library version such as: `1.8.4` or `2.3.4`
