...
and 3.4 do not support Python 3.11 or above; Python 3.12 requires PySpark 3.5 or
above; and Python 3.7 requires PySpark 3.4 or below, since PySpark 3.5 raised its own
minimum to 3.8.
