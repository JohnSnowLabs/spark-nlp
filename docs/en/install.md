...
spark-shell --jar spark-nlp-assembly-2.7.5
```
...
Spark NLP 2.7.5 has been tested and is compatible with the following runtimes: 6.2, 6.2 ML, 6.3, 6.3 ML, 6.4, 6.4 ML, 6.5, 6.5 ML
