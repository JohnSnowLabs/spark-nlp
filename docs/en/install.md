...
spark-shell --jar spark-nlp-assembly-2.4.0
```
...
From Licensed version 2.4.0 in order to access private JohnSnowLabs
...
We will be using version 2.4.0 of Spark NLP Open Source and 2.4.0 of
...
spark = SparkSession.builder \
    .appName("Global DEMO - Spark NLP Enterprise 2.4.0") \
    .master("local[*]") \
...
```bash
// https://mvnrepository.com/artifact/com.johnsnowlabs.nlp/spark-nlp-ocr
libraryDependencies += "com.johnsnowlabs.nlp" %% "spark-nlp-ocr" % "2.4.0"
```
...
5- Now, all available **Spark Packages** are at your fingertips! Just search for **JohnSnowLabs:spark-nlp:version** where **version** stands for the library version such as: `1.8.4` or `2.4.0`
