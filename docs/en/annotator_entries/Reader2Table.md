...
- `contentType`: MIME type of the documents (e.g., `"text/html"`, `"application/vnd.ms-excel"`, `"application/vnd.oasis.opendocument.text"`) (optional).
