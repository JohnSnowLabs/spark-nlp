...
<img class="image image--xl" src="/assets/images/annotation_lab/4.1.0/user_management.png" style="width:25%; align:left; box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);"/>
...
<img class="image image--xl" src="/assets/images/annotation_lab/4.1.0/users.png" style="width:110%; align:center; box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);"/>
...
<img class="image image--xl" src="/assets/images/annotation_lab/4.1.0/user_details.png" style="width:110%; align:center; box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);"/>
...
<img class="image image--xl" src="/assets/images/annotation_lab/4.1.0/user_group.png" style="width:110%; align:center; box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);"/>
...
<img class="image image--xl" src="/assets/images/annotation_lab/4.1.0/user_credentials.png" style="width:110%; align:center; box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);"/>
