...
date: 2023-06-27
tags: [roberta, embeddings, te, open_source, onnx]
task: Embeddings
language: te
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_embeddings_indic_transformers_te_roberta_te_5.0.0_3.0_1687874468330.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_embeddings_indic_transformers_te_roberta_te_5.0.0_3.0_1687874468330.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
