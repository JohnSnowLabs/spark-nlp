---
layout: model
title: English image_classifier_vit_new_exper3 ViTForImageClassification from sudo-s
author: John Snow Labs
name: image_classifier_vit_new_exper3
date: 2022-08-10
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/image_classifier_vit_new_exper3_en_4.1.0_3.0_1660173387567.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/image_classifier_vit_new_exper3_en_4.1.0_3.0_1660173387567.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
imageClassifier = ViTForImageClassification \
    .pretrained("image_classifier_vit_new_exper3", "en")\
...
nlu.load("en.classify_image.new_exper3").predict("hen.JPEG")
```
...
{:.table-model}
|---|---|
|Model Name:|image_classifier_vit_new_exper3|
