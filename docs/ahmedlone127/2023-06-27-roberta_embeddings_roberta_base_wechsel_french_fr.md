...
date: 2023-06-27
tags: [roberta, embeddings, fr, open_source, onnx]
task: Embeddings
language: fr
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/roberta_embeddings_roberta_base_wechsel_french_fr_5.0.0_3.0_1687870303923.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/roberta_embeddings_roberta_base_wechsel_french_fr_5.0.0_3.0_1687870303923.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
