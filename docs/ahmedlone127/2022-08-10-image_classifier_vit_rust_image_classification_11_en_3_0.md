...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/image_classifier_vit_rust_image_classification_11_en_4.1.0_3.0_1660171448218.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
nlu.load("en.classify_image.rust_image_classification_11").predict("hen.JPEG")
```
