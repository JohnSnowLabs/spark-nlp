---
layout: model
title: Smaller BERT Embeddings (L-2_H-768_A-12) Quantized
author: John Snow Labs
name: small_bert_L2_768_quantized
date: 2023-06-28
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/small_bert_L2_768_quantized_en_5.0.0_3.0_1687953706128.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/small_bert_L2_768_quantized_en_5.0.0_3.0_1687953706128.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
```python
...
embeddings = BertEmbeddings.pretrained("small_bert_L2_768_quantized", "en") \
...
```scala
...
val embeddings = BertEmbeddings.pretrained("small_bert_L2_768_quantized", "en")
.setInputCols("sentence", "token")
.setOutputCol("embeddings")
...
{:.table-model}
|---|---|
|Model Name:|small_bert_L2_768_quantized|
