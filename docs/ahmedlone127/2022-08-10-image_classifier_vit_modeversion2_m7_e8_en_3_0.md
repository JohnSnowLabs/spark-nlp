...
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/image_classifier_vit_modeversion2_m7_e8_en_4.1.0_3.0_1660165696411.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
nlu.load("en.classify_image.modeversion2_m7_e8").predict("hen.JPEG")
```
