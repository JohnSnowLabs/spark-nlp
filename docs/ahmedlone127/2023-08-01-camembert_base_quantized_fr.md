---
layout: model
title: CamemBERT Base Model  Quantized
...
```python
embeddings = CamemBertEmbeddings.pretrained("camembert_base_quantized", "fr") \
.setInputCols("sentence", "token") \
.setOutputCol("embeddings")
```
```scala
val embeddings = CamemBertEmbeddings.pretrained("camembert_base_quantized", "fr")
.setInputCols("sentence", "token")
.setOutputCol("embeddings")
```
