...
NOTE: This model only works on a CPU, if you need to use this model on a GPU device please use asr_baseline_gpu

{:.btn-box}
<button class="button button-orange" disabled>Live Demo</button>
<button class="button button-orange" disabled>Open in Colab</button>
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/asr_baseline_ab_4.2.0_3.0_1664021865075.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
[Copy S3 URI](s3://auxdata.johnsnowlabs.com/public/models/asr_baseline_ab_4.2.0_3.0_1664021865075.zip){:.button.button-orange.button-orange-trans.button-icon.button-copy-s3}
...
nlu.load("ab.speech2text.wav2vec2.base").predict("ngm_12484_01067234848.wav")
```
