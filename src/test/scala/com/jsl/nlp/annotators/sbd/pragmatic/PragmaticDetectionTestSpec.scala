...
/**
  ...
  */
class PragmaticDetectionTestSpec extends FlatSpec with PragmaticDetectionBehaviors {
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(simplePeriod, simplePeriodAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(questionMark, questionMarkAns)

  //Exclamation point to end sentence
  val exclamationAns = Array("There it is!", "I found it.")
  val exclamation = "There it is! I found it."
  "an isolated pragmatic detector" should behave like isolatedPDRead(exclamation, exclamationAns)

  //One letter upper case abbreviations
  val upperAbbrAns = Array("My name is Jonas E. Smith.")
  val upperAbbr = "My name is Jonas E. Smith."
  "an isolated pragmatic detector" should behave like isolatedPDRead(upperAbbr, upperAbbrAns)

  //One letter lower case abbreviations
  val lowerAbbrAns = Array("Please turn to p. 55.")
  val lowerAbbr = "Please turn to p. 55."
  "an isolated pragmatic detector" should behave like isolatedPDRead(lowerAbbr, lowerAbbrAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(twoLowerAbbr, twoLowerAbbrAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(twoUpperAbbr, twoUpperAbbrAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(twoLowerAbbrEnd, twoLowerAbbrEndAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(twoUpperAbbrEnd, twoUpperAbbrEndAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(twoPrepositive, twoPrepositiveAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(prepepost, prepepostAns)

  //Possesive two letter abbreviations
  val possessiveAns = Array("That is JFK Jr.'s book.")
  val possessive = "That is JFK Jr.'s book."
  "an isolated pragmatic detector" should behave like isolatedPDRead(possessive, possessiveAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(multiper, multiperAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(multiperEnd, multiperEndAns)

  //U.S. as sentence boundary
  val USBoundAns = Array("I live in the U.S.", "How about you?")
  val USBound = "I live in the U.S. How about you?"
  "an isolated pragmatic detector" should behave like isolatedPDRead(USBound, USBoundAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(USBoundNextCap, USBoundNextCapAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(USNonSentence, USNonSentenceAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(AMPM, AMPMAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(numberNonSent, numberNonSentAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(numberSent, numberSentAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(parents, parentsAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(email, emailAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(web, webAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(singleQuot, singleQuotAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(doubleQuot, doubleQuotAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(doubleQuotEnd, doubleQuotEndAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(doublePunct, doublePunctAns)

  //Double punctuation (question mark)
  val doublePunctQuestAns = Array("Hello??", "Who is there?")
  val doublePunctQuest = "Hello?? Who is there?"
  "an isolated pragmatic detector" should behave like isolatedPDRead(doublePunctQuest, doublePunctQuestAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(doublePunctExcQuest, doublePunctExcQuestAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(doublePunctQuestExc, doublePunctQuestExcAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(listParens, listParensAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(listParensPeriod, listParensPeriodAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(listParensNoPeriod, listParensNoPeriodAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(listParensPeriodEnd, listParensPeriodEndAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(listPeriodMark, listPeriodMarkAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(listPeriodMarkEnd, listPeriodMarkEndAns)

  //List with bullet
  val listBulletAns = Array("• 9. The first item", "• 10. The second item")
  val listBullet = "• 9. The first item • 10. The second item"
  "an isolated pragmatic detector" should behave like isolatedPDRead(listBullet, listBulletAns)

  //List with hypthen
  val listHypthenAns = Array("⁃9. The first item", "⁃10. The second item")
  val listHypthen = "⁃9. The first item ⁃10. The second item"
  "an isolated pragmatic detector" should behave like isolatedPDRead(listHypthen, listHypthenAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(listAlpha, listAlphaAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(errantNewline, errantNewlineAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(errantNewlineMiddle, errantNewlineMiddleAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(lowerCaseList, lowerCaseListAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(geoCoords, geoCoordsAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(namedEntities, namedEntitiesAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(IConfusing, IConfusingAns)
  ...
  val ellipsis = "Thoreau argues that by simplifying one’s life, “the laws of the universe will appear less " +
    "complex. . . .”"
  "an isolated pragmatic detector" should behave like isolatedPDRead(ellipsis, ellipsisAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(ellipsisSquareBr, ellipsisSquareBrAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(ellipsisBoundary, ellipsisBoundaryAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(ellipsisNoSt, ellipsisNoStAns)
  ...
  val ellipsisNonBound = "I wasn’t really ... well, what I mean...see . . . what I'm saying, the thing is . . . " +
    "I didn’t mean it."
  "an isolated pragmatic detector" should behave like isolatedPDRead(ellipsisNonBound, ellipsisNonBoundAns)
  ...
  val ellipsis4dot = "One further habit which was somewhat weakened . . . was that of combining words " +
    "into self-interpreting compounds. . . . The practice was not abandoned. . . ."
  "an isolated pragmatic detector" should behave like isolatedPDRead(ellipsis4dot, ellipsis4dotAns)
  ...
  "an isolated pragmatic detector" should behave like isolatedPDRead(noWhiteSpace, noWhiteSpaceAns)
