...
class DistilBertForSequenceClassificationTestSpec extends AnyFlatSpec {
  ...
  "DistilBertForSequenceClassification" should "be saved and loaded correctly" taggedAs LocalTest in {
  ...
  "DistilBertForSequenceClassification" should "benchmark test" taggedAs LocalTest in {
