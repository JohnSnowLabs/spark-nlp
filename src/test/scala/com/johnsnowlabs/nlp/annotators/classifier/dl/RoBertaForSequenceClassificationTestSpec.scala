...
class RoBertaForSequenceClassificationTestSpec extends AnyFlatSpec {
  ...
  "RoBertaForSequenceClassification" should "run end to end pipeline test" taggedAs SlowTest in {
  ...
  "RoBertaForSequenceClassification" should "correctly load custom model with extracted signatures" taggedAs LocalTest in {
  ...
  "RoBertaForSequenceClassification" should "be saved and loaded correctly" taggedAs LocalTest in {
    ...
    Benchmark.time("Time to save RoBertaForSequenceClassification model") {
      pipelineModel.stages.last
        .asInstanceOf[RoBertaForSequenceClassification]
        .write
        .overwrite()
  ...
  "RoBertaForSequenceClassification" should "benchmark test" taggedAs LocalTest in {
