...
class RoBertaForTokenClassificationTestSpec extends AnyFlatSpec {
  ...
  "RoBertaForTokenClassification" should "run end to end pipeline test" taggedAs SlowTest in {
  ...
  "RoBertaForTokenClassification" should "correctly load custom model with extracted signatures" taggedAs LocalTest in {
  ...
  "RoBertaForTokenClassification" should "be saved and loaded correctly" taggedAs LocalTest in {
    ...
    Benchmark.time("Time to save RoBertaForTokenClassification model") {
      pipelineModel.stages.last
        .asInstanceOf[RoBertaForTokenClassification]
        .write
        .overwrite()
        .save("./tmp_robertafortoken_model")
    }
  ...
  "RoBertaForTokenClassification" should "benchmark test" taggedAs LocalTest in {
