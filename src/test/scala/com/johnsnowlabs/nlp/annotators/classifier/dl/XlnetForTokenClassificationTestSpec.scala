...
class XlnetForTokenClassificationTestSpec extends AnyFlatSpec {
  ...
  "XlnetForTokenClassification" should "run end to end pipeline test" taggedAs SlowTest in {
    ...
    assert(totalLabels > 0, "because token classification should produce labels")
  }
  ...
  "XlnetForTokenClassification" should "be saved and loaded correctly" taggedAs LocalTest in {
    ...
    Benchmark.time("Time to save XlnetForTokenClassification model") {
      pipelineModel.stages.last
        .asInstanceOf[XlnetForTokenClassification]
        .write
        .overwrite()
        .save("./tmp_xlnetfortoken_model")
    }
  ...
  "XlnetForTokenClassification" should "benchmark test" taggedAs LocalTest in {
