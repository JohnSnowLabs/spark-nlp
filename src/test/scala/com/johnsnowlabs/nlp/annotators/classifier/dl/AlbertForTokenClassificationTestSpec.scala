...
class AlbertForTokenClassificationTestSpec extends AnyFlatSpec {
  ...
  "AlbertForTokenClassification" should "be saved and loaded correctly" taggedAs LocalTest in {
  ...
  "AlbertForTokenClassification" should "benchmark test" taggedAs LocalTest in {
