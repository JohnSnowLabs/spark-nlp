...
class RoBertaForQuestionAnsweringTestSpec extends AnyFlatSpec {
  ...
  "RoBertaForQuestionAnswering" should "run end to end pipeline test" taggedAs SlowTest in {
  ...
  "RoBertaForQuestionAnswering" should "correctly load custom model with extracted signatures" taggedAs LocalTest in {
  ...
  "RoBertaForQuestionAnswering" should "be saved and loaded correctly" taggedAs LocalTest in {
    ...
    Benchmark.time("Time to save RoBertaForQuestionAnswering pipeline model") {
      pipelineModel.write.overwrite().save("./tmp_forquestionanswering_pipeline")
    }

    Benchmark.time("Time to save RoBertaForQuestionAnswering model") {
      pipelineModel.stages.last
        .asInstanceOf[RoBertaForQuestionAnswering]
        .write
        .overwrite()
    ...
    val loadedSequenceModel = RoBertaForQuestionAnswering.load("./tmp_forquestionanswering_model")

  }

  "RoBertaForQuestionAnswering" should "benchmark test" taggedAs LocalTest in {
  ...
  "RoBertaForQuestionAnswering" should "produce correct score and index" taggedAs LocalTest in {
