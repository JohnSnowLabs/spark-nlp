...
class RobertaForMultipleChoiceTestSpec extends AnyFlatSpec with SparkSessionTest {
  ...
  "RobertaForMultipleChoice" should "run end to end pipeline test" taggedAs SlowTest in {
    pipelineModel.transform(testDataframe).show(truncate = false)
  }

  "RobertaForMultipleChoice" should "answer a multiple choice question" taggedAs LocalTest in {
