...
class DeBertaForSequenceClassificationTestSpec extends AnyFlatSpec {
  ...
  "DeBertaForSequenceClassification" should "correctly load custom model with extracted signatures" taggedAs SlowTest in {
  ...
  "DeBertaForSequenceClassification" should "be saved and loaded correctly" taggedAs SlowTest in {
  ...
  "DeBertaForSequenceClassification" should "benchmark test" taggedAs SlowTest in {
