...
class DeBertaForSequenceClassificationTestSpec extends AnyFlatSpec {

  import ResourceHelper.spark.implicits._

  "DeBertaForSequenceClassification" should "run end to end pipeline test" taggedAs SlowTest in {
    ...
    val classifier = DeBertaForSequenceClassification
      .pretrained()
  ...
  "DeBertaForSequenceClassification" should "correctly load custom model with extracted signatures" taggedAs LocalTest in {
  ...
  "DeBertaForSequenceClassification" should "be saved and loaded correctly" taggedAs LocalTest in {
    ...
    Benchmark.time("Time to save DeBertaForSequenceClassification pipeline model") {
      pipelineModel.write.overwrite().save("./tmp_forsequence_pipeline")
    }

    Benchmark.time("Time to save DeBertaForSequenceClassification model") {
      pipelineModel.stages.last
        .asInstanceOf[DeBertaForSequenceClassification]
        .write
        .overwrite()
    ...
    val loadedSequenceModel = DeBertaForSequenceClassification.load("./tmp_forsequence_model")
    println(loadedSequenceModel.getClasses.mkString("Array(", ", ", ")"))

  }

  "DeBertaForSequenceClassification" should "benchmark test" taggedAs LocalTest in {
