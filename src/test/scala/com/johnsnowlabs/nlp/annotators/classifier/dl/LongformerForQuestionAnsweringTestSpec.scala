...
class LongformerForQuestionAnsweringTestSpec extends AnyFlatSpec {
  ...
  "LongformerForQuestionAnswering" should "correctly load custom model with extracted signatures" taggedAs SlowTest in {
  ...
  "LongformerForQuestionAnswering" should "benchmark test" taggedAs SlowTest in {
    ...
    Benchmark.time("Time to show LongformerForQuestionAnswering results") {
      pipelineDF.select("answer").show(10, false)
    }

    Benchmark.time("Time to save LongformerForQuestionAnswering results") {
      pipelineDF
