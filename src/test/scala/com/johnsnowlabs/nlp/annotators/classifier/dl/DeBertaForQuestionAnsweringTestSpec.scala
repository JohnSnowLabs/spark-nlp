...
class DeBertaForQuestionAnsweringTestSpec extends AnyFlatSpec {
  ...
  "DeBertaForQuestionAnswering" should "be saved and loaded correctly" taggedAs LocalTest in {
  ...
  "DeBertaForQuestionAnswering" should "benchmark test" taggedAs LocalTest in {
