...
class DistilBertForQuestionAnsweringTestSpec extends AnyFlatSpec {

  import ResourceHelper.spark.implicits._

  "DistilBertForQuestionAnswering" should "correctly load custom model with extracted signatures" taggedAs LocalTest in {
    ...
    val questionAnswering = DistilBertForQuestionAnswering
      .pretrained()
    ...
    pipeline.fit(testDF).transform(testDF).show()
  ...
  "DistilBertForQuestionAnswering" should "be saved and loaded correctly" taggedAs LocalTest in {
    ...
    Benchmark.time("Time to save DistilBertForQuestionAnswering pipeline model") {
      pipelineModel.write.overwrite().save("./tmp_forquestionanswering_pipeline")
    }

    Benchmark.time("Time to save DistilBertForQuestionAnswering model") {
      pipelineModel.stages.last
        .asInstanceOf[DistilBertForQuestionAnswering]
        .write
        .overwrite()
  ...
  "DistilBertForQuestionAnswering" should "benchmark test" taggedAs LocalTest in {
    ...
    Benchmark.time("Time to show DistilBertForQuestionAnswering results") {
      pipelineDF.select("answer").show(10, false)
    }

    Benchmark.time("Time to save DistilBertForQuestionAnswering results") {
      pipelineDF
