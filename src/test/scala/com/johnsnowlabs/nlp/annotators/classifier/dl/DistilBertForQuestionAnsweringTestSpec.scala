...
class DistilBertForQuestionAnsweringTestSpec extends AnyFlatSpec {
  ...
  "DistilBertForQuestionAnswering" should "correctly load custom model with extracted signatures" taggedAs SlowTest in {
  ...
  "DistilBertForQuestionAnswering" should "be saved and loaded correctly" taggedAs SlowTest in {
  ...
  "DistilBertForQuestionAnswering" should "benchmark test" taggedAs SlowTest in {
