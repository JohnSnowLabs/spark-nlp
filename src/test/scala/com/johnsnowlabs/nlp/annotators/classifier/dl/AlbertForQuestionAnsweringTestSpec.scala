...
class AlbertForQuestionAnsweringTestSpec extends AnyFlatSpec {
  ...
  "AlbertForQuestionAnswering" should "run end to end pipeline test" taggedAs SlowTest in {
    ...
    val ddd = Seq(("What was the first album Beyoncé released as a solo artist?", beyonceContext))
  ...
  "AlbertForQuestionAnswering" should "correctly load custom model with extracted signatures" taggedAs LocalTest in {
  ...
  "AlbertForQuestionAnswering" should "be saved and loaded correctly" taggedAs LocalTest in {
    ...
    Benchmark.time("Time to save AlbertForQuestionAnswering pipeline model") {
      pipelineModel.write.overwrite().save("./tmp_forquestionanswering_pipeline")
    }

    Benchmark.time("Time to save AlbertForQuestionAnswering model") {
      pipelineModel.stages.last
        .asInstanceOf[AlbertForQuestionAnswering]
        .write
        .overwrite()
    ...
    val loadedSequenceModel = AlbertForQuestionAnswering.load("./tmp_forquestionanswering_model")

  }
  "AlbertForQuestionAnswering" should "benchmark test" taggedAs LocalTest in {
