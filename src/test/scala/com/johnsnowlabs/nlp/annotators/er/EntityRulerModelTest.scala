...
class EntityRulerModelTest extends AnyFlatSpec with SparkSessionTest {
  ...
  "EntityRulerModel (default)" should "extract both email and IP entities" taggedAs FastTest in {
  ...
  "EntityRulerModel (email-only)" should "extract only email addresses" taggedAs FastTest in {
  ...
  "EntityRulerModel (ip-only)" should "extract only IP addresses" taggedAs FastTest in {
  ...
  "EntityRulerModel (email+ip)" should "extract both emails and IPs when both requested" taggedAs FastTest in {
  ...
  "EntityRulerModel (autoMode='contact_entities')" should "extract emails" taggedAs FastTest in {
  ...
  it should "detect only emails and phones with COMMUNICATION_ENTITIES mode" taggedAs FastTest in {
  ...
  it should "detect only IPs and hostnames with NETWORK_ENTITIES mode" taggedAs FastTest in {
  ...
  it should "detect both emails, phones, and IPs with CONTACT_ENTITIES mode" taggedAs FastTest in {
  ...
  it should "detect everything with ALL_ENTITIES mode" taggedAs FastTest in {
  ...
  it should "handle case-insensitive autoMode values" taggedAs FastTest in {
  ...
  it should "detect email addresses using sentence-level regex matching" taggedAs FastTest in {
    val data =
  ...
  it should "detect full IP range patterns at sentence-level when using NETWORK_ENTITIES mode" taggedAs FastTest in {
    val data =
  ...
  it should "handle case-insensitive autoMode with sentenceMatch = true" taggedAs FastTest in {
