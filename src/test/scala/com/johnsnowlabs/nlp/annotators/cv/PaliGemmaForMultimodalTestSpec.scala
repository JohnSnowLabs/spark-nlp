...
class PaliGemmaForMultiModalTestSpec extends AnyFlatSpec {
  ...
  "PaliGemmaForMultiModal" should "answer a question for a given image" taggedAs LocalTest in {
  ...
  "PaliGemmaForMultiModal" should "run end to end pipeline test" taggedAs SlowTest in {
    val testDF = getTestDF
