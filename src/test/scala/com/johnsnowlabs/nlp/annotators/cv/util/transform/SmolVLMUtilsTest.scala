...
//    g.dispose()
  ...
  it should "pad single image correctly" taggedAs SlowTest in {
    ...
    val image = Array(
      ...
      Array(Array(7.0f, 8.0f), Array(9.0f, 10.0f), Array(11.0f, 12.0f)), // channel 2
      Array(Array(13.0f, 14.0f), Array(15.0f, 16.0f), Array(17.0f, 18.0f)) // channel 3
    )
    ...
    result.paddedImages.head.head.length shouldBe 3 // channels
    result.paddedImages.head.head(0).length shouldBe 3 // height
    result.paddedImages.head.head(0)(0).length shouldBe 2 // width

    // Check original values preserved
    result.paddedImages.head.head(0)(0) shouldBe Array(1.0f, 2.0f)
    result.paddedImages.head.head(0)(1) shouldBe Array(3.0f, 4.0f)
    result.paddedImages.head.head(0)(2) shouldBe Array(5.0f, 6.0f)
    result.paddedImages.head.head(1)(0) shouldBe Array(7.0f, 8.0f)
    result.paddedImages.head.head(1)(1) shouldBe Array(9.0f, 10.0f)
    result.paddedImages.head.head(1)(2) shouldBe Array(11.0f, 12.0f)
    result.paddedImages.head.head(2)(0) shouldBe Array(13.0f, 14.0f)
    result.paddedImages.head.head(2)(1) shouldBe Array(15.0f, 16.0f)
    result.paddedImages.head.head(2)(2) shouldBe Array(17.0f, 18.0f)
  ...
  it should "pad multiple images in batch correctly" taggedAs SlowTest in {
    ...
    val image1 = Array( // 3x2x2
      ...
      Array(Array(5.0f, 6.0f), Array(7.0f, 8.0f)), // channel 2
      Array(Array(9.0f, 10.0f), Array(11.0f, 12.0f)) // channel 3
    )
    val image2 = Array( // 3x3x2
      Array(Array(13.0f, 14.0f), Array(15.0f, 16.0f), Array(17.0f, 18.0f)), // channel 1
      Array(Array(19.0f, 20.0f), Array(21.0f, 22.0f), Array(23.0f, 24.0f)), // channel 2
      Array(Array(25.0f, 26.0f), Array(27.0f, 28.0f), Array(29.0f, 30.0f)) // channel 3
    )
    ...
    result.paddedImages.head.length shouldBe 2 // 2 images in batch
    result.paddedImages.head.head.length shouldBe 3 // channels
    result.paddedImages.head.head.head.length shouldBe 3 // height
    result.paddedImages.head.head.head(0).length shouldBe 2 // width

    // Check first image
    result.paddedImages.head(0)(0)(0) shouldBe Array(1.0f, 2.0f)
    result.paddedImages.head(0)(0)(1) shouldBe Array(3.0f, 4.0f)
    result.paddedImages.head(0)(0)(2) shouldBe Array(0.0f, 0.0f)
    result.paddedImages.head(0)(1)(0) shouldBe Array(5.0f, 6.0f)
    result.paddedImages.head(0)(1)(1) shouldBe Array(7.0f, 8.0f)
    result.paddedImages.head(0)(1)(2) shouldBe Array(0.0f, 0.0f)
    result.paddedImages.head(0)(2)(0) shouldBe Array(9.0f, 10.0f)
    result.paddedImages.head(0)(2)(1) shouldBe Array(11.0f, 12.0f)
    result.paddedImages.head(0)(2)(2) shouldBe Array(0.0f, 0.0f)

    // Check second image
    result.paddedImages.head(1)(0)(0) shouldBe Array(13.0f, 14.0f)
    result.paddedImages.head(1)(0)(1) shouldBe Array(15.0f, 16.0f)
    result.paddedImages.head(1)(0)(2) shouldBe Array(17.0f, 18.0f)
    result.paddedImages.head(1)(1)(0) shouldBe Array(19.0f, 20.0f)
    result.paddedImages.head(1)(1)(1) shouldBe Array(21.0f, 22.0f)
    result.paddedImages.head(1)(1)(2) shouldBe Array(23.0f, 24.0f)
    result.paddedImages.head(1)(2)(0) shouldBe Array(25.0f, 26.0f)
    result.paddedImages.head(1)(2)(1) shouldBe Array(27.0f, 28.0f)
    result.paddedImages.head(1)(2)(2) shouldBe Array(29.0f, 30.0f)

    // Check pixel masks
    result.pixelMasks.get.head(0) shouldBe Array(Array(1, 1), Array(1, 1), Array(0, 0))
  ...
  it should "pad with different constant value" taggedAs SlowTest in {
    ...
    result.paddedImages.head(0)(0)(2) shouldBe Array(5.0f, 5.0f)
    result.paddedImages.head(0)(1)(2) shouldBe Array(5.0f, 5.0f)
    result.paddedImages.head(0)(2)(2) shouldBe Array(5.0f, 5.0f)
  ...
  it should "handle different sized images in batch" taggedAs SlowTest in {
    ...
    val image1 = Array(
      ...
      Array(Array(2.0f)), // channel 2
      Array(Array(3.0f)) // channel 3
    )
    val image2 = Array(
      Array(Array(4.0f, 5.0f), Array(6.0f, 7.0f)), // channel 1
      Array(Array(8.0f, 9.0f), Array(10.0f, 11.0f)), // channel 2
      Array(Array(12.0f, 13.0f), Array(14.0f, 15.0f)) // channel 3
    )
    val images = Seq(Seq(image1, image2))
    ...
    result.paddedImages.head(0).length shouldBe 3 // channels
    result.paddedImages.head(0)(0).length shouldBe 2 // height
    result.paddedImages.head(0)(0)(0).length shouldBe 2 // width
    result.paddedImages.head(1).length shouldBe 3 // channels
    result.paddedImages.head(1)(0).length shouldBe 2 // height
    result.paddedImages.head(1)(0)(0).length shouldBe 2 // width
