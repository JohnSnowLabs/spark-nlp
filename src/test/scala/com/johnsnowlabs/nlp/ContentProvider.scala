...
object ContentProvider {
  ...
  lazy val parquetData =
    SparkAccessor.spark.read.parquet("./src/test/resources/sentiment.parquet")

  val latinBody: String =
  ...
  val targetSentencesFromWsj = Array(
