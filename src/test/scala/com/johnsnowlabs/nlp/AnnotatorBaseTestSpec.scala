...
class DummyAnnotatorModel(override val uid: String) extends AnnotatorModel[DummyAnnotatorModel] with WithAnnotate[DummyAnnotatorModel] {
...
class DemandingDummyAnnotatorModel(override val uid: String) extends AnnotatorModel[DemandingDummyAnnotatorModel] with WithAnnotate[DemandingDummyAnnotatorModel] {
  import AnnotatorType._
  override val outputAnnotatorType: AnnotatorType = DUMMY
