...
case class TextSentenceAttrs(words: Seq[TextAttr])
case class TextAttr(attrs: Seq[(String, String)])
...
object DatasetReader {
  ...
  def encodeLabels(labels: TextSentenceLabels, metadata: DatasetMetadata): InstanceLabels = {
