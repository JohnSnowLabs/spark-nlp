...
/**
  ...
  */
class PerceptronApproachLegacy(override val uid: String) extends AnnotatorApproach[PerceptronModel] with PerceptronUtils {
...
object PerceptronApproachLegacy extends DefaultParamsReadable[PerceptronApproach]