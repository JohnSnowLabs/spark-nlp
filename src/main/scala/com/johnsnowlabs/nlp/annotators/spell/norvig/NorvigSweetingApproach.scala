 ...
 * as an [[com.johnsnowlabs.nlp.util.io.ExternalResource ExternalResource]], where each word is parsed by a regex pattern.
 *
 ...
 * }}}
 *
 * @see [[com.johnsnowlabs.nlp.annotators.spell.symmetric.SymmetricDeleteApproach SymmetricDeleteApproach]] for an alternative approach to spell checking
