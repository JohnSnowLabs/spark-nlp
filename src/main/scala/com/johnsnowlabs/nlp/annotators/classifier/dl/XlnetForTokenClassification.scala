...
/** XlnetForTokenClassification can load XLNet Models with a token classification head on top (a
  ...
  *
  * and the
  * [[https://github.com/JohnSnowLabs/spark-nlp/blob/master/src/test/scala/com/johnsnowlabs/nlp/annotators/classifier/dl/XlnetForTokenClassificationTestSpec.scala XlnetForTokenClassificationTestSpec]].
...
/** This is the companion object of [[XlnetForTokenClassification]]. Please refer to that class
