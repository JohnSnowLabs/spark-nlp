...
/** XlnetForSequenceClassification can load XLNet Models with sequence classification/regression
...
/** This is the companion object of [[XlnetForSequenceClassification]]. Please refer to that class
