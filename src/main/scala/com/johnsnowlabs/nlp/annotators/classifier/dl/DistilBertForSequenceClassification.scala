...
/** DistilBertForSequenceClassification can load DistilBERT Models with sequence
...
trait ReadDistilBertForSequenceDLModel extends ReadTensorflowModel with ReadOnnxModel with ReadOpenvinoModel{
  ...
  def loadSavedModel(
    ...
    val annotatorModel = new DistilBertForSequenceClassification()
...
/** This is the companion object of [[DistilBertForSequenceClassification]]. Please refer to that
