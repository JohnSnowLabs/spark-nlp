 ...
 *
 * See also [[https://en.wikipedia.org/wiki/Inside%E2%80%93outside%E2%80%93beginning_(tagging) Inside–outside–beginning (tagging)]] for more information.
 *
 * ==Example==
