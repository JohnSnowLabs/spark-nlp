...
import com.johnsnowlabs.ml.ai.GPTJ
...
import com.johnsnowlabs.nlp.annotators.tokenizer.bpe.{BpeTokenizer, GPTJTokenizer}
...
/** GPT-2: the OpenAI Text-To-Text Transformer
  ...
  * {{{
  * val gpt2 = GPTJTransformer.pretrained()
  ...
  * import com.johnsnowlabs.nlp.annotators.seq2seq.GPTJTransformer
  ...
  *
  * val gpt2 = GPTJTransformer.pretrained("gpt2")
  ...
  */
class GPTJTransformer(override val uid: String)
    extends AnnotatorModel[GPTJTransformer]
    with HasBatchedAnnotate[GPTJTransformer]
    with ParamsAndFeaturesWritable
    with WriteTensorflowModel
    with HasEngine {

  def this() = this(Identifiable.randomUID("GPTJTRANSFORMER"))
  ...
  /** @group setParam */
  def setTask(value: String): GPTJTransformer.this.type = {
    if (get(task).isEmpty)
      set(task, value)
    this
  }
  ...
  /** @group setParam */
  def setMinOutputLength(value: Int): GPTJTransformer.this.type = {
  ...
  /** @group setParam */
  def setMaxOutputLength(value: Int): GPTJTransformer.this.type = {
  ...
  /** @group setParam */
  def setDoSample(value: Boolean): GPTJTransformer.this.type = {
    set(doSample, value)
    this
  }
  ...
  /** @group setParam */
  def setTemperature(value: Double): GPTJTransformer.this.type = {
  ...
  /** @group setParam */
  def setTopK(value: Int): GPTJTransformer.this.type = {
    set(topK, value)
    this
  }
  ...
  /** @group setParam */
  def setTopP(value: Double): GPTJTransformer.this.type = {
    set(topP, value)
    this
  }
  ...
  /** @group setParam */
  def setRepetitionPenalty(value: Double): GPTJTransformer.this.type = {
  ...
  /** @group setParam */
  def setNoRepeatNgramSize(value: Int): GPTJTransformer.this.type = {
  ...
  /** @group setParam */
  def setRandomSeed(value: Int): GPTJTransformer.this.type = {
  ...
  /** @group setParam */
  def setIgnoreTokenIds(tokenIds: Array[Int]): GPTJTransformer.this.type = {
  ...
  /** @group setParam */
  def setConfigProtoBytes(bytes: Array[Int]): GPTJTransformer.this.type =
    set(this.configProtoBytes, bytes)

  /** @group getParam */
  def getConfigProtoBytes: Option[Array[Byte]] = get(this.configProtoBytes).map(_.map(_.toByte))

  private var _tfModel: Option[Broadcast[GPTJ]] = None
  ...
  def setModelIfNotSet(spark: SparkSession, tfWrapper: TensorflowWrapper): this.type = {
    if (_tfModel.isEmpty) {
      ...
      val bpeTokenizer = BpeTokenizer
        ...
        .asInstanceOf[GPTJTokenizer]

      _tfModel = Some(
        spark.sparkContext.broadcast(
          new GPTJ(tfWrapper, bpeTokenizer, configProtoBytes = getConfigProtoBytes)))
    }
    this
  }

  /** @group getParam */
  def getModelIfNotSet: GPTJ = _tfModel.get.value
  ...
  override def onWrite(path: String, spark: SparkSession): Unit = {
    ...
    writeTensorflowModelV2(
      ...
      "_gptj",
      GPTJTransformer.tfFile,
      configProtoBytes = getConfigProtoBytes)
  }
}

trait ReadablePretrainedGPTJTransformerModel
    extends ParamsAndFeaturesReadable[GPTJTransformer]
    with HasPretrained[GPTJTransformer] {
  override val defaultModelName: Some[String] = Some("gptj")

  /** Java compliant-overrides */
  override def pretrained(): GPTJTransformer = super.pretrained()

  override def pretrained(name: String): GPTJTransformer = super.pretrained(name)

  override def pretrained(name: String, lang: String): GPTJTransformer =
    super.pretrained(name, lang)

  override def pretrained(name: String, lang: String, remoteLoc: String): GPTJTransformer =
    super.pretrained(name, lang, remoteLoc)
}

trait ReadGPTJTransformerDLModel extends ReadTensorflowModel {
  this: ParamsAndFeaturesReadable[GPTJTransformer] =>

  override val tfFile: String = "gptj_tensorflow"

  def readModel(instance: GPTJTransformer, path: String, spark: SparkSession): Unit = {
    val tf = readTensorflowModel(path, spark, "_gptj_tf")
    instance.setModelIfNotSet(spark, tf)
  }

  addReader(readModel)

  def loadSavedModel(modelPath: String, spark: SparkSession): GPTJTransformer = {
    ...
    val annotatorModel = new GPTJTransformer()
...
object GPTJTransformer
    extends ReadablePretrainedGPTJTransformerModel
    with ReadGPTJTransformerDLModel
