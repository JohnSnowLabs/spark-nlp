...
import com.johnsnowlabs.nlp.{Annotation, AnnotatorModel, AnnotatorType, WithAnnotate}
...
/**
  ...
  **/
class Chunker(override val uid: String) extends AnnotatorModel[Chunker] with WithAnnotate[Chunker] {
