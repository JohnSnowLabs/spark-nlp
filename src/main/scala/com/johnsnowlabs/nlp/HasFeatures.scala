...
trait HasFeatures {
  ...
  protected def setDefault[T](feature: ArrayFeature[T], value: Array[T]): this.type = {feature.setDefault(Some(value)); this}

  protected def setDefault[K, V](feature: MapFeature[K, V], value: Map[K, V]): this.type = {feature.setDefault(Some(value)); this}

  protected def setDefault[T](feature: StructFeature[T], value: T): this.type = {feature.setDefault(Some(value)); this}
