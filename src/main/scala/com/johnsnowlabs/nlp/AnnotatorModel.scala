...
abstract class AnnotatorModel[M <: Model[M]]
  ...
  /**
    ...
    */
  def annotate(annotations: Seq[Annotation], recursivePipeline: Option[PipelineModel] = None): Seq[Annotation]
  ...
  /**
    ...
    */
  protected def dfAnnotate(recursivePipeline: Option[PipelineModel]): UserDefinedFunction = udf {
  ...
  protected def _transform(dataset: Dataset[_], recursivePipeline: Option[PipelineModel]): DataFrame = {
    ...
    val processedDataset = inputDataset.withColumn(
      getOutputCol,
      wrapColumnMetadata(dfAnnotate(recursivePipeline)(
