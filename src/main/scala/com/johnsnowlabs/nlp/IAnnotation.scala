...
/**
 * IAnnotation trait is used to abstract the annotator's output for each NLP tasks
 * available in Spark NLP.
 *
 ...
 *
 * LightPipeline models in Java/Scala returns an IAnnotation collection.
 * All of these outputs are structs with the required data types to represent Text, Image and Audio.
 *
 * If one wants to access the data as Annotation, AnnotationImage or AnnotationAudio,
 * one just needs casting to the desired output.
 * ==Example==
 * {{{
