...
import com.johnsnowlabs.nlp.annotators.tokenizer.bpe.GPTJTokenizer
...
private[johnsnowlabs] class GPTJ(
    val tensorflow: TensorflowWrapper,
    val bpeTokenizer: GPTJTokenizer,
    configProtoBytes: Option[Array[Byte]] = None)
    extends Serializable {

  // keys representing the input and output tensors of the GPT2 model
  private val inputIdsKey = "serving_default_input_ids:0"
  private val attentionMaskKey = "serving_default_attention_mask:0"
  private val outputLogitsKey = "StatefulPartitionedCall_1:0"
  private val outputPastKeyValuesKey = "StatefulPartitionedCall_1:1"
