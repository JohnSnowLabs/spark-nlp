...
import com.johnsnowlabs.nlp.annotators.tokenizer.bpe.{BpeTokenizer, Phi4Tokenizer, SpecialTokens}
...
/** Phi-4: State-of-the-art open model by Microsoft Research
  ...
  */
private[johnsnowlabs] class Phi4(
  ...
  val bpeTokenizer: Phi4Tokenizer = BpeTokenizer
    .forModel(
      "phi4",
      merges = merges,
      vocab = vocabulary,
