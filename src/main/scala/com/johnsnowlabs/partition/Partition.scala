...
class Partition(params: java.util.Map[String, String] = new java.util.HashMap())
  ...
  /** The Partition class is a unified interface for extracting structured content from various
    ...
    *
    * Supported formats include plain text, HTML, Word (.doc/.docx), Excel (.xls/.xlsx),
    ...
    * initialization.
    *
    * By abstracting reader initialization, type detection, and parsing logic, Partition
    * simplifies document ingestion in scalable NLP pipelines.
    *
    * @param params
    ...
    *   - threshold (Text): Ratio of empty lines used to switch between newline-based and
    *     paragraph grouping.
  ...
  private def getReaderForBytesContent(
    ...
    def partitionUrls(
        urls: Array[String],
        headers: Map[String, String] = Map.empty): DataFrame = {
