...
st.set_page_config(
    layout="wide", page_title="Stopwords for African ", page_icon=jsl_logo_path, initial_sidebar_state="auto"
)

st.caption("")
st.title("Stopwords Remover for African")
...
model_mappings = {
    "Afrikaans": ["stopwords_iso", "af"],
    "Amharic": ["stopwords_iso", "am"],
    "Hausa": ["stopwords_ha", "ha"],
    "Swahili": ["stopwords_sw", "sw"],
    "Yoruba": ["stopwords_yo", "yo"],
}
...
folder_path = f"/content/StopWords African/inputs/{model}"
