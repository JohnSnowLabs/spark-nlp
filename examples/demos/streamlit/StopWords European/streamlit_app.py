...
st.set_page_config(
    layout="wide", page_title="Stopwords for European ", page_icon=jsl_logo_path, initial_sidebar_state="auto"
)

st.caption("")
st.title("Stopwords Remover for European")
...
model_mappings = {
    "Danish": ["stopwords_iso", "da"],
    "French": ["stopwords_iso", "fr"],
    "German": ["stopwords_iso", "de"],
    "Italian": ["stopwords_iso", "it"],
    "Portuguese": ["stopwords_iso", "pt"],
    "Romanian": ["stopwords_iso", "ro"],
    "Spanish": ["stopwords_iso", "es"],
    "Swedish": ["stopwords_iso", "sv"],
...
folder_path = f"/content/StopWords European/inputs/{model}"
