...
st.set_page_config(
    layout="wide", page_title="Stopwords for Middle Eastern", page_icon=jsl_logo_path, initial_sidebar_state="auto"
)

st.caption("")
st.title("Stopwords Remover for Middle Eastern")
...
model_mappings = {
    "Persian": ["stopwords_iso", "fa"],
    "Arabic": ["stopwords_iso", "ar"],
    "Urdu": ["stopwords_iso", "ur"],
}
...
folder_path = f"/content/StopWords Middle Eastern/inputs/{model}"
